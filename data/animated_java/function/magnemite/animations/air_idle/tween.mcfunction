...
execute unless entity @s[type=minecraft:item_display,tag=aj.magnemite.root] run return run function animated_java:global/errors/function_not_executed_as_root_entity {'export_namespace': 'magnemite', 'function_path': 'animated_java:magnemite/animations/air_idle/tween'}
