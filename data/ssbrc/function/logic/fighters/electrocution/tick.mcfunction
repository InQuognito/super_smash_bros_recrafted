...
execute if score in_electric_terrain temp matches 1 as @e[tag=!self,predicate=ssbrc:flag/targets,distance=..4] run function ssbrc:logic/fighters/electrocution/hit
