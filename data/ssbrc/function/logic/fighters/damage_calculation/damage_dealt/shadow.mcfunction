...
execute if score chaos_energy temp >= shadow.chaos_spear.cost vars run function ssbrc:logic/modify_item {old:"chaos_spear",new:"ssbrc:fighters/shadow/chaos_spear/default"}
