...
execute if data storage ssbrc:temp player.temp_data{fighter:"link"} if items entity @s[scores={health=..39}] container.* minecraft:carrot_on_a_stick[minecraft:custom_data~{item:"master_sword",awakened:"true"}] run function ssbrc:logic/item/data/get {item:"master_sword",flag_key:"awakened",flag_value:"false"}
