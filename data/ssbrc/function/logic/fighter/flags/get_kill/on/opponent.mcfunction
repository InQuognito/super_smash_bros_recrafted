...
execute if data storage ssbrc:temp player.temp_data{fighter:"snake"} if entity @s[predicate=ssbrc:flag/holding_sword] unless score players.ingame temp matches 1 run function ssbrc:fighter/snake/logic/get_kill
