...
execute if entity @s[advancements={ssbrc:utility/flag/hurt_player/custom/shadow_neutral=true}] run function ssbrc:fighter/shadow/logic/chaos_meters/fill_random
