...
execute if data storage ssbrc:temp player.temp_data{fighter:"hero"} run scoreboard players add @s magic 2
...
execute if data storage ssbrc:temp player.temp_data{fighter:"shadow"} run function ssbrc:fighter/shadow/logic/chaos_gauge/increase
