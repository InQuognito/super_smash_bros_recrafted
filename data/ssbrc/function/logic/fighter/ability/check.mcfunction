...
execute if entity @s[tag=fox_blaster] run return run function ssbrc:fighter/fox/logic/abilities/blaster/tick
...
execute if entity @s[tag=link_boomerang] run return run function ssbrc:fighter/link/logic/abilities/boomerang/tick
...
# Wolf
execute if entity @s[tag=wolf_blaster] run return run function ssbrc:fighter/wolf/logic/abilities/blaster/tick
...
execute if entity @s[tag=zelda_boomerang] run return run function ssbrc:fighter/zelda/logic/abilities/boomerang/tick
...
function ssbrc:logic/fighter/ability/tick_specific with entity @s data
