...
attribute @s minecraft:jump_strength modifier add ssbrc:immobile -1.0 add_multiplied_total
attribute @s minecraft:knockback_resistance modifier add ssbrc:immobile 1.0 add_value
attribute @s minecraft:movement_speed modifier add ssbrc:immobile -1.0 add_multiplied_total
