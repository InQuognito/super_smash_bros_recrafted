$execute if data storage ssbrc:output {slot_string:"weapon.mainhand"} store result $(output_type) $(output_path) run return run data get entity @s SelectedItem.components.$(component)
