$data modify storage ssbrc:leaderboard $(n).index set value "$(n)"
...
$data modify storage ssbrc:leaderboard $(n).name set from block 0 17 0 front_text.messages[0]

$data modify block 0 17 0 front_text.messages[0] set value '{"score":{"name":"leaderboard.value.$(n)","objective":"temp"}}'
$data modify storage ssbrc:leaderboard $(n).value set from block 0 17 0 front_text.messages[0]

$data modify block 0 17 0 front_text.messages[0] set value '{"score":{"name":"leaderboard.ratio.$(n)","objective":"temp"}}'
$data modify storage ssbrc:leaderboard $(n).ratio set from block 0 17 0 front_text.messages[0]

$data modify block 0 17 0 front_text.messages[0] set value '{"score":{"name":"leaderboard.ratio.$(n).integer","objective":"temp"}}'
$data modify storage ssbrc:leaderboard $(n).ratio_integer set from block 0 17 0 front_text.messages[0]

$data modify block 0 17 0 front_text.messages[0] set value '{"score":{"name":"leaderboard.ratio.$(n).decimal","objective":"temp"}}'
$data modify storage ssbrc:leaderboard $(n).ratio_decimal set from block 0 17 0 front_text.messages[0]
