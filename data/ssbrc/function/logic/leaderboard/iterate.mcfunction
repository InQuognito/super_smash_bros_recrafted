...
$execute if score counter temp matches ..5 if entity @a[tag=!leaderboard.loaded,scores={stats.$(value)=1..}] run function ssbrc:logic/leaderboard/$(value)/check with storage ssbrc:leaderboard
