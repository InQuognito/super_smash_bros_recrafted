...
function ssbrc:logic/fighter/get {function:"ssbrc:logic/fighter/tick"}
...
execute if entity @s[scores={flag.damage_dealt=1..}] run function ssbrc:logic/fighter/damage_dealt
execute if entity @s[scores={flag.damage_taken=1..}] run function ssbrc:logic/fighter/damage_taken

execute if entity @s[scores={fall_distance=1..}] run function ssbrc:logic/fighter/shockwave/check
...
# Fighter Effects
execute if data storage ssbrc:temp player.temp_data{skin:"gold"} run function ssbrc:logic/tick/gold_trail
...
execute if entity @s[scores={revenge.timer=0..}] run function ssbrc:logic/fighter/bonuses/revenge/tick
