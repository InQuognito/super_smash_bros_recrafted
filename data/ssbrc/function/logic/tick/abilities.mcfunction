...
execute if entity @s[tag=holy_water.display] unless predicate ssbrc:flag/in_air run return run function ssbrc:fighter/alucard/logic/abilities/holy_water/kill_item
