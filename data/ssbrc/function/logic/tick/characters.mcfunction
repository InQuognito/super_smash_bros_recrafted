...
execute at @s[predicate=ssbrc:flag/player] run function ssbrc:logic/tick/fighters

execute as @e[type=!minecraft:player,predicate=ssbrc:id_match] at @s run function ssbrc:logic/tick/abilities
