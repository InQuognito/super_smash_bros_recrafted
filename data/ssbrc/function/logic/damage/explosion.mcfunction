...
$execute unless items entity @s container.* minecraft:stick[minecraft:custom_data~{item:"ring_of_blasting"}] run attribute @s minecraft:knockback_resistance modifier add ssbrc:knockback_resistance $(kb_resist) add_value
