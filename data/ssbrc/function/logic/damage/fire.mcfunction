$execute unless items entity @s container.* minecraft:nether_star[minecraft:custom_data~{item:"goron_locket"}] run attribute @s minecraft:generic.knockback_resistance modifier add ssbrc:knockback_resistance $(kb_resist) add_value
