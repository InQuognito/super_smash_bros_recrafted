...
execute as @e[type=minecraft:text_display,tag=vote_counter,tag=highest,sort=random,limit=1] run data modify storage ssbrc:temp stage_select.highest set string entity @s CustomName
