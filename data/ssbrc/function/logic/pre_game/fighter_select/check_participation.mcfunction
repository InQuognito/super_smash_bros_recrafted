...
execute if score players temp matches ..0 run return run function ssbrc:logic/pre_game/fighter_select/check_participation/no_players

execute if score players temp matches 1.. if score fighter_picked temp = players temp run return run function ssbrc:logic/pre_game/fighter_select/check_participation/quickstart
