...
execute unless score game_stage temp matches -1 unless score players temp matches 1 if score countdown timer matches 0.. run scoreboard players remove @s[tag=!exempt_influence,scores={influence=1..}] influence 1
