...
execute if score game_stage temp matches ..0 if score players temp matches 1.. if score fighter_picked temp = players temp run function ssbrc:logic/pre_game/fighter_select/check_participation/quickstart
