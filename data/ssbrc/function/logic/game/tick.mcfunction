execute as @a[scores={flag.dead=1..}] run function ssbrc:logic/fighter/stock/lose
execute as @a[scores={respawn=2..}] run function ssbrc:logic/fighter/respawn/tick
...
# Fighters
execute as @a[predicate=ssbrc:ingame] run function ssbrc:logic/game/player/tick
...
execute as @a[team=!admin,tag=alive,scores={respawn=..0},gamemode=!adventure,gamemode=!spectator] run function ssbrc:logic/game/team/admin
