...
# Fighters
function ssbrc:logic/fighters/loop {function:"ssbrc:logic/player_data/reset/fighter"}

# Bonuses
function ssbrc:logic/bonuses/loop {function:"ssbrc:logic/player_data/reset/bonus"}
