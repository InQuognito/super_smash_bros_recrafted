...
scoreboard players set fall_distance.low vars 500
scoreboard players set fall_distance.medium vars 800
scoreboard players set fall_distance.high vars 1100
scoreboard players set hud_frequency vars 20
