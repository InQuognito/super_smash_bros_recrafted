...
data modify storage ssbrc:bonuses value append value '[{"translate":"ssbrc.bonuses.participation","bold":true,"color":"gold"},{"text":" - ","bold":false,"color":"white"},{"score":{"name":"value.participation","objective":"const"},"bold":false,"color":"yellow"},{"text":"₡","bold":false,"color":"yellow"}]'
scoreboard players operation @s stats.credits.temp += value.participation const

execute if entity @s[tag=winner,tag=!ended_early] run data modify storage ssbrc:bonuses value append value '[{"translate":"ssbrc.bonuses.win","bold":true,"color":"gold"},{"text":" - ","bold":false,"color":"white"},{"score":{"name":"value.victory","objective":"const"},"bold":false,"color":"yellow"},{"text":"₡","bold":false,"color":"yellow"}]'
