...
execute positioned ~-0.5 ~-0.5 ~-0.5 at @n[type=minecraft:item_display,tag=selectable,tag=hitbox.humanoid,dy=1.5] run function ssbrc:logic/selector/raycast/get_object
