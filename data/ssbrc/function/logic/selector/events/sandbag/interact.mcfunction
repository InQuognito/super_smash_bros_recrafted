...
tellraw @s[advancements={ssbrc:tutorial/fighter_select/2=true,ssbrc:tutorial/stage_select/1=false}] [{"text":"Mr. Sandbag | ","bold":true,"color":"yellow"},{"translate":"ssbrc.sandbag.reminder.2","bold":false,"color":"white"}]
