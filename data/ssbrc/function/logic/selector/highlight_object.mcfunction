function ssbrc:logic/selector/fighter/highlight with storage ssbrc:temp player.data
...
execute if score highlight temp matches 4 positioned ^ ^ ^0.1 run function ssbrc:logic/selector/stage/highlight {particle:"minecraft:dust{color:[0.0,1.0,0.0],scale:0.5}"}
