function ssbrc:logic/player/selector/fighter/highlight with storage ssbrc:temp player.temp_data
...
execute if entity @n[distance=..0.1,name=assets] run particle minecraft:dust_color_transition{from_color:[0.0,1.0,0.0],to_color:[1.0,1.0,1.0],scale:0.5} ~ ~ ~ 0.15 0.15 0.15 0.0 5 force @s
...
execute if score highlight temp matches 4 positioned ^ ^ ^-0.45 run function ssbrc:logic/player/selector/stage/highlight {particle:"minecraft:dust{color:[0.0,1.0,0.0],scale:0.5}"}
execute if score highlight temp matches 5 run function ssbrc:logic/player/selector/stage/highlight {particle:"minecraft:dust{color:[0.0,1.0,0.0],scale:0.5}"}
