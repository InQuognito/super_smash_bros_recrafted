execute positioned ~-0.5 ~-0.5 ~-0.5 at @n[type=minecraft:item_display,nbt={data:{}},tag=!hitbox.humanoid,dx=0] run return run function ssbrc:logic/player/selector/object/get
execute positioned ~-0.5 ~-1 ~-0.5 at @n[type=minecraft:item_display,nbt={data:{}},tag=hitbox.humanoid,dy=1] run return run function ssbrc:logic/player/selector/object/get
