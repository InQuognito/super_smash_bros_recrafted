...
$summon minecraft:text_display ~ ~0.65 ~ {text:{"translate":"$(text)","color":"$(color)","bold":true},Rotation:[-90f,0f],transformation:[0.75f,0f,0f,0f,0f,0.75f,0f,0f,0f,0f,0.75f,0f,0f,0f,0f,1f],alignment:'center'}
