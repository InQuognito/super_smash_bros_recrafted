...
execute if score random.output temp matches 4 if entity @s[advancements={ssbrc:fighters/luigi/skins/penguin=true}] run return run function ssbrc:logic/fighters/select_skin {fighter:"luigi",skin:"penguin",color:"blue"}
execute if score random.output temp matches 5 if entity @s[advancements={ssbrc:fighters/luigi/skins/gooigi=true}] run return run function ssbrc:logic/fighters/select_skin {fighter:"luigi",skin:"gooigi",color:"green"}
