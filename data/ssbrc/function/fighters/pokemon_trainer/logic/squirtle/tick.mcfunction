...
function ssbrc:logic/item/cooldown/display/check {item:"water_gun"}
...
execute if score @s[predicate=!ssbrc:flag/sneaking] charge.2 matches 1.. run function ssbrc:fighters/pokemon_trainer/logic/squirtle/withdraw/reset
