...
execute if score random.output temp matches 3 if entity @s[advancements={ssbrc:fighters/pokemon_trainer/skins/shiny=true}] run return run function ssbrc:logic/fighters/select_skin {fighter:"pokemon_trainer",skin:"shiny",color:"dark_gray"}
execute if score random.output temp matches 4 if entity @s[advancements={ssbrc:fighters/pokemon_trainer/skins/dawn=true}] run return run function ssbrc:logic/fighters/select_skin {fighter:"pokemon_trainer",skin:"dawn",color:"light_purple"}
