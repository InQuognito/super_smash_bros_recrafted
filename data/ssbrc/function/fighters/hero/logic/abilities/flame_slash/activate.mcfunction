...
execute if score random.output temp matches 1 run function ssbrc:fighters/hero/logic/abilities/flame_slash/particles/0_degrees
execute if score random.output temp matches 2 run function ssbrc:fighters/hero/logic/abilities/flame_slash/particles/45_degrees
