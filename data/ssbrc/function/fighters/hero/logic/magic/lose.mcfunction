...
execute unless items entity @s weapon.offhand * run return run loot replace entity @s weapon.offhand loot ssbrc:fighters/hero/shield
loot give @s loot ssbrc:fighters/hero/shield
