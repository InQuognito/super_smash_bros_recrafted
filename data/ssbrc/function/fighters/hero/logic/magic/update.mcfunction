...
execute if items entity @s weapon.mainhand #ssbrc:equipment[minecraft:custom_data~{group:"hero.spell"}] run function ssbrc:fighters/hero/logic/magic/hud/calculate
...
function ssbrc:fighters/hero/logic/magic/hud/check

function ssbrc:logic/player_data/temp/set_storage/get {input:"ssbrc:hud hero.magic",output:"hud.1"}
