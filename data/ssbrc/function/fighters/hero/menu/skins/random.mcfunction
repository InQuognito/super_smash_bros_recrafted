...
execute if score random.output temp matches 4 if entity @s[advancements={ssbrc:fighters/hero/skins/solo=true}] run return run function ssbrc:logic/fighters/select_skin {fighter:"hero",skin:"solo",color:"green"}
...
execute if score random.output temp matches 6 if entity @s[advancements={ssbrc:fighters/hero/skins/rek=true}] run return run function ssbrc:logic/fighters/select_skin {fighter:"hero",skin:"rek",color:"blue"}
