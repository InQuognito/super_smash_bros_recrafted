...
function ssbrc:logic/item/init/slot {item:"dragon_claw",slot:"hotbar.0",type:"variant"}
loot replace entity @s hotbar.1 loot ssbrc:fighters/altered_beast/electrocution
