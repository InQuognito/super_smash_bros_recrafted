...
execute if score @s charge.2 >= altered_beast.pounce.threshold const if score pounce.falloff temp >= altered_beast.pounce.falloff const run function ssbrc:fighters/altered_beast/logic/weretiger/pounce/charge
