...
execute if score random.output temp matches 4 if entity @s[advancements={ssbrc:fighters/sonic/skins/hylian_tunic=true}] run return run function ssbrc:logic/fighters/select_skin {fighter:"sonic",skin:"hylian_tunic",color:"green"}
execute if score random.output temp matches 5 if entity @s[advancements={ssbrc:fighters/sonic/skins/werehog=true}] run return run function ssbrc:logic/fighters/select_skin {fighter:"sonic",skin:"werehog",color:"dark_blue"}
