...
item modify entity @s weapon.mainhand [{"function":"minecraft:set_components","components":{"!minecraft:consumable":{}}},{"function":"minecraft:set_custom_model_data","value":1845}]
