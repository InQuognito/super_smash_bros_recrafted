...
execute unless score @s resource >= cloud.limit.max const run playsound ssbrc:fighters.cloud.blade_beam.activate player @a
execute if score @s resource >= cloud.limit.max const run function ssbrc:fighters/cloud/logic/abilities/buster_sword/blade_beam/limit_break
