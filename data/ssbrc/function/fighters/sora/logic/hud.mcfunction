...
scoreboard players operation percentage temp *= 100 integers
scoreboard players operation percentage temp /= sora.drive.threshold.bar vars
...
title @s actionbar [{"translate":"ssbrc.fighter.sora.mp","bold":true,"color":"blue"},{"nbt":"sora_hud_mp","storage":"ssbrc:data","interpret":true},{"text":" | ","color":"white"},{"translate":"ssbrc.fighter.sora.drive","bold":true,"color":"yellow"},{"nbt":"sora_hud_drive","storage":"ssbrc:data","interpret":true}," ",{"score":{"name":"@s","objective":"resource"},"color":"yellow"}]
