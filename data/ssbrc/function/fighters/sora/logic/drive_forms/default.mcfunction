...
execute if items entity @s container.* minecraft:nether_star[minecraft:custom_data~{item:"keyblade"}] run function ssbrc:logic/replace_item {tag:"item",old:"keyblade",new:"fighters/sora/keyblades/primary/fire"}
