...
execute unless data storage ssbrc:temp player.temp_data{skin:"gold"} run tellraw @s[advancements={ssbrc:fighters/sora/skins/gold=true}] {"translate":"ssbrc.skin.gold","color":"gold","clickEvent":{"action":"run_command","value":"/trigger menu set 2"}}
execute if data storage ssbrc:temp player.temp_data{skin:"gold"} run tellraw @s [{"translate":"ssbrc.skin.gold","color":"gold"},{"text":" ✔","color":"green"}]

execute unless data storage ssbrc:temp player.temp_data{skin:"timeless_river"} run tellraw @s[advancements={ssbrc:fighters/sora/skins/timeless_river=true}] {"translate":"ssbrc.skin.timeless_river","color":"gray","clickEvent":{"action":"run_command","value":"/trigger menu set 3"}}
