...
function ssbrc:logic/item/init/get {item:"fairy_bow",slot:"hotbar.1",type:"default"}

function ssbrc:logic/item/init/get {item:"boomerang",slot:"hotbar.2",type:"default"}
