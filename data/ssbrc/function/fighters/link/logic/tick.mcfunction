# Health
execute if entity @s[scores={health=40..},nbt={Inventory:[{components:{"minecraft:custom_data":{master_sword:1,awakened:0}}}]}] run function ssbrc:logic/item/replace/get {search_key:"item",search_value:"master_sword",new:"ssbrc:fighters/link/master_sword"}
