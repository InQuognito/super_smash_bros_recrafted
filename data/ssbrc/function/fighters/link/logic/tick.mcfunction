# Health
execute if items entity @s[scores={health=40..}] container.* minecraft:nether_star[minecraft:custom_data~{item:"master_sword",awakened:"false"}] run function ssbrc:fighters/link/logic/master_sword/enable
