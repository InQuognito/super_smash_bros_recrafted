execute if score @s charge.output matches 40.. positioned ^ ^ ^-1 run function ssbrc:fighters/steve/logic/item/spawn
...
function ssbrc:fighters/steve/logic/abilities/mining/material with block 0 16 0 Items[{Slot:8b}]
