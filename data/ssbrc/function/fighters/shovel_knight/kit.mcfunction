...
execute if entity @s[tag=war_horn.active] run function ssbrc:fighters/shovel_knight/logic/abilities/war_horn/deactivate

clear @s #ssbrc:equipment

function ssbrc:logic/item/init/default/get {item:"shovel_blade",slot:"hotbar.0",type:"default"}
