...
execute if score random.output temp matches 5 if entity @s[tag=anti_personnel_mine] run return run function ssbrc:fighters/snake/logic/scavenger/utility {item:"anti_personnel_mine"}
execute if score random.output temp matches 6 if entity @s[tag=smoke_grenade] run return run function ssbrc:fighters/snake/logic/scavenger/utility {item:"smoke_grenade"}
