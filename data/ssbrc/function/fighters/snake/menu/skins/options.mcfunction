...
execute unless data storage ssbrc:temp player.temp_data{skin:"gold"} run tellraw @s[advancements={ssbrc:fighters/snake/skins/gold=true}] {"translate":"ssbrc.skin.gold","color":"gold","clickEvent":{"action":"run_command","value":"/trigger menu set 2"}}
execute if data storage ssbrc:temp player.temp_data{skin:"gold"} run tellraw @s [{"translate":"ssbrc.skin.gold","color":"gold"},{"text":" ✔","color":"green"}]

execute unless data storage ssbrc:temp player.temp_data{skin:"classic_tuxedo"} run tellraw @s[advancements={ssbrc:fighters/snake/skins/classic_tuxedo=true}] {"translate":"ssbrc.skin.classic_tuxedo","color":"white","clickEvent":{"action":"run_command","value":"/trigger menu set 3"}}
...
execute unless data storage ssbrc:temp player.temp_data{skin:"iroquois_pliskin"} run tellraw @s[advancements={ssbrc:fighters/snake/skins/iroquois_pliskin=true}] {"translate":"ssbrc.skin.iroquois_pliskin","color":"dark_green","clickEvent":{"action":"run_command","value":"/trigger menu set 4"}}
