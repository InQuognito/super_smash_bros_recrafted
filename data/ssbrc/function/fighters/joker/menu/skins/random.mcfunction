...
execute if score random.output temp matches 3 if entity @s[advancements={ssbrc:fighters/joker/skins/shujin_academy=true}] run return run function ssbrc:logic/fighters/select_skin {fighter:"joker",skin:"shujin_academy",color:"dark_red"}
execute if score random.output temp matches 4 if entity @s[advancements={ssbrc:fighters/joker/skins/christmas_outfit=true}] run return run function ssbrc:logic/fighters/select_skin {fighter:"joker",skin:"christmas_outfit",color:"red"}
