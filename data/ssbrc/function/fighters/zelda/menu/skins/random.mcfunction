...
execute unless score @s[advancements={ssbrc:fighters/zelda/skins/hyrule_warriors=true}] skin_picked matches 1 if score random.output temp matches 3 run function ssbrc:fighters/zelda/menu/skins/hyrule_warriors

execute if score @s skin_picked matches 1 run function ssbrc:logic/fighters/select with storage ssbrc:data fighters.zelda
