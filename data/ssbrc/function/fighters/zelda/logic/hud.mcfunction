...
execute if items entity @s weapon.mainhand #ssbrc:equipment[minecraft:custom_data~{group:"dungeon_item"}] run function ssbrc:fighters/zelda/logic/mana/hud/calculate
