...
execute if items entity @s weapon.mainhand #ssbrc:equipment[minecraft:custom_data~{group:"dungeon_item"}] unless score @s zelda.magic_fountain matches 1.. run function ssbrc:fighters/zelda/logic/magic/hud/calculate
...
function ssbrc:fighters/zelda/logic/magic/hud/check
