...
execute if score ray_length temp matches 0 positioned ^ ^ ^0.05 run function ssbrc:fighters/ryu/logic/abilities/tatsumaki_senpukyaku/raycast/end with storage ssbrc:rotation
