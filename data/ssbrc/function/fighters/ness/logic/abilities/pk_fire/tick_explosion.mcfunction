...
execute positioned ~ ~1 ~ run function ssbrc:fighters/ness/logic/abilities/pk_fire/particles/diamonds/spawn
function ssbrc:fighters/ness/logic/abilities/pk_fire/particles/smoke/offset
function ssbrc:fighters/ness/logic/abilities/pk_fire/particles/smoke/offset
function ssbrc:fighters/ness/logic/abilities/pk_fire/particles/smoke/offset
...
execute as @e[predicate=ssbrc:flag/targets,tag=!self,distance=..1.5] run function ssbrc:logic/damage/fire {amount:"4.0",burning:"10",type:"pierce",kb_resist:"0.9"}
