execute if score @s charge.1 matches ..99 run function ssbrc:logic/player_data/temp/set {mode:"store",key:"form",value:"depleted"}
execute if score @s charge.1 matches 100..199 run function ssbrc:logic/player_data/temp/set {mode:"store",key:"form",value:"ready"}
