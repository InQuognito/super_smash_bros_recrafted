...
execute if score random.output temp matches 3 if entity @s[advancements={ssbrc:fighters/rob/skins/famicom=true}] run return run function ssbrc:logic/fighters/select_skin {fighter:"rob",skin:"famicom",color:"red"}
execute if score random.output temp matches 4 if entity @s[advancements={ssbrc:fighters/rob/skins/ancient_minister=true}] run return run function ssbrc:logic/fighters/select_skin {fighter:"rob",skin:"ancient_minister",color:"dark_green"}
