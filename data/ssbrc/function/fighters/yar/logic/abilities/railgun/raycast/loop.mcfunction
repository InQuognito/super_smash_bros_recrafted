...
execute if score ray_length temp matches 1.. if score ray_piercing temp <= yar.railgun.piercing const positioned ^ ^ ^0.1 run function ssbrc:fighters/yar/logic/abilities/railgun/raycast/loop
