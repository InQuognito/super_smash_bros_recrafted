...
execute anchored eyes positioned ^ ^ ^1 summon minecraft:marker run function ssbrc:fighters/yar/logic/abilities/gatling_gun/init/marker
...
execute if score @s cooldown.1 matches 15 run function ssbrc:fighters/yar/logic/abilities/gatling_gun/charge/on
