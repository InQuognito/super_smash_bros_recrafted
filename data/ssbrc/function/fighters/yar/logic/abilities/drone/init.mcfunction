...
execute store result entity @s attributes[{id:"minecraft:generic.max_health"}].base double 1.0 run scoreboard players get yar.drone.drone.health.cushion vars
