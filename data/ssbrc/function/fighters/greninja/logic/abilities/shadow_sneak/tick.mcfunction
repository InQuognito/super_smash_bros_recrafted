...
execute positioned ~ ~0.5 ~ positioned ^ ^ ^0.5 run function ssbrc:logic/fighters/checks/raycast/block_water
...
execute if entity @s[scores={temp=41..}] as @a[tag=self,limit=1] at @s run function ssbrc:fighters/greninja/logic/abilities/shadow_sneak/end
