...
execute as @a[tag=self,distance=..1.5] run function ssbrc:logic/damage/unsourced {amount:"6.0",type:"generic",kb_resist:"0.0"}
...
execute as @a[tag=self,limit=1] run function ssbrc:logic/item/init/get {item:"barrel",slot:"hotbar.0",type:"default"}
