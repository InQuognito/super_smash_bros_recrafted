...
execute if score chaos_energy temp < shadow.chaos_spear.cost vars run function ssbrc:logic/item/modify {old:"chaos_spear",new:"ssbrc:fighters/shadow/chaos_spear/disabled"}
