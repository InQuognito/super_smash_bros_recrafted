...
execute if score random.output temp matches 3 if entity @s[advancements={ssbrc:fighters/shadow/skins/sir_lancelot=true}] run return run function ssbrc:logic/fighters/select_skin {fighter:"shadow",skin:"sir_lancelot",color:"red"}
execute if score random.output temp matches 4 if entity @s[advancements={ssbrc:fighters/shadow/skins/yellow_android=true}] run return run function ssbrc:logic/fighters/select_skin {fighter:"shadow",skin:"yellow_android",color:"yellow"}
