...
execute unless data storage ssbrc:temp player.temp_data{skin:"yellow_android"} run tellraw @s[advancements={ssbrc:fighters/shadow/skins/yellow_android=true}] {"translate":"ssbrc.skin.yellow_android","color":"yellow","clickEvent":{"action":"run_command","value":"/trigger menu set 3"}}
...
execute unless data storage ssbrc:temp player.temp_data{skin:"sir_lancelot"} run tellraw @s[advancements={ssbrc:fighters/shadow/skins/sir_lancelot=true}] {"translate":"ssbrc.skin.sir_lancelot","color":"red","clickEvent":{"action":"run_command","value":"/trigger menu set 4"}}
