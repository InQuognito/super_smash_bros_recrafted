...
execute if score random.output temp matches 3 if entity @s[advancements={ssbrc:fighters/samus/skins/gravity_suit=true}] run return run function ssbrc:logic/fighters/select_skin {fighter:"samus",skin:"gravity_suit",color:"light_purple"}
