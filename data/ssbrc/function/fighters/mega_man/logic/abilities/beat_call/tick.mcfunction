...
execute if entity @s[tag=stop,scores={cooldown.1=..0}] facing entity @n[tag=!self,predicate=ssbrc:flag/targets,distance=..3] eyes run function ssbrc:fighters/mega_man/logic/abilities/beat_call/projectile/activate
