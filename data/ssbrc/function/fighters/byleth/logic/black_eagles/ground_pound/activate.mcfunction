...
execute as @e[predicate=ssbrc:flag/targets,tag=!self,distance=..6] unless block ~ ~-0.5 ~ minecraft:air run function ssbrc:logic/damage/player {amount:"20.0",type:"generic",kb_resist:"0.0"}

scoreboard players set @s cooldown 10

item modify entity @s weapon.mainhand ssbrc:fighters/byleth/black_eagles/aymr/default

scoreboard players set durability.modify temp 3
