...
execute if items entity @s[predicate=ssbrc:flag/sneaking] weapon.mainhand minecraft:iron_axe[minecraft:custom_data~{item:"aymr"},!minecraft:consumable] run item modify entity @s weapon.mainhand ssbrc:init/ability/enable
