...
execute as @n[type=minecraft:armor_stand,tag=guardian_orbitar,predicate=ssbrc:id_match] run function ssbrc:fighters/pit/logic/abilities/guardian_orbitars/damage
