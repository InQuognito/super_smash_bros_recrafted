...
execute if score random.output temp matches 4 if entity @s[advancements={ssbrc:fighters/ganondorf/skins/tears_of_the_kingdom=true}] run return run function ssbrc:logic/fighters/select_skin {fighter:"ganondorf",skin:"tears_of_the_kingdom",color:"dark_red"}
execute if score random.output temp matches 5 if entity @s[advancements={ssbrc:fighters/ganondorf/skins/wind_waker=true}] run return run function ssbrc:logic/fighters/select_skin {fighter:"ganondorf",skin:"wind_waker",color:"aqua"}
