...
execute if score random.output temp matches 0 unless score neutral_zone temp matches 1 run function ssbrc:stages/planet_epp/logic/hazards/neutral_zone/activate
...
execute unless score planet_epp.hazard temp matches 1 run function ssbrc:stages/planet_epp/logic/hazards/choose
