...
execute if score random.output temp matches 4 run function ssbrc:stages/final_destination/load/generic_cloud {trim:"lime_concrete",light:"verdant_froglight",cloud:"lime_stained_glass"}
