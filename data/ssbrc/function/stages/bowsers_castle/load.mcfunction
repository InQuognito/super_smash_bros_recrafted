...
execute positioned -735.0 27.5 834.5 rotated -90.0 0.0 summon minecraft:item_display run function ssbrc:stages/bowsers_castle/logic/armor_stands/toad {pose:"clutching_bars",color:"red"}
execute positioned -737.7 27.2 833.2 rotated -45.0 0.0 summon minecraft:item_display run function ssbrc:stages/bowsers_castle/logic/armor_stands/toad {pose:"sitting",color:"yellow"}
execute positioned -736.5 27.5 836.0 rotated 0.0 0.0 summon minecraft:item_display run function ssbrc:stages/bowsers_castle/logic/armor_stands/toad {pose:"clutching_bars",color:"blue"}
