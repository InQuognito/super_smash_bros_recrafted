...
execute if score @s[y=45.5,dy=0] temp >= thwomp_time const run function ssbrc:stages/bowsers_castle/logic/hazards/thwomp/middle/deactivate
...
execute if score @s[tag=sinking] temp >= thwompSinkTime const run function ssbrc:stages/bowsers_castle/logic/hazards/thwomp/middle/deactivate
