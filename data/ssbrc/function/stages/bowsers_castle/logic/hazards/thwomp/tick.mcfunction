...
execute if score @s temp = thwomp_time const run function ssbrc:stages/bowsers_castle/logic/hazards/thwomp/idle
execute if score @s[tag=!sinking] temp >= thwomp_time const run function ssbrc:stages/bowsers_castle/logic/hazards/thwomp/move_upward
