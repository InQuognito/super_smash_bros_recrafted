...
execute if score hazards options matches 1 if predicate ssbrc:random_chance/0.15 run function ssbrc:stages/bowsers_castle/logic/hazards/choose

execute if score banzai_bill temp matches 1 as @e[type=minecraft:item_display,tag=banzai_bill] at @s run function ssbrc:stages/bowsers_castle/logic/hazards/banzai_bill/tick
...
execute as @e[type=minecraft:armor_stand,tag=bob_omb] at @s run function ssbrc:stages/bowsers_castle/logic/hazards/bob_omb/tick
execute as @e[type=minecraft:armor_stand,tag=thwomp] at @s run function ssbrc:stages/bowsers_castle/logic/hazards/thwomp/tick
