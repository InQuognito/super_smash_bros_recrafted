...
execute if predicate ssbrc:random_chance/palutenas_temple_hazard unless entity @e[type=minecraft:item,nbt={Item:{components:{"minecraft:custom_data":{item:"angel_feather"}}}}] positioned 50005.5 223.5 24960.0 run function ssbrc:stages/palutenas_temple/logic/angel_feather/spawn
