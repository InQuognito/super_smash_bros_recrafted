...
# Shiny Modifiers
execute as @e[type=minecraft:item_display,tag=abra] if predicate ssbrc:fighters/pokemon/shiny_chance run item replace entity @s contents with minecraft:diamond[minecraft:custom_model_data=631]
execute as @e[type=minecraft:item_display,tag=diglett] if predicate ssbrc:fighters/pokemon/shiny_chance run item replace entity @s contents with minecraft:diamond[minecraft:custom_model_data=502]
execute as @e[type=minecraft:item_display,tag=dugtrio] if predicate ssbrc:fighters/pokemon/shiny_chance run item replace entity @s contents with minecraft:diamond[minecraft:custom_model_data=512]
...
execute as @e[type=minecraft:item_display,tag=metapod] if predicate ssbrc:fighters/pokemon/shiny_chance run item replace entity @s contents with minecraft:diamond[minecraft:custom_model_data=111]
execute as @e[type=minecraft:item_display,tag=snorlax] if predicate ssbrc:fighters/pokemon/shiny_chance run item replace entity @s contents with minecraft:diamond[minecraft:custom_model_data=1431]
