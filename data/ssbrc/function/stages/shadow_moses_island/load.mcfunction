execute if score hazards options matches 0 run function ssbrc:stages/shadow_moses_island/load/hazards_off
execute if score hazards options matches 1 run function ssbrc:stages/shadow_moses_island/load/hazards_on
