summon minecraft:marker 2500.5 0.0 4005.5 {Tags:["center_point"]}
...
execute as @e[type=minecraft:item_display,tag=geodude] if predicate ssbrc:fighters/pokemon/shiny_chance run item replace entity @s contents with minecraft:diamond[minecraft:custom_model_data=741]
execute as @e[type=minecraft:item_display,tag=lapras] if predicate ssbrc:fighters/pokemon/shiny_chance run item replace entity @s contents with minecraft:diamond[minecraft:custom_model_data=1311]
execute as @e[type=minecraft:item_display,tag=slowpoke] if predicate ssbrc:fighters/pokemon/shiny_chance run item replace entity @s contents with minecraft:diamond[minecraft:custom_model_data=791]
execute as @e[type=minecraft:item_display,tag=sudowoodo] if predicate ssbrc:fighters/pokemon/shiny_chance run item replace entity @s contents with minecraft:diamond[minecraft:custom_model_data=1851]
