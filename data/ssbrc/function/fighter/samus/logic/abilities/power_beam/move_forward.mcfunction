...
execute positioned ~-0.15 ~-0.15 ~-0.15 as @e[tag=!self,predicate=ssbrc:flag/targets,dx=0] positioned ~-0.7 ~-0.7 ~-0.7 if entity @s[dx=0] run function ssbrc:logic/damage/generic {amount:"3.0",type:"generic",kb_resist:"0.9",source:" by @a[tag=self,limit=1"}
