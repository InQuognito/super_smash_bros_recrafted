...
execute unless data storage ssbrc:temp player.temp_data{skin:"gold"} run tellraw @s[advancements={ssbrc:fighter/samus/skin/gold=true}] {"translate":"ssbrc.skin.gold","color":"gold","clickEvent":{"action":"run_command","value":"/trigger menu set 2"}}
execute if data storage ssbrc:temp player.temp_data{skin:"gold"} run tellraw @s [{"translate":"ssbrc.skin.gold","color":"gold"},{"text":" ✔","color":"green"}]

execute unless data storage ssbrc:temp player.temp_data{skin:"gravity_suit"} run tellraw @s[advancements={ssbrc:fighter/samus/skin/gravity_suit=true}] {"translate":"ssbrc.skin.gravity_suit","color":"#BB2EF4","clickEvent":{"action":"run_command","value":"/trigger menu set 3"}}
...
execute unless data storage ssbrc:temp player.temp_data{skin:"phazon_suit"} run tellraw @s[advancements={ssbrc:fighter/samus/skin/phazon_suit=true}] {"translate":"ssbrc.skin.phazon_suit","color":"red","clickEvent":{"action":"run_command","value":"/trigger menu set 4"}}
