...
execute if score random.output temp matches 5 if entity @s[advancements={ssbrc:fighter/samus/cloaked=true}] run return run function ssbrc:logic/fighter/select_skin {fighter:"samus",skin:"cloaked",color:"gold"}
