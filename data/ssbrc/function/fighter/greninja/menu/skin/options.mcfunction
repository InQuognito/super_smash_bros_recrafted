...
execute unless data storage ssbrc:temp player.temp_data{skin:"hero_style"} run tellraw @s[advancements={ssbrc:fighter/greninja/hero_style=true}] {"translate":"ssbrc.skin.hero_style","color":"green","click_event":{"action":"run_command","command":"trigger menu set 4"}}
