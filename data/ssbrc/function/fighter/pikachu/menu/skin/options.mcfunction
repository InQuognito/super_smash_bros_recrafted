...
execute unless data storage ssbrc:temp player.temp_data{skin:"pikachu_libre"} run tellraw @s[advancements={ssbrc:fighter/pikachu/pikachu_libre=true}] {"translate":"ssbrc.skin.pikachu_libre","color":"gold","click_event":{"action":"run_command","command":"trigger menu set 4"}}
...
execute unless data storage ssbrc:temp player.temp_data{skin:"holiday"} run tellraw @s[advancements={ssbrc:fighter/pikachu/holiday=true}] {"translate":"ssbrc.skin.holiday","color":"red","click_event":{"action":"run_command","command":"trigger menu set 5"}}
