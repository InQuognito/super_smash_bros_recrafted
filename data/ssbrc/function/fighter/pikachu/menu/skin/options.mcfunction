...
execute unless data storage ssbrc:temp player.temp_data{skin:"santa_hat"} run tellraw @s[advancements={ssbrc:fighter/pikachu/santa_hat=true}] {"translate":"ssbrc.skin.santa_hat","color":"red","clickEvent":{"action":"run_command","value":"/trigger menu set 3"}}
...
execute unless data storage ssbrc:temp player.temp_data{skin:"shiny"} run tellraw @s[advancements={ssbrc:fighter/pikachu/shiny=true}] {"translate":"ssbrc.skin.shiny","color":"yellow","clickEvent":{"action":"run_command","value":"/trigger menu set 4"}}
