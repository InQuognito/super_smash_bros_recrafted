...
execute if score @s temp matches ..19 unless block ~ ~0.2 ~ #ssbrc:passthrough run return run function ssbrc:fighter/ness/logic/abilities/pk_flash/explode
execute if score @s temp matches 20.. unless block ~ ~-0.3 ~ #ssbrc:passthrough run return run function ssbrc:fighter/ness/logic/abilities/pk_flash/explode
