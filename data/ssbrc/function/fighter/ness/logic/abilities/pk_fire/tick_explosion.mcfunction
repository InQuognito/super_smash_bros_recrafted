...
execute as @e[predicate=ssbrc:target,tag=!self,distance=..1.5] run function ssbrc:logic/damage/fire {amount:"4.0",burning:"10",type:"pierce",kb_resist:"0.9",source:" by @a[tag=self,limit=1]"}
