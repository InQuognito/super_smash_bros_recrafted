...
execute positioned ~-0.15 ~-0.15 ~-0.15 as @e[tag=!self,predicate=ssbrc:flag/targets,dx=0] positioned ~-0.7 ~-0.7 ~-0.7 if entity @s[dx=0] positioned ~0.85 ~0.85 ~0.85 as @n[type=minecraft:marker,tag=pk_fire,predicate=ssbrc:id_match,distance=..0.5] at @s run return run function ssbrc:fighter/ness/logic/abilities/pk_fire/explode
