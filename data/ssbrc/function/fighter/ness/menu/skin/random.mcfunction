...
execute if score random.output temp matches 3 if entity @s[advancements={ssbrc:fighter/ness/pajamas=true}] run return run function ssbrc:logic/fighter/select_skin {fighter:"ness",skin:"pajamas",color:"dark_aqua"}
execute if score random.output temp matches 4 if entity @s[advancements={ssbrc:fighter/ness/moonside=true}] run return run function ssbrc:logic/fighter/select_skin {fighter:"ness",skin:"moonside",color:"aqua"}
