...
execute unless data storage ssbrc:temp player.temp_data{skin:"moonside"} run tellraw @s[advancements={ssbrc:fighter/ness/moonside=true}] {"translate":"ssbrc.skin.moonside","color":"aqua","click_event":{"action":"run_command","command":"trigger menu set 3"}}
...
execute unless data storage ssbrc:temp player.temp_data{skin:"pajamas"} run tellraw @s[advancements={ssbrc:fighter/ness/pajamas=true}] {"translate":"ssbrc.skin.pajamas","color":"dark_aqua","click_event":{"action":"run_command","command":"trigger menu set 4"}}
