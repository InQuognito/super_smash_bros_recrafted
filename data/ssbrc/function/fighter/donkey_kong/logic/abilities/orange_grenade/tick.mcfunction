...
execute positioned ~-0.375 ~-0.375 ~-0.375 as @e[tag=!self,predicate=ssbrc:flag/targets,dx=0] positioned ~-0.25 ~-0.25 ~-0.25 if entity @s[dx=0] as @n[type=minecraft:marker,tag=orange_grenade] at @s run function ssbrc:fighter/donkey_kong/logic/abilities/orange_grenade/explode
...
execute at @s[scores={temp=40..}] run function ssbrc:fighter/donkey_kong/logic/abilities/orange_grenade/explode
