...
execute positioned ~-0.375 ~-0.375 ~-0.375 as @e[tag=!self,predicate=ssbrc:target,dx=0] positioned ~-0.25 ~-0.25 ~-0.25 if entity @s[dx=0] as @n[type=minecraft:marker,tag=orange_grenade] at @s run function ssbrc:fighter/donkey_kong/logic/abilities/orange_grenade/explode
