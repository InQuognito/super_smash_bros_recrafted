...
execute unless items entity @s weapon.mainhand minecraft:stick[minecraft:custom_data~{item:"orange_grenade"}] run title @s actionbar ""
execute if items entity @s weapon.mainhand minecraft:stick[minecraft:custom_data~{item:"orange_grenade"}] run title @s actionbar {"score":{"name":"@s","objective":"charge.1"},color:"gold"}
