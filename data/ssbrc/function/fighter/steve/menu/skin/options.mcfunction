...
execute unless data storage ssbrc:temp player.temp_data{skin:"herobrine"} run tellraw @s[advancements={ssbrc:fighter/steve/herobrine=true}] {"translate":"ssbrc.skin.herobrine","clickEvent":{"action":"run_command","value":"/trigger menu set 4"}}
