...
execute if score n temp matches 1.. unless score entity_hit temp matches 1 at @s run function ssbrc:fighter/altered_beast/logic/werewolf/flame_hands/move_forward
