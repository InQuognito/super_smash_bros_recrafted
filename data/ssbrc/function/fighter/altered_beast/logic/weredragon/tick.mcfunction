# Wings
execute if entity @s[tag=!wings_flapped,scores={motion_y=..-100},predicate=!ssbrc:flag/on_ground,predicate=ssbrc:input/jump] run function ssbrc:fighter/altered_beast/logic/weredragon/flap
...
# Electrocution
execute if score @s duration.1 matches 1.. run function ssbrc:fighter/altered_beast/logic/weredragon/electrocution/tick
