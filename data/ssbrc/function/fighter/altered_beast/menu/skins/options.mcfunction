...
execute unless data storage ssbrc:temp player.temp_data{skin:"gold"} run tellraw @s[advancements={ssbrc:fighter/altered_beast/skin/gold=true}] {"translate":"ssbrc.skin.gold","color":"gold","clickEvent":{"action":"run_command","value":"/trigger menu set 2"}}
execute if data storage ssbrc:temp player.temp_data{skin:"gold"} run tellraw @s [{"translate":"ssbrc.skin.gold","color":"gold"},{"text":" ✔","color":"green"}]

execute unless data storage ssbrc:temp player.temp_data{skin:"player_2"} run tellraw @s[advancements={ssbrc:fighter/altered_beast/skin/player_2=true}] {"translate":"ssbrc.skin.player_2","color":"blue","clickEvent":{"action":"run_command","value":"/trigger menu set 3"}}
