...
execute if score random.output temp matches 6 if entity @s[advancements={ssbrc:fighter/sonic/scarlet_speedster=true}] run return run function ssbrc:logic/fighter/select_skin {fighter:"sonic",skin:"scarlet_speedster",color:"red"}
