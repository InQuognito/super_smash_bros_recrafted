...
execute if score @s menu matches 1 run return run function ssbrc:logic/fighter/select_skin {fighter:"sonic",skin:"default",color:"blue"}
execute if score @s menu matches 2 run return run function ssbrc:logic/fighter/select_skin {fighter:"sonic",skin:"gold",color:"gold"}
