...
execute if score random.output temp matches 3 if entity @s[advancements={ssbrc:fighter/fox/adventures=true}] run return run function ssbrc:logic/fighter/select_skin {fighter:"fox",skin:"adventures",color:"yellow"}
