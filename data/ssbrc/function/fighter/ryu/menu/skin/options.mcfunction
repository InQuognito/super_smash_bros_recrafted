...
execute unless data storage ssbrc:temp player.temp_data{skin:"hot_ryu"} run tellraw @s[advancements={ssbrc:fighter/ryu/hot_ryu=true}] {"translate":"ssbrc.skin.hot_ryu","clickEvent":{"action":"run_command","value":"/trigger menu set 3"}}
