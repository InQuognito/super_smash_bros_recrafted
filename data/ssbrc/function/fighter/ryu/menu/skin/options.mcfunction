...
execute unless data storage ssbrc:temp player.temp_data{skin:"hot_ryu"} run tellraw @s[advancements={ssbrc:fighter/ryu/hot_ryu=true}] {"translate":"ssbrc.skin.hot_ryu","click_event":{"action":"run_command","command":"trigger menu set 3"}}
