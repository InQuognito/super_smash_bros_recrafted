function ssbrc:fighter/ryu/logic/abilities/tatsumaki_senpukyaku/particles/speed

function ssbrc:fighter/ryu/logic/abilities/tatsumaki_senpukyaku/raycast/start
