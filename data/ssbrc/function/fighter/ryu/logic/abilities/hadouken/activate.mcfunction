...
execute if entity @s[scores={charge.output=..11}] run function ssbrc:fighter/ryu/logic/abilities/hadouken/activate/default
execute if entity @s[scores={charge.output=12..}] run function ssbrc:fighter/ryu/logic/abilities/hadouken/activate/heavy
