...
execute if score percentage temp matches 1..5 run title @s actionbar "\u25ae"
execute if score percentage temp matches 6..10 run title @s actionbar "\u25ae\u25ae"
...
execute if entity @s[scores={duration.1=1}] run function ssbrc:fighter/ryu/logic/abilities/satsui_no_hado_rage/deactivate
