...
execute if score @s duration.2 matches 1 run function ssbrc:fighter/ryu/logic/abilities/tatsumaki_senpukyaku/deactivate

# Satsui no Hado Rage
execute if score @s duration.1 matches 1.. run function ssbrc:fighter/ryu/logic/abilities/satsui_no_hado_rage/tick
