...
execute as @e[tag=!self,tag=!hit_ground,predicate=ssbrc:target,distance=..1] run function ssbrc:logic/damage/generic {amount:"6.0",type:"pierce",kb_resist:"0.0",source:" by @a[tag=self,limit=1]"}
