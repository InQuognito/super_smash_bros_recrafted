...
execute unless data storage ssbrc:temp player.temp_data{skin:"armor_of_chaos"} run tellraw @s[advancements={ssbrc:fighter/shovel_knight/armor_of_chaos=true}] {translate:"ssbrc.skin.armor_of_chaos",color:"red",click_event:{action:run_command,command:"trigger menu set 3"}}
...
execute unless data storage ssbrc:temp player.temp_data{skin:"toad_gear"} run tellraw @s[advancements={ssbrc:fighter/shovel_knight/toad_gear=true}] {translate:"ssbrc.skin.toad_gear",color:"green",click_event:{action:run_command,command:"trigger menu set 4"}}
