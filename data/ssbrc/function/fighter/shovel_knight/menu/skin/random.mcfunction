...
execute if score random.output temp matches 3 if entity @s[advancements={ssbrc:fighter/shovel_knight/armor_of_chaos=true}] run return run function ssbrc:logic/fighter/select_skin {fighter:"shovel_knight",skin:"armor_of_chaos",color:"red"}
execute if score random.output temp matches 4 if entity @s[advancements={ssbrc:fighter/shovel_knight/toad_gear=true}] run return run function ssbrc:logic/fighter/select_skin {fighter:"shovel_knight",skin:"toad_gear",color:"green"}
