...
execute if score random.output temp matches 3 if entity @s[advancements={ssbrc:fighter/bowser/bowsette=true}] run return run function ssbrc:logic/fighter/select_skin {fighter:"bowser",skin:"bowsette",color:"yellow"}
