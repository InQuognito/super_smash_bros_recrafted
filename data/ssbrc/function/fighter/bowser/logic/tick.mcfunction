# Fire Breath
execute if entity @s[predicate=ssbrc:flag/sneaking] run function ssbrc:fighter/bowser/logic/abilities/fire_breath/tick
...
# Rage
execute if entity @s[scores={charge.2=200..}] run function ssbrc:fighter/bowser/logic/abilities/rage/activate
...
execute if entity @s[scores={duration.1=1}] run function ssbrc:fighter/bowser/logic/abilities/rage/deactivate
