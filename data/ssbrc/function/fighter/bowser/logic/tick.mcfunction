...
execute if score @s duration.1 matches 1.. run particle minecraft:dust_color_transition{from_color:[0.3,0.0,0.0],to_color:[0.6,0.0,0.0],scale:1.0} ~ ~0.75 ~ 0.2 0.4 0.2 0.0 10 normal @a
