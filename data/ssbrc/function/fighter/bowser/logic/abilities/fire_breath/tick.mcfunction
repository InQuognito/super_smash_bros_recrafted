...
execute anchored eyes positioned ^ ^ ^0.5 run function ssbrc:fighter/bowser/logic/abilities/fire_breath/step with storage ssbrc:data/bowser

execute store result storage ssbrc:data/bowser x double 0.01 run random value -100..100
execute store result storage ssbrc:data/bowser y double 0.01 run random value -100..100
execute store result storage ssbrc:data/bowser z double 0.1 run random value 80..175

execute anchored eyes positioned ^ ^ ^0.5 run function ssbrc:fighter/bowser/logic/abilities/fire_breath/step2 with storage ssbrc:data/bowser
...
execute anchored eyes positioned ^ ^-0.3 ^0.3 run function ssbrc:fighter/bowser/logic/abilities/fire_breath/raycast
