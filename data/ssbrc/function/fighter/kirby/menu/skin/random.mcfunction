...
execute if score random.output temp matches 3 if entity @s[advancements={ssbrc:fighter/kirby/keeby=true}] run return run function ssbrc:logic/fighter/select_skin {fighter:"kirby",skin:"keeby",color:"yellow"}
