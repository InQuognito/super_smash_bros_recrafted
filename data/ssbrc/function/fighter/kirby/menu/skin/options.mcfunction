...
execute unless data storage ssbrc:temp player.temp_data{skin:"keeby"} run tellraw @s[advancements={ssbrc:fighter/kirby/keeby=true}] {translate:"ssbrc.skin.keeby",color:"yellow",click_event:{action:run_command,command:"trigger menu set 3"}}
