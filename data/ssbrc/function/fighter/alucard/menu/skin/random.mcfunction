...
execute if score random.output temp matches 3 if entity @s[advancements={ssbrc:fighter/alucard/lords_of_shadow=true}] run return run function ssbrc:logic/fighter/select_skin {fighter:"alucard",skin:"lords_of_shadow",color:"dark_gray"}
