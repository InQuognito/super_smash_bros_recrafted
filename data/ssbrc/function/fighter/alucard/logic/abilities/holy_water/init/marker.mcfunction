...
execute positioned ^ ^ ^1 summon minecraft:armor_stand run function ssbrc:fighter/alucard/logic/abilities/holy_water/init/display with storage ssbrc:temp player.temp_data
