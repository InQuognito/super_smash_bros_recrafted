...
execute unless items entity @s[scores={cooldown.2=1,duration.1=..0}] container.* minecraft:stick[minecraft:custom_data~{item:"holy_water"}] run function ssbrc:logic/item/init/slot {item:"holy_water",slot:"hotbar.1",class:"default",type:"default"}
