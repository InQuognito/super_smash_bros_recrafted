...
execute store result entity @s Pos[0] double 0.5 run scoreboard players operation pos_x_adjusted temp += offset_x temp
...
execute store result entity @s Pos[2] double 0.5 run scoreboard players operation pos_z_adjusted temp += offset_z temp
