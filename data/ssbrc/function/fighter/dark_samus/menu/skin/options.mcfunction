...
execute unless data storage ssbrc:temp player.temp_data{skin:"prime_3"} run tellraw @s[advancements={ssbrc:fighter/dark_samus/prime_3=true}] {translate:"ssbrc.skin.prime_3",color:"dark_gray",click_event:{action:run_command,command:"trigger menu set 3"}}
