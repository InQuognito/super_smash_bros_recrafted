...
execute if score n temp matches 2.. as @e[tag=!self,predicate=ssbrc:flag/targets,dx=0] run function ssbrc:fighter/team_rocket/logic/meowth/fury_swipes/hit
execute if score n temp matches 1 as @e[tag=!self,predicate=ssbrc:flag/targets,dx=0] run function ssbrc:fighter/team_rocket/logic/meowth/fury_swipes/final
