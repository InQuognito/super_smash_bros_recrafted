...
execute if score @s[predicate=ssbrc:universal_cooldown] charge.1 matches ..0 run function ssbrc:fighter/captain_falcon/logic/abilities/falcon_punch/activate
