...
# Falcon Kick
execute if entity @s[tag=!silenced,tag=!falcon_kick,scores={cooldown.2=..0},predicate=!ssbrc:flag/on_ground,predicate=ssbrc:flag/sneaking] run function ssbrc:fighter/captain_falcon/logic/abilities/falcon_kick/activate
execute if entity @s[tag=falcon_kick,predicate=ssbrc:flag/on_ground] run function ssbrc:fighter/captain_falcon/logic/abilities/falcon_kick/deactivate
