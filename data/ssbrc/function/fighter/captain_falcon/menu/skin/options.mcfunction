...
execute unless data storage ssbrc:temp player.temp_data{skin:"blood_falcon"} run tellraw @s[advancements={ssbrc:fighter/captain_falcon/blood_falcon=true}] {"translate":"ssbrc.skin.blood_falcon","color":"dark_red","click_event":{"action":"run_command","command":"trigger menu set 3"}}
...
execute unless data storage ssbrc:temp player.temp_data{skin:"rick_wheeler"} run tellraw @s[advancements={ssbrc:fighter/captain_falcon/rick_wheeler=true}] {"translate":"ssbrc.skin.rick_wheeler","color":"dark_blue","click_event":{"action":"run_command","command":"trigger menu set 4"}}
