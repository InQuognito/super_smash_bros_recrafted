...
execute if score ray_abort temp matches 1 run return run function ssbrc:fighter/wolf/logic/abilities/wolf_flash/raycast/abort

execute positioned ^ ^ ^0.1 run function ssbrc:fighter/wolf/logic/abilities/wolf_flash/raycast/proceed
