execute if entity @s[scores={character_trigger=1}] run function ssbrc:fighter/snake/menu/loadout/item/check {item:"psg1",undo:"2"}
...
execute if entity @s[scores={character_trigger=3}] run function ssbrc:fighter/snake/menu/loadout/item/check {item:"famas",undo:"4"}
...
execute if entity @s[scores={character_trigger=5}] run function ssbrc:fighter/snake/menu/loadout/item/check {item:"s1000",undo:"6"}
...
execute if entity @s[scores={character_trigger=7}] run function ssbrc:fighter/snake/menu/loadout/item/check {item:"socom",undo:"8"}
...
execute if entity @s[scores={character_trigger=9}] run function ssbrc:fighter/snake/menu/loadout/item/check {item:"anti_personnel_mine",undo:"10"}
...
execute if entity @s[scores={character_trigger=11}] run function ssbrc:fighter/snake/menu/loadout/item/check {item:"smoke_grenade",undo:"12"}
