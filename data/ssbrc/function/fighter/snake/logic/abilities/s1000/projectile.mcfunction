...
function ssbrc:fighter/snake/logic/abilities/s1000/initial_offset
...
execute summon minecraft:marker run function ssbrc:fighter/snake/logic/abilities/s1000/init
execute summon minecraft:marker run function ssbrc:fighter/snake/logic/abilities/s1000/init
execute summon minecraft:marker run function ssbrc:fighter/snake/logic/abilities/s1000/init
execute summon minecraft:marker run function ssbrc:fighter/snake/logic/abilities/s1000/init
execute summon minecraft:marker run function ssbrc:fighter/snake/logic/abilities/s1000/init
