...
execute if score random.output temp matches 3 if entity @s[tag=s1000] run return run function ssbrc:fighter/snake/logic/scavenger/weapon {id:"1",item:"s1000"}
...
execute if score random.output temp matches 5 if entity @s[tag=anti_personnel_mine] run return run function ssbrc:fighter/snake/logic/scavenger/utility {item:"anti_personnel_mine"}
