...
$title @s[scores={weapon_$(id).mags=1..,weapon_$(id).ammo=0}] actionbar [{"nbt":"snake_ammo","storage":"ssbrc:temp","interpret":true},{"translate":"ssbrc.fighter.snake.reload.prefix","color":"gray"},{"keybind":"key.drop","color":"white"},{"translate":"ssbrc.fighter.snake.reload.suffix","color":"gray"}]
