...
execute if score random.output temp matches 3 if entity @s[advancements={ssbrc:fighter/yar/recruit=true}] run return run function ssbrc:logic/fighter/select_skin {fighter:"yar",skin:"recruit",color:"dark_green"}
