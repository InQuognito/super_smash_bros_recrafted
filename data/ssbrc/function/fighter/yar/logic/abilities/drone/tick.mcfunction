...
execute if entity @s[tag=stop,scores={cooldown=..0}] facing entity @n[tag=!self,predicate=ssbrc:target,distance=0.1..3] eyes run function ssbrc:fighter/yar/logic/abilities/drone/projectile/activate
