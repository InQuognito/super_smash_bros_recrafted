execute if items entity @s container.* minecraft:stick[minecraft:custom_data~{item:"dagger"}] run function ssbrc:fighter/zelda/kit/weapon/enchant {weapon:"dagger"}
execute if items entity @s container.* minecraft:stick[minecraft:custom_data~{item:"flail"}] run function ssbrc:fighter/zelda/kit/weapon/enchant {weapon:"flail"}
