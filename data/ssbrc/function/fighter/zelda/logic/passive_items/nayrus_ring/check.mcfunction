...
execute if items entity @s[scores={zelda.shatter_resist=1..}] container.* minecraft:nether_star[minecraft:custom_data~{item:"nayrus_ring"},minecraft:damage~{damage:{min:1}}] run return run effect clear @s minecraft:resistance
