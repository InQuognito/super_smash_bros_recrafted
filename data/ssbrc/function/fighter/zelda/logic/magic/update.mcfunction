...
execute if items entity @s weapon.mainhand *[minecraft:custom_data~{group:"dungeon_item"}] unless score @s zelda.magic_fountain matches 1.. run function ssbrc:fighter/zelda/logic/magic/hud/calculate
