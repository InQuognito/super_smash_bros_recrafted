execute if items entity @s container.* *[minecraft:custom_data~{item:"nayrus_ring",shattered:"false"}] run function ssbrc:fighter/zelda/logic/passive_items/nayrus_ring/check
