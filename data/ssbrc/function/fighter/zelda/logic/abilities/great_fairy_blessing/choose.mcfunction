...
execute if score random.output temp matches 3 unless items entity @s container.* minecraft:iron_sword[minecraft:custom_data~{enchanted:"true"}] run return run function ssbrc:fighter/zelda/logic/blessings/enchant_weapon
