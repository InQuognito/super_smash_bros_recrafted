...
execute store result score glass_weapons temp if items entity @s container.* minecraft:stick[minecraft:custom_data~{enchantment:"glass"}]
execute store result score nayrus_rings temp if items entity @s container.* minecraft:stick[minecraft:custom_data~{item:"nayrus_ring"}]
