...
execute unless items entity @s container.* minecraft:stick[minecraft:custom_data~{item:"chaos_control"}] if score @s shadow.meter.hero >= shadow.chaos_meter.max const run loot replace entity @s hotbar.3 loot ssbrc:fighter/shadow/chaos_control
