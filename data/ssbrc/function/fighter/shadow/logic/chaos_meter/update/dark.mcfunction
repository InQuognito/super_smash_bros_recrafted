...
execute unless items entity @s container.* *[minecraft:custom_data~{item:"chaos_blast"}] if score @s shadow.meter.dark >= shadow.chaos_meter.max const run loot replace entity @s hotbar.4 loot ssbrc:fighter/shadow/chaos_blast
