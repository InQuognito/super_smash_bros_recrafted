...
execute if score @s charge.2 matches 6 run function ssbrc:fighter/rob/logic/abilities/robo_burner/activate
execute if score @s charge.2 matches 6.. run function ssbrc:fighter/rob/logic/abilities/robo_burner/particle
