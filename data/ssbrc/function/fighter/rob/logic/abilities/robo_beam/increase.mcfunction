...
execute if score @s charge.1 matches 100 run function ssbrc:logic/player/data/temp/set {mode:"store",key:"form",value:"ready"}
execute if score @s charge.1 matches 200 run function ssbrc:logic/player/data/temp/set {mode:"store",key:"form",value:"charged"}
