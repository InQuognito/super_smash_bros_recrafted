...
execute unless data storage ssbrc:temp player.temp_data{skin:"gold"} run tellraw @s[advancements={ssbrc:fighter/rob/skin/gold=true}] {"translate":"ssbrc.skin.gold","color":"gold","clickEvent":{"action":"run_command","value":"/trigger menu set 2"}}
execute if data storage ssbrc:temp player.temp_data{skin:"gold"} run tellraw @s [{"translate":"ssbrc.skin.gold","color":"gold"},{"text":" ✔","color":"green"}]

execute unless data storage ssbrc:temp player.temp_data{skin:"famicom"} run tellraw @s[advancements={ssbrc:fighter/rob/skin/famicom=true}] {"translate":"ssbrc.skin.famicom","color":"red","clickEvent":{"action":"run_command","value":"/trigger menu set 3"}}
...
execute unless data storage ssbrc:temp player.temp_data{skin:"ancient_minister"} run tellraw @s[advancements={ssbrc:fighter/rob/skin/ancient_minister=true}] {"translate":"ssbrc.skin.ancient_minister","color":"dark_green","clickEvent":{"action":"run_command","value":"/trigger menu set 4"}}
