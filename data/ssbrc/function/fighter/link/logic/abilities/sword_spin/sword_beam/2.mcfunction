...
execute as @e[tag=!self,predicate=ssbrc:flag/targets,distance=..2.5] run function ssbrc:logic/damage/generic {amount:"14.0",type:"generic",kb_resist:"0.0",source:" by @a[tag=self,limit=1"}
