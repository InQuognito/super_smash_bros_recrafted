...
execute if entity @s[predicate=ssbrc:fighter/link/master_sword_awakened] run function ssbrc:fighter/link/logic/abilities/sword_spin/activate/awakened
...
execute if entity @s[predicate=ssbrc:flag/in_air] run function ssbrc:fighter/link/logic/abilities/sword_spin/levitate
