...
execute if entity @s[scores={charge.output=81..}] positioned ~ ~0.75 ~ run function ssbrc:fighter/link/logic/abilities/sword_spin/sword_beams_tier1
execute if entity @s[scores={charge.output=121..}] positioned ~ ~0.75 ~ run function ssbrc:fighter/link/logic/abilities/sword_spin/sword_beams_tier2
