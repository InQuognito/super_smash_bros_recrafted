...
# Health
execute if items entity @s[scores={health=40..}] container.* minecraft:stick[minecraft:custom_data~{item:"master_sword",awakened:"false"}] run function ssbrc:fighter/link/logic/master_sword/enable
