...
execute if items entity @s[tag=!silenced,predicate=ssbrc:flag/sneaking] weapon.* *[minecraft:custom_data~{item:"master_sword"}] run function ssbrc:fighter/link/logic/abilities/sword_spin/charge/check
