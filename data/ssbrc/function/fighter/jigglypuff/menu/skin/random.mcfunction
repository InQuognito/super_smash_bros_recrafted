...
execute if score random.output temp matches 4 if entity @s[advancements={ssbrc:fighter/jigglypuff/scream_tail=true}] run return run function ssbrc:logic/fighter/select_skin {fighter:"jigglypuff",skin:"scream_tail",color:"light_purple"}
