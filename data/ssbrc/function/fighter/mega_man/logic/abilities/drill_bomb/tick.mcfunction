...
execute positioned ~-0.25 ~-0.25 ~-0.25 as @e[tag=!self,predicate=ssbrc:flag/targets,dx=0] positioned ~-0.5 ~-0.5 ~-0.5 if entity @s[dx=0] positioned ~0.75 ~0.75 ~0.75 run function ssbrc:fighter/mega_man/logic/abilities/drill_bomb/hit
