execute unless items entity @s weapon.mainhand minecraft:nether_star[minecraft:custom_data~{item:"beat_call"}] run function ssbrc:fighter/mega_man/logic/abilities/beat_call/deactivate
...
execute if score @s mega_man.beat_call matches ..0 run function ssbrc:fighter/mega_man/logic/abilities/beat_call/deactivate
