...
execute if score n temp matches 1.. unless score entity_hit temp matches 1 at @s run function ssbrc:fighter/mega_man/logic/abilities/mega_buster/move_forward
