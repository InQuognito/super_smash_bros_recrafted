...
function ssbrc:logic/execute_at_ground {result:"execute summon minecraft:item_display run function ssbrc:fighter/mega_man/logic/abilities/junk_shield/summon with storage ssbrc:display"}
function ssbrc:logic/execute_at_ground {result:"execute summon minecraft:item_display run function ssbrc:fighter/mega_man/logic/abilities/junk_shield/summon with storage ssbrc:display"}
function ssbrc:logic/execute_at_ground {result:"execute summon minecraft:item_display run function ssbrc:fighter/mega_man/logic/abilities/junk_shield/summon with storage ssbrc:display"}
function ssbrc:logic/execute_at_ground {result:"execute summon minecraft:item_display run function ssbrc:fighter/mega_man/logic/abilities/junk_shield/summon with storage ssbrc:display"}
function ssbrc:logic/execute_at_ground {result:"execute summon minecraft:item_display run function ssbrc:fighter/mega_man/logic/abilities/junk_shield/summon with storage ssbrc:display"}
