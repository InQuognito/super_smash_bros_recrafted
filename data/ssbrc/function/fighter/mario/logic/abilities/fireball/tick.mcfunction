...
execute positioned ~-0.375 ~-0.375 ~-0.375 as @e[tag=!self,predicate=ssbrc:target,dx=0] positioned ~-0.25 ~-0.25 ~-0.25 if entity @s[dx=0] run function ssbrc:logic/damage/fire {amount:"4.0",burning:"30",type:"generic",kb_resist:"0.0",source:" by @a[tag=self,limit=1]"}
