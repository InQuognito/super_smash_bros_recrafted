...
execute unless data storage ssbrc:temp player.temp_data{skin:"flower_power"} run tellraw @s[advancements={ssbrc:fighter/mario/flower_power=true}] {"translate":"ssbrc.skin.flower_power","clickEvent":{"action":"run_command","value":"/trigger menu set 3"}}
...
execute unless data storage ssbrc:temp player.temp_data{skin:"skeleton"} run tellraw @s[advancements={ssbrc:fighter/mario/skeleton=true}] {"translate":"ssbrc.skin.skeleton","clickEvent":{"action":"run_command","value":"/trigger menu set 5"}}
