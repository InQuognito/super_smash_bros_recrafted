...
execute as @e[predicate=ssbrc:flag/targets,tag=!self,distance=..6] at @s unless block ~ ~-0.5 ~ #ssbrc:passthrough run function ssbrc:logic/damage/player {amount:"16.0",type:"generic",kb_resist:"0.0"}
