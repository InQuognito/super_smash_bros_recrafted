...
execute if score charge.output temp matches 19.. positioned ^ ^-0.3 ^1 summon minecraft:spectral_arrow run function ssbrc:fighter/byleth/logic/golden_deer/brave_bow/init/projectile
execute if score charge.output temp matches 19.. positioned ^ ^0.3 ^1 summon minecraft:spectral_arrow run function ssbrc:fighter/byleth/logic/golden_deer/brave_bow/init/projectile
