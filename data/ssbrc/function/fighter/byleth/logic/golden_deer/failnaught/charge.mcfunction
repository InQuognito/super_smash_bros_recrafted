...
execute if score @s charge.output matches 80 run attribute @s minecraft:movement_speed modifier add ssbrc:fighter/byleth/golden_deer/failnaught -1.0 add_multiplied_base
