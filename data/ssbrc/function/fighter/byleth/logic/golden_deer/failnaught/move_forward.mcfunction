...
execute if score n temp matches 1.. unless score entity_hit temp matches 1 at @s run function ssbrc:fighter/byleth/logic/golden_deer/failnaught/move_forward
