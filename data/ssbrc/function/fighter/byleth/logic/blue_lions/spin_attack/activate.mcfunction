...
execute if score @s charge.output matches 81.. run return run function ssbrc:fighter/byleth/logic/blue_lions/spin_attack/activate/awakened
function ssbrc:fighter/byleth/logic/blue_lions/spin_attack/activate/default
