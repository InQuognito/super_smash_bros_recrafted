...
execute if score @s menu matches 1 run return run function ssbrc:logic/fighter/select_skin {fighter:"pokemon_trainer",skin:"default","color":"red"}
execute if score @s menu matches 2 run return run function ssbrc:logic/fighter/select_skin {fighter:"pokemon_trainer",skin:"gold","color":"gold"}
