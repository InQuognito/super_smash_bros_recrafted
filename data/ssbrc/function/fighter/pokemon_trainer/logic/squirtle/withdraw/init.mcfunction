...
execute if entity @s[tag=default] run return run item replace entity @s contents with minecraft:nether_star[minecraft:item_model="ssbrc:fighter/pokemon_trainer/misc/squirtle_shell/default"]
...
item replace entity @s contents with minecraft:nether_star[minecraft:item_model="ssbrc:common/pokemon/clam/closed"]
