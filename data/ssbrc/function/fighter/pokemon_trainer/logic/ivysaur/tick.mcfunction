# Poison Powder
function ssbrc:logic/item/cooldown/display/check {item:"poison_powder"}
...
execute if score @s charge.1 matches 1.. run function ssbrc:logic/item/cooldown/display/check {item:"leech_seed"}
