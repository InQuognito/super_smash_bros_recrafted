...
# Rebel's Guard
execute if items entity @s[tag=!silenced,tag=!rebels_guard,scores={duration.1=..0,duration.2=..0},predicate=ssbrc:flag/sneaking] weapon.mainhand minecraft:stick[minecraft:custom_data~{item:"rebel_knife"}] run function ssbrc:fighter/joker/logic/abilities/rebels_guard/activate
