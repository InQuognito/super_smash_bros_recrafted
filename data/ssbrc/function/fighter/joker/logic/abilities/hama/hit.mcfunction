execute as @e[predicate=ssbrc:target,distance=..2] run function ssbrc:logic/damage/generic {amount:"999.0",type:"generic",kb_resist:"1.0",source:" by @a[tag=self,limit=1]"}
