...
execute unless items entity @s weapon.mainhand minecraft:stone_sword[minecraft:custom_data~{item:"rebel_knife"}] run function ssbrc:fighter/joker/logic/abilities/rebels_guard/deactivate
