execute if items entity @s weapon.* minecraft:nether_star[minecraft:custom_data~{item:"tt33"}] run return run title @s actionbar {"score":{"name":"@s","objective":"weapon_1.ammo"},"color":"red"}
