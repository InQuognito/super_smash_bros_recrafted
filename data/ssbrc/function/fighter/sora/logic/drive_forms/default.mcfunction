...
execute if items entity @s weapon.offhand minecraft:nether_star[minecraft:custom_data~{item:"keyblade"}] run return run function ssbrc:fighter/sora/logic/drive_forms/keyblade/replace
