...
execute unless score wisdom_form temp matches 1 run data modify storage ssbrc:temp cache.item.suffix set value "ga"
execute if score wisdom_form temp matches 1 run data modify storage ssbrc:temp cache.item.suffix set value "za"
