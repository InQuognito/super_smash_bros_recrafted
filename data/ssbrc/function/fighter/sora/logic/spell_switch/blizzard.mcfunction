...
item modify entity @s weapon.mainhand {"function":"minecraft:set_lore","entity":"this","lore":[{"translate":"ssbrc.tooltip.effect.frostbite","color":"gray","bold":false,"italic":false}],"mode":"append"}
