...
execute positioned ~-0.5 ~-0.5 ~-0.5 as @e[tag=!self,predicate=ssbrc:target,dx=0] run function ssbrc:logic/damage/generic {amount:"10.0",type:"pierce",kb_resist:"0.0",source:" by @a[tag=self,limit=1]"}
