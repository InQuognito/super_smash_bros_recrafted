...
execute as @e[predicate=ssbrc:flag/targets,tag=!self,distance=..2] run function ssbrc:logic/damage/fire {amount:"8.0",burning:"40",type:"pierce",kb_resist:"0.0",source:" by @a[tag=self,limit=1"}
