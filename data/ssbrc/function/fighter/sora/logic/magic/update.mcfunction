...
execute if items entity @s weapon.mainhand #ssbrc:equipment[minecraft:custom_data~{item:"keyblade"}] run function ssbrc:fighter/sora/logic/magic/hud/calculate
