...
execute if items entity @s weapon.mainhand minecraft:carrot_on_a_stick[minecraft:custom_data~{item:"keyblade"}] run function ssbrc:fighter/sora/logic/magic/hud/calculate
...
function ssbrc:logic/player/data/temp/set_storage/get {input:"ssbrc:hud sora.magic",output:"hud.1"}
