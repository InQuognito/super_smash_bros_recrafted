...
data modify storage ssbrc:data ui merge value {path:"shop/buttons/skin/find_page",name:"alucard"}
...
function ssbrc:shop/buttons/skin/get {skin:"judgement",slot:"2",price:"price.skin.common"}
function ssbrc:shop/buttons/skin/get {skin:"lords_of_shadow",slot:"3",price:"price.skin.common"}
function ssbrc:shop/buttons/skin/get {skin:"moonlight_rhapsody",slot:"4",price:"price.skin.common"}
