...
data modify storage ssbrc:data ui merge value {path:"shop/buttons/skin/find_page",name:"jigglypuff"}
...
function ssbrc:shop/buttons/skin/get {skin:"scream_tail",slot:"4",price:"price.skin.common"}
