...
data modify storage ssbrc:data ui merge value {path:"shop/buttons/skin/find_page",name:"king_k_rool"}
...
function ssbrc:shop/buttons/skin/get {skin:"kaptain_k_rool",slot:"2",price:"price.skin.common"}
function ssbrc:shop/buttons/skin/get {skin:"k_roolenstein",slot:"3",price:"price.skin.common"}
function ssbrc:shop/buttons/skin/get {skin:"krusha_k_rool",slot:"4",price:"price.skin.common"}
