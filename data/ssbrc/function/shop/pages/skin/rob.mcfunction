data modify storage ssbrc:data ui merge value {path:"shop/pages/skin/rob",name:"rob"}
...
function ssbrc:shop/buttons/skin/get {skin:"ancient_minister",slot:"2",price:"price.skin.common"}
function ssbrc:shop/buttons/skin/get {skin:"famicom",slot:"3",price:"price.skin.common"}
