...
data modify storage ssbrc:data ui merge value {path:"shop/buttons/skin/find_page",name:"mario"}
...
function ssbrc:shop/buttons/skin/get {skin:"skeleton",slot:"4",price:"price.skin.common"}
