...
data modify storage ssbrc:data ui merge value {path:"shop/buttons/skin/find_page",name:"bowser"}
...
function ssbrc:shop/buttons/skin/get {skin:"dry_bowser",slot:"2",price:"price.skin.common"}
function ssbrc:shop/buttons/skin/get {skin:"rookie",slot:"3",price:"price.skin.common"}
function ssbrc:shop/buttons/skin/get {skin:"bowsette",slot:"4",price:"price.skin.common"}
