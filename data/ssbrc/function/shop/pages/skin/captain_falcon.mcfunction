...
data modify storage ssbrc:data ui merge value {path:"shop/buttons/skin/find_page",name:"captain_falcon"}
...
function ssbrc:shop/buttons/skin/get {skin:"super_falcon",slot:"2",price:"price.skin.common"}
function ssbrc:shop/buttons/skin/get {skin:"blood_falcon",slot:"3",price:"price.skin.common"}
function ssbrc:shop/buttons/skin/get {skin:"rick_wheeler",slot:"4",price:"price.skin.common"}
