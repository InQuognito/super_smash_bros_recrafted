...
data modify storage ssbrc:data ui merge value {path:"shop/buttons/skin/find_page",name:"terry"}
...
function ssbrc:shop/buttons/skin/get {skin:"mirror",slot:"2",price:"price.skin.common"}
function ssbrc:shop/buttons/skin/get {skin:"garou",slot:"3",price:"price.skin.common"}
function ssbrc:shop/buttons/skin/get {skin:"king_of_fighters_xiv",slot:"4",price:"price.skin.common"}
