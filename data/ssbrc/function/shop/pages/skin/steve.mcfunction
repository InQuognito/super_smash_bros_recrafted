data modify storage ssbrc:data ui merge value {path:"shop/pages/skin/steve",name:"steve"}
...
function ssbrc:shop/buttons/skin/get {skin:"alex",slot:"2",price:"price.skin.common"}
function ssbrc:shop/buttons/skin/get {skin:"herobrine",slot:"3",price:"price.skin.common"}
