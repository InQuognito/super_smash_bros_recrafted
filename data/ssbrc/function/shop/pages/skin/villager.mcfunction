...
function ssbrc:shop/buttons/skin/get {skin:"new_leaf",slot:"3",price:"price.skin.common"}
function ssbrc:shop/buttons/skin/get {skin:"mariokart",slot:"4",price:"price.skin.common"}
