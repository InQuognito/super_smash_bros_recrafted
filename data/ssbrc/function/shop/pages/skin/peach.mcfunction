...
data modify storage ssbrc:data ui merge value {path:"shop/buttons/skin/find_page",name:"peach"}
...
function ssbrc:shop/buttons/skin/get {skin:"shadow_queen",slot:"3",price:"price.skin.common"}
function ssbrc:shop/buttons/skin/get {skin:"pink_gold",slot:"4",price:"price.skin.common"}
