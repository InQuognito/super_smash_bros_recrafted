...
data modify storage ssbrc:data ui merge value {path:"shop/buttons/skin/find_page",name:"yar"}
...
function ssbrc:shop/buttons/skin/get {skin:"player_2",slot:"2",price:"price.skin.common"}
function ssbrc:shop/buttons/skin/get {skin:"recruit",slot:"3",price:"price.skin.common"}
function ssbrc:shop/buttons/skin/get {skin:"emi",slot:"4",price:"price.skin.common"}
