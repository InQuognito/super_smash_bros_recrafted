...
data modify storage ssbrc:data ui merge value {path:"shop/buttons/skin/find_page",name:"pikachu"}
...
function ssbrc:shop/buttons/skin/get {skin:"ditto",slot:"2",price:"price.skin.common"}
function ssbrc:shop/buttons/skin/get {skin:"shadow",slot:"3",price:"price.skin.common"}
function ssbrc:shop/buttons/skin/get {skin:"pikachu_libre",slot:"4",price:"price.skin.common"}
function ssbrc:shop/buttons/skin/get {skin:"holiday",slot:"5",price:"price.skin.common"}
