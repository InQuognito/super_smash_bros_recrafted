...
function ssbrc:shop/buttons/skin/get {skin:"pikachu_libre",slot:"2",price:"price.skin.common"}
function ssbrc:shop/buttons/skin/get {skin:"holiday",slot:"3",price:"price.skin.common"}
