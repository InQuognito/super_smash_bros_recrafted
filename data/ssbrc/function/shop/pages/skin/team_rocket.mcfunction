...
data modify storage ssbrc:data ui merge value {path:"shop/buttons/skin/find_page",name:"team_rocket"}
...
function ssbrc:shop/buttons/skin/get {skin:"mays_family",slot:"2",price:"price.skin.common"}
function ssbrc:shop/buttons/skin/get {skin:"mega_evolution_appraisers",slot:"3",price:"price.skin.common"}
function ssbrc:shop/buttons/skin/get {skin:"alternate_world",slot:"4",price:"price.skin.common"}
