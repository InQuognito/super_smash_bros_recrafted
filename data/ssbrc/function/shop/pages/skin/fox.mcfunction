...
data modify storage ssbrc:data ui merge value {path:"shop/buttons/skin/find_page",name:"fox"}
...
function ssbrc:shop/buttons/skin/get {skin:"adventures",slot:"3",price:"price.skin.common"}
function ssbrc:shop/buttons/skin/get {skin:"g_zero",slot:"4",price:"price.skin.common"}
