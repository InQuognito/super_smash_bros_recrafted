...
data modify storage ssbrc:data ui merge value {path:"shop/buttons/skin/find_page",name:"greninja"}
...
function ssbrc:shop/buttons/skin/get {skin:"hero_style",slot:"4",price:"price.skin.common"}
