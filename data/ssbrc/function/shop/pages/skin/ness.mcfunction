...
function ssbrc:shop/buttons/skin/get {skin:"moonside",slot:"2",price:"price.skin.common"}
function ssbrc:shop/buttons/skin/get {skin:"pajamas",slot:"3",price:"price.skin.common"}
