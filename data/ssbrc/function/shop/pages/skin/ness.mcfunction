...
data modify storage ssbrc:data ui merge value {path:"shop/buttons/skin/find_page",name:"ness"}
...
function ssbrc:shop/buttons/skin/get {skin:"pajamas",slot:"2",price:"price.skin.common"}
function ssbrc:shop/buttons/skin/get {skin:"moonside",slot:"3",price:"price.skin.common"}
function ssbrc:shop/buttons/skin/get {skin:"phase_distortion",slot:"4",price:"price.skin.common"}
