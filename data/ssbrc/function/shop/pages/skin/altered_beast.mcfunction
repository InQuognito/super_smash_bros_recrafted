...
function ssbrc:shop/buttons/skin/get {skin:"luke_custer",slot:"3",price:"price.skin.common"}
function ssbrc:shop/buttons/skin/get {skin:"lost_warrior",slot:"4",price:"price.skin.common"}
