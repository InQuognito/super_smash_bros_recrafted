...
data modify storage ssbrc:data ui merge value {path:"shop/buttons/skin/find_page",name:"giegue"}
...
function ssbrc:shop/buttons/skin/get {skin:"niiue",slot:"3",price:"price.skin.common"}
function ssbrc:shop/buttons/skin/get {skin:"giegue_league",slot:"4",price:"price.skin.common"}
