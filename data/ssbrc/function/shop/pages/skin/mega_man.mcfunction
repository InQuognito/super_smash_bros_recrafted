...
data modify storage ssbrc:data ui merge value {path:"shop/buttons/skin/find_page",name:"mega_man"}
...
function ssbrc:shop/buttons/skin/get {skin:"mega_man_x",slot:"2",price:"price.skin.common"}
function ssbrc:shop/buttons/skin/get {skin:"star_force",slot:"3",price:"price.skin.common"}
function ssbrc:shop/buttons/skin/get {skin:"bad_box_art",slot:"4",price:"price.skin.common"}
