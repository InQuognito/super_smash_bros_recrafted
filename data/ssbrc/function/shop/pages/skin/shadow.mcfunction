...
data modify storage ssbrc:data ui merge value {path:"shop/buttons/skin/find_page",name:"shadow"}
...
function ssbrc:shop/buttons/skin/get {skin:"yellow_android",slot:"2",price:"price.skin.common"}
function ssbrc:shop/buttons/skin/get {skin:"sir_lancelot",slot:"3",price:"price.skin.common"}
function ssbrc:shop/buttons/skin/get {skin:"dark_knight",slot:"4",price:"price.skin.common"}
