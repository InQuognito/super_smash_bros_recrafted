data modify storage ssbrc:data ui merge value {path:"shop/pages/skin/shadow",name:"shadow"}
...
function ssbrc:shop/buttons/skin/get {skin:"sir_lancelot",slot:"2",price:"price.skin.common"}
function ssbrc:shop/buttons/skin/get {skin:"yellow_android",slot:"3",price:"price.skin.common"}
