...
data modify storage ssbrc:data ui merge value {path:"shop/buttons/skin/find_page",name:"hero"}
...
function ssbrc:shop/buttons/skin/get {skin:"solo",slot:"3",price:"price.skin.common"}
function ssbrc:shop/buttons/skin/get {skin:"sofia",slot:"4",price:"price.skin.common"}
function ssbrc:shop/buttons/skin/get {skin:"rek",slot:"5",price:"price.skin.common"}
