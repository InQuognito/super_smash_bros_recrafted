...
data modify storage ssbrc:data ui merge value {path:"shop/buttons/skin/find_page",name:"wolf"}
...
function ssbrc:shop/buttons/skin/get {skin:"assault",slot:"2",price:"price.skin.common"}
function ssbrc:shop/buttons/skin/get {skin:"star_fox_2",slot:"3",price:"price.skin.common"}
function ssbrc:shop/buttons/skin/get {skin:"starlink",slot:"4",price:"price.skin.common"}
