...
data modify storage ssbrc:data ui merge value {path:"shop/buttons/skin/find_page",name:"dark_samus"}
...
function ssbrc:shop/buttons/skin/get {skin:"prime_2",slot:"2",price:"price.skin.common"}
function ssbrc:shop/buttons/skin/get {skin:"prime_3",slot:"3",price:"price.skin.common"}
function ssbrc:shop/buttons/skin/get {skin:"prototype",slot:"4",price:"price.skin.common"}
