...
data modify storage ssbrc:data ui merge value {path:"shop/buttons/skin/find_page",name:"lucario"}
...
function ssbrc:shop/buttons/skin/get {skin:"mirror",slot:"4",price:"price.skin.common"}
function ssbrc:shop/buttons/skin/get {skin:"costume_party",slot:"5",price:"price.skin.common"}
