...
data modify storage ssbrc:data ui merge value {path:"shop/buttons/skin/find_page",name:"ryu"}
...
function ssbrc:shop/buttons/skin/get {skin:"super_turbo",slot:"2",price:"price.skin.common"}
function ssbrc:shop/buttons/skin/get {skin:"hot_ryu",slot:"3",price:"price.skin.common"}
function ssbrc:shop/buttons/skin/get {skin:"iron_fist",slot:"4",price:"price.skin.common"}
