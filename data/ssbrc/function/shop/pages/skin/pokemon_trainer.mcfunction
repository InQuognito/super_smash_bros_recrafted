...
function ssbrc:shop/buttons/skin/get {skin:"dawn",slot:"3",price:"price.skin.common"}
function ssbrc:shop/buttons/skin/get {skin:"victor",slot:"4",price:"price.skin.common"}
