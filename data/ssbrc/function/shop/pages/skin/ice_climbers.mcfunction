...
data modify storage ssbrc:data ui merge value {path:"shop/buttons/skin/find_page",name:"ice_climbers"}
...
function ssbrc:shop/buttons/skin/get {skin:"frostbite",slot:"2",price:"price.skin.common"}
function ssbrc:shop/buttons/skin/get {skin:"polar_parka",slot:"3",price:"price.skin.common"}
function ssbrc:shop/buttons/skin/get {skin:"climbing_gear",slot:"4",price:"price.skin.common"}
