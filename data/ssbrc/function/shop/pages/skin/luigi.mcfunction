...
data modify storage ssbrc:data ui merge value {path:"shop/buttons/skin/find_page",name:"luigi"}
...
function ssbrc:shop/buttons/skin/get {skin:"gooigi",slot:"4",price:"price.skin.common"}
