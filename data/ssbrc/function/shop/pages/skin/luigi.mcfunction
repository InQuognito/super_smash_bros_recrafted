data modify storage ssbrc:data ui merge value {path:"shop/pages/skin/luigi",name:"luigi"}
...
function ssbrc:shop/buttons/skin/get {skin:"gooigi",slot:"3",price:"price.skin.common"}
function ssbrc:shop/buttons/skin/get {skin:"penguin",slot:"4",price:"price.skin.common"}
