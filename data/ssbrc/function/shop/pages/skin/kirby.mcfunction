data modify storage ssbrc:data ui merge value {path:"shop/pages/skin/kirby",name:"kirby"}
...
function ssbrc:shop/buttons/skin/get {skin:"keeby",slot:"2",price:"price.skin.common"}
