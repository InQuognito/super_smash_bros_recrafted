data modify storage ssbrc:data ui merge value {path:"shop/pages/skins/bowser",name:"bowser",ui_color:"yellow"}
...
function ssbrc:shop/buttons/skin/get {skin:"bowsette",slot:"2"}
