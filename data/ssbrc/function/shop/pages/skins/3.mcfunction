...
function ssbrc:shop/buttons/header/get {name:"shovel_knight",slot:"2"}
function ssbrc:shop/buttons/header/get {name:"altered_beast",slot:"3"}
function ssbrc:shop/buttons/header/get {name:"yar",slot:"4"}
