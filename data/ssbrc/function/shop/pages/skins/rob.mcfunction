data modify storage ssbrc:data ui merge value {path:"shop/pages/skins/rob",name:"rob",ui_color:"lime"}
...
function ssbrc:shop/buttons/skin/get {skin:"ancient_minister",slot:"2"}
function ssbrc:shop/buttons/skin/get {skin:"famicom",slot:"3"}
