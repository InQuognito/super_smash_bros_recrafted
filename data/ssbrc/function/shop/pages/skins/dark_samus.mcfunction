data modify storage ssbrc:data ui merge value {path:"shop/pages/skins/dark_samus",name:"dark_samus"}
...
function ssbrc:shop/buttons/skin/get {skin:"prime_3",slot:"2"}
