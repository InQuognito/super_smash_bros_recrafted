data modify storage ssbrc:data ui merge value {path:"shop/pages/skins/kirby",name:"kirby",ui_color:"yellow"}
...
function ssbrc:shop/buttons/skin/get {skin:"keeby",slot:"2"}
