data modify storage ssbrc:data ui merge value {path:"shop/pages/skins/sora",name:"sora",ui_color:"lime"}
...
function ssbrc:shop/buttons/skin/get {skin:"timeless_river",slot:"2"}
