data modify storage ssbrc:data ui merge value {path:"shop/pages/skins/jigglypuff",name:"jigglypuff"}
...
function ssbrc:shop/buttons/skin/get {skin:"scream_tail",slot:"2"}
