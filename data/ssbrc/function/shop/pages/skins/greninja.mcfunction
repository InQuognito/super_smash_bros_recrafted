data modify storage ssbrc:data ui merge value {path:"shop/pages/skins/greninja",name:"greninja",ui_color:"yellow"}
...
function ssbrc:shop/buttons/skin/get {skin:"hero_style",slot:"2"}
