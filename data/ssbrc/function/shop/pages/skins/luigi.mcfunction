data modify storage ssbrc:data ui merge value {path:"shop/pages/skins/luigi",name:"luigi",ui_color:"yellow"}
...
function ssbrc:shop/buttons/skin/get {skin:"gooigi",slot:"3"}
function ssbrc:shop/buttons/skin/get {skin:"penguin",slot:"4"}
