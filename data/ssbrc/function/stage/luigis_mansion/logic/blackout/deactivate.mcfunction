...
execute as @a[predicate=ssbrc:flag/targets] unless data storage ssbrc:temp player.temp_data{fighter:"snake"} run function ssbrc:logic/fighter/effects/glowing/uncloak
