execute positioned -30.0 18.1 228.0 as @a[predicate=ssbrc:player,predicate=!ssbrc:fighter/effects/has/levitation,dy=0] run function ssbrc:stage/green_hill_zone/logic/spring
