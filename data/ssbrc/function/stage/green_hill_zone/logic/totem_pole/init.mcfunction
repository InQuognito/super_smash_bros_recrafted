...
$execute positioned ~ ~1 ~ rotated $(rotation) 0.0 summon minecraft:item_display run function ssbrc:stage/green_hill_zone/logic/totem_pole/face {emotion:"$(face_1)"}"
$execute positioned ~ ~2 ~ rotated $(rotation) 0.0 summon minecraft:item_display run function ssbrc:stage/green_hill_zone/logic/totem_pole/face {emotion:"$(face_1)"}"
