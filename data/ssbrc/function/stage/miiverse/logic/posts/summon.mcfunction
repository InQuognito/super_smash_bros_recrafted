...
execute store result storage ssbrc:temp cache.offset int 1.0 run scoreboard players operation odd temp *= 5 const

execute summon minecraft:item_display run function ssbrc:stage/miiverse/logic/posts/init with storage ssbrc:temp cache
