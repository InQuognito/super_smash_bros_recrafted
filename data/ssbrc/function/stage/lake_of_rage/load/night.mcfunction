...
# Lapras
execute positioned 2553.5 12.5 4045.5 rotated 135.0 0.0 run function animated_java:lapras/summon {args:{animation:"animation_lapras_surfacewater_idle",start_animation:true}}
