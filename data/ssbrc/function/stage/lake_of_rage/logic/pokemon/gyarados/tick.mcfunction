...
execute if entity @s[scores={temp=252..330}] positioned ^ ^2.5 ^6 run function ssbrc:stage/lake_of_rage/logic/pokemon/gyarados/hyper_beam/tick
...
execute if entity @s[scores={temp=621}] run function ssbrc:stage/lake_of_rage/logic/pokemon/gyarados/deactivate
