...
execute if score hazards options matches 0 positioned 23360.5 5.0 8636.5 summon minecraft:armor_stand run function ssbrc:stage/pac_maze/logic/ghosts/init {name:"blinky"}
execute if score hazards options matches 1 positioned 23360.5 5.0 8633.5 summon minecraft:armor_stand run function ssbrc:stage/pac_maze/logic/ghosts/init {name:"blinky"}
execute positioned 23360.5 5.0 8638.0 summon minecraft:armor_stand run function ssbrc:stage/pac_maze/logic/ghosts/init {name:"pinky"}
execute positioned 23358.5 5.0 8638.0 summon minecraft:armor_stand run function ssbrc:stage/pac_maze/logic/ghosts/init {name:"inky"}
execute positioned 23362.5 5.0 8638.0 summon minecraft:armor_stand run function ssbrc:stage/pac_maze/logic/ghosts/init {name:"clyde"}
