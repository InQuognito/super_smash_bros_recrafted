...
execute if entity @s[tag=blinky,scores={cooldown=1}] run function ssbrc:stage/pac_maze/logic/ghosts/release/blinky
execute if entity @s[tag=clyde,scores={cooldown=1}] run function ssbrc:stage/pac_maze/logic/ghosts/release/clyde
execute if entity @s[tag=inky,scores={cooldown=1}] run function ssbrc:stage/pac_maze/logic/ghosts/release/inky
execute if entity @s[tag=pinky,scores={cooldown=1}] run function ssbrc:stage/pac_maze/logic/ghosts/release/pinky
