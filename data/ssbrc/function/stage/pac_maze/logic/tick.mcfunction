...
# Pickups
execute as @a[predicate=ssbrc:player] at @s positioned ~ ~0.5 ~ if entity @e[type=minecraft:item_display,tag=dot,distance=..0.75] run function ssbrc:stage/pac_maze/logic/dot/pickup with storage ssbrc:temp game.stage
