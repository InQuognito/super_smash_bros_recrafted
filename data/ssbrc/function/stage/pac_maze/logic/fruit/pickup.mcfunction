...
execute if entity @s[tag=galaxian_flagship] as @p[predicate=ssbrc:flag/player] run function ssbrc:stage/pac_maze/logic/fruit/galaxian_flagship/pickup
...
$playsound ssbrc:stage.pac_maze.$(variant).eat_fruit player @a
