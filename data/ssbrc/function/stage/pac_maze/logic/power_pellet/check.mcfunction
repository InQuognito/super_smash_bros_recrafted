...
execute unless score pac_maze.power_pellet.count temp matches 4.. run function ssbrc:stage/pac_maze/logic/power_pellet/spawn with storage ssbrc:temp game.stage
