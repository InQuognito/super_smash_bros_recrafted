...
execute if score hazards options matches 0 run function ssbrc:stage/flat_zone/load/hazards_off
execute if score hazards options matches 1 run function ssbrc:stage/flat_zone/load/hazards_on
