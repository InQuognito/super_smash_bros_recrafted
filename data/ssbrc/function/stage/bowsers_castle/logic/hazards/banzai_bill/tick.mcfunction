...
execute positioned ^ ^ ^2 if block ^ ^ ^0.1 minecraft:ladder run function ssbrc:stage/bowsers_castle/logic/hazards/destruction/top_platform
execute positioned ^ ^ ^2 if block ^ ^ ^0.1 #ssbrc:stage/bowsers_castle/rear_wall run function ssbrc:stage/bowsers_castle/logic/hazards/destruction/rear_wall
