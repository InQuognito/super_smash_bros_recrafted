...
# Bowser Face - Black
summon minecraft:item_display -736.99 33.5 867.0 {Rotation:[-90f,0f],item:{id:"minecraft:stick",components:{"minecraft:item_model":"ssbrc:stage/bowsers_castle/bowser_face/black"}},transformation:[2f,0f,0f,0f,0f,2f,0f,0f,0f,0f,2f,0f,0f,0f,0f,1f],brightness:{sky:6,block:6}}
summon minecraft:item_display -736.99 33.5 822.0 {Rotation:[-90f,0f],item:{id:"minecraft:stick",components:{"minecraft:item_model":"ssbrc:stage/bowsers_castle/bowser_face/black"}},transformation:[2f,0f,0f,0f,0f,2f,0f,0f,0f,0f,2f,0f,0f,0f,0f,1f],brightness:{sky:6,block:6}}
...
# Armor Stands
execute positioned -734.9 27.0 854.5 summon minecraft:armor_stand run function ssbrc:stage/bowsers_castle/logic/armor_stands/peach
execute positioned -735.0 27.5 834.5 rotated -90.0 0.0 summon minecraft:item_display run function ssbrc:stage/bowsers_castle/logic/armor_stands/toad {pose:"clutching_bars",color:"red"}
execute positioned -737.7 27.2 833.2 rotated -45.0 0.0 summon minecraft:item_display run function ssbrc:stage/bowsers_castle/logic/armor_stands/toad {pose:"sitting",color:"yellow"}
execute positioned -736.5 27.5 836.0 rotated 0.0 0.0 summon minecraft:item_display run function ssbrc:stage/bowsers_castle/logic/armor_stands/toad {pose:"clutching_bars",color:"blue"}
