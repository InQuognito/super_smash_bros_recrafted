...
# Destroy Tower
execute if score tower_of_fate.destroyed temp matches 1.. if score tower_of_fate.destroyedTimer temp matches 1.. run function ssbrc:stage/tower_of_fate/logic/destroy_tower/tick
