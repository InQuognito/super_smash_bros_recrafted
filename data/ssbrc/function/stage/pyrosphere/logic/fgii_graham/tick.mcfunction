execute as @n[type=minecraft:item_display,tag=fgii_graham.propeller] at @s run function ssbrc:stage/pyrosphere/logic/fgii_graham/tick_propeller
...
execute if entity @s[scores={temp=193..}] run function ssbrc:stage/pyrosphere/logic/fgii_graham/tick_active
