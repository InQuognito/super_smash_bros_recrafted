...
particle minecraft:item{item:{id:"minecraft:sugar",components:{"minecraft:item_model":"animated_java:blueprint/fgii_graham/body"}}} ~ ~ ~ 0.0 0.0 0.0 0.15 100 normal @a
