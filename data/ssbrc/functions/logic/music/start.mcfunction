...
execute if score $acropolisGraveyard map matches 1 if score song temp matches 0 run playsound ssbrc:anatasia_battle_intro music @s
...
execute if score $acropolisGraveyard map matches 1 if score song temp matches 1 run playsound ssbrc:rise_from_your_grave_intro music @s
...
execute if score $bigBattlefield map matches 1 if score song temp matches 1 run playsound ssbrc:the_eel_deal_intro music @s
...
execute if score $bowsersCastle map matches 1 if score song temp matches 0 run playsound ssbrc:bowsers_lava_lair_intro music @s
...
execute if score $bowsersCastle map matches 1 if score song temp matches 1 run playsound ssbrc:chase_giga_bowser_intro music @s
...
execute if score $castleSiege map matches 1 if score song temp matches 0 run playsound ssbrc:story_5_meeting_intro music @s
...
execute if score $castleSiege map matches 1 if score song temp matches 1 run playsound ssbrc:with_milas_divine_protection_intro music @s
...
execute if score $draculasCastle map matches 1 if score song temp matches 0 run playsound ssbrc:aquarius_intro music @s
...
execute if score $draculasCastle map matches 1 if score song temp matches 1 run playsound ssbrc:bloody_tears_intro music @s
...
execute if score $dreamLand map matches 1 if score song temp matches 0 run playsound ssbrc:checker_knights_intro music @s
...
execute if score $dreamLand map matches 1 if score song temp matches 1 run playsound ssbrc:planet_popstar_intro music @s
...
execute if score $finalDestination map matches 1 if score song temp matches 0 run playsound ssbrc:final_destination_melee_intro music @s
...
execute if score $finalDestination map matches 1 if score song temp matches 1 run playsound ssbrc:master_hand_fight_intro music @s
...
execute if score $flatZone map matches 1 if score song temp matches 0 run playsound ssbrc:flat_zone_intro music @s
...
execute if score $flatZone map matches 1 if score song temp matches 1 run playsound ssbrc:flat_zone_2_intro music @s
...
execute if score $frozenHijinx map matches 1 if score song temp matches 0 run playsound ssbrc:homecoming_hijinx_intro music @s
...
execute if score $frozenHijinx map matches 1 if score song temp matches 1 run playsound ssbrc:stickerbrush_symphony_intro music @s
...
execute if score $gardenOfHope map matches 1 if score song temp matches 0 run playsound ssbrc:forest_of_hope_intro music @s
...
execute if score $gardenOfHope map matches 1 if score song temp matches 1 run playsound ssbrc:garden_of_hope_intro music @s
...
execute if score $greatBay map matches 1 if score song temp matches 0 run playsound ssbrc:legend_of_zelda_main_theme_intro music @s
...
execute if score $greatBay map matches 1 if score song temp matches 1 run playsound ssbrc:termina_field_intro music @s
...
execute if score $greatPlateau map matches 1 if score song temp matches 0 run playsound ssbrc:kass_theme_intro music @s
...
execute if score $greatPlateau map matches 1 if score song temp matches 1 run playsound ssbrc:legend_of_zelda_main_theme_intro music @s
...
execute if score $greatPlateau map matches 1 if score song temp matches 2 run playsound ssbrc:rescue_operation_intro music @s
...
execute if score $greenHillZone map matches 1 if score song temp matches 0 run playsound ssbrc:sonic_adventure_2_intro music @s
...
execute if score $greenHillZone map matches 1 if score song temp matches 1 run playsound ssbrc:sonic_mania_intro music @s
...
execute if score $hyruleCastle map matches 1 if score song temp matches 0 run playsound ssbrc:ballad_of_the_goddess_intro music @s
...
execute if score $hyruleCastle map matches 1 if score song temp matches 1 run playsound ssbrc:hyrule_castle_theme_intro music @s
...
execute if score $icicleMountain map matches 1 if score song temp matches 0 run playsound ssbrc:ice_climber_melee_intro music @s
...
execute if score $jungleJapes map matches 1 if score song temp matches 0 run playsound ssbrc:jungle_japes_melee_intro music @s
...
execute if score $lakeOfRage map matches 1 if score song temp matches 0 run playsound ssbrc:pokemon_gold_pokemon_silver_medley_intro music @s
...
execute if score $lakeOfRage map matches 1 if score song temp matches 1 run playsound ssbrc:trainer_battle_pokemon_gold_silver_intro music @s
...
execute if score $luigisMansion map matches 1 if score song temp matches 0 run playsound ssbrc:dark_hallways_intro music @s
...
execute if score $luigisMansion map matches 1 if score song temp matches 1 run playsound ssbrc:luigis_mansion_theme_intro music @s
...
execute if score $mementosType map matches 1 if score song temp matches 0 run playsound ssbrc:light_in_starless_sky_intro music @s
...
execute if score $mementosType map matches 1 if score song temp matches 1 run playsound ssbrc:mass_destruction_dual_mix_part_1 music @s
...
execute if score $mementosType map matches 2 if score song temp matches 0 run playsound ssbrc:reach_out_to_the_truth_intro music @s
...
execute if score $mementosType map matches 2 if score song temp matches 1 run playsound ssbrc:time_to_make_history_intro music @s
...
execute if score $mementosType map matches 3 if score song temp matches 0 run playsound ssbrc:axe_to_grind_intro music @s
...
execute if score $mementosType map matches 3 if score song temp matches 1 run playsound ssbrc:take_over_intro music @s
...
execute if score $mushroomKingdom map matches 1 if score song temp matches 0 run playsound ssbrc:bob_omb_battlefield_intro music @s
...
execute if score $mushroomKingdom map matches 1 if score song temp matches 1 run playsound ssbrc:mario_paint_medley_intro music @s
...
execute if score $mushroomKingdom map matches 1 if score song temp matches 2 run playsound ssbrc:super_mario_bros_main_theme_intro music @s
...
execute if score pacMaze map matches 1 if score song temp matches 0 run playsound ssbrc:pac_man_club_mix_intro music @s
...
execute if score $palletTown map matches 1 if score song temp matches 0 run playsound ssbrc:battle_lets_go_pikachu_eevee_intro music @s
...
execute if score $palletTown map matches 1 if score song temp matches 1 run playsound ssbrc:road_to_viridian_city_intro music @s
...
execute if score $palutenasTemple map matches 1 if score song temp matches 0 run playsound ssbrc:dark_pits_theme_intro music @s
...
execute if score $palutenasTemple map matches 1 if score song temp matches 1 run playsound ssbrc:destroyed_skyworld_intro music @s
...
execute if score $planetEpp map matches 1 if score song temp matches 0 run playsound ssbrc:draconus_intro music @s
...
execute if score $planetEpp map matches 1 if score song temp matches 1 run playsound ssbrc:zybex_intro music @s
...
execute if score $planetZebes map matches 1 if score song temp matches 0 run playsound ssbrc:brinstar_intro music @s
...
execute if score $planetZebes map matches 1 if score song temp matches 1 run playsound ssbrc:magmoor_caverns_intro music @s
...
execute if score $planetZebes map matches 1 if score song temp matches 2 run playsound ssbrc:multiplayer_metroid_prime_2_echoes_intro music @s
...
execute if score $planetZebes map matches 1 if score song temp matches 3 run playsound ssbrc:theme_of_samus_aran_space_warrior_intro music @s
...
execute if score $sandOcean map matches 1 if score song temp matches 0 run playsound ssbrc:brain_cleaner_intro music @s
...
execute if score $saturnValley map matches 1 if score song temp matches 0 run playsound ssbrc:humoresque_of_a_little_dog_intro music @s
...
execute if score $sectorZ map matches 1 if score song temp matches 0 run playsound ssbrc:area_6_intro music @s
...
execute if score $sectorZ map matches 1 if score song temp matches 1 run playsound ssbrc:star_wolf_intro music @s
...
execute if score $shadowMosesIsland map matches 1 if score song temp matches 0 run playsound ssbrc:encounter_intro music @s
...
execute if score $spearPillar map matches 1 if score song temp matches 0 run playsound ssbrc:dialga_and_palkia_battle_intro music @s
...
execute if score $spearPillar map matches 1 if score song temp matches 1 run playsound ssbrc:team_galactic_battle_intro music @s
...
execute if score $suzakuCastle map matches 1 if score song temp matches 0 run playsound ssbrc:ryu_stage_intro music @s
...
execute if score $suzakuCastle map matches 1 if score song temp matches 1 run playsound ssbrc:street_fighter_4_intro_intro music @s
...
execute if score $wilyCastle map matches 1 if score song temp matches 0 run playsound ssbrc:mega_man_2_medley_intro music @s
...
execute if score $wilyCastle map matches 1 if score song temp matches 1 run playsound ssbrc:mega_man_4_medley_intro music @s
...
execute if score $yggdrasilsAltar map matches 1 if score song temp matches 0 run playsound ssbrc:battle_for_glory_intro music @s
...
execute if score $yggdrasilsAltar map matches 1 if score song temp matches 1 run playsound ssbrc:the_hero_goes_forth_with_a_determination_intro music @s
