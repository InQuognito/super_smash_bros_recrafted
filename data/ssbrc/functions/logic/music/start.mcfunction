...
execute if score $acropolisGraveyard map matches 1 if score result_music random matches 0 run tellraw @s [{"translate":"ssbrc.game.music.nowPlaying","bold":true,"color":"gold"},{"text":"Anatasia Battle","color":"yellow"}]
...
execute if score $acropolisGraveyard map matches 1 if score result_music random matches 1 run tellraw @s [{"translate":"ssbrc.game.music.nowPlaying","bold":true,"color":"gold"},{"text":"Rise From Your Grave","color":"yellow"}]
...
execute if score $battlefield map matches 1 if score result_music random matches 0 run tellraw @s [{"translate":"ssbrc.game.music.nowPlaying","bold":true,"color":"gold"},{"text":"Aquos Arena","color":"yellow"}]
...
execute if score $battlefield map matches 1 if score result_music random matches 1 run tellraw @s [{"translate":"ssbrc.game.music.nowPlaying","bold":true,"color":"gold"},{"text":"Battle on the Big Bridge","color":"yellow"}]
...
execute if score $bigBattlefield map matches 1 if score result_music random matches 0 run tellraw @s [{"translate":"ssbrc.game.music.nowPlaying","bold":true,"color":"gold"},{"text":"Rock Solid","color":"yellow"}]
...
execute if score $bigBattlefield map matches 1 if score result_music random matches 1 run tellraw @s [{"translate":"ssbrc.game.music.nowPlaying","bold":true,"color":"gold"},{"text":"The Eel Deal","color":"yellow"}]
...
execute if score $bowsersCastle map matches 1 if score result_music random matches 0 run tellraw @s [{"translate":"ssbrc.game.music.nowPlaying","bold":true,"color":"gold"},{"text":"Bowser's Lava Lair","color":"yellow"}]
...
execute if score $bowsersCastle map matches 1 if score result_music random matches 1 run tellraw @s [{"translate":"ssbrc.game.music.nowPlaying","bold":true,"color":"gold"},{"text":"Chase Giga Bowser","color":"yellow"}]
...
execute if score $castleSiege map matches 1 if score result_music random matches 0 run tellraw @s [{"translate":"ssbrc.game.music.nowPlaying","bold":true,"color":"gold"},{"text":"Story 5 Meeting","color":"yellow"}]
...
execute if score $castleSiege map matches 1 if score result_music random matches 1 run tellraw @s [{"translate":"ssbrc.game.music.nowPlaying","bold":true,"color":"gold"},{"text":"With Mila's Divine Protection","color":"yellow"}]
...
execute if score $draculasCastle map matches 1 if score result_music random matches 0 run tellraw @s [{"translate":"ssbrc.game.music.nowPlaying","bold":true,"color":"gold"},{"text":"Aquarius","color":"yellow"}]
...
execute if score $draculasCastle map matches 1 if score result_music random matches 1 run tellraw @s [{"translate":"ssbrc.game.music.nowPlaying","bold":true,"color":"gold"},{"text":"Bloody Tears","color":"yellow"}]
...
execute if score $dreamLand map matches 1 if score result_music random matches 0 run tellraw @s [{"translate":"ssbrc.game.music.nowPlaying","bold":true,"color":"gold"},{"text":"Checker Knights","color":"yellow"}]
...
execute if score $dreamLand map matches 1 if score result_music random matches 1 run tellraw @s [{"translate":"ssbrc.game.music.nowPlaying","bold":true,"color":"gold"},{"text":"Planet Popstar","color":"yellow"}]
...
execute if score $finalDestination map matches 1 if score result_music random matches 0 run tellraw @s [{"translate":"ssbrc.game.music.nowPlaying","bold":true,"color":"gold"},{"text":"Final Destination (Melee)","color":"yellow"}]
...
execute if score $finalDestination map matches 1 if score result_music random matches 1 run tellraw @s [{"translate":"ssbrc.game.music.nowPlaying","bold":true,"color":"gold"},{"text":"Master Hand Fight","color":"yellow"}]
...
execute if score $flatZone map matches 1 if score result_music random matches 0 run tellraw @s [{"translate":"ssbrc.game.music.nowPlaying","bold":true,"color":"gold"},{"text":"Flat Zone","color":"yellow"}]
...
execute if score $flatZone map matches 1 if score result_music random matches 1 run tellraw @s [{"translate":"ssbrc.game.music.nowPlaying","bold":true,"color":"gold"},{"text":"Flat Zone 2","color":"yellow"}]
...
execute if score $frozenHijinx map matches 1 if score result_music random matches 0 run tellraw @s [{"translate":"ssbrc.game.music.nowPlaying","bold":true,"color":"gold"},{"text":"Homecoming Hijinx","color":"yellow"}]
...
execute if score $frozenHijinx map matches 1 if score result_music random matches 1 run tellraw @s [{"translate":"ssbrc.game.music.nowPlaying","bold":true,"color":"gold"},{"text":"Stickerbrush Symphony","color":"yellow"}]
...
execute if score $gardenOfHope map matches 1 if score result_music random matches 0 run tellraw @s [{"translate":"ssbrc.game.music.nowPlaying","bold":true,"color":"gold"},{"text":"Forest of Hope","color":"yellow"}]
...
execute if score $gardenOfHope map matches 1 if score result_music random matches 1 run tellraw @s [{"translate":"ssbrc.game.music.nowPlaying","bold":true,"color":"gold"},{"text":"Garden of Hope","color":"yellow"}]
...
execute if score $greatBay map matches 1 if score result_music random matches 0 run tellraw @s [{"translate":"ssbrc.game.music.nowPlaying","bold":true,"color":"gold"},{"text":"Legend of Zelda Main Theme","color":"yellow"}]
...
execute if score $greatBay map matches 1 if score result_music random matches 1 run tellraw @s [{"translate":"ssbrc.game.music.nowPlaying","bold":true,"color":"gold"},{"text":"Termina Field","color":"yellow"}]
...
execute if score $greatPlateau map matches 1 if score result_music random matches 0 run tellraw @s [{"translate":"ssbrc.game.music.nowPlaying","bold":true,"color":"gold"},{"text":"Kass's Theme","color":"yellow"}]
...
execute if score $greatPlateau map matches 1 if score result_music random matches 1 run tellraw @s [{"translate":"ssbrc.game.music.nowPlaying","bold":true,"color":"gold"},{"text":"Legend of Zelda Main Theme","color":"yellow"}]
...
execute if score $greatPlateau map matches 1 if score result_music random matches 2 run tellraw @s [{"translate":"ssbrc.game.music.nowPlaying","bold":true,"color":"gold"},{"text":"Rescue Operation","color":"yellow"}]
...
execute if score $greenHillZone map matches 1 if score result_music random matches 0 run tellraw @s [{"translate":"ssbrc.game.music.nowPlaying","bold":true,"color":"gold"},{"text":"Green Hill Zone - Sonic Adventure 2","color":"yellow"}]
...
execute if score $greenHillZone map matches 1 if score result_music random matches 1 run tellraw @s [{"translate":"ssbrc.game.music.nowPlaying","bold":true,"color":"gold"},{"text":"Green Hill Zone - Sonic Mania","color":"yellow"}]
...
execute if score $hyruleCastle map matches 1 if score result_music random matches 0 run tellraw @s [{"translate":"ssbrc.game.music.nowPlaying","bold":true,"color":"gold"},{"text":"Ballad of the Goddess","color":"yellow"}]
...
execute if score $hyruleCastle map matches 1 if score result_music random matches 1 run tellraw @s [{"translate":"ssbrc.game.music.nowPlaying","bold":true,"color":"gold"},{"text":"Hyrule Castle Theme","color":"yellow"}]
...
execute if score $icicleMountain map matches 1 if score result_music random matches 0 run tellraw @s [{"translate":"ssbrc.game.music.nowPlaying","bold":true,"color":"gold"},{"text":"Ice Climber (Melee)","color":"yellow"}]
...
execute if score $icicleMountain map matches 1 if score result_music random matches 1 run tellraw @s [{"translate":"ssbrc.game.music.nowPlaying","bold":true,"color":"gold"},{"text":"Ice Climber (Retro)","color":"yellow"}]
...
execute if score $jungleJapes map matches 1 if score result_music random matches 0 run tellraw @s [{"translate":"ssbrc.game.music.nowPlaying","bold":true,"color":"gold"},{"text":"Jungle Japes (Melee)","color":"yellow"}]
...
execute if score $jungleJapes map matches 1 if score result_music random matches 1 run tellraw @s [{"translate":"ssbrc.game.music.nowPlaying","bold":true,"color":"gold"},{"text":"Jungle Swing","color":"yellow"}]
...
execute if score $lakeOfRage map matches 1 if score result_music random matches 0 run tellraw @s [{"translate":"ssbrc.game.music.nowPlaying","bold":true,"color":"gold"},{"text":"Pokémon Gold & Silver Medley","color":"yellow"}]
...
execute if score $lakeOfRage map matches 1 if score result_music random matches 1 run tellraw @s [{"translate":"ssbrc.game.music.nowPlaying","bold":true,"color":"gold"},{"text":"Trainer Battle! (Pokémon Gold/Pokémon Silver)","color":"yellow"}]
...
execute if score $luigisMansion map matches 1 if score result_music random matches 0 run tellraw @s [{"translate":"ssbrc.game.music.nowPlaying","bold":true,"color":"gold"},{"text":"Dark Hallways","color":"yellow"}]
...
execute if score $luigisMansion map matches 1 if score result_music random matches 1 run tellraw @s [{"translate":"ssbrc.game.music.nowPlaying","bold":true,"color":"gold"},{"text":"Luigi's Mansion Theme","color":"yellow"}]
...
execute if score $magicant map matches 1 if score result_music random matches 0 run tellraw @s [{"translate":"ssbrc.game.music.nowPlaying","bold":true,"color":"gold"},{"text":"Magicant (Cognitive Dissonance)","color":"yellow"}]
...
execute if score $magicant map matches 1 if score result_music random matches 1 run tellraw @s [{"translate":"ssbrc.game.music.nowPlaying","bold":true,"color":"gold"},{"text":"Eight Melodies","color":"yellow"}]
...
execute if score $mementosType map matches 1 if score result_music random matches 0 run tellraw @s [{"translate":"ssbrc.game.music.nowPlaying","bold":true,"color":"gold"},{"text":"Light in Starless Sky","color":"yellow"}]
...
execute if score $mementosType map matches 1 if score result_music random matches 1 run tellraw @s [{"translate":"ssbrc.game.music.nowPlaying","bold":true,"color":"gold"},{"text":"Mass Destruction - Dual Mix","color":"yellow"}]
...
execute if score $mementosType map matches 2 if score result_music random matches 0 run tellraw @s [{"translate":"ssbrc.game.music.nowPlaying","bold":true,"color":"gold"},{"text":"Reach Out to the Truth","color":"yellow"}]
...
execute if score $mementosType map matches 2 if score result_music random matches 1 run tellraw @s [{"translate":"ssbrc.game.music.nowPlaying","bold":true,"color":"gold"},{"text":"Time to Make History","color":"yellow"}]
...
execute if score $mementosType map matches 3 if score result_music random matches 0 run tellraw @s [{"translate":"ssbrc.game.music.nowPlaying","bold":true,"color":"gold"},{"text":"Axe to Grind","color":"yellow"}]
...
execute if score $mementosType map matches 3 if score result_music random matches 1 run tellraw @s [{"translate":"ssbrc.game.music.nowPlaying","bold":true,"color":"gold"},{"text":"Take Over","color":"yellow"}]
...
execute if score $miiverse map matches 1 if score result_music random matches 0 run tellraw @s [{"translate":"ssbrc.game.music.nowPlaying","bold":true,"color":"gold"},{"text":"Mario Paint Medley","color":"yellow"}]
...
execute if score $miiverse map matches 1 if score result_music random matches 1 run tellraw @s [{"translate":"ssbrc.game.music.nowPlaying","bold":true,"color":"gold"},{"text":"Nintendo Land Medley","color":"yellow"}]
...
execute if score $mushroomKingdom map matches 1 if score result_music random matches 0 run tellraw @s [{"translate":"ssbrc.game.music.nowPlaying","bold":true,"color":"gold"},{"text":"Bob-Omb Battlefield","color":"yellow"}]
...
execute if score $mushroomKingdom map matches 1 if score result_music random matches 1 run tellraw @s [{"translate":"ssbrc.game.music.nowPlaying","bold":true,"color":"gold"},{"text":"Mario Paint Medley","color":"yellow"}]
...
execute if score $mushroomKingdom map matches 1 if score result_music random matches 2 run tellraw @s [{"translate":"ssbrc.game.music.nowPlaying","bold":true,"color":"gold"},{"text":"Super Mario Bros. Main Theme","color":"yellow"}]
...
execute if score $pacMaze map matches 1 if score result_music random matches 0 run tellraw @s [{"translate":"ssbrc.game.music.nowPlaying","bold":true,"color":"gold"},{"text":"PAC-MAN (Club Mix)","color":"yellow"}]
...
execute if score $pacMaze map matches 1 if score result_music random matches 1 run tellraw @s [{"translate":"ssbrc.game.music.nowPlaying","bold":true,"color":"gold"},{"text":"Pac-Rainbow","color":"yellow"}]
...
execute if score $palletTown map matches 1 if score result_music random matches 0 run tellraw @s [{"translate":"ssbrc.game.music.nowPlaying","bold":true,"color":"gold"},{"text":"Battle! (Let's Go Pikachu / Let's Go Eevee)","color":"yellow"}]
...
execute if score $palletTown map matches 1 if score result_music random matches 1 run tellraw @s [{"translate":"ssbrc.game.music.nowPlaying","bold":true,"color":"gold"},{"text":"Road to Viridian City","color":"yellow"}]
...
execute if score $palutenasTemple map matches 1 if score result_music random matches 0 run tellraw @s [{"translate":"ssbrc.game.music.nowPlaying","bold":true,"color":"gold"},{"text":"Dark Pit's Theme","color":"yellow"}]
...
execute if score $palutenasTemple map matches 1 if score result_music random matches 1 run tellraw @s [{"translate":"ssbrc.game.music.nowPlaying","bold":true,"color":"gold"},{"text":"Destroyed Skyworld","color":"yellow"}]
...
execute if score $planetEpp map matches 1 if score result_music random matches 0 run tellraw @s [{"translate":"ssbrc.game.music.nowPlaying","bold":true,"color":"gold"},{"text":"Draconus","color":"yellow"}]
...
execute if score $planetEpp map matches 1 if score result_music random matches 1 run tellraw @s [{"translate":"ssbrc.game.music.nowPlaying","bold":true,"color":"gold"},{"text":"Zybex","color":"yellow"}]
...
execute if score $planetZebes map matches 1 if score result_music random matches 0 run tellraw @s [{"translate":"ssbrc.game.music.nowPlaying","bold":true,"color":"gold"},{"text":"Brinstar","color":"yellow"}]
...
execute if score $planetZebes map matches 1 if score result_music random matches 1 run tellraw @s [{"translate":"ssbrc.game.music.nowPlaying","bold":true,"color":"gold"},{"text":"Magmoor Caverns","color":"yellow"}]
...
execute if score $planetZebes map matches 1 if score result_music random matches 2 run tellraw @s [{"translate":"ssbrc.game.music.nowPlaying","bold":true,"color":"gold"},{"text":"Multiplayer (Metroid Prime 2: Echoes)","color":"yellow"}]
...
execute if score $planetZebes map matches 1 if score result_music random matches 3 run tellraw @s [{"translate":"ssbrc.game.music.nowPlaying","bold":true,"color":"gold"},{"text":"Theme of Samus Aran, Space Warrior","color":"yellow"}]
...
execute if score $pyrosphere map matches 1 if score result_music random matches 0 run tellraw @s [{"translate":"ssbrc.game.music.nowPlaying","bold":true,"color":"gold"},{"text":"Brinstar","color":"yellow"}]
...
execute if score $pyrosphere map matches 1 if score result_music random matches 1 run tellraw @s [{"translate":"ssbrc.game.music.nowPlaying","bold":true,"color":"gold"},{"text":"Magmoor Caverns","color":"yellow"}]
...
execute if score $pyrosphere map matches 1 if score result_music random matches 2 run tellraw @s [{"translate":"ssbrc.game.music.nowPlaying","bold":true,"color":"gold"},{"text":"Multiplayer (Metroid Prime 2: Echoes)","color":"yellow"}]
...
execute if score $pyrosphere map matches 1 if score result_music random matches 3 run tellraw @s [{"translate":"ssbrc.game.music.nowPlaying","bold":true,"color":"gold"},{"text":"Theme of Samus Aran, Space Warrior","color":"yellow"}]
...
execute if score $sandOcean map matches 1 if score result_music random matches 0 run tellraw @s [{"translate":"ssbrc.game.music.nowPlaying","bold":true,"color":"gold"},{"text":"Brain Cleaner","color":"yellow"}]
...
execute if score $sandOcean map matches 1 if score result_music random matches 1 run tellraw @s [{"translate":"ssbrc.game.music.nowPlaying","bold":true,"color":"gold"},{"text":"Sand Ocean","color":"yellow"}]
...
execute if score $saturnValley map matches 1 if score result_music random matches 0 run tellraw @s [{"translate":"ssbrc.game.music.nowPlaying","bold":true,"color":"gold"},{"text":"Humoresque of a Little Dog","color":"yellow"}]
...
execute if score $saturnValley map matches 1 if score result_music random matches 1 run tellraw @s [{"translate":"ssbrc.game.music.nowPlaying","bold":true,"color":"gold"},{"text":"Mr. Saturn Theme Z","color":"yellow"}]
...
execute if score $sectorZ map matches 1 if score result_music random matches 0 run tellraw @s [{"translate":"ssbrc.game.music.nowPlaying","bold":true,"color":"gold"},{"text":"Area 6","color":"yellow"}]
...
execute if score $sectorZ map matches 1 if score result_music random matches 1 run tellraw @s [{"translate":"ssbrc.game.music.nowPlaying","bold":true,"color":"gold"},{"text":"Star Wolf","color":"yellow"}]
...
execute if score $shadowMosesIsland map matches 1 if score result_music random matches 0 run tellraw @s [{"translate":"ssbrc.game.music.nowPlaying","bold":true,"color":"gold"},{"text":"Encounter","color":"yellow"}]
...
execute if score $shadowMosesIsland map matches 1 if score result_music random matches 1 run tellraw @s [{"translate":"ssbrc.game.music.nowPlaying","bold":true,"color":"gold"},{"text":"Metal Gear Online 3 Main Theme","color":"yellow"}]
...
execute if score $spearPillar map matches 1 if score result_music random matches 0 run tellraw @s [{"translate":"ssbrc.game.music.nowPlaying","bold":true,"color":"gold"},{"text":"Dialga and Palkia Battle","color":"yellow"}]
...
execute if score $spearPillar map matches 1 if score result_music random matches 1 run tellraw @s [{"translate":"ssbrc.game.music.nowPlaying","bold":true,"color":"gold"},{"text":"Team Galactic Battle","color":"yellow"}]
...
execute if score $suzakuCastle map matches 1 if score result_music random matches 0 run tellraw @s [{"translate":"ssbrc.game.music.nowPlaying","bold":true,"color":"gold"},{"text":"Ryu Stage","color":"yellow"}]
...
execute if score $suzakuCastle map matches 1 if score result_music random matches 1 run tellraw @s [{"translate":"ssbrc.game.music.nowPlaying","bold":true,"color":"gold"},{"text":"Street Fighter 4 Intro","color":"yellow"}]
...
execute if score $towerOfFate map matches 1 if score result_music random matches 0 run tellraw @s [{"translate":"ssbrc.game.music.nowPlaying","bold":true,"color":"gold"},{"text":"Hitting Close to Home","color":"yellow"}]
...
execute if score $towerOfFate map matches 1 if score result_music random matches 1 run tellraw @s [{"translate":"ssbrc.game.music.nowPlaying","bold":true,"color":"gold"},{"text":"The Fateful Return","color":"yellow"}]
...
execute if score $wilyCastle map matches 1 if score result_music random matches 0 run tellraw @s [{"translate":"ssbrc.game.music.nowPlaying","bold":true,"color":"gold"},{"text":"Mega Man 2 Medley","color":"yellow"}]
...
execute if score $wilyCastle map matches 1 if score result_music random matches 1 run tellraw @s [{"translate":"ssbrc.game.music.nowPlaying","bold":true,"color":"gold"},{"text":"Mega Man 4 Medley","color":"yellow"}]
...
execute if score $yggdrasilsAltar map matches 1 if score result_music random matches 0 run tellraw @s [{"translate":"ssbrc.game.music.nowPlaying","bold":true,"color":"gold"},{"text":"Battle for Glory","color":"yellow"}]
...
execute if score $yggdrasilsAltar map matches 1 if score result_music random matches 1 run tellraw @s [{"translate":"ssbrc.game.music.nowPlaying","bold":true,"color":"gold"},{"text":"The Hero Goes Forth With a Determination","color":"yellow"}]
