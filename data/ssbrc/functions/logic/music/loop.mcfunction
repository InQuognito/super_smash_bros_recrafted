...
execute if score $acropolisGraveyard map matches 1 if score song temp matches 0 run playsound ssbrc:anatasia_battle music @s
...
execute if score $acropolisGraveyard map matches 1 if score song temp matches 1 run playsound ssbrc:rise_from_your_grave music @s
...
execute if score $bigBattlefield map matches 1 if score song temp matches 0 run playsound ssbrc:rock_solid music @s
...
execute if score $bigBattlefield map matches 1 if score song temp matches 1 run playsound ssbrc:the_eel_deal music @s
...
execute if score $bowsersCastle map matches 1 if score song temp matches 0 run playsound ssbrc:bowsers_lava_lair music @s
...
execute if score $bowsersCastle map matches 1 if score song temp matches 1 run playsound ssbrc:chase_giga_bowser music @s
...
execute if score $castleSiege map matches 1 if score song temp matches 0 run playsound ssbrc:story_5_meeting music @s
...
execute if score $castleSiege map matches 1 if score song temp matches 1 run playsound ssbrc:with_milas_divine_protection music @s
...
execute if score $draculasCastle map matches 1 if score song temp matches 0 run playsound ssbrc:aquarius music @s
...
execute if score $draculasCastle map matches 1 if score song temp matches 1 run playsound ssbrc:bloody_tears music @s
...
execute if score $dreamLand map matches 1 if score song temp matches 0 run playsound ssbrc:checker_knights music @s
...
execute if score $dreamLand map matches 1 if score song temp matches 1 run playsound ssbrc:planet_popstar music @s
...
execute if score $finalDestination map matches 1 if score song temp matches 0 run playsound ssbrc:final_destination_melee music @s
...
execute if score $finalDestination map matches 1 if score song temp matches 1 run playsound ssbrc:master_hand_fight music @s
...
execute if score $flatZone map matches 1 if score song temp matches 0 run playsound ssbrc:flat_zone music @s
...
execute if score $flatZone map matches 1 if score song temp matches 1 run playsound ssbrc:flat_zone_2 music @s
...
execute if score $frozenHijinx map matches 1 if score song temp matches 0 run playsound ssbrc:homecoming_hijinx music @s
...
execute if score $frozenHijinx map matches 1 if score song temp matches 1 run playsound ssbrc:stickerbrush_symphony music @s
...
execute if score $gardenOfHope map matches 1 if score song temp matches 0 run playsound ssbrc:forest_of_hope music @s
...
execute if score $gardenOfHope map matches 1 if score song temp matches 1 run playsound ssbrc:garden_of_hope music @s
...
execute if score $greatBay map matches 1 if score song temp matches 0 run playsound ssbrc:legend_of_zelda_main_theme music @s
...
execute if score $greatBay map matches 1 if score song temp matches 1 run playsound ssbrc:termina_field music @s
...
execute if score $greatPlateau map matches 1 if score song temp matches 0 run playsound ssbrc:kass_theme music @s
...
execute if score $greatPlateau map matches 1 if score song temp matches 1 run playsound ssbrc:legend_of_zelda_main_theme music @s
...
execute if score $greatPlateau map matches 1 if score song temp matches 2 run playsound ssbrc:rescue_operation music @s
...
execute if score $greenHillZone map matches 1 if score song temp matches 0 run playsound ssbrc:sonic_adventure_2 music @s
...
execute if score $greenHillZone map matches 1 if score song temp matches 1 run playsound ssbrc:sonic_mania music @s
...
execute if score $hyruleCastle map matches 1 if score song temp matches 0 run playsound ssbrc:ballad_of_the_goddess music @s
...
execute if score $hyruleCastle map matches 1 if score song temp matches 1 run playsound ssbrc:hyrule_castle_theme music @s
...
execute if score $icicleMountain map matches 1 if score song temp matches 0 run playsound ssbrc:ice_climber_melee music @s
...
execute if score $icicleMountain map matches 1 if score song temp matches 1 run playsound ssbrc:ice_climber_retro music @s
...
execute if score $jungleJapes map matches 1 if score song temp matches 0 run playsound ssbrc:jungle_japes_melee music @s
...
execute if score $jungleJapes map matches 1 if score song temp matches 1 run playsound ssbrc:jungle_swing music @s
...
execute if score $lakeOfRage map matches 1 if score song temp matches 0 run playsound ssbrc:pokemon_gold_pokemon_silver_medley music @s
...
execute if score $lakeOfRage map matches 1 if score song temp matches 1 run playsound ssbrc:trainer_battle_pokemon_gold_silver music @s
...
execute if score $luigisMansion map matches 1 if score song temp matches 0 run playsound ssbrc:dark_hallways music @s
...
execute if score $luigisMansion map matches 1 if score song temp matches 1 run playsound ssbrc:luigis_mansion_theme music @s
...
execute if score $mementosType map matches 1 if score song temp matches 0 run playsound ssbrc:light_in_starless_sky music @s
...
execute if score $mementosType map matches 1 if score song temp matches 1 run playsound ssbrc:mass_destruction_dual_mix_part_2 music @s
...
execute if score $mementosType map matches 2 if score song temp matches 0 run playsound ssbrc:reach_out_to_the_truth music @s
...
execute if score $mementosType map matches 2 if score song temp matches 1 run playsound ssbrc:time_to_make_history music @s
...
execute if score $mementosType map matches 3 if score song temp matches 0 run playsound ssbrc:axe_to_grind music @s
...
execute if score $mementosType map matches 3 if score song temp matches 1 run playsound ssbrc:take_over music @s
...
execute if score $mushroomKingdom map matches 1 if score song temp matches 0 run playsound ssbrc:bob_omb_battlefield music @s
...
execute if score $mushroomKingdom map matches 1 if score song temp matches 1 run playsound ssbrc:mario_paint_medley music @s
...
execute if score $mushroomKingdom map matches 1 if score song temp matches 2 run playsound ssbrc:super_mario_bros_main_theme music @s
...
execute if score pacMaze map matches 1 if score song temp matches 0 run playsound ssbrc:pac_man_club_mix music @s
...
execute if score pacMaze map matches 1 if score song temp matches 1 run playsound ssbrc:pac_rainbow music @s
...
execute if score $palletTown map matches 1 if score song temp matches 0 run playsound ssbrc:battle_lets_go_pikachu_eevee music @s
...
execute if score $palletTown map matches 1 if score song temp matches 1 run playsound ssbrc:road_to_viridian_city music @s
...
execute if score $palutenasTemple map matches 1 if score song temp matches 0 run playsound ssbrc:dark_pits_theme music @s
...
execute if score $palutenasTemple map matches 1 if score song temp matches 1 run playsound ssbrc:destroyed_skyworld music @s
...
execute if score $planetEpp map matches 1 if score song temp matches 0 run playsound ssbrc:draconus music @s
...
execute if score $planetEpp map matches 1 if score song temp matches 1 run playsound ssbrc:zybex music @s
...
execute if score $planetZebes map matches 1 if score song temp matches 0 run playsound ssbrc:brinstar music @s
...
execute if score $planetZebes map matches 1 if score song temp matches 1 run playsound ssbrc:magmoor_caverns music @s
...
execute if score $planetZebes map matches 1 if score song temp matches 2 run playsound ssbrc:multiplayer_metroid_prime_2_echoes music @s
...
execute if score $planetZebes map matches 1 if score song temp matches 3 run playsound ssbrc:theme_of_samus_aran_space_warrior music @s
...
execute if score $sandOcean map matches 1 if score song temp matches 0 run playsound ssbrc:brain_cleaner music @s
...
execute if score $sandOcean map matches 1 if score song temp matches 1 run playsound ssbrc:sand_ocean music @s
...
execute if score $saturnValley map matches 1 if score song temp matches 0 run playsound ssbrc:humoresque_of_a_little_dog music @s
...
execute if score $saturnValley map matches 1 if score song temp matches 1 run playsound ssbrc:mr_saturn_theme_z music @s
...
execute if score $sectorZ map matches 1 if score song temp matches 0 run playsound ssbrc:area_6 music @s
...
execute if score $sectorZ map matches 1 if score song temp matches 1 run playsound ssbrc:star_wolf music @s
...
execute if score $shadowMosesIsland map matches 1 if score song temp matches 0 run playsound ssbrc:encounter music @s
...
execute if score $shadowMosesIsland map matches 1 if score song temp matches 1 run playsound ssbrc:metal_gear_online_3_main_theme music @s
...
execute if score $spearPillar map matches 1 if score song temp matches 0 run playsound ssbrc:dialga_and_palkia_battle music @s
...
execute if score $spearPillar map matches 1 if score song temp matches 1 run playsound ssbrc:team_galactic_battle music @s
...
execute if score $suzakuCastle map matches 1 if score song temp matches 0 run playsound ssbrc:ryu_stage music @s
...
execute if score $suzakuCastle map matches 1 if score song temp matches 1 run playsound ssbrc:street_fighter_4_intro music @s
...
execute if score $towerOfFate map matches 1 if score song temp matches 0 run playsound ssbrc:hitting_close_to_home music @s
...
execute if score $towerOfFate map matches 1 if score song temp matches 1 run playsound ssbrc:the_fateful_return music @s
...
execute if score $wilyCastle map matches 1 if score song temp matches 0 run playsound ssbrc:mega_man_2_medley music @s
...
execute if score $wilyCastle map matches 1 if score song temp matches 1 run playsound ssbrc:mega_man_4_medley music @s
...
execute if score $yggdrasilsAltar map matches 1 if score song temp matches 0 run playsound ssbrc:battle_for_glory music @s
...
execute if score $yggdrasilsAltar map matches 1 if score song temp matches 1 run playsound ssbrc:the_hero_goes_forth_with_a_determination music @s
