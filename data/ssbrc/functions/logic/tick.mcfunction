...
execute if score $mapRoom timer matches 3.. as @e[type=minecraft:glow_item_frame,tag=mapIcon] run function ssbrc:logic/pre_game/map_voting/map_choices/choose/modify_post
execute if score $mapRoom timer matches 3.. run scoreboard players reset $mapRoom timer
