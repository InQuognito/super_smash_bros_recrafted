...
execute if score $mapRoom timer matches 5 as @e[type=minecraft:glow_item_frame,tag=mapIcon] run function ssbrc:logic/pre_game/map_voting/map_choices/choose/modify_post
execute if score $mapRoom timer matches 5.. run scoreboard players reset $mapRoom timer
