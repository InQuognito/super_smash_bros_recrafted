...
execute if score $mapRoom timer matches 6 as @e[type=minecraft:glow_item_frame,tag=mapIcon] run function ssbrc:logic/pre_game/map_voting/prepare
execute if score $mapRoom timer matches 6.. run scoreboard players reset $mapRoom timer
