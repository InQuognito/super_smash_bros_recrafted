...
execute if score @s[scores={duration.1=1..}] charge.1 >= #joker.personaBreak vars run function ssbrc:fighters/joker/logic/abilities/persona_awakening/deactivate
