...
execute if score chaosEnergy temp >= shadow.chaosSpearCost vars run function ssbrc:logic/fighters/modify_item {old:"chaosSpear",new:"shadow/chaos_spear/default"}
