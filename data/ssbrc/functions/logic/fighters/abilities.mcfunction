...
execute if entity @s[tag=phazonPool] run function ssbrc:fighters/dark_samus/logic/abilities/phazon_spike/phazon_pool/tick
execute if entity @s[tag=phazonSpike] run function ssbrc:fighters/dark_samus/logic/abilities/phazon_spike/tick

# Donkey Kong
execute if entity @s[tag=barrel] run function ssbrc:fighters/donkey_kong/logic/abilities/barrel/tick
execute if entity @s[tag=orangeGrenade] run function ssbrc:fighters/donkey_kong/logic/abilities/orange_grenade/tick
...
execute if entity @s[tag=blackHoleBomb] unless block ~ ~-0.1 ~ #ssbrc:passthrough run function ssbrc:fighters/mega_man/logic/abilities/black_hole_bomb/tick

# Ness
execute if entity @s[tag=pkFire,tag=!exploded] run function ssbrc:fighters/ness/logic/abilities/pk_fire/tick
execute if entity @s[tag=pkFire,tag=exploded] run function ssbrc:fighters/ness/logic/abilities/pk_fire/tick_explosion
execute if entity @a[tag=self,limit=1,tag=ness,predicate=ssbrc:flag/player,predicate=!ssbrc:flag/sneaking] if entity @s[tag=pkFlash,scores={temp=20..}] run function ssbrc:fighters/ness/logic/abilities/pk_flash/adjust
execute if entity @s[tag=pkFlash] run function ssbrc:fighters/ness/logic/abilities/pk_flash/tick
...
execute if entity @s[tag=guardianOrbitar] run function ssbrc:fighters/pit/logic/abilities/guardian_orbitars/tick

# Pokémon Trainer
execute if entity @s[tag=flareBlitz] run function ssbrc:fighters/pokemon_trainer/logic/charizard/flare_blitz/tick
execute if entity @s[tag=leechSeed] run function ssbrc:fighters/pokemon_trainer/logic/ivysaur/leech_seed/tick/projectile
execute if entity @s[tag=leechSeed.healingOrb] run function ssbrc:fighters/pokemon_trainer/logic/ivysaur/leech_seed/tick/healing_orb
execute if entity @s[tag=waterGun] run function ssbrc:fighters/pokemon_trainer/logic/squirtle/water_gun/tick

# R.O.B.
execute if entity @s[tag=roboBeam] run function ssbrc:fighters/rob/logic/abilities/robo_beam/tick
...
# Samus
execute if entity @s[tag=powerBeam] run function ssbrc:fighters/samus/logic/abilities/power_beam/tick
...
execute if entity @s[tag=antiPersonnelMine] unless block ~ ~-0.1 ~ #ssbrc:passthrough run function ssbrc:fighters/snake/logic/weapons/anti_personnel_mine/tick
execute if entity @s[tag=smokeGrenade] unless block ~ ~-0.1 ~ #ssbrc:passthrough run function ssbrc:fighters/snake/logic/weapons/smoke_grenade/tick
...
execute if entity @s[tag=strikeRaid] run function ssbrc:fighters/sora/logic/abilities/strike_raid/tick
