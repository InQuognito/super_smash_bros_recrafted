...
# Princess Peach
execute if entity @s[scores={cooldown.1=..0},nbt={SelectedItem:{tag:{vegetable:1}}}] if score speed temp matches ..0 at @s unless block ~ ~-0.1 ~ #ssbrc:passthrough_charge anchored eyes positioned ^ ^ ^ run function ssbrc:fighters/peach/logic/abilities/turnip/activate
