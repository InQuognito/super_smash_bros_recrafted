...
execute if score gameStage temp matches 4 if entity @s[tag=teamrocket,tag=wobbuffet] run loot replace entity @s hotbar.0 loot ssbrc:fighters/teamrocket/wobbuffet/counter
