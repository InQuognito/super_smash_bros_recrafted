execute if score @s[predicate=ssbrc:fighters/weight/heavy] fallDistance matches 500..800 anchored feet run function ssbrc:logic/fighters/shockwave/low
execute if score @s[predicate=ssbrc:fighters/weight/heavy,predicate=!ssbrc:fighters/weight/very_heavy] fallDistance matches 801.. anchored feet run function ssbrc:logic/fighters/shockwave/medium
