...
execute if score @s frostbite matches 3 run function ssbrc:logic/fighters/effects/frostbite/display/3
execute if score @s frostbite matches 4 run function ssbrc:logic/fighters/effects/frostbite/display/4
execute if score @s frostbite matches 5 run function ssbrc:logic/fighters/effects/frostbite/display/5
...
execute if score @s frostbite.timer matches 0 run function ssbrc:logic/fighters/effects/frostbite/decrease
