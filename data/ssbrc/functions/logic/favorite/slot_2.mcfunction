...
execute if entity @s[tag=favoritetry.shovelknight] run scoreboard players set @s favorite.slot2 2000
execute if entity @s[tag=favoritetry.teamrocket] run scoreboard players set @s favorite.slot2 1919
