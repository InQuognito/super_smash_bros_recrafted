execute if entity @s[tag=favoritetry.rob] run scoreboard players set @s favorite.slot2 1
execute if entity @s[tag=favoritetry.bowser] run scoreboard players set @s favorite.slot2 60
...
execute if entity @s[tag=favoritetry.link] run scoreboard players set @s favorite.slot2 720
execute if entity @s[tag=favoritetry.luigi] run scoreboard players set @s favorite.slot2 820
execute if entity @s[tag=favoritetry.mario] run scoreboard players set @s favorite.slot2 840
execute if entity @s[tag=favoritetry.megaman] run scoreboard players set @s favorite.slot2 880
execute if entity @s[tag=favoritetry.ness] run scoreboard players set @s favorite.slot2 1080
execute if entity @s[tag=favoritetry.pikachu] run scoreboard players set @s favorite.slot2 1200
execute if entity @s[tag=favoritetry.pit] run scoreboard players set @s favorite.slot2 1220
execute if entity @s[tag=favoritetry.pokemontrainer] run scoreboard players set @s favorite.slot2 1260
execute if entity @s[tag=favoritetry.ryu] run scoreboard players set @s favorite.slot2 1400
execute if entity @s[tag=favoritetry.samus] run scoreboard players set @s favorite.slot2 1420
execute if entity @s[tag=favoritetry.snake] run scoreboard players set @s favorite.slot2 1520
execute if entity @s[tag=favoritetry.sonic] run scoreboard players set @s favorite.slot2 1540
execute if entity @s[tag=favoritetry.sora] run scoreboard players set @s favorite.slot2 1560
execute if entity @s[tag=favoritetry.steve] run scoreboard players set @s favorite.slot2 1580
...
execute if entity @s[tag=favoritetry.giegue] run scoreboard players set @s favorite.slot2 1860
