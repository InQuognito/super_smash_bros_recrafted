execute if entity @s[tag=favoritetry.rob] run scoreboard players set @s favorite.slot1 1
...
execute if entity @s[tag=favoritetry.jigglypuff] run scoreboard players set @s favorite.slot1 580
