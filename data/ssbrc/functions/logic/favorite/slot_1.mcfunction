...
execute if entity @s[tag=favoritetry.fox] run scoreboard players set @s favorite.slot1 380
execute if entity @s[tag=favoritetry.ganondorf] run scoreboard players set @s favorite.slot1 400
execute if entity @s[tag=favoritetry.greninja] run scoreboard players set @s favorite.slot1 420
execute if entity @s[tag=favoritetry.hero] run scoreboard players set @s favorite.slot1 440
execute if entity @s[tag=favoritetry.joker] run scoreboard players set @s favorite.slot1 600
...
execute if entity @s[tag=favoritetry.shovelknight] run scoreboard players set @s favorite.slot1 2000
execute if entity @s[tag=favoritetry.teamrocket] run scoreboard players set @s favorite.slot1 1919
