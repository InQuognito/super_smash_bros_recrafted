...
execute if entity @s[tag=shovel_knight,scores={cooldown.2=..0,cooldown.3=..0,duration.2=..0},nbt={SelectedItem:{tag:{propeller_dagger:1}}}] run function ssbrc:fighters/shovel_knight/logic/abilities/propeller_dagger/check
