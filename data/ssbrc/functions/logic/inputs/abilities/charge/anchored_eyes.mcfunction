...
execute if entity @s[tag=dark_samus,scores={duration.1=..0,cooldown.1=..0},predicate=ssbrc:flag/sneaking,nbt={SelectedItem:{tag:{phazon_beam:1}}}] run function ssbrc:fighters/dark_samus/logic/abilities/phazon_beam/activate
...
execute if entity @s[tag=pit,scores={cooldown.1=..0},nbt={SelectedItem:{tag:{palutena_bow:1}}}] run function ssbrc:fighters/pit/logic/abilities/palutena_bow/check

execute if entity @s[tag=ryu,scores={cooldown.1=..0},nbt={SelectedItem:{tag:{collarbone_breaker:1}}}] run function ssbrc:fighters/ryu/logic/abilities/hadouken/check
