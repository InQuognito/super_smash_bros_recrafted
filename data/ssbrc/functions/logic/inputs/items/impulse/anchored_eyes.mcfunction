...
execute unless score @s[nbt={SelectedItem:{tag:{ray_gun:1}}}] item.cooldown matches 1.. run function ssbrc:items/ray_gun/activate
...
execute unless score @s[nbt={SelectedItem:{tag:{fgii_blaster:1}}}] item.cooldown matches 1.. run function ssbrc:stages/pyrosphere/logic/fgii_graham/items/blaster/activate
