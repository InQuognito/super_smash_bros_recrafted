...
execute positioned -43.5 7.5 22.5 if block ~ ~ ~ #minecraft:buttons[powered=true] run function ssbrc:stages/battlefield/vote
execute positioned -46.5 7.5 24.5 if block ~ ~ ~ #minecraft:buttons[powered=true] run function ssbrc:stages/big_battlefield/vote
execute positioned -31.5 7.5 22.5 if block ~ ~ ~ #minecraft:buttons[powered=true] run function ssbrc:stages/final_destination/vote
