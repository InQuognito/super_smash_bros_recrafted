tellraw @a[tag=room.characterSelect] [{"translate":"ssbrc.options.game_mode","color":"yellow"},{"text":": ","color":"yellow"},{"translate":"ssbrc.options.game_mode.stock","color":"blue"}]
