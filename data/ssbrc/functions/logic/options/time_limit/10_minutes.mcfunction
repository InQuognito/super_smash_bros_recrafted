execute if score $gameMode options matches 2 unless score $timeLimit options matches 600 run tellraw @a [{"text":"Time Limit","color":"yellow"},{"text":" set to "},{"text":"10 Minutes","color":"dark_blue"}]
