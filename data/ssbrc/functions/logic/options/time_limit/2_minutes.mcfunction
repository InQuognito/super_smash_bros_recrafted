execute if score $gameMode options matches 2 unless score $timeLimit options matches 120 run tellraw @a [{"text":"Time Limit","color":"yellow"},{"text":" set to "},{"text":"2 Minutes","color":"dark_aqua"}]
