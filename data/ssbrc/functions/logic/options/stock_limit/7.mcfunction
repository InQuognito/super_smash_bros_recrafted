execute if score $gameMode options matches 1 unless score $stockLimit options matches 7 run tellraw @a [{"text":"Stock Limit","color":"yellow"},{"text":" set to "},{"text":"7","color":"dark_blue"}]
