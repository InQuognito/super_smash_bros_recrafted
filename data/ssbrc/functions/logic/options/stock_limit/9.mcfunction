execute if score $gameMode options matches 1 unless score $stockLimit options matches 9 run tellraw @a [{"text":"Stock Limit","color":"yellow"},{"text":" set to "},{"text":"9","color":"blue"}]
