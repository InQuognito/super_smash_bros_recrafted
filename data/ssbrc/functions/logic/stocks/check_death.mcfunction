...
# Bonuses
execute if score players.playing temp matches 3.. unless score $gotKill temp matches 0 at @s run scoreboard players operation @s revenge.tracking = @p[tag=check_kill] id
