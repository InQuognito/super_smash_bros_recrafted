...
execute if entity @s[tag=teamrocket.arbok] run function ssbrc:characters/teamrocket/kits/meowth
execute if entity @s[tag=teamrocket.meowth] run function ssbrc:characters/teamrocket/kits/wobbuffet
execute if entity @s[tag=teamrocket.wobbuffet] run function ssbrc:characters/teamrocket/kits/arbok
