...
# Skybox
summon minecraft:block_display -520.5 5.5 -1944.5 {block_state:{Name:"minecraft:weathered_copper"},brightness:{sky:15,block:15},transformation:[60f,0f,0f,-30f,0f,60f,0f,-30f,0f,0f,60f,-30f,0f,0f,0f,1f]}
