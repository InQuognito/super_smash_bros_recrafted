...
# Logo
summon minecraft:item_display -542.5 20.5 -1944.5 {Tags:["lobby.logo"],Rotation:[-90f,30f],item:{id:"minecraft:stick",tag:{CustomModelData:1100000},Count:1b},transformation:[10f,0f,0f,0f,0f,10f,0f,0f,0f,0f,10f,0f,0f,0f,0f,1f],brightness:{sky:15,block:15}}
