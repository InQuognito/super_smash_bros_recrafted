...
summon minecraft:text_display -520.5 5.25 62.5 {text:'[{"text":"✪ ","color":"gold"},{"translate":"ssbrc.shop","color":"gold"},{"text":" ✪","color":"gold"}]',billboard:center}
summon minecraft:text_display -520.5 5.25 48.5 {text:'[{"text":"✪ ","color":"gold"},{"translate":"ssbrc.shop","color":"gold"},{"text":" ✪","color":"gold"}]',billboard:center}
...
summon minecraft:text_display -528.5 6.5 60.5 {Tags:["lobby.status"],text:'[{"translate":"ssbrc.lobby.status","color":"gold"},{"translate":"ssbrc.lobby.fighterSelect","color":"yellow"}]',billboard:center}
summon minecraft:text_display -528.5 6.25 60.5 {Tags:["lobby.players"],text:'[{"translate":"ssbrc.lobby.players","color":"gold"},{"text":"0/8","color":"yellow"}]',billboard:center}
