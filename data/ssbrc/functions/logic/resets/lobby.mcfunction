...
# Social Links
summon minecraft:text_display -524.5 8.0 -1942.5 {text:'{"text":"YouTube","color":"red"}',billboard:center}
summon minecraft:item_display -524.5 7.5 -1942.5 {Tags:["logo","youtube","selectable"],item:{id:"minecraft:glowstone_dust",tag:{CustomModelData:99992},Count:1b},transformation:[0.75f,0f,0f,0f,0f,0.75f,0f,0f,0f,0f,0.75f,0f,0f,0f,0f,1f],billboard:center}
summon minecraft:text_display -524.5 8.0 -1944.5 {text:'{"text":"Discord","color":"blue"}',billboard:center}
summon minecraft:item_display -524.5 7.5 -1944.5 {Tags:["logo","discord","selectable"],item:{id:"minecraft:glowstone_dust",tag:{CustomModelData:99990},Count:1b},transformation:[0.75f,0f,0f,0f,0f,0.75f,0f,0f,0f,0f,0.75f,0f,0f,0f,0f,1f],billboard:center}
summon minecraft:text_display -524.5 8.0 -1946.5 {text:'{"text":"PMC","color":"green"}',billboard:center}
summon minecraft:item_display -524.5 7.5 -1946.5 {Tags:["logo","planetminecraft","selectable"],item:{id:"minecraft:glowstone_dust",tag:{CustomModelData:99991},Count:1b},transformation:[0.75f,0f,0f,0f,0f,0.75f,0f,0f,0f,0f,0.75f,0f,0f,0f,0f,1f],billboard:center}
