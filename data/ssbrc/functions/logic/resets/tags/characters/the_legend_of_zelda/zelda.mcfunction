...
function ssbrc:series/the_legend_of_zelda/zelda/logic/abilities/ice_rod/damage
function ssbrc:series/the_legend_of_zelda/zelda/logic/abilities/magic_boomerang/damage
