...
function ssbrc:series/indie_fighters/shovelknight/logic/abilities/chaos_sphere/damage
function ssbrc:series/indie_fighters/shovelknight/logic/abilities/war_horn/damage
