...
tag @s remove charizard.hardy
tag @s remove charizard.impish
tag @s remove charizard.jolly
...
tag @s remove ivysaur.impish
tag @s remove ivysaur.jolly
...
tag @s remove squirtle.impish
tag @s remove squirtle.jolly
