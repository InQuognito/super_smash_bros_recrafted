...
scoreboard objectives remove stats.bonus.bank_shot
scoreboard objectives remove stats.bonus.bully
scoreboard objectives remove stats.bonus.cement_shoes
scoreboard objectives remove stats.bonus.coward
scoreboard objectives remove stats.bonus.crushing_weight
scoreboard objectives remove stats.bonus.einstein
scoreboard objectives remove stats.bonus.first_strike
scoreboard objectives remove stats.bonus.full_power
scoreboard objectives remove stats.bonus.good_friend
scoreboard objectives remove stats.bonus.heartgold
scoreboard objectives remove stats.bonus.heavy_damage
scoreboard objectives remove stats.bonus.ion_zone_protection
scoreboard objectives remove stats.bonus.last_second
scoreboard objectives remove stats.bonus.lucky_number_seven
scoreboard objectives remove stats.bonus.merciful_master
scoreboard objectives remove stats.bonus.no_johns
scoreboard objectives remove stats.bonus.npc_ko
scoreboard objectives remove stats.bonus.on_a_roll
scoreboard objectives remove stats.bonus.quitter
scoreboard objectives remove stats.bonus.rapid_kill
scoreboard objectives remove stats.bonus.revenge
scoreboard objectives remove stats.bonus.shield_breaker
scoreboard objectives remove stats.bonus.shiny_encounter
scoreboard objectives remove stats.bonus.sniper
scoreboard objectives remove stats.bonus.speed_demon
scoreboard objectives remove stats.bonus.stiff_knees
scoreboard objectives remove stats.bonus.sudden_death
scoreboard objectives remove stats.bonus.switzerland
scoreboard objectives remove stats.bonus.tortoise
scoreboard objectives remove stats.bonus.truly_heroic
scoreboard objectives remove stats.bonus.truly_villainous
