...
scoreboard objectives add loadout.famasA dummy
scoreboard objectives add loadout.famasM dummy
scoreboard objectives add loadout.famasR dummy
scoreboard objectives add loadout.famasF dummy
scoreboard objectives add loadout.psg1A dummy
scoreboard objectives add loadout.psg1M dummy
scoreboard objectives add loadout.psg1R dummy
scoreboard objectives add loadout.s1000A dummy
scoreboard objectives add loadout.s1000M dummy
scoreboard objectives add loadout.s1000R dummy
scoreboard objectives add loadout.s1000F dummy
scoreboard objectives add loadout.socomA dummy
scoreboard objectives add loadout.socomM dummy
scoreboard objectives add loadout.socomR dummy
scoreboard objectives add loadout.socomF dummy
scoreboard objectives add loadout.smokeGrenadeA dummy
scoreboard objectives add loadout.smokeGrenadeF dummy
