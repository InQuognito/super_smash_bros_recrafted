...
scoreboard objectives add item.cracker_launcherUses dummy
...
scoreboard objectives add item.ray_gunCooldown dummy
scoreboard objectives add item.ray_gunUses dummy
