...
scoreboard players set #damage.fireball vars 40
scoreboard players set #damage.plasmaBeam vars 40
scoreboard players set #damage.powerBeam vars 40
scoreboard players set #damage.waveBeam vars 40
