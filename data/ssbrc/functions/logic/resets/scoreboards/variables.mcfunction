...
scoreboard players set #joker.personaBreak vars 350
...
scoreboard players set #zelda.bombMagicCost vars 2
...
scoreboard players operation value.bonus.8 vars = value.participation vars
...
scoreboard players operation value.bonus.allEars vars = value.participation vars
scoreboard players operation value.bonus.allEars vars *= 2 integers

scoreboard players operation value.bonus.archNemesis vars = value.participation vars
...
scoreboard players operation value.bonus.bloodTransfusion vars = value.participation vars
...
scoreboard players operation value.bonus.corruption vars = value.participation vars
scoreboard players operation value.bonus.corruption vars *= 4 integers

scoreboard players operation value.bonus.craftingConnoisseur vars = value.participation vars
...
scoreboard players operation value.bonus.dreamTeam vars = value.participation vars
scoreboard players operation value.bonus.dreamTeam vars *= 2 integers

scoreboard players operation value.bonus.eagleEye vars = value.participation vars
scoreboard players operation value.bonus.eagleEye vars *= 3 integers

scoreboard players operation value.bonus.fleshAndBlood vars = value.victory vars
scoreboard players operation value.bonus.fleshAndBlood vars *= 2 integers

scoreboard players operation value.bonus.foodie vars = value.participation vars
scoreboard players operation value.bonus.foodie vars *= 4 integers

scoreboard players operation value.bonus.fullHouse vars = value.participation vars
scoreboard players operation value.bonus.fullHouse vars *= 3 integers

scoreboard players operation value.bonus.goodFriend vars = value.victory vars
...
scoreboard players operation value.bonus.homeFieldAdvantage vars = value.participation vars
scoreboard players operation value.bonus.homeFieldAdvantage vars *= 1 integers

scoreboard players operation value.bonus.inTheirNature vars = value.participation vars
...
scoreboard players operation value.bonus.magus vars = value.participation vars
...
scoreboard players operation value.bonus.onARoll vars = value.victory vars
...
scoreboard players operation value.bonus.oohShiny vars = value.participation vars
scoreboard players operation value.bonus.oohShiny vars *= 20 integers

scoreboard players operation value.bonus.pathOfGood vars = value.participation vars
...
scoreboard players operation value.bonus.showdown vars = value.participation vars
...
scoreboard players operation value.bonus.trueHero vars = value.participation vars
scoreboard players operation value.bonus.trueHero vars *= 2 integers

scoreboard players operation value.bonus.trueVillain vars = value.participation vars
...
scoreboard players operation value.bonus.wellCrafted vars = value.participation vars
scoreboard players operation value.bonus.wellCrafted vars *= 2 integers

scoreboard players operation value.bonus.yearLongBattle vars = value.participation vars
