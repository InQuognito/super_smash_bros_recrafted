# Project Leads
summon minecraft:item_display -556.5 -2.925 57.5 {item:{id:"minecraft:player_head",tag:{CustomModelData:1},Count:1b},Rotation:[90f,0f]}
...
summon minecraft:item_display -556.5 -2.925 53.5 {item:{id:"minecraft:player_head",tag:{CustomModelData:2},Count:1b},Rotation:[90f,0f]}
...
summon minecraft:item_display -542.5 -2.925 63.5 {item:{id:"minecraft:player_head",tag:{CustomModelData:3},Count:1b},Rotation:[0f,0f]}
summon minecraft:text_display -542.5 -1.75 63.5 {text:'{"text":"OrionBrigade","bold":true,"color":"white"}',billboard:center}

summon minecraft:item_display -546.5 -2.925 64.5 {item:{id:"minecraft:player_head",tag:{CustomModelData:4},Count:1b},Rotation:[0f,0f]}
summon minecraft:text_display -546.5 -1.75 64.5 {text:'{"text":"JediMasterHomer","bold":true,"color":"white"}',billboard:center}

summon minecraft:item_display -550.5 -2.925 63.5 {item:{id:"minecraft:player_head",tag:{CustomModelData:5},Count:1b},Rotation:[0f,0f]}
...
summon minecraft:item_display -549.5 -2.925 47.5 {item:{id:"minecraft:player_head",tag:{CustomModelData:6},Count:1b},Rotation:[180f,0f]}
summon minecraft:text_display -549.5 -1.75 47.5 {text:'{"text":"HomegaddielMC","bold":true,"color":"white"}',billboard:center}

summon minecraft:item_display -548.5 -2.925 45.5 {item:{id:"minecraft:player_head",tag:{CustomModelData:7},Count:1b},Rotation:[180f,0f]}
summon minecraft:text_display -548.5 -1.75 45.5 {text:'{"text":"Pxlsamosa","bold":true,"color":"white"}',billboard:center}

summon minecraft:item_display -547.5 -2.925 47.5 {item:{id:"minecraft:player_head",tag:{CustomModelData:8},Count:1b},Rotation:[180f,0f]}
summon minecraft:text_display -547.5 -1.75 47.5 {text:'{"text":"Thxlotl","bold":true,"color":"white"}',billboard:center}

summon minecraft:item_display -546.5 -2.925 45.5 {item:{id:"minecraft:player_head",tag:{CustomModelData:9},Count:1b},Rotation:[180f,0f]}
summon minecraft:text_display -546.5 -1.75 45.5 {text:'{"text":"Peteerrosh","bold":true,"color":"white"}',billboard:center}

summon minecraft:item_display -545.5 -2.925 47.5 {item:{id:"minecraft:player_head",tag:{CustomModelData:10},Count:1b},Rotation:[180f,0f]}
summon minecraft:text_display -545.5 -1.75 47.5 {text:'{"text":"DavidTippy","bold":true,"color":"white"}',billboard:center}

summon minecraft:item_display -544.5 -2.925 45.5 {item:{id:"minecraft:player_head",tag:{CustomModelData:11},Count:1b},Rotation:[180f,0f]}
summon minecraft:text_display -544.5 -1.75 45.5 {text:'{"text":"Ricardo64","bold":true,"color":"white"}',billboard:center}

summon minecraft:item_display -543.5 -2.925 47.5 {item:{id:"minecraft:player_head",tag:{CustomModelData:12},Count:1b},Rotation:[180f,0f]}
