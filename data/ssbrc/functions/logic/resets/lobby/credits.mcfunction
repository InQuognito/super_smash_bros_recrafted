# Project Leads
summon minecraft:item_display -556.5 -3.0 57.5 {item:{id:"minecraft:player_head",tag:{CustomModelData:1},Count:1b},Rotation:[0f,0f]}
...
summon minecraft:item_display -556.5 -3.0 53.5 {item:{id:"minecraft:player_head",tag:{CustomModelData:2},Count:1b},Rotation:[0f,0f]}
...
summon minecraft:item_display -550.5 -3.0 63.5 {item:{id:"minecraft:player_head",tag:{CustomModelData:4},Count:1b},Rotation:[0f,0f]}
summon minecraft:text_display -550.5 -1.75 63.5 {text:'{"text":"SugarShrimp","bold":true,"color":"white"}',billboard:center}

summon minecraft:item_display -546.5 -3.0 64.5 {item:{id:"minecraft:player_head",tag:{CustomModelData:5},Count:1b},Rotation:[0f,0f]}
