...
execute if entity @s[tag=!peach,advancements={ssbrc:fighters/peach/skins/default=true}] if entity @e[type=minecraft:item_display,tag=peach,dx=0,sort=nearest,limit=1] run function ssbrc:fighters/peach/menu/select_character
execute if entity @s[advancements={ssbrc:fighters/peach/skins/default=false}] if entity @e[type=minecraft:item_display,tag=peach,dx=0,sort=nearest,limit=1] run function ssbrc:logic/selector/unowned
...
execute if entity @s[tag=!roy,advancements={ssbrc:fighters/roy/skins/default=true}] if entity @e[type=minecraft:item_display,tag=roy,dx=0,sort=nearest,limit=1] run function ssbrc:fighters/roy/menu/select_character
execute if entity @s[advancements={ssbrc:fighters/roy/skins/default=false}] if entity @e[type=minecraft:item_display,tag=roy,dx=0,sort=nearest,limit=1] run function ssbrc:logic/selector/unowned
