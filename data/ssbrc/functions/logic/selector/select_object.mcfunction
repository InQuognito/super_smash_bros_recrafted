...
execute if entity @s[tag=!megaman,advancements={ssbrc:fighters/mega_man/skins/default=true}] if entity @e[type=minecraft:item_display,tag=megaman,dx=0,sort=nearest,limit=1] run function ssbrc:fighters/mega_man/menu/select_character
execute if entity @s[advancements={ssbrc:fighters/mega_man/skins/default=false}] if entity @e[type=minecraft:item_display,tag=megaman,dx=0,sort=nearest,limit=1] run function ssbrc:logic/selector/unowned
