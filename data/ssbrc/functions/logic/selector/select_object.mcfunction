...
execute if entity @s[tag=!alteredbeast,advancements={ssbrc:fighters/alteredbeast/skins/default=true}] if entity @e[type=minecraft:item_display,tag=alteredbeast,dx=0,sort=nearest,limit=1] run function ssbrc:fighters/alteredbeast/menu/select_character
execute if entity @s[advancements={ssbrc:fighters/alteredbeast/skins/default=false}] if entity @e[type=minecraft:item_display,tag=alteredbeast,dx=0,sort=nearest,limit=1] run function ssbrc:logic/selector/unowned
...
execute if entity @s[tag=!captainfalcon,advancements={ssbrc:fighters/captainfalcon/skins/default=true}] if entity @e[type=minecraft:item_display,tag=captainfalcon,dx=0,sort=nearest,limit=1] run function ssbrc:fighters/captainfalcon/menu/select_character
execute if entity @s[advancements={ssbrc:fighters/captainfalcon/skins/default=false}] if entity @e[type=minecraft:item_display,tag=captainfalcon,dx=0,sort=nearest,limit=1] run function ssbrc:logic/selector/unowned
...
execute if entity @s[tag=!darksamus,advancements={ssbrc:fighters/darksamus/skins/default=true}] if entity @e[type=minecraft:item_display,tag=darksamus,dx=0,sort=nearest,limit=1] run function ssbrc:fighters/darksamus/menu/select_character
execute if entity @s[advancements={ssbrc:fighters/darksamus/skins/default=false}] if entity @e[type=minecraft:item_display,tag=darksamus,dx=0,sort=nearest,limit=1] run function ssbrc:logic/selector/unowned
execute if entity @s[tag=!donkeykong,advancements={ssbrc:fighters/donkeykong/skins/default=true}] if entity @e[type=minecraft:item_display,tag=donkeykong,dx=0,sort=nearest,limit=1] run function ssbrc:fighters/donkeykong/menu/select_character
execute if entity @s[advancements={ssbrc:fighters/donkeykong/skins/default=false}] if entity @e[type=minecraft:item_display,tag=donkeykong,dx=0,sort=nearest,limit=1] run function ssbrc:logic/selector/unowned
...
execute if entity @s[tag=!kingkrool,advancements={ssbrc:fighters/kingkrool/skins/default=true}] if entity @e[type=minecraft:item_display,tag=kingkrool,dx=0,sort=nearest,limit=1] run function ssbrc:fighters/kingkrool/menu/select_character
execute if entity @s[advancements={ssbrc:fighters/kingkrool/skins/default=false}] if entity @e[type=minecraft:item_display,tag=kingkrool,dx=0,sort=nearest,limit=1] run function ssbrc:logic/selector/unowned
...
execute if entity @s[tag=!megaman,advancements={ssbrc:fighters/megaman/skins/default=true}] if entity @e[type=minecraft:item_display,tag=megaman,dx=0,sort=nearest,limit=1] run function ssbrc:fighters/megaman/menu/select_character
execute if entity @s[advancements={ssbrc:fighters/megaman/skins/default=false}] if entity @e[type=minecraft:item_display,tag=megaman,dx=0,sort=nearest,limit=1] run function ssbrc:logic/selector/unowned
...
execute if entity @s[tag=!pokemontrainer,advancements={ssbrc:fighters/pokemontrainer/skins/default=true}] if entity @e[type=minecraft:item_display,tag=pokemontrainer,dx=0,sort=nearest,limit=1] run function ssbrc:fighters/pokemontrainer/menu/select_character
execute if entity @s[advancements={ssbrc:fighters/pokemontrainer/skins/default=false}] if entity @e[type=minecraft:item_display,tag=pokemontrainer,dx=0,sort=nearest,limit=1] run function ssbrc:logic/selector/unowned
...
execute if entity @s[tag=!shovelknight,advancements={ssbrc:fighters/shovelknight/skins/default=true}] if entity @e[type=minecraft:item_display,tag=shovelknight,dx=0,sort=nearest,limit=1] run function ssbrc:fighters/shovelknight/menu/select_character
execute if entity @s[advancements={ssbrc:fighters/shovelknight/skins/default=false}] if entity @e[type=minecraft:item_display,tag=shovelknight,dx=0,sort=nearest,limit=1] run function ssbrc:logic/selector/unowned
...
execute if entity @s[tag=!teamrocket,advancements={ssbrc:fighters/teamrocket/skins/default=true}] if entity @e[type=minecraft:item_display,tag=teamrocket,dx=0,sort=nearest,limit=1] run function ssbrc:fighters/teamrocket/menu/select_character
execute if entity @s[advancements={ssbrc:fighters/teamrocket/skins/default=false}] if entity @e[type=minecraft:item_display,tag=teamrocket,dx=0,sort=nearest,limit=1] run function ssbrc:logic/selector/unowned
