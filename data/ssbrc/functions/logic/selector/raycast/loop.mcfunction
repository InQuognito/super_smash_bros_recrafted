...
execute if score @s use_ability matches 1.. positioned ~-0.5 ~-0.5 ~-0.5 at @e[type=minecraft:item_display,tag=selectable,dx=0,sort=nearest,limit=1] positioned ~-0.5 ~-0.5 ~-0.5 run function ssbrc:logic/selector/select_object/run
