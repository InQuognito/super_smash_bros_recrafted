...
execute positioned ~-0.5 ~-0.5 ~-0.5 at @e[type=minecraft:armor_stand,tag=selectable,dx=0,sort=nearest,limit=1] run function ssbrc:logic/selector/highlight_object
