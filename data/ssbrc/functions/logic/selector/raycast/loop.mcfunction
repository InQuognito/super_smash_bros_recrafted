...
execute positioned ~-0.5 ~-0.5 ~-0.5 if entity @e[type=minecraft:armor_stand,dx=0,sort=nearest,limit=1] at @e[type=minecraft:armor_stand,dx=0,sort=nearest,limit=1] run function ssbrc:logic/selector/highlight_object
