...
summon minecraft:text_display -507.5 8.0 55.5 {Tags:["leaderboard.label"],text:'[{"text":"Wins","bold":true,"underlined":true,"color":"aqua"},{"text":" | ","bold":true,"underlined":false,"color":"white"},{"text":"W/L Ratio","bold":true,"underlined":true,"color":"light_purple"}]',billboard:center}
...
summon minecraft:text_display -507.5 6.75 51.5 {Tags:["leaderboard.label"],text:'{"text":"Wins","bold":true,"color":"gold"}',billboard:center}
summon minecraft:text_display -507.5 6.5 51.5 {Tags:["leaderboard.label"],text:'{"text":"Kills","bold":false,"color":"yellow"}',billboard:center}
