...
summon minecraft:text_display -507.1 7.5 -1944.5 {Tags:["leaderboard.label"],Rotation:[90f,0f],text:'[{"translate":"ssbrc.stats.wins","bold":true,"underlined":true,"color":"aqua"},{"translate":" | ","bold":true,"underlined":false,"color":"white"},{"translate":"ssbrc.stats.win_loss_ratio","bold":true,"underlined":true,"color":"light_purple"}]'}
