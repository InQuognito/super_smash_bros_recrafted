...
summon minecraft:area_effect_cloud -507.5 7.0 55.5 {Tags:["leaderboard.label"],CustomName:'[{"text":"Wins","bold":true,"underlined":true,"color":"green"},{"text":" | ","bold":true,"false":true,"color":"white"},{"text":"W/L Ratio","bold":true,"underlined":true,"color":"red"}]',CustomNameVisible:1b,Age:-2147483648,Duration:-1,WaitTime:-2147483648}
