...
execute if score gameStage temp matches 2..4 if score players.playing temp matches 1 unless score singleplayer options matches 1 run function ssbrc:logic/post_game/end
