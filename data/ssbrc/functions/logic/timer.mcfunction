...
execute if score game_stage temp matches 0..1 run function ssbrc:logic/timer/character_select
execute if score game_stage temp matches 2 run function ssbrc:logic/timer/map_voting/timer
