...
item replace entity @s[tag=!noReplace] weapon.mainhand with minecraft:redstone{display:{Name:'""'},HideFlags:255} 1
item replace entity @s[tag=!noReplace] weapon.offhand with minecraft:redstone{display:{Name:'""'},HideFlags:255} 1
