...
#partners in time
execute if score $playersAlive temp matches 4 if entity @a[tag=bowser,limit=1] if entity @a[tag=ganon,limit=1] if entity @a[tag=kingkrool,limit=1] run advancement grant @s[tag=mario] only ssbrc:characters/mario/three_trouble_kings
