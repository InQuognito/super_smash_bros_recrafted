...
item replace entity @s[tag=!gold,tag=!ganondorf,tag=!kingkrool,tag=!pit,tag=!samus.default,tag=!shovelknight] armor.chest with minecraft:leather_chestplate{Unbreakable:1,HideFlags:127}
item replace entity @a[tag=gold] armor.chest with minecraft:golden_chestplate{Unbreakable:1,HideFlags:127} 1
...
item replace entity @a[tag=gold] armor.legs with minecraft:golden_leggings{Unbreakable:1,HideFlags:127} 1
...
item replace entity @a[tag=gold] armor.feet with minecraft:golden_boots{Unbreakable:1,HideFlags:127} 1
