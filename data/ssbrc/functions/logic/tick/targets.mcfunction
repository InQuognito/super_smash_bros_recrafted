execute if entity @s[scores={burning=1..}] run function ssbrc:logic/fighters/effects/burning/tick
...
execute if entity @s[scores={frostbite.timer=1..}] run function ssbrc:logic/fighters/effects/frostbite/tick

execute if entity @s[scores={immobile=2..}] run function ssbrc:logic/fighters/effects/mobility/tick
