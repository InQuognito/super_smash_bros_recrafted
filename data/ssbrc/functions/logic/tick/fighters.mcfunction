...
execute at @s[tag=rob] run function ssbrc:fighters/rob/logic/tick
...
execute if score @s armor_break matches 60.. run function ssbrc:fighters/pokemon_trainer/logic/charizard/rock_smash/deactivate

execute if entity @s[tag=leech_seed] run function ssbrc:fighters/pokemon_trainer/logic/ivysaur/leech_seed/calculate
execute if score @s leech_seed.stacks matches 1.. run function ssbrc:fighters/pokemon_trainer/logic/ivysaur/leech_seed/calculate_healing
...
# Map Effects
execute at @s unless block ~ ~ ~ minecraft:lava run scoreboard players remove @s[scores={flag.in_lava=1..}] flag.in_lava 1
execute at @s if block ~ ~ ~ minecraft:lava run scoreboard players add @s flag.in_lava 1
execute if score @s flag.in_lava matches 60.. run kill @s
scoreboard players reset @s[scores={flag.in_lava=60..}] flag.in_lava

execute if score sand_ocean stage matches 1 if score hazards options matches 1 at @s[tag=!quicksand] if block ~ ~ ~ minecraft:cyan_carpet run function ssbrc:logic/fighters/quicksand/activate
execute if score sand_ocean stage matches 1 if score hazards options matches 1 at @s[tag=quicksand] unless block ~ ~ ~ minecraft:cyan_carpet run function ssbrc:logic/fighters/quicksand/deactivate
