...
execute unless score $sectorZ map matches 1 run effect give @a[team=alive,gamemode=adventure,scores={flag.dead=..0},predicate=ssbrc:below_y_0] minecraft:blindness 2 0 true
