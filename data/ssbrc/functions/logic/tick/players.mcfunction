...
execute at @s[scores={useAbility=1..},nbt={SelectedItem:{tag:{skin_options:1}}}] run function ssbrc:logic/fighters/get {function:"ssbrc:logic/selector/skin_options"}
execute if entity @s[scores={useAbility=1..},nbt={SelectedItem:{tag:{wiki:1}}}] run function ssbrc:logic/fighters/get {function:"ssbrc:logic/selector/wiki"}
