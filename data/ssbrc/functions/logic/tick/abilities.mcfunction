...
# Altered Beast
execute if entity @s[tag=sabretooth] at @s run function ssbrc:fighters/altered_beast/logic/waretiger/sabretooth/raycast/start
execute if entity @s[tag=super_jump] at @s run function ssbrc:fighters/altered_beast/logic/waretiger/super_jump/raycast/start
execute if entity @s[tag=flame_hands] at @s run function ssbrc:fighters/altered_beast/logic/warewolf/flame_hands/tick
execute if entity @s[tag=flame_arrow] at @s run function ssbrc:fighters/altered_beast/logic/warewolf/flame_arrow/tick
