...
# Samus
execute if entity @s[tag=powerBeam] run function ssbrc:fighters/samus/logic/weapons/power_beam/tick
execute if entity @s[tag=waveBeam] run function ssbrc:fighters/samus/logic/weapons/wave_beam/raycast/start
execute if entity @s[tag=plasmaBeam] run function ssbrc:fighters/samus/logic/weapons/plasma_beam/tick
...
execute if entity @s[tag=holyWater.display] unless predicate ssbrc:flag/in_air run function ssbrc:fighters/alucard/logic/abilities/holy_water/kill_item
