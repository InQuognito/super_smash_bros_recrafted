...
execute as @e[type=minecraft:marker,tag=fireRod,predicate=ssbrc:id_match] at @s run function ssbrc:fighters/zelda/logic/abilities/fire_rod/tick
execute as @e[type=minecraft:marker,tag=fireRod,tag=!pillar,predicate=ssbrc:id_match] at @s run function ssbrc:fighters/zelda/logic/abilities/fire_rod/alternate_function/tick
execute as @e[type=minecraft:marker,tag=fireRod,tag=pillar,predicate=ssbrc:id_match] at @s run function ssbrc:fighters/zelda/logic/abilities/fire_rod/alternate_function/tick_pillar
