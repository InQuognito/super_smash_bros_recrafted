...
# Mega Man
execute as @e[type=minecraft:marker,tag=megaBuster] at @s if score @s id = @p[tag=self] id unless block ~ ~-0.1 ~ #ssbrc:passthrough run function ssbrc:series/mega_man/megaman/logic/abilities/mega_buster/tick
