...
# Snake
execute as @e[type=minecraft:marker,tag=psg1,predicate=ssbrc:id_match] at @s run function ssbrc:series/metal_gear_solid/snake/logic/weapons/psg1/tick
execute as @e[type=minecraft:marker,tag=famas,predicate=ssbrc:id_match] at @s run function ssbrc:series/metal_gear_solid/snake/logic/weapons/famas/tick
execute as @e[type=minecraft:marker,tag=s1000,predicate=ssbrc:id_match] at @s run function ssbrc:series/metal_gear_solid/snake/logic/weapons/s1000/tick
execute as @e[type=minecraft:marker,tag=socom,predicate=ssbrc:id_match] at @s run function ssbrc:series/metal_gear_solid/snake/logic/weapons/socom/tick
...
execute as @e[type=minecraft:arrow,tag=drone.bullet,predicate=ssbrc:id_match] at @s run function ssbrc:series/retro_fighters/yar/logic/abilities/drone/projectiles
