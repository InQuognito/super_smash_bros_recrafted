...
execute unless entity @s[x=-525.0,y=6.0,z=63.0,dy=0] run scoreboard players reset @s sandbag.standOn
scoreboard players add @s[x=-525.0,y=6.0,z=63.0,dy=0] sandbag.standOn 1
