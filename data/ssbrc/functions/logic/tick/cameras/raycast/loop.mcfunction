...
execute if score @s raycast matches 1.. unless block ^ ^ ^0.1 #ssbrc:passthrough if score @s raycastSuccess matches 0 positioned ^ ^ ^0.1 run function ssbrc:logic/tick/cameras/raycast/loop
