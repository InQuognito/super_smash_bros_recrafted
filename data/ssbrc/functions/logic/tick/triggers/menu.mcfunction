...
execute if score @s[tag=!bowser] menu matches 63 run function ssbrc:series/super_mario_bros/bowser/menu/how_to_play
...
execute if score @s[tag=!byleth] menu matches 102 run function ssbrc:series/fire_emblem/byleth/menu/favorite
execute if score @s[tag=!byleth] menu matches 103 run function ssbrc:series/fire_emblem/byleth/menu/how_to_play
...
execute if score @s[tag=!captainfalcon] menu matches 122 run function ssbrc:series/f_zero/captainfalcon/menu/favorite
execute if score @s[tag=!captainfalcon] menu matches 123 run function ssbrc:series/f_zero/captainfalcon/menu/how_to_play
...
execute if score @s[tag=!cloud] menu matches 182 run function ssbrc:series/final_fantasy/cloud/menu/favorite
execute if score @s[tag=!cloud] menu matches 183 run function ssbrc:series/final_fantasy/cloud/menu/how_to_play
...
execute if score @s[tag=!darksamus] menu matches 262 run function ssbrc:series/metroid/darksamus/menu/favorite
execute if score @s[tag=!darksamus] menu matches 263 run function ssbrc:series/metroid/darksamus/menu/how_to_play
...
execute if score @s[tag=!donkeykong] menu matches 302 run function ssbrc:series/donkey_kong/donkeykong/menu/favorite
execute if score @s[tag=!donkeykong] menu matches 303 run function ssbrc:series/donkey_kong/donkeykong/menu/how_to_play
...
execute if score @s[tag=!fox] menu matches 382 run function ssbrc:series/star_fox/fox/menu/favorite
execute if score @s[tag=!fox] menu matches 383 run function ssbrc:series/star_fox/fox/menu/how_to_play
...
execute if score @s[tag=!ganondorf] menu matches 402 run function ssbrc:series/the_legend_of_zelda/ganondorf/menu/favorite
execute if score @s[tag=!ganondorf] menu matches 403 run function ssbrc:series/the_legend_of_zelda/ganondorf/menu/how_to_play
...
execute if score @s[tag=!greninja] menu matches 422 run function ssbrc:series/pokemon/greninja/menu/favorite
execute if score @s[tag=!greninja] menu matches 423 run function ssbrc:series/pokemon/greninja/menu/how_to_play
...
execute if score @s[tag=!hero] menu matches 442 run function ssbrc:series/dragon_quest/hero/menu/favorite
execute if score @s[tag=!hero] menu matches 443 run function ssbrc:series/dragon_quest/hero/menu/how_to_play
...
execute if score @s[tag=!joker] menu matches 603 run function ssbrc:series/persona/joker/menu/how_to_play
...
execute if score @s[tag=!kingkrool] menu matches 682 run function ssbrc:series/donkey_kong/kingkrool/menu/favorite
execute if score @s[tag=!kingkrool] menu matches 683 run function ssbrc:series/donkey_kong/kingkrool/menu/how_to_play
...
execute if score @s[tag=!kirby] menu matches 702 run function ssbrc:series/kirby/kirby/menu/favorite
execute if score @s[tag=!kirby] menu matches 703 run function ssbrc:series/kirby/kirby/menu/how_to_play
...
execute if score @s[tag=!link] menu matches 722 run function ssbrc:series/the_legend_of_zelda/link/menu/favorite
execute if score @s[tag=!link] menu matches 723 run function ssbrc:series/the_legend_of_zelda/link/menu/how_to_play
...
execute if score @s[tag=!luigi] menu matches 822 run function ssbrc:series/super_mario_bros/luigi/menu/favorite
execute if score @s[tag=!luigi] menu matches 823 run function ssbrc:series/super_mario_bros/luigi/menu/how_to_play
...
execute if score @s[tag=!mario] menu matches 842 run function ssbrc:series/super_mario_bros/mario/menu/favorite
execute if score @s[tag=!mario] menu matches 843 run function ssbrc:series/super_mario_bros/mario/menu/how_to_play
...
execute if score @s[tag=!megaman] menu matches 882 run function ssbrc:series/mega_man/megaman/menu/favorite
execute if score @s[tag=!megaman] menu matches 883 run function ssbrc:series/mega_man/megaman/menu/how_to_play
...
execute if score @s[tag=!ness] menu matches 1082 run function ssbrc:series/earthbound/ness/menu/favorite
execute if score @s[tag=!ness] menu matches 1083 run function ssbrc:series/earthbound/ness/menu/how_to_play
...
execute if score @s[tag=!pit] menu matches 1223 run function ssbrc:series/kid_icarus/pit/menu/how_to_play
...
execute if score @s[tag=!pokemontrainer] menu matches 1262 run function ssbrc:series/pokemon/pokemontrainer/menu/favorite
execute if score @s[tag=!pokemontrainer] menu matches 1263 run function ssbrc:series/pokemon/pokemontrainer/menu/how_to_play
...
execute if score @s[tag=!ryu] menu matches 1403 run function ssbrc:series/street_fighter/ryu/menu/how_to_play
...
execute if score @s[tag=!samus] menu matches 1422 run function ssbrc:series/metroid/samus/menu/favorite
execute if score @s[tag=!samus] menu matches 1423 run function ssbrc:series/metroid/samus/menu/how_to_play
...
execute if score @s[tag=!snake] menu matches 1523 run function ssbrc:series/metal_gear_solid/snake/menu/how_to_play
...
execute if score @s[tag=!sonic] menu matches 1542 run function ssbrc:series/sonic_the_hedgehog/sonic/menu/favorite
execute if score @s[tag=!sonic] menu matches 1543 run function ssbrc:series/sonic_the_hedgehog/sonic/menu/how_to_play
...
execute if score @s[tag=!sora] menu matches 1562 run function ssbrc:series/kingdom_hearts/sora/menu/favorite
execute if score @s[tag=!sora] menu matches 1563 run function ssbrc:series/kingdom_hearts/sora/menu/how_to_play
...
execute if score @s[tag=!steve] menu matches 1582 run function ssbrc:series/indie_fighters/steve/menu/favorite
execute if score @s[tag=!steve] menu matches 1583 run function ssbrc:series/indie_fighters/steve/menu/how_to_play
...
execute if score @s[tag=!alteredbeast] menu matches 1822 run function ssbrc:series/retro_fighters/alteredbeast/menu/favorite
execute if score @s[tag=!alteredbeast] menu matches 1823 run function ssbrc:series/retro_fighters/alteredbeast/menu/how_to_play
...
execute if score @s[tag=!alucard] menu matches 1843 run function ssbrc:series/castlevania/alucard/menu/how_to_play
...
execute if score @s[tag=!giegue] menu matches 1862 run function ssbrc:series/earthbound/giegue/menu/favorite
execute if score @s[tag=!giegue] menu matches 1863 run function ssbrc:series/earthbound/giegue/menu/how_to_play
...
execute if score @s[tag=!shadow] menu matches 1902 run function ssbrc:series/sonic_the_hedgehog/shadow/menu/favorite
execute if score @s[tag=!shadow] menu matches 1903 run function ssbrc:series/sonic_the_hedgehog/shadow/menu/how_to_play
...
execute if score @s[tag=!shovelknight] menu matches 1923 run function ssbrc:series/indie_fighters/shovelknight/menu/how_to_play
...
execute if score @s[tag=!teamrocket] menu matches 1942 run function ssbrc:series/pokemon/teamrocket/menu/favorite
