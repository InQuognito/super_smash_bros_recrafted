execute if entity @s[scores={menu=-999}] run function ssbrc:logic/resets/player_data/ask
execute if entity @s[scores={menu=-998,reset=1}] run function ssbrc:logic/resets/player_data/cancel
execute if entity @s[scores={menu=-997,reset=1}] run function ssbrc:logic/resets/player_data/confirm
...
execute if entity @s[tag=lucario] run function ssbrc:fighters/lucario/menu/trigger
...
execute if entity @s[tag=roy] run function ssbrc:fighters/roy/menu/trigger
...
execute if entity @s[tag=toon_link] run function ssbrc:fighters/toon_link/menu/trigger
