...
execute if score @s[nbt={SelectedItem:{tag:{options:1}}}] options matches 18 run function ssbrc:logic/options/items/on
execute if score @s[nbt={SelectedItem:{tag:{options:1}}}] options matches 19 run function ssbrc:logic/options/items/off

execute if score @s[nbt={SelectedItem:{tag:{options:1}}}] options matches 20 if score items options matches 1 run function ssbrc:logic/options/item_rate/fixed
execute if score @s[nbt={SelectedItem:{tag:{options:1}}}] options matches 21 if score items options matches 1 run function ssbrc:logic/options/item_rate/low
execute if score @s[nbt={SelectedItem:{tag:{options:1}}}] options matches 22 if score items options matches 1 run function ssbrc:logic/options/item_rate/medium
execute if score @s[nbt={SelectedItem:{tag:{options:1}}}] options matches 23 if score items options matches 1 run function ssbrc:logic/options/item_rate/high

execute if score @s[nbt={SelectedItem:{tag:{options:1}}}] options matches 24 run function ssbrc:logic/options/blind_pick/on
execute if score @s[nbt={SelectedItem:{tag:{options:1}}}] options matches 25 run function ssbrc:logic/options/blind_pick/off

execute if score @s[nbt={SelectedItem:{tag:{options:1}}}] options matches 26 run function ssbrc:logic/options/music/shuffle
execute if score @s[nbt={SelectedItem:{tag:{options:1}}}] options matches 27 run function ssbrc:logic/options/music/loop
