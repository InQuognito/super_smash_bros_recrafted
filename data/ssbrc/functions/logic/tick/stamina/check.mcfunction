...
execute if score $stamina.saturation saturation matches ..0 run effect clear @s minecraft:hunger
execute if score $stamina.saturation saturation matches 1.. run effect give @s minecraft:hunger 1000000 255 true
