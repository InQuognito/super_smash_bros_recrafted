...
execute if score $sandOcean map matches 1 if score $hazards options matches 1 at @s if block ~ ~ ~ minecraft:cyan_carpet run effect give @s minecraft:levitation 1 128 true
execute if score $sandOcean map matches 1 if score $hazards options matches 1 at @s unless block ~ ~ ~ minecraft:cyan_carpet run effect clear @s[predicate=ssbrc:characters/effects/has/levitation/128] minecraft:levitation
