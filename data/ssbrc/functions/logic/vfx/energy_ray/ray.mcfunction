...
particle minecraft:flame ~ ~ ~ 0 0 0 0.01 1 force @a
execute if score $recursions temp matches 0 run return run function ssbrc:logic/vfx/energy_ray/end_segment
execute unless block ^ ^ ^.1 #augments:passable summon minecraft:marker run return run function ssbrc:logic/vfx/energy_ray/bounce
