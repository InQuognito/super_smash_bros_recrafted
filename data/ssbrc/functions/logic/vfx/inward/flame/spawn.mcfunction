...
function ssbrc:logic/vfx/inward/flame/roll_distance with storage particle:temp
execute store result storage particle:temp distance double 0.000001 run data get storage particle:temp velocity
function ssbrc:logic/vfx/inward/flame/particle with storage particle:temp