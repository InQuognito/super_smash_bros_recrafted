...
execute if score @s 8PlayerMatch matches 1.. run data modify storage ssbrc:bonuses value append value '[{"text":"8-Player Match","bold":true,"color":"gold"},{"translate":" - ","bold":false,"color":"white"},{"score":{"name":"value","objective":"8PlayerMatch"},"bold":false,"color":"yellow"},{"translate":"₡","bold":false,"color":"yellow"}]}}]'
...
execute if score @s acrobat matches 1.. run data modify storage ssbrc:bonuses value append value '[{"text":"Acrobat","bold":true,"color":"gold"},{"translate":" - ","bold":false,"color":"white"},{"score":{"name":"value","objective":"acrobat"},"bold":false,"color":"yellow"},{"translate":"₡","bold":false,"color":"yellow"}]}}]'
...
execute if score @s aerialist matches 1.. run data modify storage ssbrc:bonuses value append value '[{"text":"Aerialist","bold":true,"color":"gold"},{"translate":" - ","bold":false,"color":"white"},{"score":{"name":"value","objective":"aerialist"},"bold":false,"color":"yellow"},{"translate":"₡","bold":false,"color":"yellow"}]}}]'
...
execute if score @s armistice matches 1.. run data modify storage ssbrc:bonuses value append value '[{"text":"Armistice","bold":true,"color":"gold"},{"translate":" - ","bold":false,"color":"white"},{"score":{"name":"value","objective":"armistice"},"bold":false,"color":"yellow"},{"translate":"₡","bold":false,"color":"yellow"}]}}]'
...
#execute if score @s cementShoes matches 1.. run data modify storage ssbrc:bonuses value append value '[{"text":"Cement Shoes","bold":true,"color":"gold"},{"translate":" - ","bold":false,"color":"white"},{"score":{"name":"value","objective":"cementShoes"},"bold":false,"color":"yellow"},{"translate":"₡","bold":false,"color":"yellow"}]}}]'
...
execute if score @s firstStrike matches 1.. run data modify storage ssbrc:bonuses value append value '[{"text":"First Strike","bold":true,"color":"gold"},{"translate":" - ","bold":false,"color":"white"},{"score":{"name":"value","objective":"firstStrike"},"bold":false,"color":"yellow"},{"translate":"₡","bold":false,"color":"yellow"}]}}]'
...
execute if score @s fullPower matches 1.. run data modify storage ssbrc:bonuses value append value '[{"text":"Full Power","bold":true,"color":"gold"},{"translate":" - ","bold":false,"color":"white"},{"score":{"name":"value","objective":"fullPower"},"bold":false,"color":"yellow"},{"translate":"₡","bold":false,"color":"yellow"}]}}]'
...
execute if score @s goodFriend matches 1.. run data modify storage ssbrc:bonuses value append value '[{"text":"Good Friend","bold":true,"color":"gold"},{"translate":" - ","bold":false,"color":"white"},{"score":{"name":"value","objective":"goodFriend"},"bold":false,"color":"yellow"},{"translate":"₡","bold":false,"color":"yellow"}]}}]'
...
execute if score @s heartgold matches 1.. run data modify storage ssbrc:bonuses value append value '[{"text":"Heartgold","bold":true,"color":"gold"},{"translate":" - ","bold":false,"color":"white"},{"score":{"name":"value","objective":"heartgold"},"bold":false,"color":"yellow"},{"translate":"₡","bold":false,"color":"yellow"}]}}]'
...
execute if score @s heavyDamage matches 1.. run data modify storage ssbrc:bonuses value append value '[{"text":"Heavy Damage","bold":true,"color":"gold"},{"translate":" - ","bold":false,"color":"white"},{"score":{"name":"value","objective":"heavyDamage"},"bold":false,"color":"yellow"},{"translate":"₡","bold":false,"color":"yellow"}]}}]'
...
execute if score @s lastSecond matches 1.. run data modify storage ssbrc:bonuses value append value '[{"text":"Last Second","bold":true,"color":"gold"},{"translate":" - ","bold":false,"color":"white"},{"score":{"name":"value","objective":"lastSecond"},"bold":false,"color":"yellow"},{"translate":"₡","bold":false,"color":"yellow"}]}}]'
...
execute if score @s luckyNumberSeven matches 1.. run data modify storage ssbrc:bonuses value append value '[{"text":"Lucky Number Seven","bold":true,"color":"gold"},{"translate":" - ","bold":false,"color":"white"},{"score":{"name":"value","objective":"luckyNumberSeven"},"bold":false,"color":"yellow"},{"translate":"₡","bold":false,"color":"yellow"}]}}]'
...
execute if score @s mercifulMaster matches 1.. run data modify storage ssbrc:bonuses value append value '[{"text":"Merciful Master","bold":true,"color":"gold"},{"translate":" - ","bold":false,"color":"white"},{"score":{"name":"value","objective":"mercifulMaster"},"bold":false,"color":"yellow"},{"translate":"₡","bold":false,"color":"yellow"}]}}]'
...
execute if score @s noJohns matches 1.. run data modify storage ssbrc:bonuses value append value '[{"text":"No Johns","bold":true,"color":"gold"},{"translate":" - ","bold":false,"color":"white"},{"score":{"name":"value","objective":"noJohns"},"bold":false,"color":"yellow"},{"translate":"₡","bold":false,"color":"yellow"}]}}]'
...
execute if score @s onARoll matches 1.. run data modify storage ssbrc:bonuses value append value '[{"text":"On a Roll","bold":true,"color":"gold"},{"translate":" - ","bold":false,"color":"white"},{"score":{"name":"value","objective":"onARoll"},"bold":false,"color":"yellow"},{"translate":"₡","bold":false,"color":"yellow"}]}}]'
...
execute if score @s speedDemon matches 1.. run data modify storage ssbrc:bonuses value append value '[{"text":"Speed Demon","bold":true,"color":"gold"},{"translate":" - ","bold":false,"color":"white"},{"score":{"name":"value","objective":"speedDemon"},"bold":false,"color":"yellow"},{"translate":"₡","bold":false,"color":"yellow"}]}}]'
...
execute if score @s stiffKnees matches 1.. run data modify storage ssbrc:bonuses value append value '[{"text":"Stiff Knees","bold":true,"color":"gold"},{"translate":" - ","bold":false,"color":"white"},{"score":{"name":"value","objective":"stiffKnees"},"bold":false,"color":"yellow"},{"translate":"₡","bold":false,"color":"yellow"}]}}]'
...
execute if score @s suddenDeath matches 1.. run data modify storage ssbrc:bonuses value append value '[{"text":"Sudden Death","bold":true,"color":"gold"},{"translate":" - ","bold":false,"color":"white"},{"score":{"name":"value","objective":"suddenDeath"},"bold":false,"color":"yellow"},{"translate":"₡","bold":false,"color":"yellow"}]}}]'
...
execute if score @s switzerland matches 1.. run data modify storage ssbrc:bonuses value append value '[{"text":"Switzerland","bold":true,"color":"gold"},{"translate":" - ","bold":false,"color":"white"},{"score":{"name":"value","objective":"switzerland"},"bold":false,"color":"yellow"},{"translate":"₡","bold":false,"color":"yellow"}]}}]'
...
execute if score @s tortoise matches 1.. run data modify storage ssbrc:bonuses value append value '[{"text":"Tortoise","bold":true,"color":"gold"},{"translate":" - ","bold":false,"color":"white"},{"score":{"name":"value","objective":"tortoise"},"bold":false,"color":"yellow"},{"translate":"₡","bold":false,"color":"yellow"}]}}]'
...
execute if score @s trulyHeroic matches 1.. run data modify storage ssbrc:bonuses value append value '[{"text":"Truly Heroic","bold":true,"color":"gold"},{"translate":" - ","bold":false,"color":"white"},{"score":{"name":"value","objective":"trulyHeroic"},"bold":false,"color":"yellow"},{"translate":"₡","bold":false,"color":"yellow"}]}}]'
...
execute if score @s trulyVillainous matches 1.. run data modify storage ssbrc:bonuses value append value '[{"text":"Truly Villainous","bold":true,"color":"gold"},{"translate":" - ","bold":false,"color":"white"},{"score":{"name":"value","objective":"trulyVillainous"},"bold":false,"color":"yellow"},{"translate":"₡","bold":false,"color":"yellow"}]}}]'
...
execute if score @s WACCoordinator matches 1.. run data modify storage ssbrc:bonuses value append value '[{"text":"WAC Coordinator","bold":true,"color":"gold"},{"translate":" - ","bold":false,"color":"white"},{"score":{"name":"value","objective":"WACCoordinator"},"bold":false,"color":"yellow"},{"translate":"₡","bold":false,"color":"yellow"}]}}]'
...
execute if score @s yearLongBattle matches 1.. run data modify storage ssbrc:bonuses value append value '[{"text":"Year-Long Battle","bold":true,"color":"gold"},{"translate":" - ","bold":false,"color":"white"},{"score":{"name":"value","objective":"yearLongBattle"},"bold":false,"color":"yellow"},{"translate":"₡","bold":false,"color":"yellow"}]}}]'
...
execute if score @s 765o matches 1.. run data modify storage ssbrc:bonuses value append value '[{"score":{"name":"@s","objective":"765o"},"bold":true,"color":"yellow"},{"translate":"x ","bold":true,"color":"yellow"},{"text":"765o","bold":true,"color":"gold"},{"translate":" - ","bold":false,"color":"white"},{"score":{"name":"value","objective":"765o"},"bold":false,"color":"yellow"},{"translate":"₡","bold":false,"color":"yellow"}]}}]'
...
execute if score @s bankShot matches 1.. run data modify storage ssbrc:bonuses value append value '[{"score":{"name":"@s","objective":"bankShot"},"bold":true,"color":"yellow"},{"translate":"x ","bold":true,"color":"yellow"},{"text":"Bank-Shot","bold":true,"color":"gold"},{"translate":" - ","bold":false,"color":"white"},{"score":{"name":"value","objective":"bankShot"},"bold":false,"color":"yellow"},{"translate":"₡","bold":false,"color":"yellow"}]}}]'
...
execute if score @s crushingWeight matches 1.. run data modify storage ssbrc:bonuses value append value '[{"score":{"name":"@s","objective":"crushingWeight"},"bold":true,"color":"yellow"},{"translate":"x ","bold":true,"color":"yellow"},{"text":"Crushing Weight","bold":true,"color":"gold"},{"translate":" - ","bold":false,"color":"white"},{"score":{"name":"value","objective":"crushingWeight"},"bold":false,"color":"yellow"},{"translate":"₡","bold":false,"color":"yellow"}]}}]'
...
execute if score @s ionZoneProtection matches 1.. run data modify storage ssbrc:bonuses value append value '[{"score":{"name":"@s","objective":"ionZoneProtection"},"bold":true,"color":"yellow"},{"translate":"x ","bold":true,"color":"yellow"},{"text":"Ion Zone Protection","bold":true,"color":"gold"},{"translate":" - ","bold":false,"color":"white"},{"score":{"name":"value","objective":"ionZoneProtection"},"bold":false,"color":"yellow"},{"translate":"₡","bold":false,"color":"yellow"}]}}]'
...
execute if score @s NPCKO matches 1.. run data modify storage ssbrc:bonuses value append value '[{"score":{"name":"@s","objective":"NPCKO"},"bold":true,"color":"yellow"},{"translate":"x ","bold":true,"color":"yellow"},{"text":"NPC K.O.","bold":true,"color":"gold"},{"translate":" - ","bold":false,"color":"white"},{"score":{"name":"value","objective":"NPCKO"},"bold":false,"color":"yellow"},{"translate":"₡","bold":false,"color":"yellow"}]}}]'
...
execute if score @s rapidKill matches 1.. run data modify storage ssbrc:bonuses value append value '[{"score":{"name":"@s","objective":"rapidKill"},"bold":true,"color":"yellow"},{"translate":"x ","bold":true,"color":"yellow"},{"text":"Rapid Kill","bold":true,"color":"gold"},{"translate":" - ","bold":false,"color":"white"},{"score":{"name":"value","objective":"rapidKill"},"bold":false,"color":"yellow"},{"translate":"₡","bold":false,"color":"yellow"}]}}]'
...
execute if score @s revenge matches 1.. run data modify storage ssbrc:bonuses value append value '[{"score":{"name":"@s","objective":"revenge"},"bold":true,"color":"yellow"},{"translate":"x ","bold":true,"color":"yellow"},{"text":"Revenge","bold":true,"color":"gold"},{"translate":" - ","bold":false,"color":"white"},{"score":{"name":"value","objective":"revenge"},"bold":false,"color":"yellow"},{"translate":"₡","bold":false,"color":"yellow"}]}}]'
...
execute if score @s shieldBreaker matches 1.. run data modify storage ssbrc:bonuses value append value '[{"score":{"name":"@s","objective":"shieldBreaker"},"bold":true,"color":"yellow"},{"translate":"x ","bold":true,"color":"yellow"},{"text":"Shield Breaker","bold":true,"color":"gold"},{"translate":" - ","bold":false,"color":"white"},{"score":{"name":"value","objective":"shieldBreaker"},"bold":false,"color":"yellow"},{"translate":"₡","bold":false,"color":"yellow"}]}}]'
...
execute if score @s shinyEncounter matches 1.. run data modify storage ssbrc:bonuses value append value '[{"score":{"name":"@s","objective":"shinyEncounter"},"bold":true,"color":"yellow"},{"translate":"x ","bold":true,"color":"yellow"},{"text":"Shiny Encounter","bold":true,"color":"gold"},{"translate":" - ","bold":false,"color":"white"},{"score":{"name":"value","objective":"shinyEncounter"},"bold":false,"color":"yellow"},{"translate":"₡","bold":false,"color":"yellow"}]}}]'
...
execute if score @s sniper matches 1.. run data modify storage ssbrc:bonuses value append value '[{"score":{"name":"@s","objective":"sniper"},"bold":true,"color":"yellow"},{"translate":"x ","bold":true,"color":"yellow"},{"text":"Sniper","bold":true,"color":"gold"},{"translate":" - ","bold":false,"color":"white"},{"score":{"name":"value","objective":"sniper"},"bold":false,"color":"yellow"},{"translate":"₡","bold":false,"color":"yellow"}]}}]'
...
execute if score @s bully matches 1.. run data modify storage ssbrc:bonuses value append value '[{"text":"Bully","bold":true,"color":"gold"},{"translate":" - ","bold":false,"color":"white"},{"score":{"name":"value","objective":"bully"},"bold":false,"color":"yellow"},{"translate":"₡","bold":false,"color":"yellow"}]}}]'
...
execute if score @s coward matches 1.. run data modify storage ssbrc:bonuses value append value '[{"score":{"name":"@s","objective":"coward"},"bold":true,"color":"yellow"},{"translate":"x ","bold":true,"color":"yellow"},{"text":"Coward","bold":true,"color":"gold"},{"translate":" - ","bold":false,"color":"white"},{"score":{"name":"value","objective":"coward"},"bold":false,"color":"yellow"},{"translate":"₡","bold":false,"color":"yellow"}]}}]'
...
execute if score @s selfDestruct matches 1.. run data modify storage ssbrc:bonuses value append value '[{"score":{"name":"@s","objective":"selfDestruct"},"bold":true,"color":"yellow"},{"translate":"x ","bold":true,"color":"yellow"},{"text":"Self Destruct","bold":true,"color":"gold"},{"translate":" - ","bold":false,"color":"white"},{"score":{"name":"value","objective":"selfDestruct"},"bold":false,"color":"yellow"},{"translate":"₡","bold":false,"color":"yellow"}]}}]'
scoreboard players operation @s stats.credits.temp += value selfDestruct

execute if score @s quitter matches 1.. run data modify storage ssbrc:bonuses value append value '[{"text":"Quitter","bold":true,"color":"gold"},{"translate":" - ","bold":false,"color":"white"},{"text":"ALL CREDITS FORFEIT","bold":false,"color":"red"}]}}]'
...
tellraw @s [{"text":"Credits Earned: ","color":"gold"},{"score":{"name":"@s","objective":"stats.credits.temp"},"color":"yellow"},{"translate":"₡","color":"yellow"}]
