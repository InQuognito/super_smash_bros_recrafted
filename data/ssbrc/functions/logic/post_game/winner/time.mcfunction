...
execute unless score players_alive temp matches ..1 if score mostPoints temp matches 0 run function ssbrc:logic/post_game/end
execute unless score players_alive temp matches ..1 if score mostPoints temp matches 1 as @a[tag=mostPoints,limit=1] run function ssbrc:logic/post_game/end
execute unless score players_alive temp matches ..1 if score mostPoints temp matches 2.. run function ssbrc:logic/post_game/sudden_death/activate
