...
execute if score $gameMode options matches 1 run tellraw @s [{"translate":"ssbrc.game.end.summary.duration","color":"gold"},{"score":{"name":"$gameTime","objective":"timer"},"color":"yellow"},{"text":"s","color":"gold"}]
