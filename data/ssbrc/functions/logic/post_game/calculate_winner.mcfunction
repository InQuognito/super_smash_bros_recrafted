...
execute if score $mostKills temp matches 1 as @a[tag=mostKills] run function ssbrc:logic/post_game/end
execute if score $mostKills temp matches 2.. as @a[team=alive] run function ssbrc:logic/post_game/sudden_death
