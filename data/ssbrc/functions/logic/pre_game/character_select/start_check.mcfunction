...
execute if score $teams options matches 1 if score #characterPicked temp = #players temp unless score #characterPicked temp = $highestTeam teamAmount unless score #players temp matches ..1 run function ssbrc:logic/pre_game/map_voting/goto
execute if score $teams options matches 1 if score #characterPicked temp = #players temp if score #players temp matches ..1 run function ssbrc:logic/pre_game/map_voting/goto
