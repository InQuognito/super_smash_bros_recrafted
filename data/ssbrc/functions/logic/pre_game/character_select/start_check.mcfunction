...
execute if score $teams options matches 1 if score #characterPicked temp = #players temp if score #characterPicked temp = $highestTeam teamAmount run scoreboard players set $countdown timer 5
