...
execute unless score $gameStage temp matches 1 if score #characterPicked temp = #players temp run scoreboard players set $gameStage temp 1
execute unless score $gameStage temp matches 1 if score #characterPicked temp = #players temp run scoreboard players operation $countdown timer = #quickStart vars
