...
execute if entity @s[tag=icicle_mountain] run function ssbrc:logic/pre_game/stage_select/stage_choices/stages/icicle_mountain
execute if entity @s[tag=magicant] run function ssbrc:logic/pre_game/stage_select/stage_choices/stages/magicant
execute if entity @s[tag=mementos] run function ssbrc:logic/pre_game/stage_select/stage_choices/stages/mementos
execute if entity @s[tag=miiverse] run function ssbrc:logic/pre_game/stage_select/stage_choices/stages/miiverse
...
execute if entity @s[tag=pyrosphere] run function ssbrc:logic/pre_game/stage_select/stage_choices/stages/pyrosphere
execute if entity @s[tag=spear_pillar] run function ssbrc:logic/pre_game/stage_select/stage_choices/stages/spear_pillar
execute if entity @s[tag=tower_of_fate] run function ssbrc:logic/pre_game/stage_select/stage_choices/stages/tower_of_fate
