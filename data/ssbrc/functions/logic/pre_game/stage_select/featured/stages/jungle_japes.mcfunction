...
summon minecraft:text_display ~ ~1.25 ~ {Tags:["info_display"],text:'{"translate":"ssbrc.stages.jungle_japes","bold":false,"color":"dark_green"}',billboard:"center",alignment:"center"}
