...
summon minecraft:text_display ~ ~1.25 ~ {Tags:["infoDisplay"],text:'{"translate":"ssbrc.stages.magicant","bold":false,"color":"light_purple"}',billboard:"center",alignment:"center"}
