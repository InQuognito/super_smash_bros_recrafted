...
summon minecraft:text_display ~ ~1.25 ~ {Tags:["infoDisplay"],text:'{"translate":"ssbrc.stages.great_plateau","bold":false,"color":"green"}',billboard:"center",alignment:"center"}
