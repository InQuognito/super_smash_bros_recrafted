...
summon minecraft:text_display ~ ~1.25 ~ {Tags:["infoDisplay"],text:'{"translate":"ssbrc.stages.spear_pillar","bold":false,"color":"yellow"}',alignment:"center",billboard:center}
