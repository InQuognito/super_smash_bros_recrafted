...
execute if score @s temp matches 1.. at @s as @e[type=minecraft:area_effect_cloud,tag=voteCounter,tag=!selected,sort=random,limit=1] run function ssbrc:logic/pre_game/map_voting/map_choices/choose/lobby_size/decide
