...
summon minecraft:glow_item_frame 7.5 11.0 14.5 {Fixed:1b,Invisible:1b,Facing:3b,Item:{id:"minecraft:sugar",tag:{CustomModelData:1900},Count:1b}}
# Sand Ocean
...
summon minecraft:glow_item_frame 10.5 11.0 19.5 {Fixed:1b,Invisible:1b,Facing:4b,Item:{id:"minecraft:sugar",tag:{CustomModelData:1850},Count:1b}}
# Random
...
execute if score #goldSkins temp = $playersAlive temp run scoreboard players set @a[predicate=ssbrc:flag/player] heartgold 1
