...
execute as @e[type=minecraft:area_effect_cloud,tag=voteCounter,sort=nearest,limit=1] if entity @s[tag=acropolisGraveyard] as @p[tag=self] run function ssbrc:maps/a/acropolis_graveyard/vote
execute as @e[type=minecraft:area_effect_cloud,tag=voteCounter,sort=nearest,limit=1] if entity @s[tag=bowsersCastle] as @p[tag=self] run function ssbrc:maps/b/bowsers_castle/vote
execute as @e[type=minecraft:area_effect_cloud,tag=voteCounter,sort=nearest,limit=1] if entity @s[tag=castleSiege] as @p[tag=self] run function ssbrc:maps/c/castle_siege/vote
execute as @e[type=minecraft:area_effect_cloud,tag=voteCounter,sort=nearest,limit=1] if entity @s[tag=draculasCastle] as @p[tag=self] run function ssbrc:maps/d/draculas_castle/vote
execute as @e[type=minecraft:area_effect_cloud,tag=voteCounter,sort=nearest,limit=1] if entity @s[tag=dreamLand] as @p[tag=self] run function ssbrc:maps/d/dream_land/vote
execute as @e[type=minecraft:area_effect_cloud,tag=voteCounter,sort=nearest,limit=1] if entity @s[tag=flatZone] as @p[tag=self] run function ssbrc:maps/f/flat_zone/vote
execute as @e[type=minecraft:area_effect_cloud,tag=voteCounter,sort=nearest,limit=1] if entity @s[tag=frozenHijinx] as @p[tag=self] run function ssbrc:maps/f/frozen_hijinx/vote
execute as @e[type=minecraft:area_effect_cloud,tag=voteCounter,sort=nearest,limit=1] if entity @s[tag=gardenOfHope] as @p[tag=self] run function ssbrc:maps/g/garden_of_hope/vote
execute as @e[type=minecraft:area_effect_cloud,tag=voteCounter,sort=nearest,limit=1] if entity @s[tag=greatBay] as @p[tag=self] run function ssbrc:maps/g/great_bay/vote
execute as @e[type=minecraft:area_effect_cloud,tag=voteCounter,sort=nearest,limit=1] if entity @s[tag=greatPlateau] as @p[tag=self] run function ssbrc:maps/g/great_plateau/vote
execute as @e[type=minecraft:area_effect_cloud,tag=voteCounter,sort=nearest,limit=1] if entity @s[tag=greenHillZone] as @p[tag=self] run function ssbrc:maps/g/green_hill_zone/vote
...
execute as @e[type=minecraft:area_effect_cloud,tag=voteCounter,sort=nearest,limit=1] if entity @s[tag=miiverse] as @p[tag=self] run function ssbrc:maps/m/miiverse/vote
execute as @e[type=minecraft:area_effect_cloud,tag=voteCounter,sort=nearest,limit=1] if entity @s[tag=mushroomKingdom] as @p[tag=self] run function ssbrc:maps/m/mushroom_kingdom/vote
...
execute as @e[type=minecraft:area_effect_cloud,tag=voteCounter,sort=nearest,limit=1] if entity @s[tag=saturnValley] as @p[tag=self] run function ssbrc:maps/s/saturn_valley/vote
execute as @e[type=minecraft:area_effect_cloud,tag=voteCounter,sort=nearest,limit=1] if entity @s[tag=sectorZ] as @p[tag=self] run function ssbrc:maps/s/sector_z/vote
execute as @e[type=minecraft:area_effect_cloud,tag=voteCounter,sort=nearest,limit=1] if entity @s[tag=shadowMosesIsland] as @p[tag=self] run function ssbrc:maps/s/shadow_moses_island/vote
execute as @e[type=minecraft:area_effect_cloud,tag=voteCounter,sort=nearest,limit=1] if entity @s[tag=spearPillar] as @p[tag=self] run function ssbrc:maps/s/spear_pillar/vote
