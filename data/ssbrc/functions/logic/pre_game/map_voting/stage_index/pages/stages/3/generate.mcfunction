...
item replace entity @s enderchest.4 with minecraft:sugar{ui:{id:"stages.shadowMosesIsland",sound:"click"},CustomModelData:1600,HideFlags:127,display:{Name:'{"translate":"ssbrc.stages.shadowMosesIsland","color":"white","italic":false}',Lore:['{"translate":"ssbrc.series.metalGearSolid","color":"red","italic":false}','""','{"translate":"ssbrc.ui.clickToVote","color":"yellow","italic":false}']}}
