...
item replace entity @s enderchest.6 with minecraft:sugar{ui:{id:"stages.yggdrasils_altar",sound:"click"},CustomModelData:1950,HideFlags:255,display:{Name:'{"translate":"ssbrc.stages.yggdrasils_altar","color":"yellow","italic":false}',Lore:['{"translate":"ssbrc.series.dragonQuest","color":"red","italic":false}','""','{"translate":"ssbrc.ui.clickToVote","color":"yellow","italic":false}']}}

item replace entity @s enderchest.11 with minecraft:sugar{ui:{id:"stages.tower_of_fate",sound:"click"},CustomModelData:1750,HideFlags:255,display:{Name:'{"translate":"ssbrc.stages.tower_of_fate","color":"dark_purple","italic":false}',Lore:['{"translate":"ssbrc.fighters.shovel_knight","color":"yellow","italic":false}','""','{"translate":"ssbrc.ui.clickToVote","color":"yellow","italic":false}']}}
...
item replace entity @s enderchest.13 with minecraft:sugar{ui:{id:"stages.planet_epp",sound:"click"},CustomModelData:1850,HideFlags:255,display:{Name:'{"translate":"ssbrc.stages.planet_epp","color":"red","italic":false}',Lore:['{"translate":"ssbrc.series.yarsRevenge","color":"gold","italic":false}','""','{"translate":"ssbrc.ui.clickToVote","color":"yellow","italic":false}']}}
