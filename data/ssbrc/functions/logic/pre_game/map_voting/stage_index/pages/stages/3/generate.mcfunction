...
<<<<<<< HEAD
item replace entity @s enderchest.11 with minecraft:sugar{ui:{id:"stages.towerOfFate",sound:"click"},CustomModelData:1750,HideFlags:255,display:{Name:'{"translate":"ssbrc.stages.towerOfFate","color":"dark_purple","italic":false}',Lore:['{"translate":"ssbrc.series.shovel_knight","color":"yellow","italic":false}','""','{"translate":"ssbrc.ui.clickToVote","color":"yellow","italic":false}']}}
=======
item replace entity @s enderchest.11 with minecraft:sugar{ui:{id:"stages.towerOfFate",sound:"click"},CustomModelData:1750,HideFlags:255,display:{Name:'{"translate":"ssbrc.stages.towerOfFate","color":"dark_purple","italic":false}',Lore:['{"translate":"ssbrc.fighters.shovel_knight","color":"yellow","italic":false}','""','{"translate":"ssbrc.ui.clickToVote","color":"yellow","italic":false}']}}
>>>>>>> v2.3.1
