...
execute if score @s stageIndexCalculator matches 1.. at @s run playsound minecraft:ui.button.click master @s
...
execute if score @s stageIndex matches 3 run function ssbrc:logic/pre_game/map_voting/stage_index/triggers/triggers/stages/3
