...
execute if entity @s[tag=palutenas_temple] run scoreboard players remove @e[type=minecraft:text_display,tag=voteCounter,tag=palutenas_temple,limit=1] mapVote 1
execute if entity @s[tag=planet_epp] run scoreboard players remove @e[type=minecraft:text_display,tag=voteCounter,tag=planet_epp,limit=1] mapVote 1
execute if entity @s[tag=planet_zebes] run scoreboard players remove @e[type=minecraft:text_display,tag=voteCounter,tag=planet_zebes,limit=1] mapVote 1
...
execute if entity @s[tag=sand_ocean] run scoreboard players remove @e[type=minecraft:text_display,tag=voteCounter,tag=sand_ocean,limit=1] mapVote 1
execute if entity @s[tag=saturn_valley] run scoreboard players remove @e[type=minecraft:text_display,tag=voteCounter,tag=saturn_valley,limit=1] mapVote 1
execute if entity @s[tag=sector_z] run scoreboard players remove @e[type=minecraft:text_display,tag=voteCounter,tag=sector_z,limit=1] mapVote 1
execute if entity @s[tag=shadow_moses_island] run scoreboard players remove @e[type=minecraft:text_display,tag=voteCounter,tag=shadow_moses_island,limit=1] mapVote 1
execute if entity @s[tag=spear_pillar] run scoreboard players remove @e[type=minecraft:text_display,tag=voteCounter,tag=spear_pillar,limit=1] mapVote 1
execute if entity @s[tag=suzaku_castle] run scoreboard players remove @e[type=minecraft:text_display,tag=voteCounter,tag=suzaku_castle,limit=1] mapVote 1
execute if entity @s[tag=tower_of_fate] run scoreboard players remove @e[type=minecraft:text_display,tag=voteCounter,tag=tower_of_fate,limit=1] mapVote 1
execute if entity @s[tag=wily_castle] run scoreboard players remove @e[type=minecraft:text_display,tag=voteCounter,tag=wily_castle,limit=1] mapVote 1
execute if entity @s[tag=yggdrasils_altar] run scoreboard players remove @e[type=minecraft:text_display,tag=voteCounter,tag=yggdrasils_altar,limit=1] mapVote 1
