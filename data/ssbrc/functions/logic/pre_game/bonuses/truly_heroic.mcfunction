...
execute if entity @s[team=team1] store result score #heroes temp if entity @a[predicate=ssbrc:characters/alignment/hero,team=team1]
execute if entity @s[team=team2] store result score #heroes temp if entity @a[predicate=ssbrc:characters/alignment/hero,team=team2]
execute if entity @s[team=team3] store result score #heroes temp if entity @a[predicate=ssbrc:characters/alignment/hero,team=team3]
execute if entity @s[team=team4] store result score #heroes temp if entity @a[predicate=ssbrc:characters/alignment/hero,team=team4]
execute if entity @s[team=team5] store result score #heroes temp if entity @a[predicate=ssbrc:characters/alignment/hero,team=team5]
execute if entity @s[team=team6] store result score #heroes temp if entity @a[predicate=ssbrc:characters/alignment/hero,team=team6]
