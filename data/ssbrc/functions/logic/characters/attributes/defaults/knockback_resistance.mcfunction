...
attribute @s[predicate=ssbrc:characters/knockback_resistance/low] minecraft:generic.knockback_resistance base set 0.25
attribute @s[predicate=ssbrc:characters/knockback_resistance/medium] minecraft:generic.knockback_resistance base set 0.4
attribute @s[predicate=ssbrc:characters/knockback_resistance/full] minecraft:generic.knockback_resistance base set 1.0
