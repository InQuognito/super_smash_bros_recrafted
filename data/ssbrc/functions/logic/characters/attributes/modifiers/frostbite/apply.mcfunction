...
execute if score @s frostbite matches 2 run attribute @s generic.attack_speed modifier add 19192183-0000-0000-0002-000000000002 "frostbite.attackSpeed.2" -0.03 multiply_base
