...
execute if score @s[tag=darksamus] fallDistance matches 500.. anchored feet run function ssbrc:series/metroid/darksamus/logic/abilities/phazon_spike/activate
