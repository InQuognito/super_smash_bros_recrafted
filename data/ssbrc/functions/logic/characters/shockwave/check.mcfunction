...
execute if score @s[predicate=ssbrc:characters/weight/heavy,predicate=!ssbrc:characters/weight/very_heavy] fallDistance matches 801.. anchored feet run function ssbrc:logic/characters/shockwave/medium
...
execute if score @s[tag=darksamus,predicate=ssbrc:flag/sneaking] fallDistance matches 500.. anchored feet run function ssbrc:series/metroid/darksamus/logic/phazon_spike/activate
