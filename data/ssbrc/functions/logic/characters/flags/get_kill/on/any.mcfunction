...
execute if score $gameStage temp matches 4 if entity @s[tag=joker] if predicate ssbrc:random_chance/70 run function ssbrc:series/persona/joker/logic/masks/get
