...
execute if score $gameStage temp matches 4 if entity @s[tag=byleth,tag=byleth.weaponBroken] run scoreboard players add @s charge.2 2
...
execute if score $gameStage temp matches 4 if entity @s[tag=zelda] run function ssbrc:series/the_legend_of_zelda/zelda/logic/rupee_gain/player
