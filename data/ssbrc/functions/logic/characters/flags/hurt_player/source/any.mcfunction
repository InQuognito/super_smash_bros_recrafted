execute if score $gameStage temp matches 4 if score $playersAlive temp matches 3.. if score @s bully matches 1.. run function ssbrc:logic/characters/bonuses/bully
