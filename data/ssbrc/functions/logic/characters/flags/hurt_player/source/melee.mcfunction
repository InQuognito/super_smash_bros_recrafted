...
execute if score $gameStage temp matches 4 if entity @s[tag=sora,tag=anti] run function ssbrc:series/kingdom_hearts/sora/logic/drive_forms/anti/slash/start
