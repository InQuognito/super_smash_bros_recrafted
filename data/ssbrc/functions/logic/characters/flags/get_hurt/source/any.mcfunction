...
execute if score $gameStage temp matches 4 if entity @s[tag=pikachu,tag=balloonRing,scores={charge.1=1..}] run function ssbrc:series/pokemon/pikachu/get_hurt
