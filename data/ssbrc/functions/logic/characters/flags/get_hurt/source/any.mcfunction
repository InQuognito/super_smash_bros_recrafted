...
execute if score $gameStage temp matches 4 if entity @s[tag=zelda,nbt={SelectedItem:{tag:{emerald:1}}}] if predicate ssbrc:random_chance/30 run function ssbrc:logic/characters/effects/poison
