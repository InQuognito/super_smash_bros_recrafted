...
tellraw @s [{"translate":"ssbrc.pokemon.nature","color":"gold"},{"translate":"ssbrc.pokemon.natures.quiet","color":"yellow","hoverEvent":{"action":"show_text","contents":"+10% SpA, -10% Spe"}}]
