...
execute if score @s damage.fireball matches 1 run summon minecraft:area_effect_cloud ~ ~ ~ {Tags:["fireball","damage"],Radius:0.7f,Duration:10,Effects:[{Id:7b,Amplifier:0b,Duration:1,ShowParticles:0b},{Id:20b,Amplifier:1b,Duration:60,ShowParticles:0b}]}
