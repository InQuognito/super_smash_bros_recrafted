...
execute if entity @e[tag=!self,tag=!motionSensorBomb,type=#ssbrc:projectiles,predicate=!ssbrc:entity_kill_exceptions,distance=..1] run function ssbrc:items/motion_sensor_bomb/explode
