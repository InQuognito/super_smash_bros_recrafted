...
execute if score random.output temp matches 0 run summon minecraft:item_display -568.5 19.6 -123.5 {Tags:["staticObject","metapod"],Rotation:[-135f,0f],item:{id:"minecraft:diamond",Count:1b,tag:{CustomModelData:110}}}
execute if score random.output temp matches 1 run summon minecraft:item_display -578.5 19.6 -128.5 {Tags:["staticObject","metapod"],Rotation:[-110f,0f],item:{id:"minecraft:diamond",Count:1b,tag:{CustomModelData:110}}}
...
# Snorlax
summon minecraft:item_display -560.5 13.0 -123.5 {Tags:["staticObject","snorlax"],Rotation:[90f,0f],item:{id:"minecraft:diamond",Count:1b,tag:{CustomModelData:1430}},transformation:[2f,0f,0f,0f,0f,2f,0f,0f,0f,0f,2f,0f,0f,0f,0f,1f]}
