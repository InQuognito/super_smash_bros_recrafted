...
scoreboard players set pallet_town stage 1
...
execute if score random.output temp matches 0 run summon minecraft:item_display -568.5 19.6 -123.5 {Tags:["static_object","metapod"],Rotation:[-135f,0f],item:{id:"minecraft:diamond",components:{"minecraft:custom_model_data":110}}}
execute if score random.output temp matches 1 run summon minecraft:item_display -578.5 19.6 -128.5 {Tags:["static_object","metapod"],Rotation:[-110f,0f],item:{id:"minecraft:diamond",components:{"minecraft:custom_model_data":110}}}
...
# Abra
summon minecraft:item_display -545.5 24.0 -156.5 {Tags:["static_object","abra"],Rotation:[45f,0f],item:{id:"minecraft:diamond",components:{"minecraft:custom_model_data":630}},teleport_duration:1}
...
# Snorlax
summon minecraft:item_display -560.5 13.0 -123.5 {Tags:["static_object","snorlax"],Rotation:[90f,0f],item:{id:"minecraft:diamond",components:{"minecraft:custom_model_data":1430}},transformation:[2f,0f,0f,0f,0f,2f,0f,0f,0f,0f,2f,0f,0f,0f,0f,1f]}

# Rope
summon minecraft:item_display -553.0 16.25 -157.0 {Rotation:[90f,0f],item:{id:"minecraft:sugar",components:{"minecraft:custom_model_data":1351}},transformation:[2.5f,0f,0f,0f,0f,2.5f,0f,0f,0f,0f,2.5f,0f,0f,0f,0f,1f]}

# Misty's Bike
summon minecraft:item_display -603.0 13.45 -196.2 {Tags:["mistysBike"],Rotation:[-90f,0f],item:{id:"minecraft:sugar",components:{"minecraft:custom_model_data":1352}},transformation:[1f,0.2f,0f,0f,-0.2f,1f,0f,0f,0f,0f,1f,0f,0f,0f,0f,1f]}
