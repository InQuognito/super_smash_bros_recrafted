...
execute if entity @s[scores={team=1}] run scoreboard players add team1 points 1
execute if entity @s[scores={team=2}] run scoreboard players add team2 points 1
