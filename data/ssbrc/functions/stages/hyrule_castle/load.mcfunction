...
# Master Sword
summon minecraft:item_display 6826.5 26.75 273.5 {Tags:["master_sword"],Rotation:[-90f,0f],item:{id:"minecraft:nether_star",Count:1b,tag:{CustomModelData:721}},transformation:[-0.5f,-0.5f,0f,0f,0.5f,-0.5f,0f,0f,0f,0f,1f,0f,0f,0f,0f,1f]}
