...
execute if score result random matches 2 positioned 23287.5 5.0 8648.5 summon minecraft:armor_stand run function ssbrc:stages/pac_maze/logic/mrs_pac_maze/fruit/init
execute if score result random matches 3 positioned 23331.5 5.0 8648.5 summon minecraft:armor_stand run function ssbrc:stages/pac_maze/logic/mrs_pac_maze/fruit/init
