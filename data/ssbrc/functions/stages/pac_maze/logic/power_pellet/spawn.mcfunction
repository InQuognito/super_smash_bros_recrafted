...
execute if score pac_maze.type map matches 1 run function ssbrc:stages/pac_maze/logic/pac_maze/power_pellet/spawn
execute if score pac_maze.type map matches 2 run function ssbrc:stages/pac_maze/logic/mrs_pac_maze/power_pellet/spawn
