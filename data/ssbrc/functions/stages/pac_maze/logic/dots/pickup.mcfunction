...
execute if score pac_maze.type map matches 1 run playsound ssbrc:stages.pac_maze.pac_maze.munch player @a[predicate=ssbrc:ingame]
execute if score pac_maze.type map matches 2 run playsound ssbrc:stages.pac_maze.mrs_pac_maze.munch player @a[predicate=ssbrc:ingame]
