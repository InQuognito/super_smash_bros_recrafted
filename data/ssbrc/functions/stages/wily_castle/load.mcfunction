...
# Mural
summon minecraft:item_display 4990.5 12.5 5026.5 {Rotation:[0f,0f],item:{id:"minecraft:sugar",Count:1b,tag:{CustomModelData:1801}},brightness:{sky:15,block:15}}

# Dr. W's
summon minecraft:item_display 4913.01 13.5 5078.5 {Rotation:[-90f,0f],item:{id:"minecraft:sugar",Count:1b,tag:{CustomModelData:1802}},brightness:{sky:15,block:15}}
summon minecraft:item_display 4913.01 13.5 5087.5 {Rotation:[-90f,0f],item:{id:"minecraft:sugar",Count:1b,tag:{CustomModelData:1802}},brightness:{sky:15,block:15}}
summon minecraft:item_display 5019.99 15.5 5063.5 {Rotation:[90f,0f],item:{id:"minecraft:sugar",Count:1b,tag:{CustomModelData:1802}},brightness:{sky:15,block:15}}
