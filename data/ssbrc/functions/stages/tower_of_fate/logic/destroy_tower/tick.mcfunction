...
execute if score towerOfFateDestroyedTimer temp matches 400 if score tower_of_fateClockworkTower temp matches 1 run function ssbrc:stages/tower_of_fate/logic/lower_towers/clockwork_tower/remove_scaffolding
