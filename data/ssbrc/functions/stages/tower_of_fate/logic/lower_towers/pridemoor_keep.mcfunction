...
summon minecraft:armor_stand 5993.5 13.0 500.5 {Tags:["staticObject","prideArmor"],Rotation:[270f,0f]}
summon minecraft:armor_stand 6007.5 13.0 500.5 {Tags:["staticObject","prideArmor"],Rotation:[90f,0f]}
execute as @e[type=minecraft:armor_stand,tag=prideArmor] run function ssbrc:stages/tower_of_fate/logic/lower_towers/pridemoor_keep/armor_stands/init
