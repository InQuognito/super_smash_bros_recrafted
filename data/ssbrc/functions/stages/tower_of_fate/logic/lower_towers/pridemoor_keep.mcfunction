...
summon minecraft:armor_stand 5993.5 13.0 500.5 {Tags:["decorObject","prideArmor"],Rotation:[270f,0f]}
summon minecraft:armor_stand 6007.5 13.0 500.5 {Tags:["decorObject","prideArmor"],Rotation:[90f,0f]}
