...
execute if entity @s[scores={temp=252..280}] positioned ^ ^2.5 ^6 run particle minecraft:dust_color_transition{from_color:[1.0,0.75,0.0],to_color:[1.0,1.0,1.0],scale:4.0} ~ ~ ~ 0.0 0.0 0.0 0.5 1 normal @a
