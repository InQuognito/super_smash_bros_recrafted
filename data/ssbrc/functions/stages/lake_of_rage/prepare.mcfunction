...
execute as @e[type=minecraft:item_display,tag=geodude] if predicate ssbrc:shiny_chance run item replace entity @s container.0 with minecraft:diamond{CustomModelData:741}
execute as @e[type=minecraft:item_display,tag=lapras] if predicate ssbrc:shiny_chance run item replace entity @s container.0 with minecraft:diamond{CustomModelData:1311}
execute as @e[type=minecraft:item_display,tag=slowpoke] if predicate ssbrc:shiny_chance run item replace entity @s container.0 with minecraft:diamond{CustomModelData:791}
execute as @e[type=minecraft:item_display,tag=sudowoodo] if predicate ssbrc:shiny_chance run item replace entity @s container.0 with minecraft:diamond{CustomModelData:1851}
