...
loot replace entity @s[advancements={ssbrc:fighters/wolf/skins/default=true}] enderchest.11 loot ssbrc:ui/shop/fighters/wolf/owned

execute if score @s[advancements={ssbrc:fighters/jigglypuff/skins/default=false}] stats.credits < #price.fighter.common vars run loot replace entity @s enderchest.12 loot ssbrc:ui/shop/fighters/jigglypuff/cannot_afford
execute if score @s[advancements={ssbrc:fighters/jigglypuff/skins/default=false}] stats.credits >= #price.fighter.common vars run loot replace entity @s enderchest.12 loot ssbrc:ui/shop/fighters/jigglypuff/unowned
loot replace entity @s[advancements={ssbrc:fighters/jigglypuff/skins/default=true}] enderchest.12 loot ssbrc:ui/shop/fighters/jigglypuff/owned

execute if score @s[advancements={ssbrc:fighters/greninja/skins/default=false}] stats.credits < #price.fighter.common vars run loot replace entity @s enderchest.13 loot ssbrc:ui/shop/fighters/greninja/cannot_afford
...
loot replace entity @s[advancements={ssbrc:fighters/giegue/skins/default=true}] enderchest.15 loot ssbrc:ui/shop/fighters/giegue/owned

execute if score @s[advancements={ssbrc:fighters/byleth/skins/default=false}] stats.credits < #price.fighter.common vars run loot replace entity @s enderchest.20 loot ssbrc:ui/shop/fighters/byleth/cannot_afford
execute if score @s[advancements={ssbrc:fighters/byleth/skins/default=false}] stats.credits >= #price.fighter.common vars run loot replace entity @s enderchest.20 loot ssbrc:ui/shop/fighters/byleth/unowned
loot replace entity @s[advancements={ssbrc:fighters/byleth/skins/default=true}] enderchest.20 loot ssbrc:ui/shop/fighters/byleth/owned

execute if score @s[advancements={ssbrc:fighters/shadow/skins/default=false}] stats.credits < #price.fighter.common vars run loot replace entity @s enderchest.21 loot ssbrc:ui/shop/fighters/shadow/cannot_afford
execute if score @s[advancements={ssbrc:fighters/shadow/skins/default=false}] stats.credits >= #price.fighter.common vars run loot replace entity @s enderchest.21 loot ssbrc:ui/shop/fighters/shadow/unowned
loot replace entity @s[advancements={ssbrc:fighters/shadow/skins/default=true}] enderchest.21 loot ssbrc:ui/shop/fighters/shadow/owned

execute if score @s[advancements={ssbrc:fighters/rob/skins/default=false}] stats.credits < #price.fighter.common vars run loot replace entity @s enderchest.22 loot ssbrc:ui/shop/fighters/rob/cannot_afford
execute if score @s[advancements={ssbrc:fighters/rob/skins/default=false}] stats.credits >= #price.fighter.common vars run loot replace entity @s enderchest.22 loot ssbrc:ui/shop/fighters/rob/unowned
loot replace entity @s[advancements={ssbrc:fighters/rob/skins/default=true}] enderchest.22 loot ssbrc:ui/shop/fighters/rob/owned

execute if score @s[advancements={ssbrc:fighters/alucard/skins/default=false}] stats.credits < #price.fighter.common vars run loot replace entity @s enderchest.23 loot ssbrc:ui/shop/fighters/alucard/cannot_afford
execute if score @s[advancements={ssbrc:fighters/alucard/skins/default=false}] stats.credits >= #price.fighter.common vars run loot replace entity @s enderchest.23 loot ssbrc:ui/shop/fighters/alucard/unowned
loot replace entity @s[advancements={ssbrc:fighters/alucard/skins/default=true}] enderchest.23 loot ssbrc:ui/shop/fighters/alucard/owned

execute if score @s[advancements={ssbrc:fighters/steve/skins/default=false}] stats.credits < #price.fighter.common vars run loot replace entity @s enderchest.24 loot ssbrc:ui/shop/fighters/steve/cannot_afford
execute if score @s[advancements={ssbrc:fighters/steve/skins/default=false}] stats.credits >= #price.fighter.common vars run loot replace entity @s enderchest.24 loot ssbrc:ui/shop/fighters/steve/unowned
loot replace entity @s[advancements={ssbrc:fighters/steve/skins/default=true}] enderchest.24 loot ssbrc:ui/shop/fighters/steve/owned
