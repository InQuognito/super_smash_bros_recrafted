...
execute if score @s[advancements={ssbrc:fighters/kingkrool/skins/default=false}] stats.credits < #price.fighter.common vars run loot replace entity @s enderchest.3 loot ssbrc:ui/shop/fighters/kingkrool/cannot_afford
execute if score @s[advancements={ssbrc:fighters/kingkrool/skins/default=false}] stats.credits >= #price.fighter.common vars run loot replace entity @s enderchest.3 loot ssbrc:ui/shop/fighters/kingkrool/unowned
loot replace entity @s[advancements={ssbrc:fighters/kingkrool/skins/default=true}] enderchest.3 loot ssbrc:ui/shop/fighters/kingkrool/owned
...
execute if score @s[advancements={ssbrc:fighters/darksamus/skins/default=false}] stats.credits < #price.fighter.common vars run loot replace entity @s enderchest.5 loot ssbrc:ui/shop/fighters/darksamus/cannot_afford
execute if score @s[advancements={ssbrc:fighters/darksamus/skins/default=false}] stats.credits >= #price.fighter.common vars run loot replace entity @s enderchest.5 loot ssbrc:ui/shop/fighters/darksamus/unowned
loot replace entity @s[advancements={ssbrc:fighters/darksamus/skins/default=true}] enderchest.5 loot ssbrc:ui/shop/fighters/darksamus/owned
...
execute if score @s[advancements={ssbrc:fighters/teamrocket/skins/default=false}] stats.credits < #price.fighter.common vars run loot replace entity @s enderchest.13 loot ssbrc:ui/shop/fighters/teamrocket/cannot_afford
execute if score @s[advancements={ssbrc:fighters/teamrocket/skins/default=false}] stats.credits >= #price.fighter.common vars run loot replace entity @s enderchest.13 loot ssbrc:ui/shop/fighters/teamrocket/unowned
loot replace entity @s[advancements={ssbrc:fighters/teamrocket/skins/default=true}] enderchest.13 loot ssbrc:ui/shop/fighters/teamrocket/owned
