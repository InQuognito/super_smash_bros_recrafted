...
item replace entity @s enderchest.11 with minecraft:barrier{ui:{id:"navigation.fighters.1",sound:"click"},CustomModelData:1820,HideFlags:127,display:{Name:'{"translate":"Fighters","color":"green","italic":false}',Lore:['""','{"translate":"Click to open","color":"yellow","italic":false}']}}
