data modify storage ssbrc:data ui merge value {path:"shop/pages/skins/yar",name:"yar",ui_color:"green"}
function ssbrc:logic/ui/reset with storage ssbrc:data ui

function ssbrc:logic/ui/buttons/placeholder/get {slot:"0"}
function ssbrc:logic/ui/buttons/navigator {path:"shop/pages/skins/3",type:"back",slot:"9"}
function ssbrc:logic/ui/buttons/placeholder/get {slot:"18"}

function ssbrc:shop/buttons/skin/get {skin:"player_2",slot:"2"}
function ssbrc:shop/buttons/skin/get {skin:"recruit",slot:"3"}
