data modify storage ssbrc:data shop merge value {page:"skins/snake",name:"snake",ui_color:"lime"}
...
function ssbrc:shop/buttons/skin/get {skin:"classic_tuxedo",slot:"2"}
function ssbrc:shop/buttons/skin/get {skin:"iroquois_pliskin",slot:"3"}
