data modify storage ssbrc:data shop merge value {page:"skins/snake",ui_color:"lime"}
...
function ssbrc:shop/contents/skin {name:"snake",skin:"classic_tuxedo",slot:"2"}
function ssbrc:shop/contents/skin {name:"snake",skin:"iroquois_pliskin",slot:"3"}
