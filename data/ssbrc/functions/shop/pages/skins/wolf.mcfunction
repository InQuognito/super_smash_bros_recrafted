data modify storage ssbrc:data ui merge value {path:"shop/pages/skins/wolf",name:"wolf",ui_color:"yellow"}
...
function ssbrc:shop/buttons/skin/get {skin:"assault",slot:"2"}
