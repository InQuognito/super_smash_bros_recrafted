data modify storage ssbrc:data ui merge value {path:"shop/pages/skins/link",name:"link",ui_color:"yellow"}
...
function ssbrc:shop/buttons/skin/get {skin:"dark_link",slot:"2"}
function ssbrc:shop/buttons/skin/get {skin:"goron_tunic",slot:"3"}
function ssbrc:shop/buttons/skin/get {skin:"zora_tunic",slot:"4"}
