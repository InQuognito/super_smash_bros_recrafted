data modify storage ssbrc:data shop merge value {page:"skins/rob",ui_color:"lime"}
...
function ssbrc:shop/contents/skin {name:"rob",skin:"ancient_minister",slot:"2"}
function ssbrc:shop/contents/skin {name:"rob",skin:"famicom",slot:"3"}
