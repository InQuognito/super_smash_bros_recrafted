data modify storage ssbrc:data shop merge value {page:"skins/pokemon_trainer",ui_color:"lime"}
...
function ssbrc:shop/contents/skin {name:"pokemon_trainer",skin:"dawn",slot:"2"}
function ssbrc:shop/contents/skin {name:"pokemon_trainer",skin:"victor",slot:"3"}
