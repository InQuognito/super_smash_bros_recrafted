...
execute if score @s[advancements={ssbrc:series/the_legend_of_zelda/ganondorf/skins/ocarina_of_time=false}] stats.credits < #price.skin.common vars run loot replace entity @s enderchest.2 loot ssbrc:ui/shop/skins/ganondorf/ocarina_of_time/cannot_afford
...
execute if score @s[advancements={ssbrc:series/the_legend_of_zelda/ganondorf/skins/wind_waker=false}] stats.credits < #price.skin.common vars run loot replace entity @s enderchest.4 loot ssbrc:ui/shop/skins/ganondorf/wind_waker/cannot_afford
execute if score @s[advancements={ssbrc:series/the_legend_of_zelda/ganondorf/skins/wind_waker=false}] stats.credits >= #price.skin.common vars run loot replace entity @s enderchest.4 loot ssbrc:ui/shop/skins/ganondorf/wind_waker/unowned
loot replace entity @s[advancements={ssbrc:series/the_legend_of_zelda/ganondorf/skins/wind_waker=true}] enderchest.4 loot ssbrc:ui/shop/skins/ganondorf/wind_waker/owned
