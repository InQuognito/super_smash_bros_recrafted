data modify storage ssbrc:data shop merge value {page:"skins/mega_man",ui_color:"lime"}
...
function ssbrc:shop/contents/skin {name:"mega_man",skin:"star_force",slot:"2"}
