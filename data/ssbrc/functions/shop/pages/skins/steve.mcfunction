data modify storage ssbrc:data ui merge value {path:"shop/pages/skins/steve",name:"steve",ui_color:"lime"}
...
function ssbrc:shop/buttons/skin/get {skin:"alex",slot:"2"}
function ssbrc:shop/buttons/skin/get {skin:"herobrine",slot:"3"}
