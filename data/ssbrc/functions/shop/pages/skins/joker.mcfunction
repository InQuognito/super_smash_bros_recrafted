data modify storage ssbrc:data shop merge value {page:"skins/joker",ui_color:"lime"}
...
function ssbrc:shop/contents/skin {name:"joker",skin:"christmas_outfit",slot:"2"}
function ssbrc:shop/contents/skin {name:"joker",skin:"shujin_academy",slot:"3"}
