data modify storage ssbrc:data shop merge value {page:"skins/alucard",ui_color:"lime"}
...
function ssbrc:shop/contents/skin {name:"alucard",skin:"lords_of_shadow",slot:"2"}
