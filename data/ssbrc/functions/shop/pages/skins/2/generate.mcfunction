...
item replace entity @s[advancements={ssbrc:series/kingdom_hearts/sora/skins/default=true}] enderchest.5 with minecraft:barrier{ui:{id:"navigation.skins.sora",sound:"click"},CustomModelData:1560,display:{Name:'{"translate":"Sora","color":"white","italic":false}',Lore:['""','{"translate":"ssbrc.ui.clickToOpen","color":"yellow","italic":false}']}}
...
item replace entity @s[advancements={ssbrc:series/indie_fighters/steve/skins/default=true}] enderchest.6 with minecraft:barrier{ui:{id:"navigation.skins.steve",sound:"click"},CustomModelData:1580,display:{Name:'{"translate":"Steve","color":"dark_aqua","italic":false}',Lore:['""','{"translate":"ssbrc.ui.clickToOpen","color":"yellow","italic":false}']}}

item replace entity @s[advancements={ssbrc:series/star_fox/wolf/skins/default=false}] enderchest.11 with minecraft:barrier{UIPlaceHolder:1b,CustomModelData:1720,display:{Name:'{"translate":"Wolf","color":"dark_purple","italic":false}',Lore:['""','{"translate":"You do not own this fighter","color":"red","italic":false}']}}
item replace entity @s[advancements={ssbrc:series/star_fox/wolf/skins/default=true}] enderchest.11 with minecraft:barrier{ui:{id:"navigation.skins.wolf",sound:"click"},CustomModelData:1720,display:{Name:'{"translate":"Wolf","color":"dark_purple","italic":false}',Lore:['""','{"translate":"ssbrc.ui.clickToOpen","color":"yellow","italic":false}']}}
