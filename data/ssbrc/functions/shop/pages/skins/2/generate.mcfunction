...
item replace entity @s[advancements={ssbrc:series/star_fox/wolf/skins/default=false}] enderchest.11 with minecraft:barrier{UIPlaceHolder:1b,CustomModelData:1580,display:{Name:'{"translate":"Wolf","color":"dark_purple","italic":false}',Lore:['""','{"translate":"You do not own this fighter","color":"red","italic":false}']}}
item replace entity @s[advancements={ssbrc:series/star_fox/wolf/skins/default=true}] enderchest.11 with minecraft:barrier{ui:{id:"navigation.skins.wolf",sound:"click"},CustomModelData:1580,display:{Name:'{"translate":"Wolf","color":"dark_purple","italic":false}',Lore:['""','{"translate":"Click to open","color":"yellow","italic":false}']}}
