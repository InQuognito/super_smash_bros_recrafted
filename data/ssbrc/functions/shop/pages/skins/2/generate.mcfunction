...
item replace entity @s[advancements={ssbrc:series/dragon_quest/hero/skins/default=false}] enderchest.6 with minecraft:barrier{UIPlaceHolder:1b,CustomModelData:440,display:{Name:'{"translate":"ssbrc.fighters.hero","color":"yellow","italic":false}',Lore:['""','{"translate":"ssbrc.fighterSelect.unowned","color":"red","italic":false}']}}
item replace entity @s[advancements={ssbrc:series/dragon_quest/hero/skins/default=true}] enderchest.6 with minecraft:barrier{ui:{id:"navigation.skins.hero",sound:"click"},CustomModelData:440,display:{Name:'{"translate":"ssbrc.fighters.hero","color":"yellow","italic":false}',Lore:['""','{"translate":"ssbrc.ui.clickToOpen","color":"yellow","italic":false}']}}
...
item replace entity @s[advancements={ssbrc:series/kingdom_hearts/sora/skins/default=false}] enderchest.12 with minecraft:barrier{UIPlaceHolder:1b,CustomModelData:1560,display:{Name:'{"translate":"ssbrc.fighters.sora","color":"white","italic":false}',Lore:['""','{"translate":"ssbrc.fighterSelect.unowned","color":"red","italic":false}']}}
item replace entity @s[advancements={ssbrc:series/kingdom_hearts/sora/skins/default=true}] enderchest.12 with minecraft:barrier{ui:{id:"navigation.skins.sora",sound:"click"},CustomModelData:1560,display:{Name:'{"translate":"ssbrc.fighters.sora","color":"white","italic":false}',Lore:['""','{"translate":"ssbrc.ui.clickToOpen","color":"yellow","italic":false}']}}

item replace entity @s[advancements={ssbrc:series/indie_fighters/shovelknight/skins/default=false}] enderchest.13 with minecraft:barrier{UIPlaceHolder:1b,CustomModelData:1920,display:{Name:'{"translate":"ssbrc.fighters.shovelknight","color":"dark_aqua","italic":false}',Lore:['""','{"translate":"ssbrc.fighterSelect.unowned","color":"red","italic":false}']}}
item replace entity @s[advancements={ssbrc:series/indie_fighters/shovelknight/skins/default=true}] enderchest.13 with minecraft:barrier{ui:{id:"navigation.skins.shovelknight",sound:"click"},CustomModelData:1920,display:{Name:'{"translate":"ssbrc.fighters.shovelknight","color":"dark_aqua","italic":false}',Lore:['""','{"translate":"ssbrc.ui.clickToOpen","color":"yellow","italic":false}']}}

item replace entity @s[advancements={ssbrc:series/retro_fighters/yar/skins/default=false}] enderchest.14 with minecraft:barrier{UIPlaceHolder:1b,CustomModelData:1960,display:{Name:'{"translate":"ssbrc.fighters.yar","color":"red","italic":false}',Lore:['""','{"translate":"ssbrc.fighterSelect.unowned","color":"red","italic":false}']}}
item replace entity @s[advancements={ssbrc:series/retro_fighters/yar/skins/default=true}] enderchest.14 with minecraft:barrier{ui:{id:"navigation.skins.yar",sound:"click"},CustomModelData:1960,display:{Name:'{"translate":"ssbrc.fighters.yar","color":"red","italic":false}',Lore:['""','{"translate":"ssbrc.ui.clickToOpen","color":"yellow","italic":false}']}}
