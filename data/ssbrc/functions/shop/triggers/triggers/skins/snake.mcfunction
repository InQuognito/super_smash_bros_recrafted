...
execute store result score @s shop.selector run clear @s #ssbrc:ui/buttons{ui:{id:"skins.snake.classic_tuxedo"}}
execute if score @s shop.selector matches 1.. run function ssbrc:shop/contents/skins/snake/classic_tuxedo

execute store result score @s shop.selector run clear @s #ssbrc:ui/buttons{ui:{id:"skins.snake.iroquois_pliskin"}}
