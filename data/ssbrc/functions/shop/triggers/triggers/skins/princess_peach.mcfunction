...
execute store result score @s shopCalculator run clear @s #ssbrc:ui/buttons{ui:{id:"skins.princessPeach.flowerPower"}}
execute if score @s shopCalculator matches 1.. run function ssbrc:shop/contents/skins/princess_peach/flower_power

execute store result score @s shopCalculator run clear @s #ssbrc:ui/buttons{ui:{id:"skins.princessPeach.shadowQueen"}}
