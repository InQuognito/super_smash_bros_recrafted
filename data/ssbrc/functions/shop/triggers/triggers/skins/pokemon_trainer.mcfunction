...
execute store result score @s shop.selector run clear @s #ssbrc:ui/buttons{ui:{id:"skins.pokemon_trainer.dawn"}}
execute if score @s shop.selector matches 1.. run function ssbrc:shop/contents/skins/pokemon_trainer/dawn

execute store result score @s shop.selector run clear @s #ssbrc:ui/buttons{ui:{id:"skins.pokemon_trainer.victor"}}
