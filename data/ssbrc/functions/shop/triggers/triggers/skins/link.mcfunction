...
execute store result score @s shop.selector run clear @s #ssbrc:ui/buttons{ui:{id:"skins.link.dark_link"}}
execute if score @s shop.selector matches 1.. run function ssbrc:shop/contents/skins/link/dark_link

execute store result score @s shop.selector run clear @s #ssbrc:ui/buttons{ui:{id:"skins.link.goron_tunic"}}
execute if score @s shop.selector matches 1.. run function ssbrc:shop/contents/skins/link/goron_tunic

execute store result score @s shop.selector run clear @s #ssbrc:ui/buttons{ui:{id:"skins.link.zora_tunic"}}
