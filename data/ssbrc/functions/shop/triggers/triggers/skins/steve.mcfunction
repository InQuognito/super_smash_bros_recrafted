...
execute store result score @s shop.selector run clear @s #ssbrc:ui/buttons{ui:{id:"skins.steve.alex"}}
execute if score @s shop.selector matches 1.. run function ssbrc:shop/contents/skins/steve/alex

execute store result score @s shop.selector run clear @s #ssbrc:ui/buttons{ui:{id:"skins.steve.herobrine"}}
