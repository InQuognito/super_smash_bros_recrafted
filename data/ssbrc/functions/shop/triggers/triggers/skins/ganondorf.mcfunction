...
execute store result score @s shop.selector run clear @s #ssbrc:ui/buttons{ui:{id:"skins.ganondorf.ocarina_of_time"}}
execute if score @s shop.selector matches 1.. run function ssbrc:shop/contents/skins/ganondorf/ocarina_of_time

execute store result score @s shop.selector run clear @s #ssbrc:ui/buttons{ui:{id:"skins.ganondorf.tears_of_the_kingdom"}}
execute if score @s shop.selector matches 1.. run function ssbrc:shop/contents/skins/ganondorf/tears_of_the_kingdom

execute store result score @s shop.selector run clear @s #ssbrc:ui/buttons{ui:{id:"skins.ganondorf.wind_waker"}}
