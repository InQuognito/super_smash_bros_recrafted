...
execute store result score @s shop.selector run clear @s #ssbrc:ui/buttons{ui:{id:"skins.hero.erdrick"}}
execute if score @s shop.selector matches 1.. run function ssbrc:shop/contents/skins/hero/erdrick

execute store result score @s shop.selector run clear @s #ssbrc:ui/buttons{ui:{id:"skins.hero.rek"}}
execute if score @s shop.selector matches 1.. run function ssbrc:shop/contents/skins/hero/rek

execute store result score @s shop.selector run clear @s #ssbrc:ui/buttons{ui:{id:"skins.hero.sofia"}}
