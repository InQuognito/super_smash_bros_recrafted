...
execute store result score @s shop.selector run clear @s #ssbrc:ui/buttons{ui:{id:"skins.rob.ancient_minister"}}
execute if score @s shop.selector matches 1.. run function ssbrc:shop/contents/skins/rob/ancient_minister

execute store result score @s shop.selector run clear @s #ssbrc:ui/buttons{ui:{id:"skins.rob.famicom"}}
