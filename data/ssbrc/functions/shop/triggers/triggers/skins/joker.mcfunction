...
execute if score @s shopCalculator matches 1.. run function ssbrc:shop/contents/skins/joker/christmas_outfit

execute store result score @s shopCalculator run clear @s #ssbrc:ui/buttons{ui:{id:"skins.joker.shujinAcademy"}}
execute if score @s shopCalculator matches 1.. run function ssbrc:shop/contents/skins/joker/shujin_academy
