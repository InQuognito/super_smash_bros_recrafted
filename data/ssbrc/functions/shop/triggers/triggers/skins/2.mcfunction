...
execute store result score @s shopCalculator run clear @s #ssbrc:ui/buttons{ui:{id:"navigation.skins.pit"}}
execute if score @s shopCalculator matches 1.. run function ssbrc:shop/pages/skins/pit/load
...
execute store result score @s shopCalculator run clear @s #ssbrc:ui/buttons{ui:{id:"navigation.skins.mega_man"}}
execute if score @s shopCalculator matches 1.. run function ssbrc:shop/pages/skins/mega_man/load
