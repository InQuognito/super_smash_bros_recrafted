...
execute store result score @s shopCalculator run clear @s #ssbrc:ui/buttons{ui:{id:"peach"}}
execute if score @s shopCalculator matches 1.. run function ssbrc:shop/contents/fighters/peach
...
execute store result score @s shopCalculator run clear @s #ssbrc:ui/buttons{ui:{id:"jigglypuff"}}
execute if score @s shopCalculator matches 1.. run function ssbrc:shop/contents/fighters/jigglypuff
...
execute store result score @s shopCalculator run clear @s #ssbrc:ui/buttons{ui:{id:"shadow"}}
execute if score @s shopCalculator matches 1.. run function ssbrc:shop/contents/fighters/shadow

execute store result score @s shopCalculator run clear @s #ssbrc:ui/buttons{ui:{id:"rob"}}
execute if score @s shopCalculator matches 1.. run function ssbrc:shop/contents/fighters/rob
