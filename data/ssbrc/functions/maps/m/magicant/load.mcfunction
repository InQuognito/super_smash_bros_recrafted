...
# Armor Stands
summon minecraft:armor_stand 647.5 23.0 -865.5 {Tags:["propStand","jeff"],NoGravity:1b,Rotation:[180f,0f],Pose:{RightArm:[333f,21f,0f],LeftArm:[10f,344f,28f]}}
summon minecraft:armor_stand 659.5 23.0 -866.7 {Tags:["propStand","paula"],NoGravity:1b,Rotation:[132f,0f],Pose:{RightArm:[337f,333f,344f],LeftLeg:[6f,0f,0f],LeftArm:[341f,25f,17f],RightLeg:[352f,0f,0f]}}
