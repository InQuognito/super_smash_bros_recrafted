...
# Armor Stands
summon minecraft:armor_stand 647.417 23.0 -865.695 {Tags:["propStand","jeff"],Rotation:[2f,0f],Pose:{RightArm:[333f,21f,0f],LeftArm:[10f,344f,28f]}}
summon minecraft:armor_stand 659.585 23.0 -866.7 {Tags:["propStand","paula"],Rotation:[132f,0f],Pose:{RightArm:[337f,333f,344f],LeftLeg:[6f,0f,0f],LeftArm:[341f,25f,17f],RightLeg:[352f,0f,0f]}}
