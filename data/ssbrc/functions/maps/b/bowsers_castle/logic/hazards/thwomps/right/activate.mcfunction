summon minecraft:armor_stand -702.0 44.0 822.5 {Tags:["thwomp","right"],Rotation:[0f,0f],ArmorItems:[{},{},{},{id:"minecraft:sugar",Count:1b,tag:{CustomModelData:156}}],Invisible:1b}
