...
execute if score result random matches 3 unless score #bowsersCastleHazard temp matches 1 unless score #thwompMiddle temp matches 1 run function ssbrc:maps/b/bowsers_castle/logic/hazards/thwomps/middle/activate
