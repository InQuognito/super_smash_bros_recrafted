...
execute if score @s[y=45.5,dy=0] temp >= thwompTime vars run function ssbrc:maps/b/bowsers_castle/logic/hazards/thwomps/middle/deactivate
...
execute if score @s[tag=sinking] temp >= thwompSinkTime vars run function ssbrc:maps/b/bowsers_castle/logic/hazards/thwomps/middle/deactivate
