...
execute if score @s[tag=!sinking] temp >= #bowsersCastle.thwompTime vars positioned ~ ~3.1 ~ run function ssbrc:maps/b/bowsers_castle/logic/hazards/thwomps/move_upward
