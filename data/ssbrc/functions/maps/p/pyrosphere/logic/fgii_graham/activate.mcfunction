summon minecraft:bee 673.5 36.5 8007.5 {Tags:["fgiiGraham","modifyEntity"],Passengers:[{id:"minecraft:armor_stand",Tags:["fgiiGraham.display","modifyPassenger"],Invisible:1b}],Health:20,NoAI:1b,NoGravity:1b,PersistenceRequired:1b,Silent:1b,Attributes:[{Name:"generic.max_health",Base:20d}]}
