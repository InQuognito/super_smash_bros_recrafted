...
execute if score $hazards options matches 1 as @e[type=item_display,tag=fiendsCauldron,sort=nearest,limit=1] at @s run function ssbrc:maps/p/palutenas_temple/logic/fiends_cauldron/tick
