...
execute if score @s fiendsCauldron matches 1 run attribute @s minecraft:generic.attack_damage modifier add fb55290d-9b2d-4305-88e1-71ffc16cdb03 "fiendsCauldron.strength.1" 1.0 add
...
execute if score @s fiendsCauldron matches 2 run attribute @s minecraft:generic.attack_damage modifier add fb55290d-9b2d-4305-88e1-71ffc16cdb03 "fiendsCauldron.strength.2" 2.0 add
...
execute if score @s fiendsCauldron matches 3 run attribute @s minecraft:generic.attack_damage modifier add fb55290d-9b2d-4305-88e1-71ffc16cdb03 "fiendsCauldron.strength.3" 3.0 add
...
execute if score @s fiendsCauldron matches 4.. run attribute @s minecraft:generic.attack_damage modifier add fb55290d-9b2d-4305-88e1-71ffc16cdb03 "fiendsCauldron.strength.4" 4.0 add
