execute if score hazards options matches 1 if predicate ssbrc:random_chance/yars_revenge_hazard run function ssbrc:maps/p/planet_epp/logic/hazards/choose
