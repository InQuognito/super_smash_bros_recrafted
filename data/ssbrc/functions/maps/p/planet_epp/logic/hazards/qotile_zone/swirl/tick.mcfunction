...
execute unless block ^ ^ ^0.5 #ssbrc:passthrough unless block ^ ^ ^0.5 minecraft:red_stained_glass run function ssbrc:maps/p/planet_epp/logic/hazards/qotile_zone/swirl/explode
