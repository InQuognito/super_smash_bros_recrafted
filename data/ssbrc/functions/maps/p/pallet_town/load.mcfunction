...
summon minecraft:armor_stand -552.5 18.0 -163.5 {Tags:["decorObject"],Invulnerable:1b,Rotation:[30f,0f],DisabledSlots:4144959,Pose:{LeftLeg:[0f,0f,358f],LeftArm:[28f,340f,0f],RightLeg:[0f,0f,4f],RightArm:[28f,12f,0f]},ArmorItems:[{id:"minecraft:leather_boots",tag:{display:{color:7293756}},Count:1b},{id:"minecraft:leather_leggings",tag:{display:{color:14527845}},Count:1b},{id:"minecraft:leather_chestplate",tag:{display:{color:11946575}},Count:1b},{id:"minecraft:player_head",Count:1b,tag:{display:{Name:'{"text":"Professor Oak"}'},SkullOwner:{Properties:{textures:[{Value:"eyJ0ZXh0dXJlcyI6eyJTS0lOIjp7InVybCI6Imh0dHA6Ly90ZXh0dXJlcy5taW5lY3JhZnQubmV0L3RleHR1cmUvM2U5NDRmMTRlNGY3NWU3ZWExOTAxM2FlNjNlMjlkMWNjNmVhNTkyNTkyOTA0OWQ4NzkyOWVkYTRlM2ZkYzdiOCJ9fX0="}]},Id:[I;736689370,-1871426504,-1747073693,-517479867]}}}],NoBasePlate:1b,ShowArms:1b}
