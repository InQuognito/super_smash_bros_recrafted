...
summon minecraft:armor_stand -603.0 13.0 -196.2 {Tags:["decorObject"],Rotation:[90f,0f],Pose:{LeftArm:[0f,0f,0f]},HandItems:[{},{id:"minecraft:sugar",Count:1b,tag:{CustomModelData:1351}}],ShowArms:1b,Invisible:1b,NoGravity:1b,DisabledSlots:4144959}
