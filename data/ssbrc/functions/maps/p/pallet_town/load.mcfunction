...
#Professor Oak
summon minecraft:armor_stand -551.426 17.5 -160.582 {Invulnerable:1b,ShowArms:1b,DisabledSlots:4144959,Pose:{RightArm:[333.0f,21.0f,0.0f],LeftLeg:[6.0f,0.0f,0.0f],LeftArm:[10.0f,344.0f,28.0f]},RightLeg:[352.0f,0.0f,0.0f]},Rotation:[132.0f,0.0f]}
#Misty
