...
# Brock
summon minecraft:armor_stand -551.5 17.0 -161.5 {Tags:["decorObject"],Invulnerable:1b,Rotation:[29f,0f],DisabledSlots:4144959,Pose:{LeftLeg:[357f,0f,0f],LeftArm:[311f,43f,19f],RightLeg:[5f,0f,0f],RightArm:[294f,301f,0f]},ArmorItems:[{id:"minecraft:leather_boots",tag:{display:{color:5529451}},Count:1b},{id:"minecraft:leather_leggings",tag:{display:{color:9200467}},Count:1b},{id:"minecraft:leather_chestplate",tag:{display:{color:7576634}},Count:1b},{id:"minecraft:player_head",tag:{display:{Name:'{"text":"Brock"}'},SkullOwner:{Id:[I;1404187014,-789036298,-1914764022,455758697],Properties:{textures:[{Value:"eyJ0ZXh0dXJlcyI6eyJTS0lOIjp7InVybCI6Imh0dHA6Ly90ZXh0dXJlcy5taW5lY3JhZnQubmV0L3RleHR1cmUvMjM4MmI0M2NhOGM0MWMxZTNjZGJmYTQ5N2QzODA3MWU3NGI1YzE5NGE2ZTdlNzc5MGFmOTk5NmY0NDk4MjAxZSJ9fX0="}]}}},Count:1b}],NoBasePlate:1b,ShowArms:1b}
