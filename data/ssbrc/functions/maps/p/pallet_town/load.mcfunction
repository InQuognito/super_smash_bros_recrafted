...
#Nurse Joy
summon armor_stand -553.441 14.93750 -159.561 {Invulnerable:1b,NoBasePlate:1b,ShowArms:1b,Rotation:[29f],ArmorItems:[{id:"leather_boots",Count:1b,tag:{display:{color:16777215}}},{id:"leather_leggings",Count:1b,tag:{display:{color:16777215}}},{id:"leather_chestplate",Count:1b,tag:{display:{color:16768493}}},{}],Pose:{LeftLeg:[357f,0f,0f],RightLeg:[5f,0f,0f],LeftArm:[312f,22f,0f],RightArm:[312f,339f,0f]}}
#Officer Jenny
