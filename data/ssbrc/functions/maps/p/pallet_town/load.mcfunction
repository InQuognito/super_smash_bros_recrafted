...
# Officer Jenny
summon minecraft:armor_stand -551.5 15.0 -158.5 {Tags:["decorObject"],Invulnerable:1b,Rotation:[29f,0f],ShowArms:1b,DisabledSlots:4144959,Pose:{RightArm:[330.0f,13.0f,0.0f],LeftLeg:[348.0f,0.0f,0.0f],LeftArm:[215.0f,352.0f,0.0f],RightLeg:[13.0f,0.0f,0.0f]},Rotation:[270.0f,0.0f],ArmorItems:[{id:"minecraft:leather_boots",Count:1b,tag:{display:{color:3096399}}},{id:"minecraft:leather_leggings",Count:1b,tag:{display:{color:5986733}}},{id:"minecraft:leather_chestplate",Count:1b,tag:{display:{color:5986733}}},{id:"minecraft:player_head",Count:1b,tag:{SkullOwner:{Properties:{textures:[{Value:"eyJ0ZXh0dXJlcyI6eyJTS0lOIjp7InVybCI6Imh0dHA6Ly90ZXh0dXJlcy5taW5lY3JhZnQubmV0L3RleHR1cmUvMzE2ODdiNjc5MjJlODY3YTY0YmQyMDFhM2RkMDhmYjE5MTEyMGEyYzNiZmRiZmFjMTZjZDI0YTQ2ODViOTE2YSJ9fX0"}]},Id:[I; 2055932220,618546984,-1337458658,812759000]}}}],NoBasePlate:1b}
