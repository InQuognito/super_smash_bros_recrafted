...
execute if score pacMazeType map matches 1 positioned 23336.0 5.0 8613.0 if entity @s[tag=!dead] unless entity @s[dx=45,dy=5,dz=55] run function ssbrc:maps/p/pac_maze/logic/ghosts/touch/kill_ghost
execute if score pacMazeType map matches 2 positioned 23284.0 5.0 8613.0 if entity @s[tag=!dead] unless entity @s[dx=50,dy=5,dz=55] run function ssbrc:maps/p/pac_maze/logic/ghosts/touch/kill_ghost
