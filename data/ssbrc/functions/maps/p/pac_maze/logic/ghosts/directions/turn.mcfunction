...
execute if score result random matches 2 unless entity @s[tag=turned] unless block ^1.0 ^7.0 ^ minecraft:red_concrete unless block ^-1.0 ^7.0 ^ minecraft:red_concrete unless block ^ ^7.0 ^1.0 minecraft:red_concrete at @s align xyz positioned ~.5 ~ ~.5 run function ssbrc:maps/p/pac_maze/logic/ghosts/directions/forward
