...
execute if score pacMazeType map matches 1 positioned 23360.5 6.5 8642.5 summon minecraft:item_display run function ssbrc:maps/p/pac_maze/logic/pac_maze/fruit/init
