...
execute as @e[tag=pacMaze.dot] at @s if entity @p[team=!spectator,distance=..0.5] run function ssbrc:maps/p/pac_maze/logic/dots/pickup
execute as @e[tag=pacMaze.pellet] at @s if entity @p[team=!spectator,distance=..0.5] run function ssbrc:maps/p/pac_maze/logic/pellets/pickup
