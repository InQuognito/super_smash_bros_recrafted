...
execute if score $hazards options matches 1 run summon minecraft:armor_stand 2120.5 17.0 1355.5 {Tags:["barrelCannon"],Rotation:[-60f,-80f],Pose:{Head:[10f,0f,0f]},ArmorItems:[{},{},{},{id:"minecraft:sugar",tag:{CustomModelData:501},Count:1b}],Invisible:1b,NoGravity:1b}
