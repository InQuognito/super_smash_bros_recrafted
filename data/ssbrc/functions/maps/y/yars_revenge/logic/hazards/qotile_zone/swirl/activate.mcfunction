...
execute unless entity @e[type=minecraft:marker,tag=swirl,sort=nearest,limit=1] run function ssbrc:maps/y/yars_revenge/logic/hazards/qotile_zone/swirl/activate
