...
summon minecraft:marker 6975.5 37.0 164.5 {Tags:["spawnpoint"]}
summon minecraft:marker 6972.5 37.0 203.5 {Tags:["spawnpoint"]}
...
summon minecraft:marker 7031.5 37.0 162.5 {Tags:["spawnpoint"]}
