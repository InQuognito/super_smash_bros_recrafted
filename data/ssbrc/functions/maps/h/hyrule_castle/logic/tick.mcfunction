execute if predicate ssbrc:random_chance/hyrule_castle_hazard run function ssbrc:maps/h/hyrule_castle/logic/hazards/choose
execute as @e[tag=tornado] at @s run function ssbrc:maps/h/hyrule_castle/logic/hazards/tornadoes/tick
