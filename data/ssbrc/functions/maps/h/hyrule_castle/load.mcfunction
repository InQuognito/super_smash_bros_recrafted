...
# Banners
summon minecraft:item_display 7012.5 33.0 225.9 {Rotation:[180f,0f],item:{id:"minecraft:sugar",tag:{CustomModelData:801},Count:1b},transformation:[2.5f,0f,0f,0f,0f,2.5f,0f,0f,0f,0f,2.5f,0f,0f,0f,0f,1f]}
summon minecraft:item_display 6968.5 33.0 225.9 {Rotation:[180f,0f],item:{id:"minecraft:sugar",tag:{CustomModelData:801},Count:1b},transformation:[2.5f,0f,0f,0f,0f,2.5f,0f,0f,0f,0f,2.5f,0f,0f,0f,0f,1f]}
