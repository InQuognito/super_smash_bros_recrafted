...
execute as @e[type=minecraft:item_display,tag=sudowoodo] if predicate ssbrc:shiny_chance run item replace entity @s hotbar.0 with minecraft:diamond{CustomModelData:1851}
