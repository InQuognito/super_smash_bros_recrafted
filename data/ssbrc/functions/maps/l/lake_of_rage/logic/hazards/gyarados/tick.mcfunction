...
execute if score @s temp matches 281..330 positioned ^ ^2.5 ^6 run function ssbrc:maps/l/lake_of_rage/logic/hazards/gyarados/hyper_beam/raycast/start
...
execute if score @s temp matches 621 run function ssbrc:maps/l/lake_of_rage/logic/hazards/gyarados/deactivate
