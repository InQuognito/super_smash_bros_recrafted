...
summon minecraft:armor_stand -5.0 25.0 274.0 {Tags:["propStand","espio"],Pose:{RightArm:[19f,352f,0f],LeftLeg:[342f,0f,0f],Head:[0f,181f,0f],LeftArm:[337f,359f,0f],RightLeg:[12f,0f,0f],Body:[0f,0f,0f]}}
...
summon minecraft:armor_stand 31.274 25.5 238.665 {Tags:["propStand","tails"],Rotation:[91f,0f],Pose:{RightArm:[31f,334f,0f],LeftLeg:[301f,0f,0f],LeftArm:[222f,341f,0f],RightLeg:[298f,0f,0f]}}
