...
summon minecraft:armor_stand -5.0 25.0 274.0 {Tags:["propStand","espio"],Pose:{RightArm:[19f,352f,0f],LeftLeg:[342f,0f,0f],Head:[0f,181f,0f],LeftArm:[337f,359f,0f],RightLeg:[12f,0f,0f],Body:[0,0f,0f]}}
