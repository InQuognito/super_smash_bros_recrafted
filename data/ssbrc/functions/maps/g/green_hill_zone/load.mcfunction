...
summon minecraft:armor_stand 32.5 25.0 236.5 {Tags:["propStand","cream"],Rotation:[90f,0f],Pose:{RightArm:[351f,20f,0f],LeftLeg:[3f,0f,0f],LeftArm:[339f,348f,0f],RightLeg:[0f,0f,0f]}}
