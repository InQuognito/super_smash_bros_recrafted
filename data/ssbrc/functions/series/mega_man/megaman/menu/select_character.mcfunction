...
execute if score $blindPick options matches 0 run tellraw @s [{"translate":"ssbrc.fighters.menu.selected","color":"white"},{"translate":"ssbrc.fighters.megaman","color":"dark_aqua"},{"translate":"!","color":"white"}]
