...
execute if entity @s[scores={useAbility=1..,charge.1=1..,cooldown.2=..0},nbt={SelectedItem:{tag:{blackHoleBomb:1}}}] at @s anchored eyes run function ssbrc:series/mega_man/megaman/logic/abilities/black_hole_bomb/activate
