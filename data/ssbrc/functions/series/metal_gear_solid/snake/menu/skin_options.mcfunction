...
tellraw @s[advancements={ssbrc:series/metal_gear_solid/snake/skins/iroquois_pliskin=true}] [{"translate":"[ ","color":"dark_green"},{"text":"Iroquois Pliskin","color":"dark_green","clickEvent":{"action":"run_command","value":"/trigger menu set 1526"}},{"translate":" ]","color":"dark_green"}]
