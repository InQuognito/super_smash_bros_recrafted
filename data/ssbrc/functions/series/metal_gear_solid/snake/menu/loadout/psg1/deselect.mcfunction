title @s[tag=selectingLoadout.snake,tag=!psg1] actionbar {"text":"You do not have this equipped.","color":"red"}

scoreboard players operation @s[tag=selectingLoadout.snake,tag=psg1] snake.capacity -= #snake.psg1Weight vars
title @s[tag=selectingLoadout.snake,tag=psg1] actionbar [{"text":"You have de-selected the PSG-1. ","color":"red"}]
