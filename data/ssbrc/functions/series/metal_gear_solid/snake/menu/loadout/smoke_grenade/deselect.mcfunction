title @s[tag=selectingLoadout,tag=!smokeGrenade] actionbar {"text":"You do not have this equipped.","color":"red"}
...
tag @s[tag=selectingLoadout,tag=smokeGrenade] remove smokeGrenade
