title @s[tag=selectingLoadout.snake,tag=!smokeGrenade] actionbar {"text":"You do not have this equipped.","color":"red"}

scoreboard players operation @s[tag=selectingLoadout.snake,tag=smokeGrenade] snake.capacity -= #snake.smokeGrenadeWeight vars
title @s[tag=selectingLoadout.snake,tag=smokeGrenade] actionbar [{"text":"You have de-selected the Smoke Grenade.","color":"red"}]
