title @s[tag=selectingLoadout.snake,tag=!s1000] actionbar {"text":"You do not have this equipped.","color":"red"}

scoreboard players operation @s[tag=selectingLoadout.snake,tag=s1000] snake.capacity -= #snake.s1000Weight vars
title @s[tag=selectingLoadout.snake,tag=s1000] actionbar [{"text":"You have de-selected the S1000.","color":"red"}]
