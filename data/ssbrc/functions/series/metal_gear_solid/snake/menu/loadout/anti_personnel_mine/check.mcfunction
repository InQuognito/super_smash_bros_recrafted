...
title @s[tag=selectingLoadout.snake,tag=antiPersonnelMine,tag=!ignoreFeedback] actionbar {"translate":"ssbrc.fighters.snake.loadout.warn.alreadyEquipped","color":"red"}
