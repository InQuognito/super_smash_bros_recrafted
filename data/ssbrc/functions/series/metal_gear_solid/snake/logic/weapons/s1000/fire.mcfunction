...
execute unless score @s snake.s1000M matches ..0 if score @s snake.s1000A matches ..0 run scoreboard players operation @s snake.s1000R = #snake.s1000Reload vars
