...
execute as @e[type=minecraft:marker,tag=offset,distance=..0.1,limit=1] at @s run function ssbrc:series/metal_gear_solid/snake/logic/weapons/s1000/projectile
