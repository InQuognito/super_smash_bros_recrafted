execute if entity @s[scores={snake.s1000M=-1..,snake.s1000A=1..,snake.s1000F=..0}] at @s run function ssbrc:series/metal_gear_solid/snake/logic/weapons/s1000/fire
