...
summon minecraft:arrow ~ ~ ~ {damage:0.8,Tags:["s1000Bullet","bullet","modifyEntity"],NoGravity:1b}
...
data modify entity @e[type=minecraft:arrow,tag=modifyEntity,limit=1,distance=..0.1] Motion set from entity @e[type=minecraft:marker,tag=direction,limit=1] Pos

tag @e[type=minecraft:arrow,tag=modifyEntity] remove modifyEntity
