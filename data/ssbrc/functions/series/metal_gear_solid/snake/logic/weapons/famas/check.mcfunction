execute if entity @s[scores={loadout.famasM=-1..,loadout.famasA=1..,loadout.famasF=..0}] at @s anchored eyes run function ssbrc:series/metal_gear_solid/snake/logic/weapons/famas/fire
