execute if entity @s[scores={snake.famasM=-1..,snake.famasA=1..,snake.famasF=..0}] anchored eyes positioned ^ ^ ^ run function ssbrc:series/metal_gear_solid/snake/logic/weapons/famas/fire
