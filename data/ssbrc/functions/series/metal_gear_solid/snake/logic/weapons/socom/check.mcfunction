execute if entity @s[scores={loadout.socomM=-1..,loadout.socomA=1..,loadout.socomF=..0}] at @s run function ssbrc:series/metal_gear_solid/snake/logic/weapons/socom/fire
