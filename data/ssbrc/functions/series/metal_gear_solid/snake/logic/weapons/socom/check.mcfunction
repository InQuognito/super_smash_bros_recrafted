execute if entity @s[scores={snake.socomM=-1..,snake.socomA=1..,snake.socomF=..0}] at @s anchored eyes run function ssbrc:series/metal_gear_solid/snake/logic/weapons/socom/fire
