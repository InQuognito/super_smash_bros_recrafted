...
summon minecraft:armor_stand ^ ^ ^0.3 {Tags:["smokeGrenade.display","vehicleProjectile"],Invisible:1b,Small:1b,Passengers:[{id:"minecraft:area_effect_cloud",Tags:["smokeGrenade","projectile"],Age:-2147483648,Duration:-1,WaitTime:-2147483648}]}
