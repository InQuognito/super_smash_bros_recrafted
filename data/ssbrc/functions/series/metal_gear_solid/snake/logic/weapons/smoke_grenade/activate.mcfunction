...
summon minecraft:armor_stand ^ ^ ^0.3 {Tags:["smokeGrenade.display","vehicleProjectile"],Invisible:1b,Small:1b,Passengers:[{id:"minecraft:marker",Tags:["smokeGrenade","modifyProjectile"]}]}
