...
execute if score @s damage matches 1 run summon minecraft:area_effect_cloud ~ ~ ~ {Tags:["damage.antiPersonnelMine","projectile"],Radius:0f,Duration:6,DurationOnUse:-100,Age:4,Effects:[{Id:7b,Amplifier:2b,Duration:1,ShowParticles:0b}]}
