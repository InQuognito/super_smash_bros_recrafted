...
execute if score @s[tag=!gold] itemCount matches ..0 run loot give @s loot ssbrc:characters/metal_gear_solid/snake/anti_personnel_mine/default/inactive
execute if score @s[tag=gold] itemCount matches ..0 run loot give @s loot ssbrc:characters/metal_gear_solid/snake/anti_personnel_mine/gold/inactive
