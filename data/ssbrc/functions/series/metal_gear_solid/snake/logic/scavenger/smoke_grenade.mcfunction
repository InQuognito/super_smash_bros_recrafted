...
execute if score @s[tag=!gold] itemCount matches ..0 run loot give @s loot ssbrc:characters/metal_gear_solid/snake/smoke_grenade/default
execute if score @s[tag=gold] itemCount matches ..0 run loot give @s loot ssbrc:characters/metal_gear_solid/snake/smoke_grenade/gold
