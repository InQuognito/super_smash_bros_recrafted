...
execute at @s[scores={flag.sprinting=40..}] unless block ~ ~-0.1 ~ minecraft:air positioned ~ ~0.1 ~ run function ssbrc:series/sonic_the_hedgehog/sonic/logic/speed/full
