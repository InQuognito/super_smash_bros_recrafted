...
execute if score $blindPick options matches 0 run tellraw @s [{"translate":"ssbrc.fighters.menu.selected","color":"white"},{"translate":"ssbrc.fighters.sonic","color":"blue"},{"translate":"!","color":"white"}]
