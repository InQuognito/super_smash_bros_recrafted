...
execute if score sqrt.output math matches ..9 run function ssbrc:series/sonic_the_hedgehog/shadow/logic/chaos_meters/hero/ones
execute if score sqrt.output math matches 10..99 run function ssbrc:series/sonic_the_hedgehog/shadow/logic/chaos_meters/hero/tens
execute if score sqrt.output math matches 100.. run function ssbrc:series/sonic_the_hedgehog/shadow/logic/chaos_meters/hero/hundreds
