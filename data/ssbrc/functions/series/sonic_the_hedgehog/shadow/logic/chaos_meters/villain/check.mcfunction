...
execute if score sqrt.output math matches ..99 run function ssbrc:series/sonic_the_hedgehog/shadow/logic/chaos_meters/villain/slow
execute if score sqrt.output math matches 100.. run function ssbrc:series/sonic_the_hedgehog/shadow/logic/chaos_meters/villain/fast
