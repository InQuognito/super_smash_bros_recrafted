...
scoreboard players operation @e[tag=projectile,limit=1] id = @p[predicate=ssbrc:flag/player,tag=shadow] id
data modify entity @e[tag=projectile,limit=1] Owner set from entity @p[predicate=ssbrc:flag/player,tag=shadow] UUID
