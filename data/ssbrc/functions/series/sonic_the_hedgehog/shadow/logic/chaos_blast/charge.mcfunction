...
execute if score @s[tag=default] charge.2 matches 70..80 run particle minecraft:dust 0.3 0.0 0.0 2.0 ~ ~0.75 ~ 1.0 1.0 1.0 0.15 200 normal @a
...
execute if score @s[tag=gold] charge.2 matches 70..80 run particle minecraft:dust 0.5 0.5 0.0 2.0 ~ ~0.75 ~ 1.0 1.0 1.0 0.15 200 normal @a
...
execute if score @s[tag=yellowAndroid] charge.2 matches 70..80 run particle minecraft:dust 0.8 0.8 0.0 2.0 ~ ~0.75 ~ 1.0 1.0 1.0 0.15 200 normal @a
execute if score @s[tag=yellowAndroid] charge.2 matches 70..80 run particle minecraft:dust 0.9 0.9 0.0 1.0 ~ ~0.75 ~ 2.0 2.0 2.0 1.5 75 normal @a
