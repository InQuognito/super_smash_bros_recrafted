...
tellraw @s[advancements={ssbrc:series/sonic_the_hedgehog/shadow/skins/yellow_android=true}] [{"translate":"[ ","color":"dark_green"},{"text":"Yellow Android","color":"yellow","clickEvent":{"action":"run_command","value":"/trigger menu set 1906"}},{"translate":" ]","color":"dark_green"}]
