execute positioned ^-0.5 ^ ^0.5 summon minecraft:arrow run function ssbrc:series/the_legend_of_zelda/link/logic/abilities/sword_beam/init/projectile
execute positioned ^-0.25 ^ ^0.75 summon minecraft:arrow run function ssbrc:series/the_legend_of_zelda/link/logic/abilities/sword_beam/init/projectile
execute positioned ^ ^ ^1 summon minecraft:arrow run function ssbrc:series/the_legend_of_zelda/link/logic/abilities/sword_beam/init/projectile
execute positioned ^0.25 ^ ^0.75 summon minecraft:arrow run function ssbrc:series/the_legend_of_zelda/link/logic/abilities/sword_beam/init/projectile
execute positioned ^0.5 ^ ^0.5 summon minecraft:arrow run function ssbrc:series/the_legend_of_zelda/link/logic/abilities/sword_beam/init/projectile
