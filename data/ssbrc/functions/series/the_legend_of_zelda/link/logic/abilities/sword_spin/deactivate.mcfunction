...
playsound ssbrc:fighters.cloud.sword_spin.unleash player @a
execute if entity @s[predicate=ssbrc:characters/link/master_sword_awakened,scores={charge.output=81..}] run playsound ssbrc:fighters.cloud.sword_beam.activate player @a
