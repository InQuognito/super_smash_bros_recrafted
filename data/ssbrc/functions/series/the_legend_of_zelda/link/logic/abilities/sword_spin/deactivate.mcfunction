execute if score @s charge.output matches 21..50 as @e[predicate=ssbrc:flag/targets,distance=0.1..2] run damage @s 6.0 ssbrc:projectile by @s
execute if score @s[predicate=!ssbrc:characters/link/master_sword_awakened] charge.output matches 51.. as @e[predicate=ssbrc:flag/targets,distance=0.1..2.25] run damage @s 6.0 ssbrc:projectile by @s
execute if score @s[predicate=ssbrc:characters/link/master_sword_awakened] charge.output matches 51..80 as @e[predicate=ssbrc:flag/targets,distance=0.1..2.25] run damage @s 6.0 ssbrc:projectile by @s
...
execute if score @s[predicate=ssbrc:characters/link/master_sword_awakened] charge.output matches 121.. as @e[predicate=ssbrc:flag/targets,distance=0.1..2.5] run damage @s 12.0 ssbrc:projectile by @s
