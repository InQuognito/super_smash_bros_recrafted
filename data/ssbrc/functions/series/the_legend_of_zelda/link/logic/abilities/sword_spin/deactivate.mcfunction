execute if score @s charge.output matches 21..50 as @e[tag=!self,predicate=ssbrc:flag/targets,distance=..2] run damage @s 8.0 ssbrc:projectile by @p[tag=self]
execute if score @s[predicate=!ssbrc:characters/link/master_sword_awakened] charge.output matches 51.. as @e[tag=!self,predicate=ssbrc:flag/targets,distance=..2.25] run damage @s 10.0 ssbrc:projectile by @p[tag=self]
execute if score @s[predicate=ssbrc:characters/link/master_sword_awakened] charge.output matches 51..80 as @e[tag=!self,predicate=ssbrc:flag/targets,distance=..2.25] run damage @s 10.0 ssbrc:projectile by @p[tag=self]
execute if score @s[predicate=ssbrc:characters/link/master_sword_awakened] charge.output matches 81..120 as @e[tag=!self,predicate=ssbrc:flag/targets,distance=..2.25] run damage @s 12.0 ssbrc:projectile by @p[tag=self]
execute if score @s[predicate=ssbrc:characters/link/master_sword_awakened] charge.output matches 121.. as @e[tag=!self,predicate=ssbrc:flag/targets,distance=..2.5] run damage @s 14.0 ssbrc:projectile by @p[tag=self]
