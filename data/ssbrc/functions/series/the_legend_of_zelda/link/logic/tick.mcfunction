...
execute as @e[tag=link.swordBeam] at @s run function ssbrc:series/the_legend_of_zelda/link/logic/weapons/sword_beam/entity
execute as @e[tag=link.boomerang] at @s run function ssbrc:series/the_legend_of_zelda/link/logic/weapons/boomerang/entity
