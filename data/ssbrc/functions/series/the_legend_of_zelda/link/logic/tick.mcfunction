...
# Boomerang
execute at @s if score @s id = @e[tag=boomerang,scores={debug=20..},sort=nearest,limit=1,dx=0.5,dy=0.5,dz=0.5] id run function ssbrc:series/the_legend_of_zelda/link/logic/weapons/boomerang/regain
