...
execute if entity @s[predicate=!ssbrc:flag/sneaking,scores={charge.1=1..}] at @s run function ssbrc:series/the_legend_of_zelda/link/logic/weapons/sword_spin/deactivate
