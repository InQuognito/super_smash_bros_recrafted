...
execute if score @s debug matches 20.. as @a[predicate=ssbrc:flag/alive,tag=link] if score @s id = #temp id facing entity @s eyes run function ssbrc:series/the_legend_of_zelda/link/logic/weapons/boomerang/movement_return
