...
tag @s[scores={damage=3}] remove damage.swordSpin.1
tag @s[scores={damage=3}] remove damage.swordSpin.2
tag @s[scores={damage=3}] remove damage.swordSpin.3
tag @s[scores={damage=3}] remove damage.swordSpin.4
