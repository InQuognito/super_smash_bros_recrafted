...
execute as @e[tag=boomerang.display,sort=nearest,limit=1] rotated as @s run function ssbrc:series/the_legend_of_zelda/link/logic/weapons/boomerang/display
