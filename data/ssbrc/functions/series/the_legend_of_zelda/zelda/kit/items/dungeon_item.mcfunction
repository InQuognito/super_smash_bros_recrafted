...
execute if score result random matches 0 run loot replace entity @s hotbar.1 loot ssbrc:characters/the_legend_of_zelda/zelda/dungeon_items/bomb/default
