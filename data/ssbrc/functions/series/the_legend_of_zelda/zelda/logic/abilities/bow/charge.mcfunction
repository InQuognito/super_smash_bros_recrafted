...
execute if score @s charge.output matches 1 run attribute @s minecraft:generic.movement_speed modifier add 19192183-0000-0000-0001-000001000000 "bowCharge" 0.5 multiply_base
