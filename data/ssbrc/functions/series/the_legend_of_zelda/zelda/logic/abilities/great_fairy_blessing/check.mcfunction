...
execute if score @s charge.1 >= #greatFairyBlessingCost temp at @s run function ssbrc:series/the_legend_of_zelda/zelda/logic/abilities/great_fairy_blessing/choose
