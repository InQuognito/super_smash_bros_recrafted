...
execute if score @s[predicate=!ssbrc:flag/sneaking] mana >= #iceRodMagicCost temp run function ssbrc:series/the_legend_of_zelda/zelda/logic/abilities/ice_rod/activate
execute if score @s[predicate=ssbrc:flag/sneaking] mana >= #iceRodMagicCost temp run function ssbrc:series/the_legend_of_zelda/zelda/logic/abilities/ice_rod/alternate_function/activate
