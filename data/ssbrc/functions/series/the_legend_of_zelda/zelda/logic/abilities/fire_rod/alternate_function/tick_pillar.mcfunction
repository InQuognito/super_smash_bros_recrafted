...
execute positioned ~-0.15 ~ ~-0.15 as @e[tag=!self,predicate=ssbrc:flag/targets,dy=2] positioned ~-0.7 ~ ~-0.7 if entity @s[dy=2] at @s run function ssbrc:series/the_legend_of_zelda/zelda/logic/abilities/fire_rod/hit
