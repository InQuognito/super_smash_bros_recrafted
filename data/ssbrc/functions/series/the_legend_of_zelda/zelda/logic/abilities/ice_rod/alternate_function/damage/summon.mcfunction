summon minecraft:area_effect_cloud ~ ~1 ~ {Tags:["damage.iceBlock","modifyProjectile"],Radius:0.0f,Duration:10,ReapplicationDelay:9999,Effects:[{Id:7,Amplifier:2b,Duration:6,ShowParticles:0b}]}
