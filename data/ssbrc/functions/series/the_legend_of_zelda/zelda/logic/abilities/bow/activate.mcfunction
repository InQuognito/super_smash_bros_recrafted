...
execute unless entity @s[tag=!shieldBroken,nbt={Inventory:[{tag:{smallShield:1}}]}] run function ssbrc:series/the_legend_of_zelda/zelda/kit/passive_items/small_shield
