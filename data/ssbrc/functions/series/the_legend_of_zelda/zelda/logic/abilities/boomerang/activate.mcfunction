summon minecraft:area_effect_cloud ^ ^ ^1 {Tags:["boomerang","modifyProjectile"],Duration:600}
...
execute as @e[tag=modifyProjectile] at @s run function ssbrc:series/the_legend_of_zelda/zelda/logic/abilities/boomerang/summon_item
