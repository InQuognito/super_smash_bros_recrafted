summon minecraft:area_effect_cloud ~ ~1 ~ {Tags:["damage.iceRod","projectile"],Radius:0.0f,Duration:10,ReapplicationDelay:9999,Effects:[{Id:7,Amplifier:1b,Duration:6,ShowParticles:0b}]}
