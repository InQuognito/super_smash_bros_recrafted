...
execute if score @s temp matches 20.. facing entity @a[tag=self,limit=1] eyes run function ssbrc:series/the_legend_of_zelda/zelda/logic/abilities/boomerang/return
