...
execute unless entity @s[tag=pillar] unless block ^ ^ ^0.1 #ssbrc:passthrough run function ssbrc:series/the_legend_of_zelda/zelda/logic/abilities/fire_rod/alternate_function/summon_pillar
