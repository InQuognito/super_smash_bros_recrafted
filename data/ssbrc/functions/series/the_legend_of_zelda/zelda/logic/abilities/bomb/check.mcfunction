...
execute if entity @s[tag=activeFuse,scores={cooldown.1=..0}] at @s anchored eyes positioned ^ ^ ^ run function ssbrc:series/the_legend_of_zelda/zelda/logic/abilities/bomb/summon
