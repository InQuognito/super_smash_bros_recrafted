...
execute if score @s[tag=!activeFuse,scores={cooldown.1=..0}] mana >= #bombMagicCost temp run function ssbrc:series/the_legend_of_zelda/zelda/logic/abilities/bomb/activate
