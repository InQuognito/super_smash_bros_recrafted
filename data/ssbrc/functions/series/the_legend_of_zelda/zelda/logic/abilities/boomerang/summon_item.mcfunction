...
summon minecraft:armor_stand ^ ^-0.8 ^ {Tags:["zelda.boomerang.display","modifyEntity"],Pose:{Head:[0f,0.1f,0f]},Invisible:1b,Small:1b,NoGravity:1b,DisabledSlots:4144959}
