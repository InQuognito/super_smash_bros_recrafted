...
tellraw @s[advancements={ssbrc:series/the_legend_of_zelda/ganondorf/skins/ocarina_of_time=true}] [{"translate":"[ ","color":"dark_green"},{"text":"Ocarina of Time","color":"gold","clickEvent":{"action":"run_command","value":"/trigger menu set 406"}},{"translate":" ]","color":"dark_green"}]
