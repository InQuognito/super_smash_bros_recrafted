...
execute as @e[type=minecraft:marker,tag=phazonBeam,limit=1,sort=nearest] run function ssbrc:series/metroid/darksamus/logic/abilities/phazon_beam/check_damage
