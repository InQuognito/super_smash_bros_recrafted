execute if entity @s[predicate=!ssbrc:flag/sneaking,scores={useAbility=1..,cooldown.1=..0},nbt={SelectedItem:{tag:{phazonBeam:1}}}] at @s anchored eyes run function ssbrc:series/metroid/darksamus/logic/abilities/phazon_beam/summon
execute if entity @s[predicate=ssbrc:flag/sneaking,scores={useAbility=1..,charge.1=..0},nbt={SelectedItem:{tag:{phazonBeam:1}}}] run function ssbrc:series/metroid/darksamus/logic/abilities/charge_beam/activate
execute if entity @s[predicate=!ssbrc:flag/sneaking,scores={charge.1=1..}] at @s anchored eyes run function ssbrc:series/metroid/darksamus/logic/abilities/charge_beam/deactivate
...
# Charge Beam
execute if entity @s[scores={charge.1=1..}] at @s anchored eyes run function ssbrc:series/metroid/darksamus/logic/abilities/charge_beam/charge
