...
execute as @e[type=minecraft:item_frame,tag=phazonSpike,tag=edit,sort=nearest,limit=1] run function ssbrc:series/metroid/darksamus/logic/phazon_spike/rotate_spike
