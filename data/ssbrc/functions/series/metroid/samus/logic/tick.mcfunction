...
execute if entity @s[predicate=!ssbrc:flag/sneaking,scores={useAbility=1..,cooldown.1=..0},nbt={SelectedItem:{tag:{waveBeam:1}}}] at @s anchored eyes positioned ^ ^0.75 ^ run function ssbrc:series/metroid/samus/logic/weapons/wave_beam/activate
