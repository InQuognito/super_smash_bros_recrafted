...
execute as @e[type=minecraft:marker,tag=waveBeam,tag=!anchor] at @s if score @s id = @p[tag=self] id run function ssbrc:series/metroid/samus/logic/weapons/wave_beam/tick
