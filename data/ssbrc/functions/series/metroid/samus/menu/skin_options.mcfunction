...
tellraw @s[advancements={ssbrc:series/metroid/samus/skins/gravity_suit=true}] [{"translate":"[ ","color":"dark_green"},{"text":"Gravity Suit","color":"aqua","clickEvent":{"action":"run_command","value":"/trigger menu set 1426"}},{"translate":" ]","color":"dark_green"}]
tellraw @s[advancements={ssbrc:series/metroid/samus/skins/phazon_suit=true}] [{"translate":"[ ","color":"dark_green"},{"text":"Phazon Suit","color":"red","clickEvent":{"action":"run_command","value":"/trigger menu set 1427"}},{"translate":" ]","color":"dark_green"}]
