...
tellraw @s[tag=!gravitySuit,advancements={ssbrc:series/metroid/samus/skins/gravity_suit=true}] [{"translate":"ssbrc.fighters.samus.skin.gravitySuit","color":"light_purple","clickEvent":{"action":"run_command","value":"/trigger menu set 1426"}}]
tellraw @s[tag=gravitySuit] [{"translate":"ssbrc.fighters.samus.skin.gravitySuit","color":"light_purple"},{"text":" ","color":"white"},{"text":"✔","color":"green"}]
