...
execute if entity @s[scores={useAbility=1..},nbt={SelectedItem:{tag:{drone:1,recall:1}}}] as @e[type=minecraft:area_effect_cloud,tag=drone] if score @s id = @p[tag=self] id run function ssbrc:series/retro_fighters/yar/logic/abilities/drone/commands/recall
execute if entity @s[scores={useAbility=1..},nbt={SelectedItem:{tag:{drone:1,stop:1}}}] as @e[type=minecraft:area_effect_cloud,tag=drone] if score @s id = @p[tag=self] id run function ssbrc:series/retro_fighters/yar/logic/abilities/drone/commands/stop
execute if entity @s[scores={useAbility=1..},predicate=!ssbrc:flag/sneaking,nbt={SelectedItem:{tag:{drone:1,activate:1}}}] at @s anchored eyes run function ssbrc:series/retro_fighters/yar/logic/abilities/drone/activate
execute if entity @s[scores={useAbility=1..},predicate=ssbrc:flag/sneaking,nbt={SelectedItem:{tag:{drone:1,activate:1}}}] at @s anchored feet run function ssbrc:series/retro_fighters/yar/logic/abilities/drone/activate
...
execute as @e[type=minecraft:area_effect_cloud,tag=drone] at @s if score @s id = @p[tag=self] id run function ssbrc:series/retro_fighters/yar/logic/abilities/drone/tick
