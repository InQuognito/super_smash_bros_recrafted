...
execute positioned ~-0.5 ~-0.5 ~-0.5 as @e[predicate=ssbrc:flag/targets,dx=0] run function ssbrc:series/retro_fighters/yar/logic/abilities/ray_blaster/variants/railgun/hit
