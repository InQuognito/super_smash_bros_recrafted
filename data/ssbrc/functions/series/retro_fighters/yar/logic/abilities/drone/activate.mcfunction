summon minecraft:bee ^ ^ ^1 {Tags:["drone","modifyEntity"],Passengers:[{id:"minecraft:area_effect_cloud",Tags:["drone.aec","modifyPassenger"],Age:-2147483648,Duration:-1,WaitTime:-2147483648}],Health:20,NoAI:1b,NoGravity:1b,PersistenceRequired:1b,Silent:1b,Attributes:[{Name:"generic.max_health",Base:20d},{Name:"generic.knockback_resistance",Base:1.0d}]}
