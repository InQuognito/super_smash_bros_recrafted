summon minecraft:bee ^ ^ ^1 {Tags:["drone","modifyEntity"],Passengers:[{id:"minecraft:armor_stand",Tags:["drone.display","modifyPassenger"],Invisible:1b}],Health:40,NoAI:1b,NoGravity:1b,PersistenceRequired:1b,Silent:1b,Attributes:[{Name:"generic.max_health",Base:40d}]}
