...
execute if entity @s[scores={useAbility=1..,cooldown.2=..0},nbt={SelectedItem:{tag:{flameHands:1}}}] at @s anchored eyes run function ssbrc:series/retro_fighters/alteredbeast/logic/abilities/flame_hands/activate
