...
tellraw @s[tag=!gold,advancements={ssbrc:series/star_fox/wolf/skins/gold=true}] [{"translate":"ssbrc.fighters.skin.gold","color":"gold","clickEvent":{"action":"run_command","value":"/trigger menu set 1725"}}]
tellraw @s[tag=gold] [{"translate":"ssbrc.fighters.skin.gold","color":"gold"},{"text":" ","color":"white"},{"text":"✔","color":"green"}]

tellraw @s[tag=!assault,advancements={ssbrc:series/star_fox/wolf/skins/assault=true}] [{"translate":"ssbrc.fighters.wolf.skin.assault","color":"green","clickEvent":{"action":"run_command","value":"/trigger menu set 1726"}}]
tellraw @s[tag=assault] [{"translate":"ssbrc.fighters.wolf.skin.assault","color":"green"},{"text":" ","color":"white"},{"text":"✔","color":"green"}]
