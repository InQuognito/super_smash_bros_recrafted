...
tellraw @s[advancements={ssbrc:series/star_fox/wolf/skins/assault=true}] [{"text":"[ ","color":"dark_green"},{"text":"Assault","color":"dark_purple","clickEvent":{"action":"run_command","value":"/trigger menu set 1726"}},{"text":" ]","color":"dark_green"}]
