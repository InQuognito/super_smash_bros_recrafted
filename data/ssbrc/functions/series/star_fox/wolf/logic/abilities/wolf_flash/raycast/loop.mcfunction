...
execute if block ^ ^ ^1 #ssbrc:passthrough_charge run function ssbrc:series/star_fox/wolf/logic/abilities/wolf_flash/end
...
execute if score $rayLength temp matches 1.. positioned ^ ^ ^0.1 if block ~ ~ ~ #ssbrc:passthrough_charge run function ssbrc:series/star_fox/wolf/logic/abilities/wolf_flash/raycast/loop
