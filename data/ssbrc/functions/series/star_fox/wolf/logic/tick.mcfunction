...
execute if entity @s[scores={useAbility=1..,cooldown.3=..0},predicate=ssbrc:flag/sneaking,nbt={SelectedItem:{tag:{wolfSlash:1}}}] at @s anchored feet run function ssbrc:series/star_fox/wolf/logic/abilities/wolf_flash/activate
