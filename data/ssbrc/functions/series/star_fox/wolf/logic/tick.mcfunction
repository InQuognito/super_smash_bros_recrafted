...
execute if entity @s[scores={useAbility=1..,cooldown.2=..0},nbt={SelectedItem:{tag:{grenade:1}}}] run function ssbrc:series/star_fox/wolf/logic/abilities/grenade/check
