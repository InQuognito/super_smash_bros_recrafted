...
execute as @e[type=minecraft:area_effect_cloud,tag=blunderbuss] at @s if score @s id = @p[tag=self] id run function ssbrc:series/donkey_kong/kingkrool/logic/abilities/blunderbuss/tick
