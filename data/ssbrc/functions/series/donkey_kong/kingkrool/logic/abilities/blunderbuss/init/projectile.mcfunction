...
loot replace entity @s[tag=default] armor.head loot ssbrc:characters/donkey_kong/kingkrool/cannonball/default
loot replace entity @s[tag=gold] armor.head loot ssbrc:characters/donkey_kong/kingkrool/cannonball/gold
