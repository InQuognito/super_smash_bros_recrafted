...
tellraw @s[advancements={ssbrc:series/donkey_kong/donkeykong/skins/super_kong=true}] [{"translate":"[ ","color":"dark_green","bold":false},{"text":"Super Kong","color":"green","clickEvent":{"action":"run_command","value":"/trigger menu set 306"}},{"translate":" ]","color":"dark_green"}]
