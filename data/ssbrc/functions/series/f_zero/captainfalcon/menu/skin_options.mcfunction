...
tellraw @s[advancements={ssbrc:series/f_zero/captainfalcon/skins/rick_wheeler=true}] [{"translate":"[ ","color":"dark_green"},{"translate":"ssbrc.fighters.captainfalcon.skin.rickWheeler","color":"dark_blue","clickEvent":{"action":"run_command","value":"/trigger menu set 126"}},{"translate":" ]","color":"dark_green"}]
