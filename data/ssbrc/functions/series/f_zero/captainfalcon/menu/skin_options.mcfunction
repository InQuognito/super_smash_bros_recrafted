...
tellraw @s[tag=bloodFalcon] [{"translate":"ssbrc.fighters.skin.bloodFalcon","color":"dark_red"},{"text":" ","color":"white"},{"text":"✔","color":"green"}]
...
tellraw @s[tag=rickWheeler] [{"translate":"ssbrc.fighters.skin.rickWheeler","color":"dark_red"},{"text":" ","color":"white"},{"text":"✔","color":"green"}]
