execute if entity @s[scores={useAbility=1..,cooldown.1=..0,duration.1=..0},nbt={SelectedItem:{tag:{fistsOfFury:1}}}] at @s positioned ~ ~0.1 ~ run function ssbrc:series/f_zero/captainfalcon/logic/abilities/raptor_boost/activate
