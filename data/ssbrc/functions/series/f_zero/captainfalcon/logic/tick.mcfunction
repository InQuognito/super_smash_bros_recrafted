...
execute if entity @s[scores={useAbility=1..,cooldown.2=..0},nbt={SelectedItem:{tag:{falconPunch:1}}}] run function ssbrc:series/f_zero/captainfalcon/logic/abilities/falcon_punch/check
