...
tellraw @s[tag=!gold,advancements={ssbrc:series/kirby/kirby/skins/gold=true}] [{"translate":"ssbrc.fighters.skin.gold","color":"gold","clickEvent":{"action":"run_command","value":"/trigger menu set 705"}}]
