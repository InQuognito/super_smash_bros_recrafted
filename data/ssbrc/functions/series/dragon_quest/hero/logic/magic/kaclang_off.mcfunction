...
item replace entity @s[tag=!rek,scores={mana=1..}] hotbar.0 with minecraft:iron_sword{flameSlash:1,CustomModelData:441,Unbreakable:1,AttributeModifiers:[{AttributeName:"minecraft:generic.attack_damage",Amount:8,Slot:mainhand,Name:"minecraft:generic.attack_damage",UUID:[I;-12164,22807,92130,-45614]},{AttributeName:"minecraft:generic.attack_speed",Amount:-2.6,Slot:mainhand,Name:"minecraft:generic.attack_speed",UUID:[I;-12164,22907,92130,-45814]}],display:{Name:'[{"text":"Flame Slash","italic":false,"color":"gold"}]'},HideFlags:127} 1
...
item replace entity @s[tag=rek,scores={mana=1..}] hotbar.0 with minecraft:iron_sword{flameSlash:1,CustomModelData:442,Unbreakable:1,AttributeModifiers:[{AttributeName:"minecraft:generic.attack_damage",Amount:8,Slot:mainhand,Name:"minecraft:generic.attack_damage",UUID:[I;-12164,22807,92130,-45614]},{AttributeName:"minecraft:generic.attack_speed",Amount:-2.6,Slot:mainhand,Name:"minecraft:generic.attack_speed",UUID:[I;-12164,22907,92130,-45814]}],display:{Name:'[{"text":"Flame Slash","italic":false,"color":"gold"}]'},Enchantments:[{id:"fire_aspect",lvl:1}],HideFlags:127} 1
item replace entity @s[scores={mana=2..}] hotbar.1 with minecraft:carrot_on_a_stick{bang:1,CustomModelData:441,Unbreakable:1,display:{Name:'[{"text":"Bang","italic":false,"color":"red"}]'},HideFlags:127} 1
item replace entity @s[scores={mana=3..}] hotbar.2 with minecraft:carrot_on_a_stick{kaclang:1,CustomModelData:442,Unbreakable:1,display:{Name:'[{"text":"Kaclang","italic":false,"color":"dark_aqua"}]'},HideFlags:127} 1
