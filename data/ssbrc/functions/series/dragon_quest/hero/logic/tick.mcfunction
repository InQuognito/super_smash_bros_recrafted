...
execute if entity @s[scores={useAbility=1..,duration.2=..0},nbt={SelectedItem:{tag:{kaclang:1}}}] at @s run function ssbrc:series/dragon_quest/hero/logic/magic/kaclang/check
