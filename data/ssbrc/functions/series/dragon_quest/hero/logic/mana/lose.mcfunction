...
loot replace entity @s[tag=!gold,tag=!erdrick,tag=!rek,tag=!sofia] weapon.offhand loot ssbrc:characters/dragon_quest/hero/shield/erdwins_shield
loot replace entity @s[tag=gold] weapon.offhand loot ssbrc:characters/dragon_quest/hero/shield/gold
