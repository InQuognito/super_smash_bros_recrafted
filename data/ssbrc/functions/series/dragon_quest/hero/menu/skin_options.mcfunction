...
tellraw @s[advancements={ssbrc:series/dragon_quest/hero/skins/sofia=true}] [{"text":"[ ","color":"dark_green"},{"text":"Sofia","color":"green","clickEvent":{"action":"run_command","value":"/trigger menu set 448"}},{"text":" ]","color":"dark_green"}]
