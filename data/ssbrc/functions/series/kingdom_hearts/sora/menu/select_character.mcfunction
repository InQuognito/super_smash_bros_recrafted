...
execute if score $blindPick options matches 0 run tellraw @s[tag=timelessRiver] [{"translate":"ssbrc.fighters.menu.skin","color":"white"},{"text":"Timeless River","color":"gray"}]
