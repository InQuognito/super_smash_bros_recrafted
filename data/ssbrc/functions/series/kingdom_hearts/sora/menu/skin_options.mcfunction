...
tellraw @s[advancements={ssbrc:series/kingdom_hearts/sora/skins/timeless_river=true}] [{"text":"[ ","color":"dark_green"},{"text":"Timeless River","color":"gold","clickEvent":{"action":"run_command","value":"/trigger menu set 1566"}},{"text":" ]","color":"dark_green"}]
