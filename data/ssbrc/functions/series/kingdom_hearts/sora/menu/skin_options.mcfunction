...
tellraw @s[tag=!timelessRiver,advancements={ssbrc:series/kingdom_hearts/sora/skins/timeless_river=true}] [{"translate":"ssbrc.fighters.sora.skin.timelessRiver","color":"gray","clickEvent":{"action":"run_command","value":"/trigger menu set 1566"}}]
