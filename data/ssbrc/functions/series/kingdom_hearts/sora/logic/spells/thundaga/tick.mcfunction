execute if score @s temp matches 5..24 positioned ^ ^ ^3.0 run particle minecraft:end_rod ~ ~-0.25 ~ 0.01 0.01 0.01 0.25 1 normal @a
execute if score @s temp matches 10..26 positioned ^ ^ ^6.0 run particle minecraft:end_rod ~ ~-0.25 ~ 0.01 0.01 0.01 0.25 1 normal @a
execute if score @s temp matches 15..28 positioned ^ ^ ^9.0 run particle minecraft:end_rod ~ ~-0.25 ~ 0.01 0.01 0.01 0.25 1 normal @a
