...
execute if score @s temp matches 25 positioned ^ ^ ^4.0 run function ssbrc:series/kingdom_hearts/sora/logic/spells/thundaga/summon_bolt
execute if score @s temp matches 27 positioned ^ ^ ^8.0 run function ssbrc:series/kingdom_hearts/sora/logic/spells/thundaga/summon_bolt
execute if score @s temp matches 29 positioned ^ ^ ^12.0 run function ssbrc:series/kingdom_hearts/sora/logic/spells/thundaga/summon_bolt
