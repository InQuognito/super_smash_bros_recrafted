summon minecraft:marker ^ ^ ^1 {Tags:["antiSlash","modifyEntity"]}
...
execute as @e[tag=modifyEntity,limit=1] at @s run teleport ^ ^ ^-.75
execute as @e[tag=modifyEntity,limit=1] at @s run function ssbrc:series/kingdom_hearts/sora/logic/drive_forms/anti/slash/loop
