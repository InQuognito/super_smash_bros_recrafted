...
execute positioned ~-0.5 ~-0.5 ~-0.5 as @e[tag=!self,predicate=ssbrc:flag/targets,dx=0] run function ssbrc:series/kingdom_hearts/sora/logic/abilities/strike_raid/hit
