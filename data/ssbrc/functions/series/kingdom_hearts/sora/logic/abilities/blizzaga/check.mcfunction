...
execute if score @s[tag=!wisdom] mana >= #sora.blizzagaMPCost vars positioned ^ ^ ^ run function ssbrc:series/kingdom_hearts/sora/logic/abilities/blizzaga/activate
