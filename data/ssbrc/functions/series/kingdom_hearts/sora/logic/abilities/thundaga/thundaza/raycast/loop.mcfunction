...
execute at @p[tag=alive,scores={respawn=..0},gamemode=adventure,dx=0,dy=0,dz=0] if score @s raycastSuccess matches 0 run function ssbrc:series/kingdom_hearts/sora/logic/abilities/thundaga/thundaza/raycast/success
