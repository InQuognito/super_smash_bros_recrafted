...
execute if score @s temp matches 24 as @e[tag=thundazaBolt,sort=nearest,limit=1] at @s run summon minecraft:lightning_bolt ~ ~ ~
...
execute if score @s temp matches 26 as @e[tag=thundazaBolt,sort=nearest,limit=1] at @s run summon minecraft:lightning_bolt ~ ~ ~
...
execute if score @s temp matches 28 as @e[tag=thundazaBolt,sort=nearest,limit=1] at @s run summon minecraft:lightning_bolt ~ ~ ~
