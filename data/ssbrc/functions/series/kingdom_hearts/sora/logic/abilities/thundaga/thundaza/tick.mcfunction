...
execute if score @s temp matches 21 as @e[tag=thundazaBolt] at @s run function ssbrc:series/kingdom_hearts/sora/logic/abilities/thundaga/summon_bolt
execute if score @s temp matches 24 run summon minecraft:lightning_bolt ~ ~ ~
execute if score @s temp matches 23 as @e[tag=thundazaBolt] at @s run function ssbrc:series/kingdom_hearts/sora/logic/abilities/thundaga/summon_bolt
execute if score @s temp matches 26 run summon minecraft:lightning_bolt ~ ~ ~
execute if score @s temp matches 25 as @e[tag=thundazaBolt] at @s run function ssbrc:series/kingdom_hearts/sora/logic/abilities/thundaga/summon_bolt
