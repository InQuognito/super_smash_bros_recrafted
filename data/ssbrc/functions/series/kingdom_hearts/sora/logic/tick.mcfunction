...
execute if entity @s[predicate=!ssbrc:flag/sneaking,scores={useAbility=1..,cooldown.2=..0},nbt={SelectedItem:{tag:{firaga:1}}}] at @s anchored eyes run function ssbrc:series/kingdom_hearts/sora/logic/spells/firaga/summon
execute if entity @s[predicate=!ssbrc:flag/sneaking,scores={useAbility=1..,cooldown.2=..0},nbt={SelectedItem:{tag:{blizzaga:1}}}] at @s anchored eyes run function ssbrc:series/kingdom_hearts/sora/logic/spells/blizzaga/summon
