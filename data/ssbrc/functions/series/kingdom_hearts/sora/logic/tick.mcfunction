...
execute if entity @s[tag=valor,predicate=!ssbrc:flag/sneaking,scores={useAbility=1..},nbt={SelectedItem:{tag:{strikeRaid:1}},Inventory:[{id:"minecraft:carrot_on_a_stick",Slot:-106b,tag:{starSeeker:1}}]}] at @s anchored eyes run function ssbrc:series/kingdom_hearts/sora/logic/spells/strike_raid/activate
