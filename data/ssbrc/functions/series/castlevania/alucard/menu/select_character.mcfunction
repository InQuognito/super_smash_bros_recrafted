...
execute if score $blindPick options matches 0 run tellraw @s[tag=lordsOfShadow] [{"translate":"ssbrc.fighters.menu.skin","color":"white"},{"text":"Lords of Shadow","color":"dark_gray"}]
