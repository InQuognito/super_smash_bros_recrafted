...
tellraw @s[tag=!gold,advancements={ssbrc:series/castlevania/alucard/skins/gold=true}] [{"translate":"ssbrc.fighters.skin.gold","color":"gold","clickEvent":{"action":"run_command","value":"/trigger menu set 1845"}}]
tellraw @s[tag=gold,advancements={ssbrc:series/castlevania/alucard/skins/gold=true}] [{"translate":"ssbrc.fighters.skin.gold","color":"gold"},{"text":" ","color":"white"},{"text":"✔","color":"green"}]
