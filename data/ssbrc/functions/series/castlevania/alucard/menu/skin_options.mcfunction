...
tellraw @s[advancements={ssbrc:series/castlevania/alucard/skins/lords_of_shadow=true}] [{"translate":"[ ","color":"dark_green"},{"translate":"ssbrc.fighters.alucard.skin.lordsOfShadow","color":"dark_gray","clickEvent":{"action":"run_command","value":"/trigger menu set 1846"}},{"translate":" ]","color":"dark_green"}]
