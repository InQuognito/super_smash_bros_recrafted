...
execute if entity @s[tag=!bloodMetamorphosis] run summon minecraft:snowball ^ ^ ^0.3 {Tags:["modifyVehicle"],Passengers:[{id:"minecraft:armor_stand",Tags:["holyWater.display","modifyDisplay"],Invisible:1b,Small:1b,Passengers:[{id:"minecraft:area_effect_cloud",Tags:["holyWater","modifyEntity"],Age:-2147483648,Duration:-1,WaitTime:-2147483648}]}]}
