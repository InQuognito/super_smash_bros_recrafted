item replace entity @s hotbar.0 with minecraft:stone_sword{rebelsKnife:1,CustomModelData:600,Unbreakable:1,AttributeModifiers:[{AttributeName:"minecraft:generic.attack_damage",Amount:6,Slot:mainhand,Name:"minecraft:generic.attack_damage",UUID:[I;-12164,26707,92130,-53414]},{AttributeName:"minecraft:generic.attack_speed",Amount:-1,Slot:mainhand,Name:"minecraft:generic.attack_speed",UUID:[I;-12164,26807,92130,-53614]}],display:{Name:'[{"text":"Rebel\'s Knife","italic":false,"color":"light_gray","bold":true}]'},HideFlags:127} 1
