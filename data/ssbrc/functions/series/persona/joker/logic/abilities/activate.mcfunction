...
item replace entity @s[tag=raoul] hotbar.2 with minecraft:carrot_on_a_stick{personaAwakening:1,amritaShower:1,CustomModelData:601,Unbreakable:1,display:{Name:'[{"text":"Amrita Shower","italic":false,"color":"yellow","bold":true}]'},HideFlags:127} 1
