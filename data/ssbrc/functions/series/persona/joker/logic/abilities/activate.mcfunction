...
item replace entity @s[tag=raoul] hotbar.2 with minecraft:carrot_on_a_stick{personaAwakening:1,phantomShow:1,CustomModelData:601,Unbreakable:1,display:{Name:'[{"text":"Phantom Show","italic":false,"color":"light_gray","bold":true}]'},HideFlags:127} 1
