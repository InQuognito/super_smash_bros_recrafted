summon minecraft:area_effect_cloud ~ ~0.1 ~ {Tags:["eiagon.pool","modifyEntity"],Particle:"minecraft:dust 0.2 0.0 0.1 0.5",Radius:1.0f,Duration:20,Effects:[{Id:7,Amplifier:0b,Duration:1,ShowParticles:0b}]}
