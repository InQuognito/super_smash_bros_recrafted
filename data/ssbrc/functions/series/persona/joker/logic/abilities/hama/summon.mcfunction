...
summon minecraft:snowball ^ ^ ^0.3 {Tags:["modifyVehicle"],Passengers:[{id:"minecraft:area_effect_cloud",Tags:["hama","modifyEntity"],Age:-2147483648,Duration:-1,WaitTime:-2147483648}]}
