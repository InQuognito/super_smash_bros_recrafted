...
tellraw @s[tag=!shujinAcademy,advancements={ssbrc:series/persona/joker/skins/shujin_academy=true}] [{"translate":"ssbrc.fighters.joker.skin.shujinAcademy","color":"dark_red","clickEvent":{"action":"run_command","value":"/trigger menu set 606"}}]
tellraw @s[tag=shujinAcademy] [{"translate":"ssbrc.fighters.joker.skin.shujinAcademy","color":"dark_red"},{"text":" ","color":"white"},{"text":"✔","color":"green"}]
