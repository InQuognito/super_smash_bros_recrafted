...
tellraw @s[advancements={ssbrc:series/pokemon/pokemontrainer/skins/shiny=true}] [{"text":"[ ","color":"dark_green"},{"text":"Shiny","color":"dark_gray","clickEvent":{"action":"run_command","value":"/trigger menu set 1266"}},{"text":" ]","color":"dark_green"}]
