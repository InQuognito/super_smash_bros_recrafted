...
tellraw @s[advancements={ssbrc:series/pokemon/pokemontrainer/a_fateful_encounter=true}] [{"text":"[ ","color":"dark_green"},{"text":"Shiny","color":"dark_gray","clickEvent":{"action":"run_command","value":"/trigger menu set 1266"}},{"text":" ]","color":"dark_green"}]
...
tellraw @s[advancements={ssbrc:series/pokemon/pokemontrainer/skins/viktor=true}] [{"text":"[ ","color":"dark_green"},{"text":"Viktor","color":"dark_blue","clickEvent":{"action":"run_command","value":"/trigger menu set 1268"}},{"text":" ]","color":"dark_green"}]
