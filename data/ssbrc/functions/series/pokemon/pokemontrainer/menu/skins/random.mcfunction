...
execute unless score @s[advancements={ssbrc:series/pokemon/pokemontrainer/shiny=true}] skinPicked matches 1 if score result random matches 2 run function ssbrc:series/pokemon/pokemontrainer/menu/skins/shiny
