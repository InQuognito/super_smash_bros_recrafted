...
execute if entity @s[scores={useAbility=1..,duration.1=1..},nbt={SelectedItem:{tag:{surf:1}}}] at @s run function ssbrc:series/pokemon/pokemontrainer/logic/squirtle/surf/on
