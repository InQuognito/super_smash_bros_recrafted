...
execute if entity @a[tag=alive,scores={respawn=..0},gamemode=adventure,distance=0.1..1.5] run function ssbrc:series/pokemon/pokemontrainer/logic/charizard/flare_blitz/hit
