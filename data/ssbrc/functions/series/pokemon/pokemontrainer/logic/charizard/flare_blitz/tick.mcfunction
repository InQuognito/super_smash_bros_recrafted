...
execute positioned ~ ~0.75 ~ unless block ^ ^ ^1 #ssbrc:passthrough_charge as @p[tag=self] run function ssbrc:series/pokemon/pokemontrainer/logic/charizard/flare_blitz/recoil
execute positioned ~ ~0.75 ~ if block ^ ^ ^1 #ssbrc:passthrough_charge run teleport @s ^ ^ ^0.6
