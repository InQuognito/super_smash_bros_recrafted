...
execute anchored eyes unless block ^ ^ ^0.7 #ssbrc:passthrough_charge as @p[tag=self] run function ssbrc:series/pokemon/pokemontrainer/logic/charizard/flare_blitz/recoil
