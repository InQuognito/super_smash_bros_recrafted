...
summon minecraft:snowball ^ ^ ^0.3 {Tags:["vehicleProjectile"],Passengers:[{id:"minecraft:area_effect_cloud",Tags:["leechSeed","projectile"],Age:-2147483648,Duration:-1,WaitTime:-2147483648}]}
