...
execute if score @s health matches 2.. if score #leechSeed temp matches 0 at @s run function ssbrc:series/pokemon/pokemontrainer/logic/ivysaur/leech_seed/healing_orb/summon
