...
tellraw @s[tag=!dawn,tag=!victor] [{"translate":"ssbrc.fighters.pokemontrainer.squirtle.default","color":"blue"},{"translate":"ssbrc.fighters.pokemontrainer.iChooseYou","color":"blue"}]
