...
execute unless entity @s[tag=active] unless block ~ ~-0.1 ~ #ssbrc:passthrough positioned ~ ~0.75 ~ run function ssbrc:series/pokemon/teamrocket/logic/meowth/payday/enable
