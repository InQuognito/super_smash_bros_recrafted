...
summon minecraft:snowball ^ ^ ^1 {Tags:["vehicleProjectile"],Passengers:[{id:"minecraft:area_effect_cloud",Tags:["payday","projectile"],Age:-2147483648,Duration:-1,WaitTime:-2147483648}]}
