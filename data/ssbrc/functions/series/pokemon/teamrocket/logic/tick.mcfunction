execute if entity @s[scores={useAbility=1..,cooldown.1=..0},nbt={SelectedItem:{tag:{acid:1}}}] at @s run function ssbrc:series/pokemon/teamrocket/logic/arbok/acid
...
# Payday
execute as @e[tag=teamrocket.meowth.payday] at @s run function ssbrc:series/pokemon/teamrocket/logic/meowth/payday/entity
