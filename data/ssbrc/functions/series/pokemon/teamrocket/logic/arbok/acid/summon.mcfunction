...
summon minecraft:snowball ^ ^ ^1 {Tags:["vehicleProjectile"],Motion:[0.0d,0.1d,0.0d],Passengers:[{id:"minecraft:area_effect_cloud",Tags:["acid","projectile"],Age:-2147483648,Duration:-1,WaitTime:-2147483648}]}
