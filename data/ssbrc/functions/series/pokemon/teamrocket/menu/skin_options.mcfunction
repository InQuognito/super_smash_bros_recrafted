...
tellraw @s[tag=!gold,advancements={ssbrc:series/pokemon/teamrocket/skins/gold=true}] [{"translate":"ssbrc.fighters.skin.gold","color":"gold","clickEvent":{"action":"run_command","value":"/trigger menu set 1945"}}]
