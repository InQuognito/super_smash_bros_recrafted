...
execute unless score @s[advancements={ssbrc:series/pokemon/jigglypuff/skins/shiny=true}] skinPicked matches 1 if score result random matches 2 run function ssbrc:series/pokemon/jigglypuff/menu/skins/shiny

execute if score @s skinPicked matches 1 run function ssbrc:series/pokemon/jigglypuff/menu/select_character
