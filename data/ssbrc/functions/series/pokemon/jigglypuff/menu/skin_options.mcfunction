...
tellraw @s[advancements={ssbrc:series/pokemon/jigglypuff/a_fateful_encounter=true}] [{"text":"[ ","color":"dark_green"},{"text":"Shiny","color":"light_purple","clickEvent":{"action":"run_command","value":"/trigger menu set 586"}},{"text":" ]","color":"dark_green"}]
