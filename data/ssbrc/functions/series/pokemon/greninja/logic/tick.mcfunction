...
tag @s add self
execute as @e[type=minecraft:arrow,tag=waterShuriken] at @s if score @s id = @p[tag=self] id run function ssbrc:series/pokemon/greninja/logic/water_shuriken/tick
tag @s remove self
