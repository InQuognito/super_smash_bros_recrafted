...
execute if entity @s[predicate=ssbrc:flag/sneaking,scores={cooldown.3=..0}] unless score @s charge.3 matches 1.. at @s run function ssbrc:series/pokemon/greninja/logic/abilities/shadow_sneak/activate
...
# Shadow Sneak
execute if entity @s[predicate=!ssbrc:flag/sneaking,scores={charge.3=1..}] run function ssbrc:series/pokemon/greninja/logic/abilities/shadow_sneak/deactivate
