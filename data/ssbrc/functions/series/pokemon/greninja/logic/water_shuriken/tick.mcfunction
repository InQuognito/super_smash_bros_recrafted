...
execute if score @s temp matches 30.. run function ssbrc:series/pokemon/greninja/logic/water_shuriken/kill
execute unless block ^ ^ ^1 #ssbrc:passthrough run function ssbrc:series/pokemon/greninja/logic/water_shuriken/kill
