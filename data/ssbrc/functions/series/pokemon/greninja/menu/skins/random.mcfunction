...
execute unless score @s[advancements={ssbrc:series/pokemon/greninja/a_fateful_encounter=true}] skinPicked matches 1 if score result random matches 2 run function ssbrc:series/pokemon/greninja/menu/skins/shiny
