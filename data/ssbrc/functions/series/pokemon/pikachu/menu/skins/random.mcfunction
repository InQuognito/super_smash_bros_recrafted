...
execute unless score @s[advancements={ssbrc:series/pokemon/pikachu/shiny=true}] skinPicked matches 1 if score result random matches 2 run function ssbrc:series/pokemon/pikachu/menu/skins/shiny
