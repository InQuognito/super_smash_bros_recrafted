...
tellraw @s[tag=!gold,advancements={ssbrc:series/pokemon/pikachu/skins/gold=true}] [{"translate":"ssbrc.fighters.skin.gold","color":"gold","clickEvent":{"action":"run_command","value":"/trigger menu set 1205"}}]
tellraw @s[tag=gold] [{"translate":"ssbrc.fighters.skin.gold","color":"gold"},{"text":" ","color":"white"},{"text":"✔","color":"green"}]

tellraw @s[tag=!shiny,advancements={ssbrc:series/pokemon/pikachu/skins/shiny=true}] [{"translate":"ssbrc.series.pokemon.skins.shiny","color":"gold","clickEvent":{"action":"run_command","value":"/trigger menu set 1206"}}]
tellraw @s[tag=shiny] [{"translate":"ssbrc.series.pokemon.skins.shiny","color":"gold"},{"text":" ","color":"white"},{"text":"✔","color":"green"}]
