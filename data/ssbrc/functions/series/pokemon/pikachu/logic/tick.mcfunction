...
# Balloon Ring
execute if entity @s[tag=!balloonRing,tag=!balloonRingCooldown,predicate=ssbrc:flag/sneaking] at @s if block ~ ~-0.1 ~ minecraft:air run function ssbrc:series/pokemon/pikachu/logic/abilities/balloon_ring/activate
