...
execute if entity @s[scores={useAbility=1..},nbt={SelectedItem:{tag:{electricTerrain:1}}}] at @s run function ssbrc:series/pokemon/pikachu/logic/abilities/electric_terrain/check
