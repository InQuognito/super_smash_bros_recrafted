...
execute positioned ~-0.075 ~-0.075 ~-0.075 as @a[tag=alive,scores={respawn=..0},gamemode=adventure,dx=0] positioned ~-0.85 ~-0.85 ~-0.85 if entity @s[dx=0] unless score @s id = @e[type=minecraft:marker,tag=fireball,sort=nearest,limit=1] id run tag @s add damage.fireball
