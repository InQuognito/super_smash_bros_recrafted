...
execute unless score #pointSlope temp matches 130.. run scoreboard players operation @s point -= @s slope
execute unless score #pointSlope temp matches 130.. run scoreboard players remove @s slope 10
