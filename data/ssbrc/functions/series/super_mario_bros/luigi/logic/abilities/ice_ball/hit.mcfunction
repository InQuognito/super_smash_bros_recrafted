...
execute as @e[type=area_effect_cloud,tag=iceBall,sort=nearest,limit=1] at @s run function ssbrc:series/super_mario_bros/luigi/logic/abilities/ice_ball/kill
