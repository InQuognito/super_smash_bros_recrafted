summon minecraft:area_effect_cloud ~ ~1 ~ {Tags:["damage.iceBall","modifyEntity"],Radius:0.0f,Duration:10,ReapplicationDelay:9999,Effects:[{Id:7,Amplifier:0b,Duration:1,ShowParticles:0b}]}
