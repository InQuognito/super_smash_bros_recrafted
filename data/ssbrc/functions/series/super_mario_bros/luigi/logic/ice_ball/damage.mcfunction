...
execute if score @s damage matches 1 run summon minecraft:area_effect_cloud ~ ~1 ~ {Tags:["damage.iceBall","projectile"],Radius:1.0f,Duration:10,Effects:[{Id:7,Amplifier:0b,Duration:1,ShowParticles:0b}]}
