...
execute if score @s damage matches 1 run summon minecraft:area_effect_cloud ~ ~1 ~ {Tags:["damage.iceBall","projectile"],Radius:0f,Duration:6,DurationOnUse:-100,Age:4,WaitTime:0,ReapplicationDelay:0,Effects:[{Id:7b,Amplifier:0b,Duration:1,ShowParticles:0b},{Id:2b,Amplifier:0b,Duration:40,ShowParticles:0b}]}
