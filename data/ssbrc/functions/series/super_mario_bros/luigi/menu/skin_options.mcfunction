...
tellraw @s[advancements={ssbrc:series/super_mario_bros/luigi/skins/flower_power=true}] [{"translate":"[ ","color":"dark_green"},{"text":"Flower Power","color":"green","clickEvent":{"action":"run_command","value":"/trigger menu set 826"}},{"translate":" ]","color":"dark_green"}]
