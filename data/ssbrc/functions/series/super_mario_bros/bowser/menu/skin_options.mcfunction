...
tellraw @s[advancements={ssbrc:series/super_mario_bros/bowser/skins/bowsette=true}] [{"translate":"[ ","color":"dark_green"},{"text":"Bowsette","color":"yellow","clickEvent":{"action":"run_command","value":"/trigger menu set 66"}},{"translate":" ]","color":"dark_green"}]
