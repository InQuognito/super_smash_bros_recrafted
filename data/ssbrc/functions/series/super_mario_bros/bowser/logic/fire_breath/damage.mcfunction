...
execute if score @s damage matches 1 run summon minecraft:area_effect_cloud ~ ~1 ~ {Tags:["damage.fireBreath","projectile"],Radius:0f,Duration:6,DurationOnUse:-100,Age:4,Effects:[{Id:20b,Amplifier:4b,Duration:6,ShowParticles:0b},{Id:20b,Amplifier:0b,Duration:60,ShowParticles:0b}]}
