...
function ssbrc:series/super_mario_bros/bowser/logic/abilities/fire_breath/update

# Rage
execute if score @s charge.2 matches 200.. run function ssbrc:series/super_mario_bros/bowser/logic/abilities/rage/activate
