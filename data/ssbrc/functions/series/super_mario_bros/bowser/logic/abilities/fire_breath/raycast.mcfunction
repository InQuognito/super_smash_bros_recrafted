...
execute positioned ~-0.5 ~-0.5 ~-0.5 as @e[tag=!self,nbt=!{Inventory:[{tag:{goronLocket:1}}]},predicate=ssbrc:flag/targets,dx=0] run function ssbrc:series/super_mario_bros/bowser/logic/abilities/fire_breath/hit
