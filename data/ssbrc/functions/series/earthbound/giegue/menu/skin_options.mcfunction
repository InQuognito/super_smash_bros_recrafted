...
tellraw @s[tag=!gold,advancements={ssbrc:series/earthbound/giegue/skins/gold=true}] [{"translate":"ssbrc.fighters.skin.gold","color":"gold","clickEvent":{"action":"run_command","value":"/trigger menu set 1865"}}]
tellraw @s[tag=gold,advancements={ssbrc:series/earthbound/giegue/skins/gold=true}] [{"translate":"ssbrc.fighters.skin.gold","color":"gold"},{"text":" ","color":"white"},{"text":"✔","color":"green"}]
