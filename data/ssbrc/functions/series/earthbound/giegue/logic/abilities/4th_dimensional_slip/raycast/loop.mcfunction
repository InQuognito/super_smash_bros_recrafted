particle minecraft:dust 1.0 0.75 1.0 0.5 ~ ~ ~ 0.05 0.05 0.05 0.0 5 normal @a
...
execute if score $rayLength temp matches 1.. if block ^ ^ ^1 #ssbrc:passthrough_charge positioned ^ ^ ^0.1 run function ssbrc:series/earthbound/giegue/logic/abilities/4th_dimensional_slip/raycast/loop
