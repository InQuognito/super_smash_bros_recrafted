...
execute if entity @s[predicate=ssbrc:flag/sneaking,scores={cooldown.3=..0}] at @s run function ssbrc:series/earthbound/giegue/logic/abilities/4th_dimensional_slip/activate
