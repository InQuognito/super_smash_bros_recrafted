...
execute if entity @s[scores={useAbility=1..,cooldown.3=..0},nbt={SelectedItem:{tag:{4thDimensionalSlip:1}}}] at @s run function ssbrc:series/earthbound/giegue/logic/abilities/4th_dimensional_slip/activate

execute if entity @s[predicate=ssbrc:flag/sneaking,scores={cooldown.1=..0}] at @s run function ssbrc:series/earthbound/giegue/logic/abilities/4th_dimensional_slip/activate
