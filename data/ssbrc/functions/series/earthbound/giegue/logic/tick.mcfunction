...
execute if entity @s[scores={useAbility=1..,cooldown.3=..0},nbt={SelectedItem:{tag:{4thDimensionalSlip:1}}}] at @s run function ssbrc:series/earthbound/giegue/logic/abilities/pk_freeze/activate
