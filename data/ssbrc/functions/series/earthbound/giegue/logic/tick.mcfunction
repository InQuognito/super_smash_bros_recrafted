...
execute as @e[type=minecraft:area_effect_cloud,tag=pkFreeze] at @s run function ssbrc:series/earthbound/giegue/logic/abilities/pk_freeze/tick
execute as @e[type=minecraft:area_effect_cloud,tag=pkBeam] at @s run function ssbrc:series/earthbound/giegue/logic/abilities/pk_beam/tick
