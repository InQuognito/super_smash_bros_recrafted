...
execute as @e[predicate=ssbrc:flag/targets,nbt=!{Inventory:[{tag:{goronLocket:1}}]},distance=..1.5] run function ssbrc:series/earthbound/ness/logic/abilities/pk_fire/hit
