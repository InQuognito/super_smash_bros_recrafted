...
execute if score @s charge.output matches 81.. at @s rotated as @e[tag=byleth.spinner,limit=1] run particle minecraft:dust 0.25 0.0 0.0 1.0 ^ ^ ^5.0 0.0 0.0 0.0 0 1 normal @a
