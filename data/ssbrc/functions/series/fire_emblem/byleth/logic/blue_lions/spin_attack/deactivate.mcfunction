tag @s add self
execute if score @s charge.output matches 21..40 as @e[tag=!self,predicate=ssbrc:flag/targets,distance=..3] run damage @s 8.0 ssbrc:projectile by @p[tag=self]
execute if score @s charge.output matches 41..60 as @e[tag=!self,predicate=ssbrc:flag/targets,distance=..3.5] run damage @s 10.0 ssbrc:projectile by @p[tag=self]
...
execute if score @s charge.output matches 81.. as @e[tag=!self,predicate=ssbrc:flag/targets,distance=..5.0] run damage @s 14.0 ssbrc:projectile by @p[tag=self]
