...
execute if score @s[tag=byleth.blackEagles] charge.2 matches 6.. run function ssbrc:series/fire_emblem/byleth/logic/aymr_restore
execute if score @s[tag=byleth.blueLions] charge.2 matches 4.. run function ssbrc:series/fire_emblem/byleth/logic/areadbhar_restore
execute if score @s[tag=byleth.goldenDeer] charge.2 matches 4.. run function ssbrc:series/fire_emblem/byleth/logic/failnaught_restore
