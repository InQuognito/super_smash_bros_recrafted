#execute if entity @s[tag=byleth.blackEagles,predicate=ssbrc:flag/sneaking,nbt={SelectedItem:{tag:{aymr:1}}},scores={cooldown.1=..0}] run function ssbrc:series/fire_emblem/byleth/logic/abilities/mist/on
