execute if entity @s[tag=blackEagles,scores={useAbility=1..,cooldown.1=..0,charge.output=100..},nbt={SelectedItem:{tag:{aymr:1,awakened:0}}}] run function ssbrc:series/fire_emblem/byleth/logic/black_eagles/aymr/awaken
execute if entity @s[tag=blackEagles,scores={useAbility=1..,cooldown.1=..0},nbt={SelectedItem:{tag:{aymr:1,awakened:1}}}] at @s unless block ~ ~-0.1 ~ minecraft:air rotated ~ 0.0 positioned ^ ^ ^1 unless block ~ ~-0.1 ~ #ssbrc:passthrough run function ssbrc:series/fire_emblem/byleth/logic/black_eagles/ground_pound/activate
