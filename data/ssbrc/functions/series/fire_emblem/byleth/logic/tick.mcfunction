...
execute if entity @s[tag=byleth.blueLions,predicate=!ssbrc:flag/sneaking,scores={charge.2=1..}] at @s run function ssbrc:series/fire_emblem/byleth/logic/abilities/spin_attack/deactivate
...
execute if entity @s[scores={charge.2=1..}] at @s anchored eyes run function ssbrc:series/fire_emblem/byleth/logic/abilities/spin_attack/charge
