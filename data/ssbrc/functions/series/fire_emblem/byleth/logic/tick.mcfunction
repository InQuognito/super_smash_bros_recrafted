execute if entity @s[tag=blackEagles,predicate=ssbrc:flag/sneaking,scores={useAbility=1..,cooldown.1=..0,charge.output=30..},nbt={SelectedItem:{tag:{aymr:1,awakened:0}}}] run function ssbrc:series/fire_emblem/byleth/logic/black_eagles/aymr/awaken
...
# Steed Charge
function ssbrc:series/fire_emblem/byleth/logic/blue_lions/steed_charge/cooldown
