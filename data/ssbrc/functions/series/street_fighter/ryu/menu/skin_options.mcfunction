...
tellraw @s[advancements={ssbrc:series/street_fighter/ryu/skins/hot=true}] [{"text":"[ ","color":"dark_green"},{"text":"Hot","color":"white","clickEvent":{"action":"run_command","value":"/trigger menu set 1406"}},{"text":" ]","color":"dark_green"}]
