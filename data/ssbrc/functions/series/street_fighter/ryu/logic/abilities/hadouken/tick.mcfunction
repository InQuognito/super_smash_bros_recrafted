execute if entity @s[tag=default,tag=!heavy] run particle minecraft:soul_fire_flame ~ ~ ~ 0.15 0.15 0.15 0.01 15 normal @a
execute if entity @s[tag=default,tag=heavy] run particle minecraft:flame ~ ~ ~ 0.25 0.25 0.25 0.01 25 normal @a
execute if entity @s[tag=evil,tag=!heavy] run particle minecraft:dust_color_transition 0.25 0.0 1.0 1.0 0.5 0.0 1.0 ~ ~ ~ 0.15 0.15 0.15 0.0 15 normal @a
execute if entity @s[tag=evil,tag=heavy] run particle minecraft:dust_color_transition 0.25 0.0 1.0 1.0 0.5 0.0 1.0 ~ ~ ~ 0.25 0.25 0.25 0.0 25 normal @a
