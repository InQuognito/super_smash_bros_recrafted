...
execute if entity @s[tag=!evil,tag=!heavy] positioned ~-0.25 ~-0.25 ~-0.25 as @e[tag=!self,predicate=ssbrc:flag/targets,dx=0] positioned ~-0.5 ~-0.5 ~-0.5 if entity @s[dx=0] run function ssbrc:series/street_fighter/ryu/logic/abilities/hadouken/hit/default/default
execute if entity @s[tag=!evil,tag=heavy] positioned ~-0.5 ~-0.5 ~-0.5 as @e[tag=!self,predicate=ssbrc:flag/targets,dx=0] run function ssbrc:series/street_fighter/ryu/logic/abilities/hadouken/hit/default/heavy
