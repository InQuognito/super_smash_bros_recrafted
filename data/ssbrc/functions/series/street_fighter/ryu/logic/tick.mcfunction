execute if entity @s[scores={charge.step=5..,cooldown.1=..0},nbt={SelectedItem:{tag:{collarboneBreaker:1}}}] at @s run function ssbrc:series/street_fighter/ryu/logic/abilities/hadouken/check
...
# Satsui no Hado Rage
execute if entity @s[scores={duration.1=1}] run function ssbrc:series/street_fighter/ryu/logic/abilities/satsui_no_hado_rage/deactivate
