...
execute unless score @s duration.1 matches 2.. if score @s[predicate=!ssbrc:flag/sneaking] charge.2 >= #ryu.tatsumakiSenpukyaku vars at @s run function ssbrc:series/street_fighter/ryu/logic/abilities/tatsumaki_senpukyaku/activate
execute if score @s duration.1 matches 2.. if score @s[predicate=!ssbrc:flag/sneaking] charge.2 >= #ryu.tatsumakiSenpukyaku vars at @s run function ssbrc:series/street_fighter/ryu/logic/abilities/ashura_senku/activate
