...
# Guardian Orbitars
execute at @s[tag=!guardianOrbitars,predicate=ssbrc:flag/sneaking,nbt={SelectedItem:{tag:{palutenaBow:1}}}] rotated ~ 0.0 run function ssbrc:series/kid_icarus/pit/logic/abilities/guardian_orbitars/activate
