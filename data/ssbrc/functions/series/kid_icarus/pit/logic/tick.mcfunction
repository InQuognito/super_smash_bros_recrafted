...
# Guardian Orbitars
execute at @s[tag=!guardianOrbitars,predicate=ssbrc:flag/sneaking,nbt={SelectedItem:{tag:{palutenaBow:1}}},scores={cooldown.2=..0}] rotated ~ 0.0 run function ssbrc:series/kid_icarus/pit/logic/abilities/guardian_orbitars/activate
execute at @s[tag=guardianOrbitars,nbt=!{SelectedItem:{tag:{palutenaBow:1}}}] run function ssbrc:series/kid_icarus/pit/logic/abilities/guardian_orbitars/deactivate
