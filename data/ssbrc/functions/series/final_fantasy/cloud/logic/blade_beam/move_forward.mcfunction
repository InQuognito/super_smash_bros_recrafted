...
execute positioned ~-0.15 ~ ~-0.15 as @e[tag=!self,predicate=ssbrc:flag/targets,dy=1] positioned ~-0.7 ~ ~-0.7 if entity @s[dy=1] run function ssbrc:series/final_fantasy/cloud/logic/blade_beam/hit
