...
execute if score @s charge.1 matches 5 run damage @e[predicate=ssbrc:flag/targets,tag=crossSlashTarget,sort=nearest,limit=1] 6.0 ssbrc:projectile by @p[tag=self]
...
execute if score @s charge.1 matches 30 run damage @e[predicate=ssbrc:flag/targets,tag=crossSlashTarget,sort=nearest,limit=1] 6.0 ssbrc:projectile by @p[tag=self]
...
execute if score @s charge.1 matches 60 run damage @e[predicate=ssbrc:flag/targets,tag=crossSlashTarget,sort=nearest,limit=1] 6.0 ssbrc:projectile by @p[tag=self]
...
execute if score @s charge.1 matches 90 run damage @e[predicate=ssbrc:flag/targets,tag=crossSlashTarget,sort=nearest,limit=1] 24.0 ssbrc:projectile by @p[tag=self]
