...
execute if score @s duration.1 matches 30 run damage @e[predicate=ssbrc:flag/targets,tag=crossSlashTarget,sort=nearest,limit=1] 6.0 ssbrc:projectile by @p[tag=self]
...
execute if score @s duration.1 matches 20 run damage @e[predicate=ssbrc:flag/targets,tag=crossSlashTarget,sort=nearest,limit=1] 6.0 ssbrc:projectile by @p[tag=self]
...
execute if score @s duration.1 matches 10 run damage @e[predicate=ssbrc:flag/targets,tag=crossSlashTarget,sort=nearest,limit=1] 6.0 ssbrc:projectile by @p[tag=self]
...
execute if score @s duration.1 matches 1 run damage @e[predicate=ssbrc:flag/targets,tag=crossSlashTarget,sort=nearest,limit=1] 24.0 ssbrc:projectile by @p[tag=self]
