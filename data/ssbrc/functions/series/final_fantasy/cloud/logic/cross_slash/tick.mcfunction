...
execute if score @s charge.1 matches 1 run tag @a[tag=crossSlashTarget] add damage.crossSlash
...
execute if score @s charge.1 matches 30 run tag @a[tag=crossSlashTarget] add damage.crossSlash
...
execute if score @s charge.1 matches 60 run tag @a[tag=crossSlashTarget] add damage.crossSlash
