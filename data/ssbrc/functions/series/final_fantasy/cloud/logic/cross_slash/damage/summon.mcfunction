...
execute if entity @s[tag=damage.crossSlash.2] run summon minecraft:area_effect_cloud ~ ~1 ~ {Tags:["damage.crossSlash","projectile"],Radius:0.0f,Duration:10,ReapplicationDelay:9999,Effects:[{Id:7,Amplifier:2b,Duration:1,ShowParticles:0b}]}
