...
tellraw @s[advancements={ssbrc:series/indie_fighters/steve/skins/alex=true}] [{"translate":"[ ","color":"dark_green"},{"text":"Alex","color":"yellow","clickEvent":{"action":"run_command","value":"/trigger menu set 1586"}},{"translate":" ]","color":"dark_green"}]
tellraw @s[advancements={ssbrc:series/indie_fighters/steve/skins/herobrine=true}] [{"translate":"[ ","color":"dark_green"},{"text":"Herobrine","color":"white","clickEvent":{"action":"run_command","value":"/trigger menu set 1587"}},{"translate":" ]","color":"dark_green"}]
