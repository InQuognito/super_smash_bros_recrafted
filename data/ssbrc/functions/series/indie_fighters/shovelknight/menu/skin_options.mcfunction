...
tellraw @s[tag=!toadGear,advancements={ssbrc:series/indie_fighters/shovelknight/skins/toad_gear=true}] [{"translate":"ssbrc.fighters.shovelKnight.skin.toadGear","color":"red","clickEvent":{"action":"run_command","value":"/trigger menu set 1927"}}]
