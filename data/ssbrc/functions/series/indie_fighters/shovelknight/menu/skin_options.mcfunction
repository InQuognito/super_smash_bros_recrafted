...
tellraw @s[advancements={ssbrc:series/indie_fighters/shovelknight/skins/armor_of_chaos=true}] [{"translate":"[ ","color":"dark_green"},{"text":"Armor of Chaos","color":"red","clickEvent":{"action":"run_command","value":"/trigger menu set 1926"}},{"translate":" ]","color":"dark_green"}]
tellraw @s[advancements={ssbrc:series/indie_fighters/shovelknight/skins/toad_gear=true}] [{"translate":"[ ","color":"dark_green"},{"text":"Toad Gear","color":"green","clickEvent":{"action":"run_command","value":"/trigger menu set 1927"}},{"translate":" ]","color":"dark_green"}]
