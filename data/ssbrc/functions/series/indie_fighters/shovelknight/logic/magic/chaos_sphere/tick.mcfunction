...
execute if score @s point < #shovelknight.chaosSphereMaxRotation vars run scoreboard players remove @s slope 10

execute if score @s point > 0 integers unless block ~ ~-0.6 ~ #ssbrc:passthrough run function ssbrc:series/indie_fighters/shovelknight/logic/magic/chaos_sphere/bounce
