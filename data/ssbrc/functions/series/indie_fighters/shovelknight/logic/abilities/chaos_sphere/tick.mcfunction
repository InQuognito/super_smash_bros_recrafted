...
execute positioned ~-0.375 ~-0.375 ~-0.375 as @a[tag=alive,scores={respawn=..0},gamemode=adventure,dx=0] positioned ~-0.25 ~-0.25 ~-0.25 if entity @s[dx=0] unless score @s id = @e[type=minecraft:marker,tag=chaosSphere,sort=nearest,limit=1] id run tag @s add damage.chaosSphere
