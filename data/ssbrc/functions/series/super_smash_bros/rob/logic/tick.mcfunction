...
# Robo Burner
execute if entity @s[predicate=ssbrc:flag/sneaking,scores={charge.2=1..}] at @s unless block ~ ~-0.1 ~ #ssbrc:passthrough_charge run function ssbrc:series/super_smash_bros/rob/logic/abilities/robo_burner/tick
