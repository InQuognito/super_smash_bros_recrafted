...
execute if entity @s[predicate=ssbrc:flag/sneaking,scores={charge.2=1..}] at @s run function ssbrc:series/super_smash_bros/rob/logic/abilities/robo_burner/tick
