...
execute if entity @s[tag=small] positioned ~-0.25 ~-0.25 ~-0.25 as @e[tag=!self,predicate=ssbrc:flag/targets,dx=0] positioned ~-0.5 ~-0.5 ~-0.5 if entity @s[dx=0] run function ssbrc:series/super_smash_bros/rob/logic/abilities/robo_beam/hit
execute if entity @s[tag=large] positioned ~-0.5 ~-0.5 ~-0.5 as @e[tag=!self,predicate=ssbrc:flag/targets,dx=0] run function ssbrc:series/super_smash_bros/rob/logic/abilities/robo_beam/hit
