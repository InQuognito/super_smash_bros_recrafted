...
tellraw @s[advancements={ssbrc:series/super_smash_bros/rob/skins/famicom=true}] [{"translate":"[ ","color":"dark_green"},{"text":"Famicom","color":"red","clickEvent":{"action":"run_command","value":"/trigger menu set 7"}},{"translate":" ]","color":"dark_green"}]
tellraw @s[advancements={ssbrc:series/super_smash_bros/rob/skins/ancient_minister=true}] [{"translate":"[ ","color":"dark_green"},{"text":"Ancient Minister","color":"dark_green","clickEvent":{"action":"run_command","value":"/trigger menu set 8"}},{"translate":" ]","color":"dark_green"}]
