...
tellraw @s[advancements={ssbrc:series/super_smash_bros/rob/skins/ancient_minister=true}] [{"text":"[ ","color":"dark_green"},{"text":"Ancient Minister","color":"dark_green","clickEvent":{"action":"run_command","value":"/trigger menu set 7"}},{"text":" ]","color":"dark_green"}]
