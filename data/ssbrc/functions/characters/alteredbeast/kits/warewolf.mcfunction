...
item replace entity @s hotbar.1 with carrot_on_a_stick{flameHands:1,Unbreakable:1,AttributeModifiers:[{AttributeName:"generic.attack_damage",Amount:4,Slot:mainhand,Name:"generic.attack_damage",UUID:[I;-1211022,10969,201940,-21938]},{AttributeName:"generic.attack_speed",Amount:-1.2,Slot:mainhand,Name:"generic.attack_speed",UUID:[I;-1211022,11069,201940,-22138]}],Enchantments:[{id:"fire_aspect",lvl:1}],display:{Name:'[{"text":"Flame Hands","italic":false,"color":"red"}]'},HideFlags:127} 1
