...
execute if score @s temp matches ..60 if score $waveLength temp matches 0 positioned ^ ^ ^0.1 run function ssbrc:characters/samus/logic/weapons/wave_beam/move_forward
