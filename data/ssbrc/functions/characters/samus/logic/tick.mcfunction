...
execute if score #samusEnergy temp matches 3.. run scoreboard players add @s[scores={samus.energy=..99}] samus.energy 1
execute if score #samusEnergy temp matches 3.. run scoreboard players set #samusEnergy temp 0
