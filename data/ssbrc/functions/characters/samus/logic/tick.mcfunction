execute if entity @s[scores={useAbility=1..,cooldown.1=..0,samus.energy=20..},nbt={SelectedItem:{tag:{ability.samus:1}}}] at @s anchored eyes run function ssbrc:characters/samus/logic/weapons/power_beam/summon
execute if entity @s[scores={useAbility=1..,cooldown.2=..0,samus.energy=30..},nbt={SelectedItem:{tag:{ability.samus:2}}}] at @s anchored eyes run function ssbrc:characters/samus/logic/weapons/wave_beam/summon
execute if entity @s[scores={useAbility=1..,cooldown.3=..0,samus.energy=40..},nbt={SelectedItem:{tag:{ability.samus:3}}}] at @s anchored eyes run function ssbrc:characters/samus/logic/weapons/plasma_beam/summon
