...
item modify entity @s armor.chest ssbrc:kits/armor/remove
item modify entity @s armor.legs ssbrc:kits/armor/remove
item modify entity @s armor.feet ssbrc:kits/armor/remove
