...
execute anchored eyes run summon minecraft:fireball ^ ^ ^1.5 {ExplosionPower:1,Tags:["projectile"]}
...
scoreboard players operation @s mana -= #shovelknight.bangManaCost vars
scoreboard players set @s shovelknight.bang 10
