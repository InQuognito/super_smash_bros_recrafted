...
execute if entity @s[predicate=ssbrc:awakened,predicate=!ssbrc:sneaking,scores={useAbility=1..,link.swordBeam=..0},nbt={SelectedItem:{tag:{masterSword:1}}}] at @s anchored eyes run function ssbrc:characters/link/logic/weapons/sword_beam/summon
