...
execute if entity @s[scores={useAbility=1..},nbt={SelectedItem:{tag:{boomerang:1}}}] at @s anchored eyes run function ssbrc:characters/link/logic/weapons/boomerang/summon
...
execute if entity @s[scores={charge.1=1..}] at @s anchored eyes run function ssbrc:characters/link/logic/weapons/sword_spin/charge
