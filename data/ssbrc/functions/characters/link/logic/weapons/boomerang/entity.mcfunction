...
execute if score @s debug matches 20.. as @a[tag=alive,scores={respawn=..0},tag=link] if score @s id = #temp id facing entity @s eyes run function ssbrc:characters/link/logic/weapons/boomerang/movement_return
