...
execute if score @s temp matches 41.. if score @s id = @p[dx=1.0,dy=1.0,dz=1.0] id run give @p[dx=1.0,dy=1.0,dz=1.0] minecraft:carrot_on_a_stick{link.ability:1,CustomModelData:-4,Unbreakable:1,display:{Name:'[{"text":"Boomerang","italic":false,"color":"gold"}]'},HideFlags:127} 1
