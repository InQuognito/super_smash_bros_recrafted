...
give @s[tag=snake.sg] minecraft:carrot_on_a_stick{SG:1,CustomModelData:-9,Unbreakable:1,display:{Name:'[{"text":"Smoke Grenade","italic":false,"color":"green","bold":true}]'},HideFlags:127} 1
