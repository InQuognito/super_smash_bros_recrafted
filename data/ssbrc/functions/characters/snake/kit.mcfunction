give @s[tag=snake.psg1] minecraft:carrot_on_a_stick{PSG1:1,CustomModelData:-9,Unbreakable:1,display:{Name:'[{"text":"PSG-1","italic":false,"color":"green","bold":true}]'},HideFlags:127} 1
give @s[tag=snake.famas] minecraft:carrot_on_a_stick{Famas:1,CustomModelData:-8,Unbreakable:1,display:{Name:'[{"text":"FAMAS","italic":false,"color":"green","bold":true}]'},HideFlags:127} 1
give @s[tag=snake.s1000] minecraft:carrot_on_a_stick{S1000:1,CustomModelData:-10,Unbreakable:1,display:{Name:'[{"text":"S1000","italic":false,"color":"green","bold":true}]'},HideFlags:127} 1
give @s[tag=snake.socom] minecraft:carrot_on_a_stick{Socom:1,CustomModelData:-11,Unbreakable:1,display:{Name:'[{"text":"SOCOM","italic":false,"color":"green","bold":true}]'},HideFlags:127} 1
...
give @s[tag=snake.sg] minecraft:carrot_on_a_stick{SG:1,CustomModelData:-12,Unbreakable:1,display:{Name:'[{"text":"Smoke Grenade","italic":false,"color":"green","bold":true}]'},HideFlags:127} 1
