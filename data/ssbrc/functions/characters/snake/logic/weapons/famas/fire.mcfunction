...
execute at @s anchored eyes run summon minecraft:arrow ^ ^ ^1 {damage:0.4,Tags:["famasBullet","bullet","killInGround","projectile"],NoGravity:1b}
...
execute if score @s snake.famasA matches 0 run tag @s add snake.famasR
scoreboard players set @s[tag=snake.famasR] snake.famasR 50
