...
execute as @a[scores={useAbility=1..,mana=2..,bang=..0},nbt={SelectedItem:{tag:{ability.hero:2}}}] at @s run function ssbrc:characters/hero/logic/magic/bang
...
scoreboard players remove @s[scores={bang=1..}] bang 1
