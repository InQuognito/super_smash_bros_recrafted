...
execute as @a[scores={useAbility=1..,mana=2..,hero.bang=..0},nbt={SelectedItem:{tag:{ability.hero:2}}}] at @s run function ssbrc:characters/hero/logic/magic/bang
...
# Magic Burst
scoreboard players add @s[tag=magicBurst] hero.magicBurst 1

execute as @s[scores={hero.magicBurst=1..10}] at @s run particle minecraft:portal ~ ~ ~ 0.0 0.0 0.0 0.75 10 normal @a
execute as @s[scores={hero.magicBurst=5..15}] at @s run particle minecraft:portal ~ ~ ~ 0.0 0.0 0.0 1.3 25 normal @a
execute as @s[scores={hero.magicBurst=10..20}] at @s run particle minecraft:portal ~ ~ ~ 0.0 0.0 0.0 3.0 75 normal @a
execute as @s[scores={hero.magicBurst=70..100}] at @s run particle minecraft:dust 0.75 0.0 0.75 2.0 ~ ~ ~ 3.0 3.0 3.0 0.15 750 normal @a
execute as @s[scores={hero.magicBurst=70..100}] at @s run particle minecraft:dust 1.0 0.0 1.0 1.0 ~ ~ ~ 4.0 4.0 4.0 1.5 100 normal @a

execute as @s[scores={hero.magicBurst=70}] at @s run function ssbrc:characters/hero/logic/magic/magic_burst

tag @s[scores={hero.magicBurst=101}] remove magicBurst
scoreboard players reset @s[scores={hero.magicBurst=101}] hero.magicBurst
