...
tellraw @s[advancements={ssbrc:characters/steve/costumes/gold=true}] [{"text":"[ ","color":"dark_green"},{"text":"Gold","color":"gold","clickEvent":{"action":"run_command","value":"/execute as @s[tag=!steve.default] run function ssbrc:characters/steve/menu/costumes/gold"}},{"text":" ]","color":"dark_green"}]
