...
execute store result score #phazonSpikePosY temp run data get entity @e[tag=phazonSpike.marker,limit=1] Pos[1]
...
scoreboard players operation #phazonSpikeOffsetY temp = result random
scoreboard players add #phazonSpikeOffsetY temp 1

scoreboard players operation #phazonSpikePosX temp += #phazonSpikeOffsetX temp
scoreboard players operation #phazonSpikePosY temp += #phazonSpikeOffsetY temp

execute store result entity @e[tag=phazonSpike.marker,limit=1] Pos[0] int 1.0 run scoreboard players get #phazonSpikePosX temp
execute store result entity @e[tag=phazonSpike.marker,limit=1] Pos[1] int 1.0 run scoreboard players get #phazonSpikePosY temp
