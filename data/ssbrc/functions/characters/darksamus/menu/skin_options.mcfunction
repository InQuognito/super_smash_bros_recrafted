...
tellraw @s[advancements={ssbrc:series/metroid/darksamus/costumes/gold=true}] [{"text":"[ ","color":"dark_green"},{"text":"Gold","color":"gold","clickEvent":{"action":"run_command","value":"/execute as @s[tag=!gold] run function ssbrc:characters/darksamus/menu/costumes/gold"}},{"text":" ]","color":"dark_green"}]
