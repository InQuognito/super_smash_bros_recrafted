tellraw @s [{"text":"Unlocked Costumes:","bold":true,"color":"yellow"},{"text":"\n"},{"text":"[ ","color":"dark_green","bold":false},{"text":"Default","color":"green","clickEvent":{"action":"run_command","value":"/execute as @s[tag=!default] run function ssbrc:characters/greninja/menu/costumes/default"}},{"text":" ]","color":"dark_green"}]
