...
execute if score @s charge.2 matches 70..80 run particle minecraft:dust 0.3 0.0 0.0 2.0 ~ ~ ~ 1.0 1.0 1.0 0.15 500 normal @a
execute if score @s charge.2 matches 70..80 run particle minecraft:dust 0.5 0.0 0.0 1.0 ~ ~ ~ 2.0 2.0 2.0 1.5 75 normal @a
