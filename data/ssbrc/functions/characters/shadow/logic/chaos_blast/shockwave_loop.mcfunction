...
summon minecraft:spectral_arrow ^ ^ ^1 {damage:10.0,Tags:["chaosBlastShockwave","projectile"],NoGravity:1b}
...
execute if entity @s[scores={temp=..360}] run function ssbrc:characters/shadow/logic/chaos_blast/shockwave_loop
