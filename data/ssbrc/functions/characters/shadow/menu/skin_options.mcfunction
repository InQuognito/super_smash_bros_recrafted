...
tellraw @s[advancements={ssbrc:characters/shadow/costumes/alt=true}] [{"text":"[ ","color":"dark_green"},{"text":"Gold","color":"yellow","clickEvent":{"action":"run_command","value":"/execute as @s[tag=!alt] run function ssbrc:characters/shadow/menu/costumes/alt"}},{"text":" ]","color":"dark_green"}]
