...
tellraw @s [{"text":"[ ","color":"dark_green","bold":false},{"text":"Male","color":"green","clickEvent":{"action":"run_command","value":"/execute as @s[tag=!byleth.male] run function ssbrc:characters/byleth/menu/costumes/male"}},{"text":" ]","color":"dark_green"}]
tellraw @s [{"text":"[ ","color":"dark_green","bold":false},{"text":"Female","color":"green","clickEvent":{"action":"run_command","value":"/execute as @s[tag=!byleth.female] run function ssbrc:characters/byleth/menu/costumes/female"}},{"text":" ]","color":"dark_green"}]
