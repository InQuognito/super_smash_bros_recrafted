...
tellraw @s [{"text":"[ ","color":"dark_green","bold":false},{"text":"Female","color":"green","clickEvent":{"action":"run_command","value":"/execute as @s[tag=!byleth.female] run function ssbrc:characters/byleth/menu/gender/female"}},{"text":" | ","color":"dark_green"},{"text":"Male","color":"green","clickEvent":{"action":"run_command","value":"/execute as @s[tag=!byleth.male] run function ssbrc:characters/byleth/menu/gender/male"}},{"text":" ]","color":"dark_green"}]
