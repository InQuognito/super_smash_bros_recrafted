...
execute if score @s[tag=byleth.goldenDeer] charge.1 matches 10.. run function ssbrc:characters/byleth/logic/failnaught_break
...
scoreboard players reset @s[tag=byleth.goldenDeer,scores={charge.1=10..}] charge.1
