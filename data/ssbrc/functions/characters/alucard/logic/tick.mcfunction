...
execute as @s[tag=!alucard.ability,scores={useAbility=1..,cooldown.3=..0},nbt={SelectedItem:{tag:{ability.alucard:2}}}] at @s run function ssbrc:characters/alucard/logic/abilities/dark_metamorphosis
