execute as @s[scores={useAbility=1..,cooldown.3=..0},nbt={SelectedItem:{tag:{ability.alucard:1}}}] at @s run function ssbrc:characters/alucard/logic/abilities/dark_metamorphosis
