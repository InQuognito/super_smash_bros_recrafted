...
execute as @s[scores={useAbility=1..,cooldown.3=..0},nbt={SelectedItem:{tag:{destinyBond:1}}}] at @s run function ssbrc:characters/teamrocket/logic/wobbuffett/destiny_bond
