execute if entity @s[tag=operator,predicate=ssbrc:flag/sneaking,scores={useAbility=1..},nbt={SelectedItem:{tag:{busterSword:1}}}] run function ssbrc:characters/cloud/logic/formation_switch/punisher
execute if entity @s[tag=punisher,predicate=ssbrc:flag/sneaking,scores={useAbility=1..},nbt={SelectedItem:{tag:{busterSword:1}}}] run function ssbrc:characters/cloud/logic/formation_switch/operator
