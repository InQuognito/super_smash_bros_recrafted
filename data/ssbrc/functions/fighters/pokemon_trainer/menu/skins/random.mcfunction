...
execute unless score @s[advancements={ssbrc:fighters/pokemon_trainer/skins/dawn=true}] skin_picked matches 1 if score random.output temp matches 3 run function ssbrc:fighters/pokemon_trainer/menu/skins/dawn
execute unless score @s[advancements={ssbrc:fighters/pokemon_trainer/skins/shiny=true}] skin_picked matches 1 if score random.output temp matches 4 run function ssbrc:fighters/pokemon_trainer/menu/skins/shiny
...
execute if score @s skin_picked matches 1 run function ssbrc:logic/selector/select_fighter with storage ssbrc:data fighters.pokemon_trainer
