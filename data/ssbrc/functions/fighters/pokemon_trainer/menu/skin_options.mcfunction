...
tellraw @s[tag=!shiny,advancements={ssbrc:fighters/pokemon_trainer/skins/shiny=true}] [{"translate":"ssbrc.series.pokemon.skin.shiny","color":"dark_gray","clickEvent":{"action":"run_command","value":"/trigger menu set 3"}}]
tellraw @s[tag=shiny] [{"translate":"ssbrc.series.pokemon.skin.shiny","color":"dark_gray"},{"text":" ✔","color":"green"}]

tellraw @s[tag=!dawn,advancements={ssbrc:fighters/pokemon_trainer/skins/dawn=true}] [{"translate":"ssbrc.fighters.pokemon_trainer.skin.dawn","color":"light_purple","clickEvent":{"action":"run_command","value":"/trigger menu set 4"}}]
