...
tellraw @s[tag=dawn] [{"translate":"ssbrc.fighters.pokemon_trainer.skin.dawn","color":"light_purple"},{"text":" ","color":"white"},{"text":"✔","color":"green"}]
...
tellraw @s[tag=victor] [{"translate":"ssbrc.fighters.pokemon_trainer.skin.victor","color":"dark_blue"},{"text":" ","color":"white"},{"text":"✔","color":"green"}]
