...
tellraw @s[tag=!shiny,advancements={ssbrc:fighters/pokemon_trainer/skins/shiny=true}] {"translate":"ssbrc.series.pokemon.skin.shiny","color":"dark_gray","clickEvent":{"action":"run_command","value":"/trigger menu set 4"}}
