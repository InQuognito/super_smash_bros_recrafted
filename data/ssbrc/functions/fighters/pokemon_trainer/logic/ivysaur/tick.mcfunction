# Poison Powder
function ssbrc:logic/fighters/cooldown/display/check {item:"poison_powder",type:"2",amount:"pokemon_trainer.poison_powder.cooldown"}
...
execute if entity @s[scores={charge.1=1..}] run function ssbrc:logic/fighters/cooldown/display/check {item:"leech_seed",type:"1",amount:"pokemon_trainer.leech_seed.cooldown"}
