...
execute if score @s health matches 2.. if score #leechSeed temp matches 0 run function ssbrc:fighters/pokemon_trainer/logic/ivysaur/leech_seed/healing_orb/summon
