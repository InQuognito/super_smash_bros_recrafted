...
execute at @e[type=minecraft:marker,tag=shadowSneak,sort=nearest,limit=1] positioned ~ ~-0.5 ~ run function ssbrc:fighters/greninja/logic/abilities/shadow_sneak/teleport
