...
execute if entity @s[predicate=ssbrc:flag/sneaking,scores={cooldown.3=..0}] at @s[tag=!shadowSneak] rotated ~ 0.0 run function ssbrc:fighters/greninja/logic/abilities/shadow_sneak/activate
