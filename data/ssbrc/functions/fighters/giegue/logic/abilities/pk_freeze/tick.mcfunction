execute unless entity @s[tag=pk_freeze.split] run particle minecraft:dust_color_transition 0.4 0.9 1.0 0.75 1.0 1.0 1.0 ~ ~ ~ 0.05 0.05 0.05 0.0 25 force @a
execute if entity @s[tag=pk_freeze.split] run particle minecraft:dust_color_transition 0.4 0.9 1.0 0.25 1.0 1.0 1.0 ~ ~ ~ 0.03 0.03 0.03 0.0 10 force @a
