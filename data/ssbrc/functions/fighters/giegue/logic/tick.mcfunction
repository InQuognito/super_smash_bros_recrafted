# PK Freeze
function ssbrc:logic/fighters/cooldown/display/check {item:"pk_freeze",type:"1",amount:"giegue.pk_freeze.cooldown"}
...
function ssbrc:logic/fighters/cooldown/display/check {item:"pk_beam",type:"2",amount:"giegue.pk_beam.cooldown"}
