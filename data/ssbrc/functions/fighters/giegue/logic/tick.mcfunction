execute if entity @s[scores={useAbility=1..,cooldown.1=..0},nbt={SelectedItem:{tag:{pkFreeze:1}}}] at @s anchored eyes run function ssbrc:fighters/giegue/logic/abilities/pk_freeze/activate
execute if entity @s[scores={useAbility=1..,cooldown.2=..0,charge.1=..0},nbt={SelectedItem:{tag:{pkBeam:1}}}] run function ssbrc:fighters/giegue/logic/abilities/pk_beam/activate
