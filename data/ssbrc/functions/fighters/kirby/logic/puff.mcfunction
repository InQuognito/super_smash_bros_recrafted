...
execute if entity @s[scores={charge.2=1}] run scoreboard players set $y delta.api.launch 5000000
execute if entity @s[scores={charge.2=2}] run scoreboard players set $y delta.api.launch 4000000
execute if entity @s[scores={charge.2=3}] run scoreboard players set $y delta.api.launch 3000000
execute if entity @s[scores={charge.2=4}] run scoreboard players set $y delta.api.launch 2000000
execute if entity @s[scores={charge.2=5}] run scoreboard players set $y delta.api.launch 1000000
