...
execute if entity @s[scores={charge.2=1}] run scoreboard players set $y delta.api.launch 10000
execute if entity @s[scores={charge.2=2}] run scoreboard players set $y delta.api.launch 9000
execute if entity @s[scores={charge.2=3}] run scoreboard players set $y delta.api.launch 8000
execute if entity @s[scores={charge.2=4}] run scoreboard players set $y delta.api.launch 7000
execute if entity @s[scores={charge.2=5}] run scoreboard players set $y delta.api.launch 6000
