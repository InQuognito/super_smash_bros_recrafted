...
execute if entity @s[scores={charge.2=3}] run scoreboard players set $y delta.api.launch 4000
execute if entity @s[scores={charge.2=4}] run scoreboard players set $y delta.api.launch 4000
execute if entity @s[scores={charge.2=5}] run scoreboard players set $y delta.api.launch 4000
