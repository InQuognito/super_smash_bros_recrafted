...
# Puff
execute if entity @s[tag=!silenced,scores={charge.2=..6,cooldown.2=..0},predicate=ssbrc:flag/sneaking,predicate=ssbrc:flag/in_air] run function ssbrc:fighters/kirby/logic/puff
