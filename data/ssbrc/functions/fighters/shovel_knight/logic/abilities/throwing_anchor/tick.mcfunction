...
execute as @e[tag=!self,tag=!hitGround,predicate=ssbrc:flag/targets,distance=..1] run function ssbrc:fighters/shovel_knight/logic/abilities/throwing_anchor/hit
