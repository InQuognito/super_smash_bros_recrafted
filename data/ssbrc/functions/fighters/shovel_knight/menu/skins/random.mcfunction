...
execute unless score @s[advancements={ssbrc:fighters/shovel_knight/skins/armor_of_chaos=true}] skinPicked matches 1 if score result random matches 1 run function ssbrc:fighters/shovel_knight/menu/skins/armor_of_chaos
execute unless score @s[advancements={ssbrc:fighters/shovel_knight/skins/toad_gear=true}] skinPicked matches 1 if score result random matches 1 run function ssbrc:fighters/shovel_knight/menu/skins/toad_gear
