...
tellraw @s[tag=armorOfChaos] [{"translate":"ssbrc.fighters.shovel_knight.skin.armorOfChaos","color":"red"},{"text":" ","color":"white"},{"text":"✔","color":"green"}]
...
tellraw @s[tag=toadGear] [{"translate":"ssbrc.fighters.shovel_knight.skin.toadGear","color":"green"},{"text":" ","color":"white"},{"text":"✔","color":"green"}]
