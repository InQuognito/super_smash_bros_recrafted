...
execute if score sword_spin temp matches 0 if entity @s[scores={charge.output=21..}] run function ssbrc:fighters/ganondorf/logic/abilities/sword_spin/raycast/start
