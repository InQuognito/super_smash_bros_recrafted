...
execute if function ssbrc:fighters/ganondorf/logic/abilities/dead_mans_volley/target/player run function ssbrc:fighters/ganondorf/logic/abilities/dead_mans_volley/target/decide
