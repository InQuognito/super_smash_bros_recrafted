...
execute if entity @s[scores={cooldown.3=..0},nbt={SelectedItem:{tag:{dark_void:1}}}] rotated ~ 0.0 run function ssbrc:fighters/ganondorf/logic/abilities/dark_void/check
