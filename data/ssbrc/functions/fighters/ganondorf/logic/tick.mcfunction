...
execute if entity @s[tag=sword_spin,predicate=!ssbrc:flag/sneaking,scores={charge.output=1..}] run function ssbrc:fighters/ganondorf/logic/abilities/sword_spin/cancel
