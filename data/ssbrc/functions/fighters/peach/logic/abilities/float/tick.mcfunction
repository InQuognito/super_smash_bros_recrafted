...
execute if score @s charge.3 matches 1 run function ssbrc:fighters/peach/logic/abilities/float/activate
...
execute if score @s charge.2 matches ..0 run function ssbrc:fighters/peach/logic/abilities/float/deactivate
