...
execute if score @s charge.1 >= #mario.super_jumpThreshold vars run particle minecraft:glow ~ ~0.01 ~ 0.2 0.2 0.2 0.0 2 normal @a

execute if score @s charge.1 = #mario.super_jumpThreshold vars run function ssbrc:fighters/mario/logic/abilities/super_jump/charge

function ssbrc:logic/fighters/move_distance
execute if score @s charge.1 >= #mario.super_jumpThreshold vars if score move_distance temp >= #mario.super_jumpMovementFalloff vars run function ssbrc:fighters/mario/logic/abilities/super_jump/reset
