...
execute if score @s piercing <= #samus.waveBeamPiercing vars anchored eyes positioned ^ ^ ^ anchored feet run function ssbrc:fighters/samus/logic/weapons/wave_beam/raycast/loop
