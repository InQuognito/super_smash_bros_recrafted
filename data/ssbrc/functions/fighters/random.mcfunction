...
execute unless score @s[advancements={ssbrc:fighters/donkeykong/skins/default=true}] characterPicked matches 1.. if score result random matches 1 run function ssbrc:fighters/donkeykong/menu/skins/random
execute unless score @s[advancements={ssbrc:fighters/kingkrool/skins/default=true}] characterPicked matches 1.. if score result random matches 2 run function ssbrc:fighters/kingkrool/menu/skins/random
...
execute unless score @s[advancements={ssbrc:fighters/captainfalcon/skins/default=true}] characterPicked matches 1.. if score result random matches 6 run function ssbrc:fighters/captainfalcon/menu/skins/random
...
execute unless score @s[advancements={ssbrc:fighters/shovelknight/skins/default=true}] characterPicked matches 1.. if score result random matches 9 run function ssbrc:fighters/shovelknight/menu/skins/random
...
execute unless score @s[advancements={ssbrc:fighters/darksamus/skins/default=true}] characterPicked matches 1.. if score result random matches 16 run function ssbrc:fighters/darksamus/menu/skins/random
...
execute unless score @s[advancements={ssbrc:fighters/pokemontrainer/skins/default=true}] characterPicked matches 1.. if score result random matches 22 run function ssbrc:fighters/pokemontrainer/menu/skins/random
execute unless score @s[advancements={ssbrc:fighters/teamrocket/skins/default=true}] characterPicked matches 1.. if score result random matches 23 run function ssbrc:fighters/teamrocket/menu/skins/random
execute unless score @s[advancements={ssbrc:fighters/alteredbeast/skins/default=true}] characterPicked matches 1.. if score result random matches 24 run function ssbrc:fighters/alteredbeast/menu/skins/random
