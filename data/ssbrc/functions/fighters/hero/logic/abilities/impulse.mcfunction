...
execute unless score spell_activated temp matches 1 store success score spell_activated temp if entity @s[nbt={SelectedItem:{tag:{accelerate:1}}}] run function ssbrc:fighters/hero/logic/abilities/spells/accelerate/check

execute unless score spell_activated temp matches 1 store success score spell_activated temp if entity @s[nbt={SelectedItem:{tag:{acceleratle:1}}}] run function ssbrc:fighters/hero/logic/abilities/spells/acceleratle/check
...
execute unless score spell_activated temp matches 1 store success score spell_activated temp if entity @s[nbt={SelectedItem:{tag:{oomph:1}}}] run function ssbrc:fighters/hero/logic/abilities/spells/oomph/check

execute unless score spell_activated temp matches 1 store success score spell_activated temp if entity @s[nbt={SelectedItem:{tag:{zap:1}}}] run function ssbrc:fighters/hero/logic/abilities/spells/zap/check

execute unless score spell_activated temp matches 1 store success score spell_activated temp if entity @s[nbt={SelectedItem:{tag:{zapple:1}}}] run function ssbrc:fighters/hero/logic/abilities/spells/zapple/check

execute unless score spell_activated temp matches 1 store success score spell_activated temp if entity @s[nbt={SelectedItem:{tag:{zoom:1}}}] run function ssbrc:fighters/hero/logic/abilities/spells/zoom/check
