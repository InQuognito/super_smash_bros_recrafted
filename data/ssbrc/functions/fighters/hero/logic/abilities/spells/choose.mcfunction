...
execute unless score teams options matches 1 store result score random.output temp run random value 1..13
execute if score teams options matches 1 store result score random.output temp run random value 1..14
...
$execute if score random.output temp matches 13 store success score spellGiven temp run loot replace entity @s[nbt=!{Inventory:[{tag:{kamikazee:1}}]}] hotbar.$(slot) loot ssbrc:fighters/hero/spells/kamikazee

$execute if score random.output temp matches 14 store success score spellGiven temp run loot replace entity @s[tag=!multiheal,nbt=!{Inventory:[{tag:{heal:1}}]},nbt=!{Inventory:[{tag:{multiheal:1}}]}] hotbar.$(slot) loot ssbrc:fighters/hero/spells/multiheal
