...
$execute store success score spellGiven temp if entity @s[nbt=!{Inventory:[{tag:{bang:1}}]},nbt=!{Inventory:[{tag:{kaboom:1}}]}] run function ssbrc:fighters/hero/logic/abilities/spells/bang/choose {slot:$(slot)}
...
$execute store success score spellGiven temp if entity @s[nbt=!{Inventory:[{tag:{zap:1}}]},nbt=!{Inventory:[{tag:{zapple:1}}]},nbt=!{Inventory:[{tag:{kazap:1}}]}] run function ssbrc:fighters/hero/logic/abilities/spells/zap/choose {slot:$(slot)}
