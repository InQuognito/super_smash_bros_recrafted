execute if entity @s[scores={use_ability=1..,cooldown.1=..0,duration.2=..0},nbt={SelectedItem:{tag:{bang:1}}}] at @s run function ssbrc:fighters/hero/logic/abilities/bang/check
execute if entity @s[scores={use_ability=1..,cooldown.1=..0,duration.2=..0},nbt={SelectedItem:{tag:{kaclang:1}}}] at @s run function ssbrc:fighters/hero/logic/abilities/kaclang/check
