...
# Bang
function ssbrc:logic/fighters/cooldown/update {item:"bang",type:"1",amount:"hero.bang.cooldown"}

# Kaclang
execute if entity @s[scores={duration.2=1..}] run function ssbrc:fighters/hero/logic/abilities/kaclang/tick

function ssbrc:logic/fighters/cooldown/update {item:"kaclang",type:"1",amount:"hero.bang.cooldown"}
