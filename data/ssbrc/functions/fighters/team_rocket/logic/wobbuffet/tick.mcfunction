execute if entity @s[scores={useAbility=1..,cooldown.1=..0},nbt={SelectedItem:{tag:{destiny_bond:1}}}] run function ssbrc:fighters/team_rocket/logic/wobbuffet/destiny_bond/activate
...
# Splash
function ssbrc:logic/fighters/cooldown {item:"splash",type:"1",amount:"team_rocket.destiny_bond.cooldown"}
