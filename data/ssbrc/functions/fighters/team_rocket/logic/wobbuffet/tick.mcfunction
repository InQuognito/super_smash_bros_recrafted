...
function ssbrc:logic/fighters/cooldown/display/check {item:"destiny_bond",type:"1",amount:"team_rocket.destiny_bond.cooldown"}

# Splash
function ssbrc:logic/fighters/cooldown/display/check {item:"splash",type:"2",amount:"team_rocket.splash.cooldown"}
