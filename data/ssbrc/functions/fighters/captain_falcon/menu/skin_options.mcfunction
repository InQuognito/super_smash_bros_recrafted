...
tellraw @s[tag=bloodFalcon] [{"translate":"ssbrc.fighters.captain_falcon.skin.bloodFalcon","color":"dark_red"},{"text":" ","color":"white"},{"text":"✔","color":"green"}]
...
tellraw @s[tag=rickWheeler] [{"translate":"ssbrc.fighters.captain_falcon.skin.rickWheeler","color":"dark_blue"},{"text":" ","color":"white"},{"text":"✔","color":"green"}]
