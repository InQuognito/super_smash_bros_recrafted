...
function ssbrc:logic/fighters/cooldown/display/check {item:"falcon_punch",type:"2",amount:"captain_falcon.falcon_punch.cooldown"}
...
function ssbrc:logic/fighters/cooldown/display/check {item:"falcon_charge",type:"3",amount:"captain_falcon.falcon_charge.cooldown"}
