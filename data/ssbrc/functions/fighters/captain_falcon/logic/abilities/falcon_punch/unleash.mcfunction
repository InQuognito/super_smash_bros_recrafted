...
execute positioned ^ ^ ^1 as @e[tag=!self,tag=!falconPunched,predicate=ssbrc:flag/targets,dy=1] run function ssbrc:fighters/captain_falcon/logic/abilities/falcon_punch/hit
execute positioned ^ ^ ^2 as @e[tag=!self,tag=!falconPunched,predicate=ssbrc:flag/targets,dy=1] run function ssbrc:fighters/captain_falcon/logic/abilities/falcon_punch/hit
