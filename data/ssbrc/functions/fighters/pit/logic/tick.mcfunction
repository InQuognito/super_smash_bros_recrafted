...
# Guardian Orbitars
execute if entity @s[tag=!guardianOrbitars,predicate=ssbrc:flag/sneaking,nbt={SelectedItem:{tag:{palutenaBow:1}}},scores={cooldown.2=..0}] positioned ~ ~0.75 ~ rotated ~ 0.0 run function ssbrc:fighters/pit/logic/abilities/guardian_orbitars/activate
