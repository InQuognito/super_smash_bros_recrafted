...
tellraw @s[tag=!retro,advancements={ssbrc:fighters/pit/skins/retro=true}] [{"translate":"ssbrc.fighters.pit.skin.retro","color":"white","clickEvent":{"action":"run_command","value":"/trigger menu set 1226"}}]
