...
execute if score @s point < #pikachu.thunder_joltMaxRotation vars run scoreboard players operation @s point -= @s slope
execute if score @s point > #pikachu.thunder_joltMaxRotation vars run scoreboard players operation @s point = #pikachu.thunder_joltMaxRotation vars
execute if score @s point < #pikachu.thunder_joltMaxRotation vars run scoreboard players remove @s slope 20
