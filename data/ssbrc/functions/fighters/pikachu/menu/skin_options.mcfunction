...
tellraw @s[tag=!shiny,advancements={ssbrc:fighters/pikachu/skins/shiny=true}] {"translate":"ssbrc.fighters.pikachu.skin.shiny","color":"yellow","clickEvent":{"action":"run_command","value":"/trigger menu set 4"}}
tellraw @s[tag=shiny] [{"translate":"ssbrc.fighters.pikachu.skin.shiny","color":"yellow"},{"text":" ✔","color":"green"}]
