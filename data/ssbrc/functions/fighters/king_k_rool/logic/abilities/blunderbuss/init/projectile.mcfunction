...
loot replace entity @s[tag=default] armor.head loot ssbrc:fighters/donkey_kong/king_k_rool/cannonball/default
loot replace entity @s[tag=gold] armor.head loot ssbrc:fighters/donkey_kong/king_k_rool/cannonball/gold
