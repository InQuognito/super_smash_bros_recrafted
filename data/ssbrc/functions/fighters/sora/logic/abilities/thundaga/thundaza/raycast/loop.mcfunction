...
execute if score @s raycast matches 1.. if score @s raycast_success matches 0 positioned ^ ^ ^0.1 run function ssbrc:fighters/sora/logic/abilities/thundaga/thundaza/raycast/loop
