...
execute if entity @s[tag=valor,scores={cooldown.2=..0},nbt={SelectedItem:{tag:{keyblade:1}},Inventory:[{tag:{keyblade:1},Slot:-106b}]},predicate=!ssbrc:flag/sneaking] anchored eyes positioned ^ ^ ^ run function ssbrc:fighters/sora/logic/abilities/strike_raid/activate
