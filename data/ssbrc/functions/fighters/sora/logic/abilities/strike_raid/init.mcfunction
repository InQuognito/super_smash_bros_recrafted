...
execute if entity @p[tag=self,nbt={SelectedItem:{tag:{primary:1}}}] run loot replace entity @s contents loot ssbrc:fighters/sora/keyblades/secondary/strike_raid
execute if entity @p[tag=self,nbt={SelectedItem:{tag:{secondary:1}}}] run loot replace entity @s contents loot ssbrc:fighters/sora/keyblades/primary/strike_raid
