execute unless score strikeRaidRegained temp matches 1 if entity @s[nbt={Inventory:[{tag:{primary:1}}]}] run function ssbrc:fighters/sora/logic/abilities/strike_raid/regain/secondary
