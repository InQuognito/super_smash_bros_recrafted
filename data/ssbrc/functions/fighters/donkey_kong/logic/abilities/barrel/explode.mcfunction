...
execute if entity @s[tag=!gold,tag=!oil] run particle minecraft:item{item:{id:"minecraft:nether_star",components:{"minecraft:custom_model_data":301}}} ~ ~ ~ 0.0 0.0 0.0 0.15 100 normal @a
execute if entity @s[tag=!gold,tag=!oil] run playsound minecraft:block.wood.break player @a

execute if entity @s[tag=gold] run particle minecraft:item{item:{id:"minecraft:nether_star",components:{"minecraft:custom_model_data":304}}} ~ ~ ~ 0.0 0.0 0.0 0.15 100 normal @a
execute if entity @s[tag=gold] run playsound minecraft:block.netherite_block.break player @a

execute if entity @s[tag=flower_power] run particle minecraft:item{item:{id:"minecraft:nether_star",components:{"minecraft:custom_model_data":303}}} ~ ~ ~ 0.0 0.0 0.0 0.15 100 normal @a
