...
tellraw @s[tag=!flowerPower,advancements={ssbrc:fighters/donkey_kong/skins/flower_power=true}] [{"translate":"ssbrc.series.super_mario_bros.skin.flowerPower","color":"red","clickEvent":{"action":"run_command","value":"/trigger menu set 306"}}]
tellraw @s[tag=flowerPower] [{"translate":"ssbrc.series.super_mario_bros.skin.flowerPower","color":"red"},{"text":" ✔","color":"green"}]
