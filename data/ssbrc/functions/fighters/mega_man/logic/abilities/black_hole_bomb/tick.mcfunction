...
execute as @e[tag=!fgiiGraham,predicate=ssbrc:flag/target_items,distance=..10] at @s run function ssbrc:fighters/mega_man/logic/abilities/black_hole_bomb/pull
