...
$execute if score random.output temp matches 7 unless entity @s[tag=mega_man.magma_bazooka] run function ssbrc:fighters/mega_man/logic/weapons/give {slot:$(slot),weapon:"magma_bazooka"}
$execute if score random.output temp matches 8 unless entity @s[tag=mega_man.metal_blade] run function ssbrc:fighters/mega_man/logic/weapons/give {slot:$(slot),weapon:"metal_blade"}
$execute if score random.output temp matches 9 unless entity @s[tag=mega_man.pile_driver] run function ssbrc:fighters/mega_man/logic/weapons/give {slot:$(slot),weapon:"pile_driver"}
$execute if score random.output temp matches 10 unless entity @s[tag=mega_man.remote_mine] run function ssbrc:fighters/mega_man/logic/weapons/give {slot:$(slot),weapon:"remote_mine"}
