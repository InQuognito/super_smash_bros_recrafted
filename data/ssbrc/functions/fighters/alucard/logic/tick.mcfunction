...
execute if entity @s[predicate=ssbrc:flag/sneaking,scores={cooldown.1=..0}] at @s if predicate ssbrc:flag/in_air run function ssbrc:fighters/alucard/logic/abilities/mist/on
