...
execute if entity @s[scores={use_ability=1..,cooldown.1=..0},nbt={SelectedItem:{tag:{fire_rod:1}}}] anchored eyes run function ssbrc:fighters/zelda/logic/abilities/fire_rod/check
execute if entity @s[scores={use_ability=1..,cooldown.1=..0},nbt={SelectedItem:{tag:{ice_rod:1}}}] anchored eyes run function ssbrc:fighters/zelda/logic/abilities/ice_rod/check
