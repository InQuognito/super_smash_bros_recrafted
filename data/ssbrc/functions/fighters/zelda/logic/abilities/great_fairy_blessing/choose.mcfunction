...
execute store result score #hasNayrusRing temp run clear @s minecraft:carrot_on_a_stick{nayrus_ring:1} 0
execute store result score #hasRedPotion temp run clear @s minecraft:potion{red_potion:1} 0
...
execute if score random.output temp matches 5 unless score @s zelda.half_magic matches 1.. unless score #hasRedPotion temp matches 1.. run function ssbrc:fighters/zelda/logic/blessings/half_magic
