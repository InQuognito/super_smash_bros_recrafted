...
execute positioned ~-0.15 ~ ~-0.15 as @e[tag=!self,nbt=!{Inventory:[{tag:{goronLocket:1}}]},predicate=ssbrc:flag/targets,dy=2] positioned ~-0.7 ~ ~-0.7 if entity @s[dy=2] at @s run function ssbrc:fighters/zelda/logic/abilities/fire_rod/alternate_function/hit
