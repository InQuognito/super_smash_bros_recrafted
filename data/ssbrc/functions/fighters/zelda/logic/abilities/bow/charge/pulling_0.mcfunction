...
tag @s[nbt=!{Inventory:[{tag:{small_shield:1}}]}] add shield_broken
execute if entity @s[tag=!shield_broken,nbt={Inventory:[{components:{"minecraft:custom_data":{small_shield:1}},Slot:-106b}]}] run function ssbrc:fighters/zelda/logic/abilities/bow/check_shield_durability
