...
execute if entity @s[nbt=!{Inventory:[{tag:{small_shield:1}}]}] run tag @s add shieldBroken
execute if entity @s[tag=!shieldBroken,nbt={Inventory:[{tag:{small_shield:1},Slot:-106b}]}] run function ssbrc:fighters/zelda/logic/abilities/bow/check_shield_durability
