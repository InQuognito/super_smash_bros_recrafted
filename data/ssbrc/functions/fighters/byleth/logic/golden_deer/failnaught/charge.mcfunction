...
item modify entity @s[scores={charge.output=53}] weapon.mainhand {"function":"minecraft:set_custom_model_data","value":110}
item modify entity @s[scores={charge.output=67}] weapon.mainhand {"function":"minecraft:set_custom_model_data","value":111}
