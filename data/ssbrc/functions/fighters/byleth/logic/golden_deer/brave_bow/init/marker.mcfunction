...
execute if score charge.output temp matches ..18 positioned ^ ^ ^1 summon minecraft:spectral_arrow run function ssbrc:fighters/byleth/logic/golden_deer/brave_bow/init/projectile
