...
execute unless score chaos_controlled temp matches 1 run attribute @s minecraft:generic.movement_speed base set 0.25
execute if score chaos_controlled temp matches 1 run attribute @s minecraft:generic.movement_speed base set 0.1875
execute unless score chaos_controlled temp matches 1 run attribute @s minecraft:horse.jump_strength base set 0.7
execute if score chaos_controlled temp matches 1 run attribute @s minecraft:horse.jump_strength base set 0.525
