# Spin Attack
execute if entity @s[scores={charge.output=1..},nbt={SelectedItem:{tag:{areadbhar:1}}}] positioned ~ ~0.75 ~ run function ssbrc:fighters/byleth/logic/blue_lions/spin_attack/charge
