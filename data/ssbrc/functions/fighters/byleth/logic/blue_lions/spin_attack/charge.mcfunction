...
execute if score spin_attack temp matches 0 if score @s charge.output matches 21.. run function ssbrc:fighters/byleth/logic/blue_lions/spin_attack/raycast/start
