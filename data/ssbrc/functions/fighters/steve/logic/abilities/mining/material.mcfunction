...
execute unless score particlePlaced temp matches 1 if block ~ ~ ~ #ssbrc:material/basalt run function ssbrc:fighters/steve/logic/abilities/mining/material/basalt
execute unless score particlePlaced temp matches 1 if block ~ ~ ~ #ssbrc:material/deepslate run function ssbrc:fighters/steve/logic/abilities/mining/material/deepslate
execute unless score particlePlaced temp matches 1 if block ~ ~ ~ #ssbrc:material/deepslate_bricks run function ssbrc:fighters/steve/logic/abilities/mining/material/deepslate_bricks
execute unless score particlePlaced temp matches 1 if block ~ ~ ~ #ssbrc:material/deepslate_tiles run function ssbrc:fighters/steve/logic/abilities/mining/material/deepslate_tiles
