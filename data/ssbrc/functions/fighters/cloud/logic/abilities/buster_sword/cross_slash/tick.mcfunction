...
execute if score @s duration.1 matches ..30 as @a[predicate=ssbrc:ingame] run function ssbrc:fighters/cloud/logic/abilities/buster_sword/cross_slash/particles/1/check
...
execute if score @s duration.1 matches ..20 as @a[predicate=ssbrc:ingame] run function ssbrc:fighters/cloud/logic/abilities/buster_sword/cross_slash/particles/2/check
...
execute if score @s duration.1 matches ..10 as @a[predicate=ssbrc:ingame] run function ssbrc:fighters/cloud/logic/abilities/buster_sword/cross_slash/particles/3/check
