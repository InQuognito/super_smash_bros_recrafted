...
execute unless score entity_hit temp matches 1 at @s[tag=limit_break] run function ssbrc:fighters/cloud/logic/abilities/buster_sword/blade_beam/move_forward
