...
execute positioned ~-0.2 ~ ~-0.2 as @e[tag=!self,predicate=ssbrc:flag/targets,dy=1] positioned ~-0.6 ~ ~-0.6 if entity @s[dy=1] run function ssbrc:fighters/shovel_knight/logic/abilities/drop_spark/hit
