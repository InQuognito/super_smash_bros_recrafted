...
execute unless score @s[advancements={ssbrc:fighters/princess_peach/skins/flower_power=true}] skinPicked matches 1 if score result random matches 1 run function ssbrc:fighters/princess_peach/menu/skins/flower_power
execute unless score @s[advancements={ssbrc:fighters/princess_peach/skins/shadow_queen=true}] skinPicked matches 1 if score result random matches 1 run function ssbrc:fighters/princess_peach/menu/skins/shadow_queen
