...
tellraw @s[tag=flower_power] [{"translate":"ssbrc.series.super_mario_bros.skin.flower_power","color":"aqua"},{"text":" ✔","color":"green"}]
...
tellraw @s[tag=!penguin,advancements={ssbrc:fighters/luigi/skins/penguin=true}] {"translate":"ssbrc.series.super_mario_bros.skin.penguin","color":"blue","clickEvent":{"action":"run_command","value":"/trigger menu set 5"}}
