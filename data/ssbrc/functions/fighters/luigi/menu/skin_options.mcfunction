...
tellraw @s[tag=!flowerPower,advancements={ssbrc:fighters/luigi/skins/flower_power=true}] [{"translate":"ssbrc.series.super_mario_bros.skin.flowerPower","color":"aqua","clickEvent":{"action":"run_command","value":"/trigger menu set 826"}}]
tellraw @s[tag=flowerPower] [{"translate":"ssbrc.series.super_mario_bros.skin.flowerPower","color":"aqua"},{"nbt":"selected","storage":"ssbrc:data/skins","interpret":true}]
