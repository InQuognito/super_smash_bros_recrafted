...
tellraw @s[tag=flowerPower] [{"translate":"ssbrc.series.superMarioBros.skin.flowerPower","color":"aqua"},{"nbt":"selected","storage":"ssbrc:data/skins","interpret":true}]

tellraw @s[tag=!gooigi,advancements={ssbrc:fighters/luigi/skins/gooigi=true}] [{"nbt":"autumn","storage":"ssbrc:data/skins","interpret":true},{"translate":"ssbrc.fighters.luigi.skin.gooigi","color":"green","clickEvent":{"action":"run_command","value":"/trigger menu set 827"}}]
tellraw @s[tag=gooigi] [{"nbt":"autumn","storage":"ssbrc:data/skins","interpret":true},{"translate":"ssbrc.fighters.luigi.skin.gooigi","color":"green"},{"nbt":"selected","storage":"ssbrc:data/skins","interpret":true}]
