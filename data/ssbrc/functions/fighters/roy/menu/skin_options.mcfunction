...
tellraw @s[tag=!flowerPower,advancements={ssbrc:fighters/roy/skins/young_lion=true}] [{"translate":"ssbrc.fighters.roy.skin.youngLion","color":"gold","clickEvent":{"action":"run_command","value":"/trigger menu set 1386"}}]
tellraw @s[tag=flowerPower] [{"translate":"ssbrc.fighters.roy.skin.youngLion","color":"gold"},{"text":" ","color":"white"},{"text":"✔","color":"green"}]
