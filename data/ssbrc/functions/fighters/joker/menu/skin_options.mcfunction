...
tellraw @s[tag=!christmasOutfit,advancements={ssbrc:fighters/joker/skins/christmas_outfit=true}] [{"translate":"ssbrc.fighters.joker.skin.christmasOutfit","color":"red","clickEvent":{"action":"run_command","value":"/trigger menu set 606"}}]
tellraw @s[tag=christmasOutfit] [{"translate":"ssbrc.fighters.joker.skin.christmasOutfit","color":"red"},{"text":" ✔","color":"green"}]
