...
execute if entity @s[nbt={SelectedItem:{tag:{highPixie:1}}}] run function ssbrc:fighters/joker/logic/masks/activate/high_pixie
execute if entity @s[nbt={SelectedItem:{tag:{jackFrost:1}}}] run function ssbrc:fighters/joker/logic/masks/activate/jack_frost
execute if entity @s[nbt={SelectedItem:{tag:{jackOLantern:1}}}] run function ssbrc:fighters/joker/logic/masks/activate/jack_o_lantern
