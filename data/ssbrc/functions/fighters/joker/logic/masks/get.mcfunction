...
execute if score random.output temp matches 3 run loot replace entity @s[nbt=!{Inventory:[{tag:{high_pixie:1}}]}] hotbar.7 loot ssbrc:fighters/joker/personas/high_pixie/mask
execute if score random.output temp matches 4 run loot replace entity @s[nbt=!{Inventory:[{tag:{jack_frost:1}}]}] hotbar.7 loot ssbrc:fighters/joker/personas/jack_frost/mask
execute if score random.output temp matches 5 run loot replace entity @s[nbt=!{Inventory:[{tag:{jack_o_lantern:1}}]}] hotbar.7 loot ssbrc:fighters/joker/personas/jack_o_lantern/mask
