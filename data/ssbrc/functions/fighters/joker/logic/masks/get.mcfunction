...
execute unless entity @s[nbt={Inventory:[{tag:{highPixie:1}}]}] if score random.output temp matches 3 run loot replace entity @s hotbar.7 loot ssbrc:fighters/joker/personas/high_pixie/mask
execute unless entity @s[nbt={Inventory:[{tag:{jackFrost:1}}]}] if score random.output temp matches 4 run loot replace entity @s hotbar.7 loot ssbrc:fighters/joker/personas/jack_frost/mask
execute unless entity @s[nbt={Inventory:[{tag:{jackOLantern:1}}]}] if score random.output temp matches 5 run loot replace entity @s hotbar.7 loot ssbrc:fighters/joker/personas/jack_o_lantern/mask
