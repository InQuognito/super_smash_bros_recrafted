...
loot give @s[tag=archangel] loot ssbrc:fighters/joker/hama
loot give @s[tag=arsene] loot ssbrc:fighters/joker/eiagon
loot give @s[tag=highPixie] loot ssbrc:fighters/joker/amrita_shower
loot give @s[tag=raoul] loot ssbrc:fighters/joker/phantom_show
