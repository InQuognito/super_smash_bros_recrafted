...
execute if score #n temp matches 1.. unless score entityHit temp matches 1 at @s run function ssbrc:fighters/joker/logic/abilities/phantom_show/move_forward
