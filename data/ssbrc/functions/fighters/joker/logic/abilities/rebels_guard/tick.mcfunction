...
execute unless items entity @s weapon.mainhand minecraft:stone_sword[minecraft:custom_data~{item:"rebel_knife"}] run function ssbrc:fighters/joker/logic/abilities/rebels_guard/deactivate
