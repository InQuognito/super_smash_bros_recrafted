...
execute if entity @s[scores={useAbility=1..,cooldown.1=..0},nbt={SelectedItem:{tag:{phantomShow:1}}}] at @s anchored eyes positioned ^ ^ ^ run function ssbrc:fighters/joker/logic/abilities/phantom_show/summon
