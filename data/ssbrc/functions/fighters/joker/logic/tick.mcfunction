...
# Rebel's Guard
execute if items entity @s[tag=!rebels_guard,scores={duration.1=..0,duration.2=..0},predicate=ssbrc:flag/sneaking] weapon.mainhand minecraft:stone_sword[minecraft:custom_data~{item:"rebel_knife"}] run function ssbrc:fighters/joker/logic/abilities/rebels_guard/activate
