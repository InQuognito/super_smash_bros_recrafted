...
# Sword Spin
execute if entity @s[tag=!silenced,scores={charge.output=1..},nbt={SelectedItem:{tag:{masterSword:1}}},predicate=ssbrc:flag/sneaking] positioned ~ ~0.75 ~ run function ssbrc:fighters/toon_link/logic/abilities/sword_spin/charge
