...
execute if score @s raycast matches 1.. if block ^ ^ ^0.1 #ssbrc:passthrough positioned ^ ^ ^0.1 run function ssbrc:fighters/darksamus/logic/abilities/phazon_overload/raycast
