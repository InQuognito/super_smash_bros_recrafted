execute if entity @s[scores={snake.famasM=-1..,snake.famasA=1..,cooldown.1=..0}] anchored eyes positioned ^ ^ ^ run function ssbrc:fighters/snake/logic/weapons/famas/fire
