...
function ssbrc:fighters/snake/logic/weapons/psg1/offset
...
execute summon minecraft:arrow run function ssbrc:fighters/snake/logic/weapons/psg1/init/projectile
