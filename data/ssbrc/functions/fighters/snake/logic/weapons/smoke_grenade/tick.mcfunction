execute unless entity @e[type=minecraft:marker,tag=electricTerrain,distance=..12] run function ssbrc:fighters/snake/logic/weapons/smoke_grenade/tick_active
