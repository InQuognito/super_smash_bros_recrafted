...
function ssbrc:fighters/snake/logic/weapons/socom/offset
...
execute summon minecraft:arrow run function ssbrc:fighters/snake/logic/weapons/socom/init/projectile
