execute if entity @s[scores={snake.s1000M=-1..,snake.s1000A=1..,cooldown.1=..0}] anchored eyes positioned ^ ^ ^ run function ssbrc:fighters/snake/logic/weapons/s1000/fire
