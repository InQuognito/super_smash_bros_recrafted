...
execute rotated as @s positioned 0.0 0.0 0.0 run tp @s ^ ^ ^6

data modify storage ssbrc:data Motion set from entity @s Pos

execute summon minecraft:arrow run function ssbrc:fighters/snake/logic/weapons/s1000/init/projectile
