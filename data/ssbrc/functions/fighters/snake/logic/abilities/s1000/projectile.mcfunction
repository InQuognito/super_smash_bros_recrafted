...
function ssbrc:fighters/snake/logic/abilities/s1000/initial_offset
...
execute summon minecraft:marker run function ssbrc:fighters/snake/logic/abilities/s1000/init
execute summon minecraft:marker run function ssbrc:fighters/snake/logic/abilities/s1000/init
execute summon minecraft:marker run function ssbrc:fighters/snake/logic/abilities/s1000/init
execute summon minecraft:marker run function ssbrc:fighters/snake/logic/abilities/s1000/init
execute summon minecraft:marker run function ssbrc:fighters/snake/logic/abilities/s1000/init
