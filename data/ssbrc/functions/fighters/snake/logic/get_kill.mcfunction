...
execute if score random.output temp matches 4 if entity @s[tag=antiPersonnelMine] run function ssbrc:fighters/snake/logic/scavenger/anti_personnel_mine
execute if score random.output temp matches 5 if entity @s[tag=smokeGrenade] run function ssbrc:fighters/snake/logic/scavenger/smoke_grenade
