execute store result score @s itemCount run clear @s minecraft:carrot_on_a_stick{anti_personnel_mine:1} 0
execute if score @s itemCount matches ..0 run loot give @s loot ssbrc:fighters/snake/anti_personnel_mine
