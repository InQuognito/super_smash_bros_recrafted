...
tellraw @s[tag=!classic_tuxedo,advancements={ssbrc:fighters/snake/skins/classic_tuxedo=true}] [{"translate":"ssbrc.fighters.snake.skin.classic_tuxedo","color":"white","clickEvent":{"action":"run_command","value":"/trigger menu set 1526"}}]
tellraw @s[tag=classic_tuxedo] [{"translate":"ssbrc.fighters.snake.skin.classic_tuxedo","color":"white"},{"text":" ✔","color":"green"}]

tellraw @s[tag=!iroquois_pliskin,advancements={ssbrc:fighters/snake/skins/iroquois_pliskin=true}] [{"translate":"ssbrc.fighters.snake.skin.iroquois_pliskin","color":"dark_green","clickEvent":{"action":"run_command","value":"/trigger menu set 1527"}}]
