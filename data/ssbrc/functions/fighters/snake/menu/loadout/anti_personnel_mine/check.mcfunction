...
execute unless entity @s[tag=antiPersonnelMine] if score $item temp <= #snake.totalWeight vars run function ssbrc:fighters/snake/menu/loadout/anti_personnel_mine/select
