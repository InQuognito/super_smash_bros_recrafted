...
scoreboard players operation $item temp += #snake.anti_personnel_mineWeight vars
...
execute unless entity @s[tag=anti_personnel_mine] if score $item temp <= #snake.totalWeight vars run function ssbrc:fighters/snake/menu/loadout/anti_personnel_mine/select
