...
title @s[tag=smokeGrenade,tag=!ignoreFeedback] actionbar {"translate":"ssbrc.fighters.snake.loadout.warn.alreadyEquipped","color":"red"}

execute unless entity @s[tag=smokeGrenade] if score $item temp <= #snake.totalWeight vars run function ssbrc:fighters/snake/menu/loadout/smoke_grenade/select
