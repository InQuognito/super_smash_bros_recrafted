...
execute unless score @s skinPicked matches 3 if score result random matches 2 run function ssbrc:fighters/snake/menu/loadout/s1000/check
execute unless score @s skinPicked matches 3 if score result random matches 3 run function ssbrc:fighters/snake/menu/loadout/socom/check
execute unless score @s skinPicked matches 3 if score result random matches 4 run function ssbrc:fighters/snake/menu/loadout/anti_personnel_mine/check
execute unless score @s skinPicked matches 3 if score result random matches 5 run function ssbrc:fighters/snake/menu/loadout/smoke_grenade/check
