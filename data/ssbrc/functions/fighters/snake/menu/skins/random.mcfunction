...
execute unless score @s[advancements={ssbrc:fighters/snake/skins/old_snake=true}] skin_picked matches 1 if score random.output temp matches 5 run function ssbrc:fighters/snake/menu/skins/old_snake
