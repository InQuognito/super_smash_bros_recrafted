...
execute unless score @s[advancements={ssbrc:fighters/snake/skins/classic_tuxedo=true}] skinPicked matches 1 if score random.output temp matches 3 run function ssbrc:fighters/snake/menu/skins/classic_tuxedo
execute unless score @s[advancements={ssbrc:fighters/snake/skins/iroquois_pliskin=true}] skinPicked matches 1 if score random.output temp matches 4 run function ssbrc:fighters/snake/menu/skins/iroquois_pliskin
