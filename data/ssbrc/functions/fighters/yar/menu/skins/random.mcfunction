...
execute unless score @s[advancements={ssbrc:fighters/yar/skins/player_2=true}] skin_picked matches 1 if score random.output temp matches 3 run function ssbrc:fighters/yar/menu/skins/player_2
execute unless score @s[advancements={ssbrc:fighters/yar/skins/recruit=true}] skin_picked matches 1 if score random.output temp matches 4 run function ssbrc:fighters/yar/menu/skins/recruit
