...
tellraw @s[tag=!recruit,advancements={ssbrc:fighters/yar/skins/recruit=true}] [{"translate":"ssbrc.fighters.yar.skin.recruit","color":"dark_green","clickEvent":{"action":"run_command","value":"/trigger menu set 1966"}}]
