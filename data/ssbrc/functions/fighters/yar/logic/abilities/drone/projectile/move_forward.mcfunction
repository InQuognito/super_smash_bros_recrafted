...
execute if score #n temp matches 1.. unless score entityHit temp matches 1 at @s run function ssbrc:fighters/yar/logic/abilities/drone/projectile/move_forward
