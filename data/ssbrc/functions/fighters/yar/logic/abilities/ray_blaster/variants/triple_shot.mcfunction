execute facing ^-1 ^ ^3 summon minecraft:marker run function ssbrc:fighters/yar/logic/abilities/ray_blaster/init/marker
execute facing ^ ^ ^1 summon minecraft:marker run function ssbrc:fighters/yar/logic/abilities/ray_blaster/init/marker
execute facing ^1 ^ ^3 summon minecraft:marker run function ssbrc:fighters/yar/logic/abilities/ray_blaster/init/marker
