...
execute if score ray_length temp matches 1.. if score $rayPiercing temp <= yar.railgun.piercing vars positioned ^ ^ ^0.1 run function ssbrc:fighters/yar/logic/abilities/ray_blaster/variants/railgun/raycast/loop
