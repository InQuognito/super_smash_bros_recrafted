execute if entity @s[scores={cooldown.1=..0},nbt={SelectedItem:{tag:{rayBlaster:1,standard:1,powerUp:0}}}] anchored eyes positioned ^ ^ ^ run function ssbrc:fighters/yar/logic/abilities/ray_blaster/check
...
execute if entity @s[nbt={SelectedItem:{tag:{powerUp:1}}}] run function ssbrc:fighters/yar/logic/abilities/power_ups/check
