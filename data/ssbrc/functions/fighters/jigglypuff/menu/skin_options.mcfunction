...
tellraw @s[tag=!shiny,advancements={ssbrc:fighters/jigglypuff/skins/shiny=true}] {"translate":"ssbrc.fighters.jigglypuff.skin.shiny","color":"light_purple","clickEvent":{"action":"run_command","value":"/trigger menu set 3"}}
tellraw @s[tag=shiny] [{"translate":"ssbrc.fighters.jigglypuff.skin.shiny","color":"light_purple"},{"text":" ✔","color":"green"}]
