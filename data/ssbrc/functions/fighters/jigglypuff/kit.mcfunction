...
loot replace entity @s[tag=!gold] hotbar.1 loot ssbrc:fighters/jigglypuff/hyper_voice/default
loot replace entity @s[tag=gold] hotbar.1 loot ssbrc:fighters/jigglypuff/hyper_voice/gold
loot replace entity @s hotbar.2 loot ssbrc:fighters/jigglypuff/rest/default
