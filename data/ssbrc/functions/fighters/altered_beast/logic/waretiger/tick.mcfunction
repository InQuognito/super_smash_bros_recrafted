execute if entity @s[scores={use_ability=1..,cooldown.1=..0},nbt={SelectedItem:{tag:{sabretooth:1}}}] run function ssbrc:fighters/altered_beast/logic/waretiger/sabretooth/activate
