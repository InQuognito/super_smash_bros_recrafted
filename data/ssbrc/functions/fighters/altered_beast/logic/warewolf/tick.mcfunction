...
# Flame Arrow
execute if entity @s[predicate=ssbrc:flag/sneaking,scores={cooldown.2=..0}] at @s if predicate ssbrc:flag/in_air run function ssbrc:fighters/altered_beast/logic/warewolf/flame_arrow/activate
