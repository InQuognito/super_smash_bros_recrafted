# Wings
execute if entity @s[tag=!wings_flapped,predicate=ssbrc:flag/in_air,predicate=ssbrc:flag/sneaking] run function ssbrc:fighters/altered_beast/logic/waredragon/flap
