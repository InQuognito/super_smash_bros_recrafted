...
tellraw @s[tag=!player_2,advancements={ssbrc:fighters/altered_beast/skins/player_2=true}] {"translate":"ssbrc.fighters.skin.player_2","color":"blue","clickEvent":{"action":"run_command","value":"/trigger menu set 3"}}
tellraw @s[tag=player_2] [{"translate":"ssbrc.fighters.skin.player_2","color":"blue"},{"text":" ✔","color":"green"}]
