...
execute unless score charge temp matches 9.. run function ssbrc:fighters/dark_samus/logic/abilities/phazon_beam/charge/1
execute if score charge temp matches 9..19 run function ssbrc:fighters/dark_samus/logic/abilities/phazon_beam/charge/2
