...
execute if score #n temp matches 1.. unless score entityHit temp matches 1 at @s run function ssbrc:fighters/dark_samus/logic/abilities/phazon_beam/move_forward
