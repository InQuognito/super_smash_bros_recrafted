...
tellraw @s[tag=!gold,advancements={ssbrc:fighters/shovelknight/skins/gold=true}] [{"translate":"ssbrc.fighters.skin.gold","color":"gold","clickEvent":{"action":"run_command","value":"/trigger menu set 1925"}}]
tellraw @s[tag=gold] [{"translate":"ssbrc.fighters.skin.gold","color":"gold"},{"text":" ","color":"white"},{"text":"✔","color":"green"}]

tellraw @s[tag=!armorOfChaos,advancements={ssbrc:fighters/shovelknight/skins/armor_of_chaos=true}] [{"translate":"ssbrc.fighters.shovelknight.skin.armorOfChaos","color":"red","clickEvent":{"action":"run_command","value":"/trigger menu set 1926"}}]
...
tellraw @s[tag=!toadGear,advancements={ssbrc:fighters/shovelknight/skins/toad_gear=true}] [{"translate":"ssbrc.fighters.shovelknight.skin.toadGear","color":"green","clickEvent":{"action":"run_command","value":"/trigger menu set 1927"}}]
