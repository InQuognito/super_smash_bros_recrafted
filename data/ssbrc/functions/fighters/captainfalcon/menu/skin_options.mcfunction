...
tellraw @s[tag=!gold,advancements={ssbrc:fighters/captainfalcon/skins/gold=true}] [{"translate":"ssbrc.fighters.skin.gold","color":"gold","clickEvent":{"action":"run_command","value":"/trigger menu set 125"}}]
tellraw @s[tag=gold] [{"translate":"ssbrc.fighters.skin.gold","color":"gold"},{"text":" ","color":"white"},{"text":"✔","color":"green"}]

tellraw @s[tag=!bloodFalcon,advancements={ssbrc:fighters/captainfalcon/skins/blood_falcon=true}] [{"translate":"ssbrc.fighters.captainfalcon.skin.bloodFalcon","color":"dark_red","clickEvent":{"action":"run_command","value":"/trigger menu set 126"}}]
...
tellraw @s[tag=!rickWheeler,advancements={ssbrc:fighters/captainfalcon/skins/rick_wheeler=true}] [{"translate":"ssbrc.fighters.captainfalcon.skin.rickWheeler","color":"dark_blue","clickEvent":{"action":"run_command","value":"/trigger menu set 127"}}]
