execute if entity @s[scores={useAbility=1..,cooldown.1=..0,charge.1=1..},nbt={SelectedItem:{tag:{roboBeam:1}}}] run function ssbrc:fighters/rob/logic/abilities/robo_beam/check
...
execute if entity @s[predicate=ssbrc:flag/sneaking,scores={charge.2=1..}] run function ssbrc:fighters/rob/logic/abilities/robo_burner/tick
