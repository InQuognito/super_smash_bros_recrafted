execute if entity @s[scores={useAbility=1..,cooldown.1=..0,charge.1=1..},nbt={SelectedItem:{tag:{robo_beam:1}}}] run function ssbrc:fighters/rob/logic/abilities/robo_beam/check
