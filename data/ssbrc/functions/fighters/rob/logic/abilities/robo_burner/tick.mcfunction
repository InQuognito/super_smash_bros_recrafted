...
execute if score @s charge.3 matches 6 run effect clear @s minecraft:levitation
execute if score @s charge.3 matches 6..15 run effect give @s minecraft:levitation infinite 1 true
