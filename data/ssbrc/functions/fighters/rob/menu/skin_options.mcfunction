...
tellraw @s[tag=!ancient_minister,advancements={ssbrc:fighters/rob/skins/ancient_minister=true}] [{"translate":"ssbrc.fighters.rob.skin.ancient_minister","color":"dark_green","clickEvent":{"action":"run_command","value":"/trigger menu set 7"}}]
