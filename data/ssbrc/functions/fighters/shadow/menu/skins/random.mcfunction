...
execute unless score @s[advancements={ssbrc:fighters/shadow/skins/sir_lancelot=true}] skinPicked matches 1 if score random.output temp matches 3 run function ssbrc:fighters/shadow/menu/skins/sir_lancelot
execute unless score @s[advancements={ssbrc:fighters/shadow/skins/yellow_android=true}] skinPicked matches 1 if score random.output temp matches 4 run function ssbrc:fighters/shadow/menu/skins/yellow_android
