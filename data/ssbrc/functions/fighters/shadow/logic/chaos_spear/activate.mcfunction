...
execute if score @s[nbt={Inventory:[{tag:{chaosControl:1}}]}] shadow.meter.hero < shadow.chaos_meter.max vars run clear @s minecraft:carrot_on_a_stick{chaosControl:1}
