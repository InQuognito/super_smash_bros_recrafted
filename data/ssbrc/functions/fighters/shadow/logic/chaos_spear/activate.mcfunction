...
scoreboard players operation chaosSpear temp = shadow.chaos_spear.cost vars
...
execute if score chaos_energy temp < shadow.chaos_spear.cost vars run function ssbrc:logic/fighters/modify_item {old:"chaosSpear",new:"shadow/chaos_spear/disabled"}
