...
execute if score chaos_energy temp >= shadow.chaos_spear.cost vars run function ssbrc:logic/fighters/cooldown/display/check {item:"chaos_spear",type:"1",amount:"shadow.chaos_spear.cooldown"}
