...
execute if score @s[nbt=!{Inventory:[{id:"minecraft:nether_star",Count:1b,tag:{chaos_control:1}}]}] shadow.meter.hero >= shadow.chaos_meter.max vars run loot replace entity @s hotbar.4 loot ssbrc:fighters/shadow/chaos_control
