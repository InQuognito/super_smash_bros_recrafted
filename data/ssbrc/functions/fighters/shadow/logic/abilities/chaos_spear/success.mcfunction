...
execute unless score chaos_spear_added temp matches 1 if score @s shadow.meter.hero = @s shadow.meter.villain run function ssbrc:fighters/shadow/logic/abilities/chaos_spear/chaos_energy/subtract_random
