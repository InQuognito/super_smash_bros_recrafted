execute as @e[predicate=ssbrc:flag/targets,distance=..1.5] run function ssbrc:fighters/donkeykong/logic/abilities/barrel/hit
...
execute as @a[tag=self,limit=1] run function ssbrc:fighters/donkeykong/logic/abilities/barrel/regain
