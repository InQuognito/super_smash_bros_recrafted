...
tellraw @s[tag=!dark_link,advancements={ssbrc:fighters/link/skins/dark_link=true}] {"translate":"ssbrc.fighters.link.skin.dark_link","color":"dark_gray","clickEvent":{"action":"run_command","value":"/trigger menu set 3"}}
tellraw @s[tag=dark_link] [{"translate":"ssbrc.fighters.link.skin.dark_link","color":"dark_gray"},{"text":" ✔","color":"green"}]

tellraw @s[tag=!goron_tunic,advancements={ssbrc:fighters/link/skins/goron_tunic=true}] {"translate":"ssbrc.fighters.link.skin.goron_tunic","color":"red","clickEvent":{"action":"run_command","value":"/trigger menu set 4"}}
tellraw @s[tag=goron_tunic] [{"translate":"ssbrc.fighters.link.skin.goron_tunic","color":"red"},{"text":" ✔","color":"green"}]

tellraw @s[tag=!zora_tunic,advancements={ssbrc:fighters/link/skins/zora_tunic=true}] {"translate":"ssbrc.fighters.link.skin.zora_tunic","color":"blue","clickEvent":{"action":"run_command","value":"/trigger menu set 5"}}
