# Health
execute if entity @s[scores={health=40..},nbt={Inventory:[{components:{"minecraft:custom_data":{master_sword:1,awakened:0}}}]}] run function ssbrc:logic/replace_item {old:"master_sword",new:"fighters/link/master_sword"}
