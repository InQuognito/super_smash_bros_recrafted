...
# Health
execute if score @s[nbt={Inventory:[{tag:{masterSword:1,awakened:0}}]}] health matches 40.. run function ssbrc:logic/fighters/replace_item {old:"masterSword",new:"link/master_sword"}
