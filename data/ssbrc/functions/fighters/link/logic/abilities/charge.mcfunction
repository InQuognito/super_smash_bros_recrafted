execute if entity @s[nbt={SelectedItem:{tag:{master_sword:1}}},predicate=ssbrc:flag/sneaking] run function ssbrc:fighters/link/logic/abilities/sword_spin/deactivate
