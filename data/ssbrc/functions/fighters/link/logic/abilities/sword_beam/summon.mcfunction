execute positioned ^-0.5 ^ ^0.5 summon minecraft:marker run function ssbrc:fighters/link/logic/abilities/sword_beam/init/marker
execute positioned ^-0.25 ^ ^0.75 summon minecraft:marker run function ssbrc:fighters/link/logic/abilities/sword_beam/init/marker
execute positioned ^ ^ ^1 summon minecraft:marker run function ssbrc:fighters/link/logic/abilities/sword_beam/init/marker
execute positioned ^0.25 ^ ^0.75 summon minecraft:marker run function ssbrc:fighters/link/logic/abilities/sword_beam/init/marker
execute positioned ^0.5 ^ ^0.5 summon minecraft:marker run function ssbrc:fighters/link/logic/abilities/sword_beam/init/marker
