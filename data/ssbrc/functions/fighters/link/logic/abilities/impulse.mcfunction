...
execute if entity @s[tag=!sheikah_slate,scores={cooldown.2=..0},nbt={SelectedItem:{tag:{sheikah_slate:1}}},predicate=ssbrc:flag/sneaking] run function ssbrc:fighters/link/logic/abilities/sheikah_slate/activate
