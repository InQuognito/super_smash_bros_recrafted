...
execute if entity @s[scores={charge.output=..80}] run function ssbrc:fighters/link/logic/abilities/sword_spin/particles/check {type:"1"}
execute if entity @s[scores={charge.output=81..},predicate=!ssbrc:fighters/link/master_sword_awakened] run function ssbrc:fighters/link/logic/abilities/sword_spin/particles/check {type:"1"}
