...
execute unless score @s[advancements={ssbrc:fighters/wolf/skins/star_fox_2=true}] skin_picked matches 1 if score random.output temp matches 4 run function ssbrc:fighters/wolf/menu/skins/star_fox_2
execute unless score @s[advancements={ssbrc:fighters/wolf/skins/starlink=true}] skin_picked matches 1 if score random.output temp matches 5 run function ssbrc:fighters/wolf/menu/skins/starlink

execute if score @s skin_picked matches 1 run function ssbrc:logic/selector/select_fighter with storage ssbrc:data fighters.wolf
