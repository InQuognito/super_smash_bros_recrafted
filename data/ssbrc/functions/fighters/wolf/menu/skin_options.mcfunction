...
tellraw @s[tag=!star_fox_2,advancements={ssbrc:fighters/wolf/skins/star_fox_2=true}] [{"translate":"ssbrc.fighters.wolf.skin.star_fox_2","color":"dark_gray","clickEvent":{"action":"run_command","value":"/trigger menu set 4"}}]
tellraw @s[tag=star_fox_2] [{"translate":"ssbrc.fighters.wolf.skin.star_fox_2","color":"dark_gray"},{"text":" ✔","color":"green"}]

tellraw @s[tag=!starlink,advancements={ssbrc:fighters/wolf/skins/starlink=true}] [{"translate":"ssbrc.fighters.wolf.skin.starlink","color":"gold","clickEvent":{"action":"run_command","value":"/trigger menu set 5"}}]
