...
execute if entity @s[scores={useAbility=1..,cooldown.3=..0},nbt={SelectedItem:{tag:{wolfSlash:1}}}] run function ssbrc:fighters/wolf/logic/abilities/wolf_flash/activate
