...
execute if score @s temp matches ..19 unless block ~ ~0.2 ~ #ssbrc:passthrough run function ssbrc:fighters/ness/logic/abilities/pk_flash/explode
execute if score @s temp matches 20.. unless block ~ ~-0.3 ~ #ssbrc:passthrough run function ssbrc:fighters/ness/logic/abilities/pk_flash/explode
execute if score @s temp matches 80.. as @a[tag=self,limit=1] run function ssbrc:fighters/ness/logic/abilities/pk_flash/deactivate
