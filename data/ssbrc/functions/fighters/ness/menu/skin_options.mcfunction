...
tellraw @s[tag=moonside] [{"translate":"ssbrc.fighters.ness.skin.moonside","color":"aqua"},{"text":" ","color":"white"},{"text":"✔","color":"green"}]
...
tellraw @s[tag=pajamas] [{"translate":"ssbrc.fighters.ness.skin.pajamas","color":"dark_aqua"},{"text":" ","color":"white"},{"text":"✔","color":"green"}]
...
tellraw @s[tag=phaseDistortion] [{"translate":"ssbrc.fighters.ness.skin.phaseDistortion","color":"gray"},{"text":" ","color":"white"},{"text":"✔","color":"green"}]
