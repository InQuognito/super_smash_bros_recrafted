...
execute if score @s[tag=hot_ryu] temp matches 3 run data modify entity @s item merge value {tag:{CustomModelData:1409000}}
...
execute if score @s[tag=hot_ryu] temp matches 6 run data modify entity @s item merge value {tag:{CustomModelData:1410000}}
...
execute if score @s[tag=hot_ryu] temp matches 9 run data modify entity @s item merge value {tag:{CustomModelData:1411000}}
