...
execute if entity @s[tag=!gold] run function ssbrc:fighters/ryu/logic/abilities/satsui_no_hado_rage/collarbone_breaker/default/evil
execute if entity @s[tag=gold] run function ssbrc:fighters/ryu/logic/abilities/satsui_no_hado_rage/collarbone_breaker/gold/evil
