function ssbrc:fighters/teamrocket/logic/meowth/payday/projectiles/offset_x
...
function ssbrc:fighters/teamrocket/logic/meowth/payday/projectiles/offset_y
...
execute summon minecraft:arrow run function ssbrc:fighters/teamrocket/logic/meowth/payday/projectiles/init/projectile
