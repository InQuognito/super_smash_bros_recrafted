...
execute positioned ~-0.5 ~-0.5 ~-0.5 as @e[tag=!self,nbt=!{Inventory:[{components:{"minecraft:custom_data":{item:"goron_locket"}}}]},predicate=ssbrc:flag/targets,dx=0] run function ssbrc:fighters/bowser/logic/abilities/fire_breath/hit
