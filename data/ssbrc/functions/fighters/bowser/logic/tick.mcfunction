...
execute if score @s[scores={cooldown.1=..0},predicate=!ssbrc:flag/sneaking] charge.1 < bowser.fire_breath.max vars run function ssbrc:logic/fighters/cooldown/set/const {type:"1",value:"20"}
