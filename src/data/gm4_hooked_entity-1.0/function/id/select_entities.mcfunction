...
execute as @e[type=!#gm4_hooked_entity:ignore,tag=!gm4_hooked_entity.id.tagged,distance=..42] at @s run function gm4_hooked_entity-1.0:id/set

# schedule again, since bobber still exists
schedule function gm4_hooked_entity-1.0:id/loop 2t
