execute if entity @s[advancements={ssbrc:tutorial/outro/2=true}] run function ssbrc:logic/npc/mr_sandbag/tips/check
...
execute as @n[type=minecraft:item_display,nbt={data:{interaction:{id:"sandbag"}}},distance=..5] run function ssbrc:logic/npc/mr_sandbag/emotions/blush
