...
execute if items entity @s armor.body *[minecraft:custom_data~{temp: {fighter: {fighter: "pokemon_trainer"}}}] run return run function ssbrc:logic/post_game/podium/voice_line/pokemon_trainer
