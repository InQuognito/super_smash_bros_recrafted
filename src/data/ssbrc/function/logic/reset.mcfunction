...
execute in ssbrc:fighter_select run function ssbrc:logic/scene/deinit {id: "fighter_select"}
execute in ssbrc:stage_select run function ssbrc:logic/scene/deinit {id: "stage_select"}
