function ssbrc:logic/game/entity/player/jump/sound with entity @s equipment.body.components."minecraft:custom_data".temp.fighter
...
execute if score @s jump matches 2.. run function ssbrc:logic/game/entity/player/jump/impulse
