...
$function ssbrc:logic/game/entity/player/skin/check {fighter: "$(fighter)"}

function ssbrc:logic/game/entity/player/skin/set with storage ssbrc:temp cache.fighter
