...
function ssbrc:logic/game/entity/player/stock/check
execute unless data storage ssbrc:data option{point_limit: -1} run function ssbrc:logic/game/entity/player/stock/lose
...
function ssbrc:logic/game/entity/player/cleanup with entity @s equipment.body.components."minecraft:custom_data".temp.fighter
