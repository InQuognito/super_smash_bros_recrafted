...
$execute store result score item.damage temp run data modify storage ssbrc:temp cache.item.name set from entity @s Inventory[{Slot:$(slot_id)b}].components."minecraft:custom_data".item
