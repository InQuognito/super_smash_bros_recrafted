...
execute if items entity @s[tag=chaos_boost] armor.body *[minecraft:custom_data~{fighter: "shadow"}] unless score @s charge.2 matches 1.. run return run function ssbrc:fighter/shadow/logic/chaos_gauge/increase
