...
execute if items entity @s armor.body *[minecraft:custom_data~{form: "wisdom"}] if score @s timer >= 3 const run return run function ssbrc:fighter/sora/magic/restore
