...
function ssbrc:logic/game/entity/player/loop {function: "ssbrc:logic/game/data/scoreboard/create/fighter"}

function ssbrc:logic/game/data/bonus/loop {function: "ssbrc:logic/game/data/scoreboard/create/bonus"}
