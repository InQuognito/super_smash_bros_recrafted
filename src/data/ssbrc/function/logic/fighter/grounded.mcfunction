...
execute if items entity @s armor.body *[minecraft:custom_data~{temp: {fighter: {fighter: "pit"}}}] run return run item modify entity @s armor.chest {function: "minecraft:set_components",components: {"!minecraft:glider":{}}}
