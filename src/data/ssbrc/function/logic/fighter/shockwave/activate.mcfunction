...
execute if items entity @s armor.body *[minecraft:custom_data~{fighter: "dark_samus"}] run return run function ssbrc:fighter/dark_samus/abilities/phazon_spike/activate
