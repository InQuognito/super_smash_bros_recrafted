...
execute if entity @s[tag=close_combat] run return run function ssbrc:fighter/lucario/logic/abilities/close_combat/tick
execute if entity @s[tag=close_combat.fist] run return run function ssbrc:fighter/lucario/logic/abilities/close_combat/fist/tick
...
# Snake
execute if entity @s[tag=claymore] unless block ~ ~-0.1 ~ #ssbrc:passthrough run return run function ssbrc:fighter/snake/logic/abilities/claymore/tick
