$function ssbrc:logic/player/data/set {key: "fighter", value: "$(fighter)"}
...
$execute unless items entity @s armor.body *[minecraft:custom_data~{fighter: "team_rocket"}] run function ssbrc:logic/player/data/set {key: "form", value: "$(default_form)"}
