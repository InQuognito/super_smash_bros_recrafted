...
execute unless score @s health = @s health.prev run function ssbrc:logic/fighter/change_health
...
execute unless score @s[scores={jumps=1..},predicate=ssbrc:input/jump,predicate=ssbrc:flag/no_vehicle] jump.cooldown matches 1.. run function ssbrc:logic/fighter/jump
...
execute unless score @s hud matches 1.. run function ssbrc:logic/fighter/hud with entity @s equipment.body.components."minecraft:custom_data".temp.fighter
