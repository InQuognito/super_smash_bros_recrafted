...
execute if entity @s[scores={duration.1=1..,charge.1=300..}] run function ssbrc:fighter/joker/persona_awakening/deactivate with entity @s equipment.body.components."minecraft:custom_data".temp.fighter
