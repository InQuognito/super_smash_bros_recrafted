...
execute if items entity @s armor.body *[minecraft:custom_data~{fighter: "zelda"}] if items entity @s container.* *[minecraft:custom_data~{item: "ring_of_blasting"}] run item modify entity @s armor.chest ssbrc:enchantments/blast_protection_infinity
