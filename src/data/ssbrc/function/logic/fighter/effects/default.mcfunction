...
execute if items entity @s armor.body *[minecraft:custom_data~{fighter: "king_k_rool"}] run return run function ssbrc:fighter/king_k_rool/abilities/adaptive_armor/enable
