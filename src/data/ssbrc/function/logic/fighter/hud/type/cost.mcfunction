...
# Module Order
execute if function ssbrc:logic/fighter/hud/module/cost/exceptions run function ssbrc:logic/fighter/hud/module/cost with entity @s equipment.body.components."minecraft:custom_data".temp.fighter
function ssbrc:logic/fighter/hud/module/resource
function ssbrc:logic/fighter/hud/module/background
