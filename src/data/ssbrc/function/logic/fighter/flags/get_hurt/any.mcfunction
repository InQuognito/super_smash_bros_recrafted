...
execute if items entity @s[predicate=ssbrc:random_chance/40] armor.body *[minecraft:custom_data~{temp: {fighter: {fighter: "jigglypuff", form: "rest"}}}] run return run function ssbrc:fighter/jigglypuff/rest/deactivate
