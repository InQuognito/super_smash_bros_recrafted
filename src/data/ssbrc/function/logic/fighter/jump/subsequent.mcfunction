...
execute if items entity @s[scores={jump=2}] armor.body *[minecraft:custom_data~{temp: {fighter: {fighter: "giegue"}}}] rotated ~ -90 run return run function ssbrc:fighter/giegue/jump/raycast/start
