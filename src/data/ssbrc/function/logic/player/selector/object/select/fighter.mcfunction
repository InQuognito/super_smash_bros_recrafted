$execute if entity @s[advancements={ssbrc:fighter/$(id)/default=true}] run return run function ssbrc:logic/game/entity/player/select/default with storage ssbrc:data fighter.$(id)
