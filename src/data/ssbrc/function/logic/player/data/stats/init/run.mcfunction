...
function ssbrc:logic/game/entity/player/loop {function: "ssbrc:logic/player/data/stats/init/fighter"}

function ssbrc:logic/game/data/bonus/loop {function: "ssbrc:logic/player/data/stats/init/bonus"}
