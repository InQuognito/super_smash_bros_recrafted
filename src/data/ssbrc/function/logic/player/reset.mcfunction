...
function ssbrc:logic/game/entity/player/select/default with storage ssbrc:data fighter.toon_link
function ssbrc:logic/game/entity/player/armor/init
tag @s remove picking_random

execute if entity @s[advancements={ssbrc:tutorial/equipment/master_sword=true}] run function ssbrc:logic/item/init/slot {item: "master_sword", slot: "hotbar.0", class: "weapon", type: "default"}
