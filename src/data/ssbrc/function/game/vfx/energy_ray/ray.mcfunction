...
execute if score recursions temp matches 0 run return run function ssbrc:game/vfx/energy_ray/end_segment

execute unless block ^ ^ ^.1 #ssbrc:passthrough summon minecraft:marker run return run function ssbrc:game/vfx/energy_ray/bounce
...
function ssbrc:game/vfx/energy_ray/adjust_rotation with storage ssbrc:temp cache
