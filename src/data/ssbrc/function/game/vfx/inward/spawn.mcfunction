...
function ssbrc:game/vfx/inward/roll_distance with storage ssbrc:temp cache
execute store result storage ssbrc:temp cache.distance double .000001 run data get storage ssbrc:temp cache.velocity

$function ssbrc:game/vfx/inward/$(particle)/particle with storage ssbrc:temp cache
