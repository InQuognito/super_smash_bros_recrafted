...
execute if function ssbrc:game/logic/game/entity/player/if_walking_or_falling run scoreboard players remove @s[scores={flag.sprinting=1..}] flag.sprinting 1
