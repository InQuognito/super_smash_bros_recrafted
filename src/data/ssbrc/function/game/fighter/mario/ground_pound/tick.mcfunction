...
execute if entity @s[tag=!launched,tag=!ground_pound,scores={cooldown.2=..0,motion_y=..-10,charge.3=..0},predicate=ssbrc:flag/sneaking] unless function ssbrc:game/fighter/_logic/if_grounded run function ssbrc:game/fighter/mario/ground_pound/start
