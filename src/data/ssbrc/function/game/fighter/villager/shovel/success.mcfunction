...
execute if score @s charge matches 40.. positioned ^ ^ ^-.5 run function ssbrc:game/fighter/villager/shovel/spawn
...
function ssbrc:game/fighter/steve/mining/material with entity @s Inventory[{Slot: 80b}]
