...
execute if score @s charge.2 matches 70..80 run function ssbrc:game/fighter/shadow/chaos_blast/particle/check

execute if score @s charge.2 matches 70 run function ssbrc:game/fighter/shadow/chaos_blast/unleash
