...
execute positioned ~-.5 ~-.5 ~-.5 as @e[predicate=!ssbrc:owner,predicate=ssbrc:target,dx=0] run function ssbrc:game/logic/damage/fire {amount: 12, duration: 60, kb_resist: 0, i_frames: 0}
