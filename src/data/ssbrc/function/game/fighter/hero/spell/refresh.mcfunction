...
function ssbrc:fighter/hero/spell/choose {slot: "hotbar.1"}
function ssbrc:fighter/hero/spell/choose {slot: "hotbar.2"}
function ssbrc:fighter/hero/spell/choose {slot: "hotbar.3"}
function ssbrc:fighter/hero/spell/choose {slot: "hotbar.4"}
