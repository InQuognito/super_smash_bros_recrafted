...
function ssbrc:game/fighter/giegue/pk_freeze/move_forward
...
execute if score @s[tag=!pk_freeze.split] temp matches 30.. run return run function ssbrc:game/fighter/giegue/pk_freeze/split
