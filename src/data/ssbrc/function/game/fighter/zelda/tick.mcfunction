...
execute if items entity @s container.* *[minecraft:custom_data~{extra:"magic_rod"}] run function ssbrc:game/fighter/zelda/magic/update
...
execute if score @s zelda.rupee.add matches 1.. run function ssbrc:game/fighter/zelda/rupees/change {mode: "add"}

execute if score @s zelda.rupee.remove matches 1.. run function ssbrc:game/fighter/zelda/rupees/change {mode: "remove"}

# Great Fairy Blessings
execute if score @s zelda.enchant_armor matches 1.. run function ssbrc:game/fighter/zelda/blessings/enchant_armor/tick
...
execute if score @s zelda.shatter_resist matches 1.. run function ssbrc:game/fighter/zelda/blessings/shatter_resist/tick

execute if score @s zelda.silent_princess matches 1.. run function ssbrc:game/fighter/zelda/blessings/silent_princess/tick
