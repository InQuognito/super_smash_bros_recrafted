...
function ssbrc:game/fighter/zelda/kit/weapon/set with storage ssbrc:temp cache.weapon
...
execute if score #random temp matches 3 run function ssbrc:game/fighter/zelda/kit/bow
