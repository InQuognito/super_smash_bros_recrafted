...
execute positioned ~-.15 ~ ~-.15 as @e[predicate=!ssbrc:owner,predicate=ssbrc:target,dy=2] positioned ~-.7 ~ ~-.7 if entity @s[dy=2] run function ssbrc:game/logic/damage/fire {amount: 4, duration: 60, kb_resist: 0, i_frames: 10}
