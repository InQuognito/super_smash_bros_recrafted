...
execute if entity @s[tag=earthquake] if function ssbrc:game/logic/game/entity/player/if_grounded run function ssbrc:fighter/pokemon_trainer/charizard/earthquake/deactivate
