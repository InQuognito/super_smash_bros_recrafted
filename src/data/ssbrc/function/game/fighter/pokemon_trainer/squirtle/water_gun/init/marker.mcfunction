...
function ssbrc:game/fighter/pokemon_trainer/squirtle/water_gun/offset
...
execute summon minecraft:arrow run function ssbrc:game/fighter/pokemon_trainer/squirtle/water_gun/init/projectile
