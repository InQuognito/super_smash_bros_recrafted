...
function ssbrc:game/fighter/byleth/black_eagles/ground_pound/particle/check
...
function ssbrc:game/fighter/byleth/black_eagles/ground_pound/particle with entity @s Inventory[{Slot:80b}]
item replace entity @s player.crafting.0 with minecraft:air

function ssbrc:game/fighter/byleth/black_eagles/ground_pound/damage
