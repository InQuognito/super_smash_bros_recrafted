...
function ssbrc:game/fighter/sora/spell_switch/display/find
...
function ssbrc:game/fighter/sora/spell_switch/display/get with storage ssbrc:temp cache.item
...
function ssbrc:game/fighter/sora/spell_switch/display/set with storage ssbrc:temp cache.item
