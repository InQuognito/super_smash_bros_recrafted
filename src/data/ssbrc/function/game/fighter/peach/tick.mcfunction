...
# Float
execute if entity @s[tag=!no_float,scores={cooldown.1=..0,charge.1=1..},predicate=ssbrc:flag/sneaking,predicate=!ssbrc:flag/grounded] run function ssbrc:game/fighter/peach/float/check
