...
execute if score #random temp matches 7029..7890 run return run function ssbrc:game/fighter/peach/turnip/set {turnip: "closed_eyes"}
execute if score #random temp matches 7891..8407 run return run function ssbrc:game/fighter/peach/turnip/set {turnip: "surprised"}
execute if score #random temp matches 8408..8921 run return run function ssbrc:game/fighter/peach/turnip/set {turnip: "happy"}
