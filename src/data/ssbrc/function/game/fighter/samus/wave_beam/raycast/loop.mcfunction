...
execute facing ^ ^1 ^ run function ssbrc:game/fighter/samus/wave_beam/raycast/loop_inner
scoreboard players operation #length_inner temp = #out math
execute facing ^1 ^-1 ^ run function ssbrc:game/fighter/samus/wave_beam/raycast/loop_inner
scoreboard players operation #length_inner temp = #out math
execute facing ^-1 ^-1 ^ run function ssbrc:game/fighter/samus/wave_beam/raycast/loop_inner
