...
function ssbrc:game/fighter/_logic/attributes/remove {attribute: "attack_damage"}

attribute @s minecraft:attack_speed base set 100.0
function ssbrc:game/fighter/_logic/attributes/remove {attribute: "attack_speed"}
...
function ssbrc:game/fighter/_logic/attributes/remove {attribute: "jump_strength"}

attribute @s minecraft:max_health base set 40.0
function ssbrc:game/fighter/_logic/attributes/remove {attribute: "max_health"}

attribute @s minecraft:movement_speed base set 0.15
function ssbrc:game/fighter/_logic/attributes/remove {attribute: "movement_speed"}

attribute @s minecraft:safe_fall_distance base set 999.0
function ssbrc:game/fighter/_logic/attributes/remove {attribute: "safe_fall_distance"}
