$function ssbrc:game/fighter/_logic/get/run {function: "ssbrc:game/fighter/_logic/attributes/defaults/armor", fighter: "$(fighter)"}

$function ssbrc:game/fighter/_logic/get/run {function: "ssbrc:game/fighter/_logic/attributes/defaults/jump_strength", fighter: "$(fighter)"}

$function ssbrc:game/fighter/_logic/get/run {function: "ssbrc:game/fighter/_logic/attributes/defaults/max_health", fighter: "$(fighter)"}
...
$function ssbrc:game/fighter/_logic/get/run {function: "ssbrc:game/fighter/_logic/attributes/defaults/movement_speed", fighter: "$(fighter)"}
