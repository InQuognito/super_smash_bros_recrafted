...
execute positioned ~-.2 ~ ~-.2 as @e[predicate=!ssbrc:owner,predicate=ssbrc:target,dy=1] positioned ~-.6 ~ ~-.6 if entity @s[dy=1] run function ssbrc:fighter/cloud/buster_sword/blade_beam/hit
