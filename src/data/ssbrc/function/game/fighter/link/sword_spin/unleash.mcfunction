...
function ssbrc:fighter/link/sword_spin/hit

execute unless function ssbrc:game/logic/game/entity/player/if_grounded run function ssbrc:fighter/link/sword_spin/levitate
