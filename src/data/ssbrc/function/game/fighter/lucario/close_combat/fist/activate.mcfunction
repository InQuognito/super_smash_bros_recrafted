...
execute positioned ~ ~1.75 ~ rotated ~ 0 summon minecraft:item_display run function ssbrc:game/fighter/lucario/close_combat/fist/init with storage ssbrc:temp cache
