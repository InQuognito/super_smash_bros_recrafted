...
execute positioned ^ ^ ^1 summon minecraft:item_display run function ssbrc:game/fighter/lucario/force_palm/particles/spike/init with storage ssbrc:temp cache.force_palm
