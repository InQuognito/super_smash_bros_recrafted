...
execute if score #random temp matches 3 if score @s frostbite matches 1.. run return run function ssbrc:game/fighter/_logic/attributes/modifiers/frostbite/remove
