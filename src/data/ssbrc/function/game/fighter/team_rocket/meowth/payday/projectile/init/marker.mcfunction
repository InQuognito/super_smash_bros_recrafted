...
execute summon minecraft:snowball run function ssbrc:fighter/team_rocket/meowth/payday/projectile/init/vehicle
execute summon minecraft:item_display run function ssbrc:fighter/team_rocket/meowth/payday/projectile/init/projectile
