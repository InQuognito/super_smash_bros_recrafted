...
execute rotated as @s positioned ^ ^ ^-.75 run function ssbrc:game/fighter/team_rocket/meowth/fury_swipes/loop

execute if score #n temp matches 2.. run function ssbrc:game/fighter/team_rocket/meowth/fury_swipes/activate/default
execute if score #n temp matches 1 run function ssbrc:game/fighter/team_rocket/meowth/fury_swipes/activate/final
