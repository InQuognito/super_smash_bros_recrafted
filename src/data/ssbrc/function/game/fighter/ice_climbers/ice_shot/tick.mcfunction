...
execute positioned ~-.5 ~-.5 ~-.5 as @e[tag=!self,predicate=ssbrc:target,dx=0] run function ssbrc:game/logic/damage/frostbite {amount: 4, stacks: 1, kb_resist: 0, i_frames: 0}
