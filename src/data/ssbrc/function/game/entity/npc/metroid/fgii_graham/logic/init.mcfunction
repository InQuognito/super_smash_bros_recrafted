...
function ssbrc:game/entity/npc/metroid/fgii_graham/rig/summon {args: {animation: "idle", start_animation: true}}
ride @n[type=minecraft:item_display,tag=ssbrc.fgii_graham.root,distance=...01] mount @s
