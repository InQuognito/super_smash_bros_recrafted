...
execute if score @s smash_item.franklin_badge.timer matches 1.. positioned ~ ~.75 ~ run function ssbrc:game/smash_item/franklin_badge/tick
execute if score @s smash_item.poison_mushroom.timer matches 1.. run function ssbrc:game/smash_item/poison_mushroom/tick
...
# Specific Tick
function ssbrc:game/entity/player/_logic/tick/specific with entity @s equipment.body.components."minecraft:custom_data".temp.fighter
