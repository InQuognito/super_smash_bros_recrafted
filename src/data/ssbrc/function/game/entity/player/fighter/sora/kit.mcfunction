function ssbrc:game/entity/player/fighter/sora/cleanup

scoreboard players set @s resource 0
function ssbrc:game/entity/player/fighter/sora/drive_forms/hud

function ssbrc:game/item/init/slot {item: "keyblade_primary", slot: "hotbar.0", class: "weapon", type: "hybrid"}
