function ssbrc:game/entity/player/fighter/shovel_knight/phase_locket/deactivate
execute if entity @s[tag=war_horn.active] run function ssbrc:game/entity/player/fighter/shovel_knight/war_horn/deactivate
