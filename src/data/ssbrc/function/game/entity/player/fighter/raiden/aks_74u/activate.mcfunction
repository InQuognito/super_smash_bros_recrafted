...
function ssbrc:game/entity/player/fighter/raiden/aks_74u/offset
...
execute anchored eyes positioned ^ ^ ^.5 run function ssbrc:game/entity/player/fighter/raiden/aks_74u/start with storage ssbrc:temp cache.rotation

scoreboard players remove @s weapon_3.ammo 1
execute if entity @s[scores={weapon_3.mags=1..,weapon_3.ammo=0}] run function ssbrc:game/entity/player/fighter/_logic/effects/reload {id: 3, duration: 30}
