...
function ssbrc:game/entity/player/fighter/_logic/attributes/modifiers/frostbite/remove
function ssbrc:game/entity/player/fighter/_logic/attributes/modifiers/frostbite/apply
