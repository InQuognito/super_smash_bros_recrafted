...
function ssbrc:game/entity/player/fighter/snake/socom/offset
...
execute anchored eyes positioned ^ ^ ^.5 run function ssbrc:game/entity/player/fighter/snake/socom/start with storage ssbrc:temp cache.rotation

scoreboard players remove @s weapon_4.ammo 1
execute if entity @s[scores={weapon_4.mags=1..,weapon_4.ammo=0}] run function ssbrc:game/entity/player/fighter/_logic/effects/reload {id: 4, duration: 40}
