...
function ssbrc:game/logic/item/component/get {search_key: "item", search_value: "alucard_shield",component:"minecraft:damage",output_type: "score",output_path:"@s durability"}
