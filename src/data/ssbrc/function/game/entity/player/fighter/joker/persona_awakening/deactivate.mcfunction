...
function ssbrc:game/item/init/replace {search_key: "item", search_value: "rebel_knife", item: "rebel_knife", class: "default", type: "default"}

$function ssbrc:game/item/modify {search_key: "group", search_value: "persona", path: {type: "minecraft:set_components", components: {"minecraft:item_model": "ssbrc:fighter/joker/misc/portrait/$(persona)/inactive"}}}
