...
execute positioned ~-.05 ~-.05 ~-.05 as @e[predicate=!ssbrc:owner,predicate=ssbrc:target,dx=0] positioned ~-.9 ~-.9 ~-.9 if entity @s[dx=0] run function ssbrc:game/damage/generic {amount: 3, kb_resist: .8, i_frames: 0}
