...
execute if items entity @s weapon.mainhand *[minecraft:custom_data~{item: "flame_hands"}] run function ssbrc:game/logic/item/init/slot {item: "flame_hands", slot: "weapon.offhand", class: "weapon", type: "hybrid"}
