...
execute if items entity @s armor.body *[minecraft:custom_data~{temp: {fighter: {form: "blood_metamorphosis"}}}] run function ssbrc:game/entity/player/fighter/alucard/mist/blood_metamorphosis

function ssbrc:game/entity/player/fighter/alucard/mist/shield
