...
execute if score #random temp matches 4 run function ssbrc:game/item/init/slot {item: "fire_rod", slot: "hotbar.1", class: "default", type: "default"}
execute if score #random temp matches 5 run function ssbrc:game/item/init/slot {item: "ice_rod", slot: "hotbar.1", class: "default", type: "default"}
