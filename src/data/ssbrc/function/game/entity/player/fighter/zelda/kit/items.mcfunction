...
function ssbrc:game/entity/player/fighter/zelda/kit/weapon/set with storage ssbrc:temp cache.weapon

execute store result score #random temp run random value 1..7

execute if score #random temp matches 1 run function ssbrc:game/logic/item/init/slot {item: "zelda_bomb", slot: "hotbar.1", class: "default", type: "default"}
execute if score #random temp matches 2 run function ssbrc:game/logic/item/init/slot {item: "zelda_boomerang", slot: "hotbar.1", class: "default", type: "default"}
execute if score #random temp matches 3 run function ssbrc:game/entity/player/fighter/zelda/kit/bow
execute if score #random temp matches 4 run function ssbrc:game/logic/item/init/slot {item: "fire_rod", slot: "hotbar.1", class: "default", type: "default"}
execute if score #random temp matches 5 run function ssbrc:game/logic/item/init/slot {item: "ice_rod", slot: "hotbar.1", class: "default", type: "default"}
execute if score #random temp matches 6 run function ssbrc:game/logic/item/init/slot {item: "magic_boomerang", slot: "hotbar.1", class: "default", type: "default"}
execute if score #random temp matches 7 run function ssbrc:game/logic/item/init/slot {item: "red_potion", slot: "hotbar.1", class: "default", type: "consumable"}
...
function ssbrc:game/logic/item/init/slot {item: "great_fairy_blessing", slot: "hotbar.4", class: "default", type: "default"}

function ssbrc:game/logic/item/init/slot {item: "inventory_refresh", slot: "hotbar.5", class: "default", type: "default"}
