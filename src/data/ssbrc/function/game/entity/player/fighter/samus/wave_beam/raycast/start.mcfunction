...
execute if score @s piercing <= #samus.wave_beam const anchored eyes positioned ^ ^ ^ anchored feet run function ssbrc:game/entity/player/fighter/samus/wave_beam/raycast/loop
