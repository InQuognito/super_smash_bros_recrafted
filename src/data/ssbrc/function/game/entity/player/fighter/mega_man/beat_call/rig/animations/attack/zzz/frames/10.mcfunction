...
execute unless entity @s[tag=aj.transforms_only] at @s run function ssbrc:game/entity/player/fighter/mega_man/beat_call/rig/animations/attack/zzz/frames/10_root_function
