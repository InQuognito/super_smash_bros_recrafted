function ssbrc:game/entity/player/fighter/ryu/tatsumaki_senpukyaku/particles/speed

function ssbrc:game/entity/player/fighter/ryu/tatsumaki_senpukyaku/raycast/start
