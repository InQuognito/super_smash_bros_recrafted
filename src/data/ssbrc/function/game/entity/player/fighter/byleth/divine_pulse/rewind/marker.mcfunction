...
$execute rotated $(rotation_x) $(rotation_y) as @a[predicate=ssbrc:owner,limit=1] run function ssbrc:game/entity/player/fighter/byleth/divine_pulse/rewind/player
