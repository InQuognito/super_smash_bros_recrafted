...
$execute if items entity @s armor.body *[minecraft:custom_data~{temp: {fighter: {skin: "dawn"}}}] run return run tellraw @s [ \
	{ \
		translate: "ssbrc.fighter.pokemon_trainer.i_choose_you.prefix", \
		color: "$(color)", \
	}, \
	{ \
		translate: "ssbrc.fighter.pokemon_trainer.$(form).dawn", \
		color: "$(color)", \
	}, \
	{ \
		translate: "ssbrc.fighter.pokemon_trainer.i_choose_you", \
		color: "$(color)", \
	} \
]
...
$execute if items entity @s armor.body *[minecraft:custom_data~{temp: {fighter: {skin: "victor"}}} \
	...
	{ \
		translate: "ssbrc.fighter.pokemon_trainer.$(form).victor", \
		color: "$(color)", \
	}, \
	{ \
		translate: "ssbrc.fighter.pokemon_trainer.i_choose_you", \
...
$tellraw @s [ \
	...
	{ \
		translate: "ssbrc.fighter.pokemon_trainer.$(form).default", \
		color: "$(color)", \
	}, \
	{ \
		translate: "ssbrc.fighter.pokemon_trainer.i_choose_you", \
