execute if items entity @s armor.body *[minecraft:custom_data~{temp: {fighter: {skin: "gold"}}}] run return run function ssbrc:game/entity/player/fighter/mega_man/armor/check/skin/gold
