...
execute anchored eyes positioned ^ ^ ^.5 run function ssbrc:game/entity/player/fighter/snake/psg1/start with storage ssbrc:temp cache.rotation

scoreboard players remove @s weapon_2.ammo 1
execute if entity @s[scores={weapon_2.mags=1..,weapon_2.ammo=0}] run function ssbrc:game/entity/player/fighter/snake/psg1/reload/start
