...
function ssbrc:game/logic/block/execute_at_ground {result: "execute summon minecraft:item_display run function ssbrc:game/entity/player/fighter/mega_man/junk_shield/summon with storage ssbrc:temp cache"}
scoreboard players set #ground_search temp 100
function ssbrc:game/logic/block/execute_at_ground {result: "execute summon minecraft:item_display run function ssbrc:game/entity/player/fighter/mega_man/junk_shield/summon with storage ssbrc:temp cache"}
scoreboard players set #ground_search temp 100
function ssbrc:game/logic/block/execute_at_ground {result: "execute summon minecraft:item_display run function ssbrc:game/entity/player/fighter/mega_man/junk_shield/summon with storage ssbrc:temp cache"}
