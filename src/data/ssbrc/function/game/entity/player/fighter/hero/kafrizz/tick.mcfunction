...
execute positioned ~-1 ~-1 ~-1 as @e[predicate=!ssbrc:owner,predicate=ssbrc:target,dx=1] run function ssbrc:game/damage/fire {amount: 20, duration: 60, kb_resist: 0, i_frames: 0}
