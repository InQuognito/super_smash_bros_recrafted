...
execute facing ~ ~-1 ~ run function ssbrc:game/entity/player/fighter/king_k_rool/blunderbuss/particles/2
execute facing ~ ~-1 ~ run function ssbrc:game/entity/player/fighter/king_k_rool/blunderbuss/particles/3
