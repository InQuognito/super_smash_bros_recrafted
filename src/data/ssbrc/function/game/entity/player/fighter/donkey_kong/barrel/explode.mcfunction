...
execute if items entity @s armor.head *[minecraft:custom_model_data={strings:["flower_power"]}] run return run function ssbrc:game/entity/player/fighter/donkey_kong/barrel/explode/flower_power
