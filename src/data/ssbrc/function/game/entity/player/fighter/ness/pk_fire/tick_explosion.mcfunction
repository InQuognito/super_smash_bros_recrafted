...
execute as @e[predicate=ssbrc:target,predicate=!ssbrc:owner,distance=..1.5] run function ssbrc:game/damage/fire {amount: 4, duration: 10, kb_resist: .9, i_frames: 10}
