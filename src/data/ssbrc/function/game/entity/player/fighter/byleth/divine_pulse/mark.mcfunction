...
execute summon minecraft:marker run function ssbrc:game/entity/player/fighter/byleth/divine_pulse/init with storage ssbrc:temp cache.divine_pulse
execute as @e[type=minecraft:marker,tag=divine_pulse,predicate=ssbrc:owner] run function ssbrc:game/entity/player/fighter/byleth/divine_pulse/increase
