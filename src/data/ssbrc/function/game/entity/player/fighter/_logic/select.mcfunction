$execute if entity @s[advancements={ssbrc:fighter/$(id)/default=true}] run return run function ssbrc:game/entity/player/fighter/_logic/select/default with storage ssbrc:data fighter.$(id)
