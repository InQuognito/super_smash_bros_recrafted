...
execute positioned ~ ~.1 ~ summon minecraft:marker run function ssbrc:game/entity/player/fighter/shovel_knight/propeller_dagger/init

scoreboard players operation @s resource -= #shovel_knight.propeller_dagger const
