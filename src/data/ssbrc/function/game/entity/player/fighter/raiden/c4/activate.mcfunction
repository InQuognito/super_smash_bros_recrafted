...
execute anchored eyes positioned ^ ^ ^.5 summon minecraft:marker run function ssbrc:game/entity/player/fighter/raiden/c4/init/marker

function ssbrc:game/entity/player/fighter/raiden/load/decrease
