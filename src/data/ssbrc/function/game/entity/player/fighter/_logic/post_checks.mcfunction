...
# General
execute as @a[tag=check_kill] if score @s timer.stat.kill matches 2 run function ssbrc:game/entity/player/fighter/_logic/check/kill
execute as @a[tag=check_death] if score @s timer.stat.death matches 2 run function ssbrc:game/entity/player/fighter/_logic/check/death
execute as @a if score @s timer.shockwave matches 2 run function ssbrc:game/entity/player/fighter/_logic/shockwave/reset
