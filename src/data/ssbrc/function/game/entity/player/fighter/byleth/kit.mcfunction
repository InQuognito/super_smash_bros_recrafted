...
execute if items entity @s armor.body *[minecraft:custom_data~{temp:{fighter: {house: "blue_lions"}}}] run return run function ssbrc:game/entity/player/fighter/byleth/blue_lions/kit

function ssbrc:game/entity/player/fighter/byleth/golden_deer/kit
