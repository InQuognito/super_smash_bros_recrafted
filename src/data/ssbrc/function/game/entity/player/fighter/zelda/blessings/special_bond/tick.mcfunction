...
execute if items entity @s container.* *[minecraft:custom_data~{item: "torch_of_wisdom"}] as @a[predicate=!ssbrc:owner,predicate=ssbrc:player,predicate=ssbrc:team_match] at @s run function ssbrc:game/entity/player/fighter/zelda/shared_passives/torch_of_wisdom
