execute if entity @s[scores={silenced=..0,charge.1=600..}] run function ssbrc:game/entity/player/fighter/joker/persona_awakening/activate with entity @s equipment.body.components."minecraft:custom_data".temp.fighter
