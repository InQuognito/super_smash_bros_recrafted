...
execute as @e[type=minecraft:item_display,tag=crossfire,predicate=ssbrc:owner,distance=..10] run function ssbrc:game/entity/player/fighter/roy/crossfire/enable
