execute unless predicate ssbrc:flag/sneaking run return run function ssbrc:game/entity/player/fighter/altered_beast/weretiger/pounce/reset
...
execute if score @s charge.2 matches 1 run function ssbrc:game/entity/player/fighter/_logic/effects/immobile/activate {duration: 1000000}
