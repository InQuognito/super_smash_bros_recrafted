...
execute if function ssbrc:game/entity/player/fighter/_logic/if_walking_or_falling run scoreboard players remove @s[scores={flag.sprinting=1..}] flag.sprinting 1
...
function ssbrc:game/entity/player/fighter/sonic/speed/tick
