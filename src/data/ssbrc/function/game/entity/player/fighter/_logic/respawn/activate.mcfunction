...
execute if entity @s[tag=alive] run function ssbrc:game/entity/player/fighter/_logic/restore_items with entity @s equipment.body.components."minecraft:custom_data".temp.fighter
...
execute if data storage ssbrc:data option{game_mode: "ctf"} run return run function ssbrc:game/entity/player/fighter/_logic/respawn/activate/ctf with storage ssbrc:temp cache
function ssbrc:game/entity/player/fighter/_logic/respawn/activate/smash
