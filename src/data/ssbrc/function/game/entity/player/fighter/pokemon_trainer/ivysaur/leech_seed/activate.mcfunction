...
execute anchored eyes positioned ^ ^ ^1 summon minecraft:marker run function ssbrc:game/entity/player/fighter/pokemon_trainer/ivysaur/leech_seed/init/marker
