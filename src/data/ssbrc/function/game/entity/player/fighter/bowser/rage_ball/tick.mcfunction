...
execute unless block ~ ~ ~ #ssbrc:passthrough run return run function ssbrc:game/entity/player/fighter/bowser/rage_ball/explode
...
execute positioned ~-.5 ~-.5 ~-.5 if entity @e[predicate=!ssbrc:owner,predicate=ssbrc:target,dx=0] run return run function ssbrc:game/entity/player/fighter/bowser/rage_ball/explode
