...
# Ammo HUD
function ssbrc:game/entity/player/fighter/snake/hud/check
title @s actionbar { \
...
# Reload
execute if score @s weapon_1.reload matches 1.. run function ssbrc:game/entity/player/fighter/snake/m870_custom/reload/tick
execute if score @s weapon_2.reload matches 1.. run function ssbrc:game/entity/player/fighter/snake/psg1/reload/tick
execute if score @s weapon_3.reload matches 1.. run function ssbrc:game/entity/player/fighter/snake/famas/reload/tick
execute if score @s weapon_4.reload matches 1.. run function ssbrc:game/entity/player/fighter/snake/socom/reload/tick
