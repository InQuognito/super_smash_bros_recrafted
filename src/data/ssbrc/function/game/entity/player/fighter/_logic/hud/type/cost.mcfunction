...
# Module Order
execute if function ssbrc:game/entity/player/fighter/_logic/hud/module/cost/exceptions run function ssbrc:game/entity/player/fighter/_logic/hud/module/cost with entity @s equipment.body.components."minecraft:custom_data".temp.fighter
