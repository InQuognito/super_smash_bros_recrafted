execute if score @s charge matches 7 run playsound ssbrc:fighter.bowser.fire_breath.activate player @a
...
execute anchored eyes positioned ^ ^ ^.5 run function ssbrc:game/entity/player/fighter/bowser/fire_breath/step with storage ssbrc:temp cache.fire_breath
