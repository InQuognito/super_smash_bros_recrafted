...
scoreboard players operation @s id = #cache temp

execute store result storage ssbrc:temp cache.rotation.value int 1 run random value 1..360
function ssbrc:game/entity/player/fighter/dark_samus/phazon_spike/rotate with storage ssbrc:temp cache.rotation
