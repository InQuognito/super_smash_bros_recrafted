execute if score @s charge.1 matches 84.. run return run function ssbrc:game/entity/player/fighter/captain_falcon/falcon_punch/deactivate

execute if score @s silenced matches 1.. run return run function ssbrc:game/entity/player/fighter/captain_falcon/falcon_punch/deactivate
