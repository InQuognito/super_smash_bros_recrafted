...
execute if score @s frostbite matches 2 run particle minecraft:dust_color_transition{from_color: [.4,.9,1], to_color: [1,1,1], scale: .625} ~ ~.75 ~ .2 .4 .2 0 1 normal @a
...
execute if score @s frostbite matches 4 run particle minecraft:dust_color_transition{from_color: [.4,.9,1], to_color: [1,1,1], scale: .875} ~ ~.75 ~ .2 .4 .2 0 1 normal @a
...
execute if score @s frostbite.timer matches 0 run function ssbrc:game/entity/player/fighter/_logic/attributes/modifiers/frostbite/decrease
