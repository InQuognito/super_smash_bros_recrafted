...
execute if score #random temp matches 3 if score @s frostbite matches 1.. run return run function ssbrc:game/entity/player/fighter/_logic/attributes/modifiers/frostbite/remove

function ssbrc:game/entity/player/fighter/team_rocket/arbok/shed_skin/choose
