...
function ssbrc:game/entity/player/fighter/rob/robo_beam/reset
...
execute if score robo_beam temp matches 100.. run function ssbrc:game/entity/player/fighter/rob/robo_beam/activate
