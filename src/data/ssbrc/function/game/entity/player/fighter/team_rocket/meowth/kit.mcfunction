function ssbrc:game/entity/player/fighter/team_rocket/update {form: "meowth"}

function ssbrc:game/item/init/slot {item: "scratch", slot: "hotbar.0", class: "weapon", type: "hybrid"}

function ssbrc:game/item/init/slot {item: "payday", slot: "hotbar.1", class: "default", type: "default"}
