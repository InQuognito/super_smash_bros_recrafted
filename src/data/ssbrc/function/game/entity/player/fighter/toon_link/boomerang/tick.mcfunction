...
execute positioned ~-.2 ~-.2 ~-.2 as @e[predicate=!ssbrc:owner,predicate=ssbrc:target,dx=0] positioned ~-.6 ~-.7 ~-.6 if entity @s[dx=0] run function ssbrc:game/damage/generic {amount: 6, kb_resist: 0, i_frames: 5}
