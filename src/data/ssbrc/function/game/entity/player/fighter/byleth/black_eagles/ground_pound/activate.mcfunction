...
function ssbrc:game/entity/player/fighter/byleth/black_eagles/ground_pound/particle/check
...
function ssbrc:game/entity/player/fighter/byleth/black_eagles/ground_pound/particle with entity @s Inventory[{Slot:80b}]
item replace entity @s player.crafting.0 with minecraft:air

function ssbrc:game/entity/player/fighter/byleth/black_eagles/ground_pound/damage
