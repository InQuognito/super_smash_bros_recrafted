...
execute as @e[type=minecraft:marker,tag=divine_pulse,predicate=ssbrc:owner,scores={temp=1},limit=1] at @s run function ssbrc:game/entity/player/fighter/byleth/divine_pulse/rewind/marker with entity @s data
