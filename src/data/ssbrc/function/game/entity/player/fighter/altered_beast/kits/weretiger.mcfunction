function ssbrc:game/entity/player/fighter/altered_beast/kits/update {form: "weretiger"}

attribute @s minecraft:safe_fall_distance modifier add ssbrc:form 9 add_multiplied_base
