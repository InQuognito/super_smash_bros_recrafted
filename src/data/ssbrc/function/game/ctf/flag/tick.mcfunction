...
execute if score #cache temp matches 0 run function ssbrc:game/ctf/flag/timer/update

execute if score @s temp matches 1 run function ssbrc:game/ctf/flag/return
