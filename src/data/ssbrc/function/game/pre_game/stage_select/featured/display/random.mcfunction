...
execute summon minecraft:interaction run function ssbrc:game/entity/_logic/init/interaction {height: 1, width: 1, left_click: "ssbrc:game/stage/_logic/vote {name: random_stage, page: 1}", right_click: "ssbrc:game/stage/_logic/vote {name: random_stage, page: 1}"}
