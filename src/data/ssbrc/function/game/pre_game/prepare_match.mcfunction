...
function ssbrc:game/team/set_option {key: "nametagVisibility", value: "hideForOtherTeams"}

teleport @a[team=spectator] 0 10 0

function ssbrc:game/pre_game/teleport/start
function ssbrc:game/pre_game/start_countdown
