...
function ssbrc:game/entity/player/fighter/_logic/loop {function: "ssbrc:game/data/scoreboard/create/fighter"}

function ssbrc:game/data/bonus/loop {function: "ssbrc:game/data/scoreboard/create/bonus"}
