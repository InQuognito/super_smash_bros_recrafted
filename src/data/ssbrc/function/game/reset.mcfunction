...
function ssbrc:game/entity/init/fighter
function ssbrc:game/entity/init/stage
function ssbrc:game/entity/init/smash_items
function ssbrc:game/entity/init/victory_podium
