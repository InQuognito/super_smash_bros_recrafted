...
$execute if score @s[advancements={ssbrc:fighter/$(fighter)/gold=false}] stats.$(fighter).wins matches 10.. run function ssbrc:game/logic/post_game/winner/gold_skin {fighter: "$(fighter)"}
