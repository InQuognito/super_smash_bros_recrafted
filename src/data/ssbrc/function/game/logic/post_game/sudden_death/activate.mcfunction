...
execute as @a[predicate=ssbrc:ingame] run function ssbrc:game/logic/post_game/sudden_death/set_players_all

function ssbrc:game/logic/pre_game/teleport_begin
