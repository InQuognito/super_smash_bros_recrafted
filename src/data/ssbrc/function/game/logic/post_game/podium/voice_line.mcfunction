execute if items entity @s armor.body *[minecraft:custom_data~{temp: {fighter: {fighter: "byleth"}}}] run return run function ssbrc:game/logic/post_game/podium/voice_line/byleth
execute if items entity @s armor.body *[minecraft:custom_data~{temp: {fighter: {fighter: "pokemon_trainer"}}}] run return run function ssbrc:game/logic/post_game/podium/voice_line/pokemon_trainer/check
