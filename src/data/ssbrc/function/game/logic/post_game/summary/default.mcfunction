...
execute if data storage ssbrc:data option{teams: true} run function ssbrc:game/logic/post_game/summary/team
...
execute if entity @s[tag=!admin,team=!spectator] run function ssbrc:game/logic/post_game/summary/player
