...
function ssbrc:game/logic/item/find with storage ssbrc:temp cache.item

function ssbrc:game/logic/item/component/store with storage ssbrc:temp cache.item
