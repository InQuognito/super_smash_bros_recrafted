...
execute if score #cache temp matches 0 run function ssbrc:game/logic/ctf/flag/timer/update

execute if score @s temp matches 1 run function ssbrc:game/logic/ctf/flag/return
