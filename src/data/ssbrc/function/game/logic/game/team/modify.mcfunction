function ssbrc:game/logic/game/team/modify/friendly_fire
function ssbrc:game/logic/game/team/modify/teams

function ssbrc:game/logic/game/team/set_option {key: "collisionRule", value: "always"}
function ssbrc:game/logic/game/team/set_option {key: "deathMessageVisibility", value: "never"}
function ssbrc:game/logic/game/team/set_option {key: "nametagVisibility", value: "always"}
function ssbrc:game/logic/game/team/set_option {key: "prefix", value: ""}
function ssbrc:game/logic/game/team/set_option {key: "suffix", value: ""}
