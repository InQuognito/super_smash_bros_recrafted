...
# Options
function ssbrc:game/logic/game/options/interface/game_mode

function ssbrc:game/logic/game/options/interface/teams

function ssbrc:game/logic/game/options/interface/friendly_fire

function ssbrc:game/logic/game/options/interface/items

function ssbrc:game/logic/game/options/interface/hazards

function ssbrc:game/logic/game/options/interface/music

execute if items entity @s container.* minecraft:written_book[minecraft:custom_data~{item: "options"}] run function ssbrc:game/logic/item/replace/get {search_key: "item", search_value: "options", path: "ssbrc:options"}
