$function ssbrc:game/logic/game/entity/player/get/run {function: "ssbrc:game/logic/game/entity/player/attributes/defaults/armor", fighter: "$(fighter)"}

$function ssbrc:game/logic/game/entity/player/get/run {function: "ssbrc:game/logic/game/entity/player/attributes/defaults/jump_strength", fighter: "$(fighter)"}

$function ssbrc:game/logic/game/entity/player/get/run {function: "ssbrc:game/logic/game/entity/player/attributes/defaults/max_health", fighter: "$(fighter)"}
...
$function ssbrc:game/logic/game/entity/player/get/run {function: "ssbrc:game/logic/game/entity/player/attributes/defaults/movement_speed", fighter: "$(fighter)"}
