...
# Module Order
execute if function ssbrc:game/logic/game/entity/player/hud/module/cost/exceptions run function ssbrc:game/logic/game/entity/player/hud/module/cost with entity @s equipment.body.components."minecraft:custom_data".temp.fighter
function ssbrc:game/logic/game/entity/player/hud/module/resource
function ssbrc:game/logic/game/entity/player/hud/module/background
