...
execute if entity @s[type=#ssbrc:movement/motion] run function ssbrc:game/logic/game/entity/player/reflect/motion
teleport @s[type=!#ssbrc:movement/motion,type=!minecraft:armor_stand] ~ ~ ~ facing ^ ^ ^-1
execute at @s[type=minecraft:armor_stand] run function ssbrc:game/logic/game/entity/player/reflect/armor_stands
