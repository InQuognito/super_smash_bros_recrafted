...
$execute if entity @s[tag=picking_random] run return run function ssbrc:game/logic/game/entity/player/select/default with storage ssbrc:data fighter.$(fighter)
