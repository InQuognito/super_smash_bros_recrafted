...
$function ssbrc:game/logic/game/entity/player/skin/check {fighter: "$(fighter)"}

function ssbrc:game/logic/game/entity/player/skin/set with storage ssbrc:temp cache.fighter
...
execute if entity @s[team=spectator] run function ssbrc:game/logic/game/team/join/red
