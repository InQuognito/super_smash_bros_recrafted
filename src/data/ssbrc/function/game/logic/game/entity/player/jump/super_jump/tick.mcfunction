execute if function ssbrc:game/logic/game/entity/player/if_grounded run scoreboard players add @s[predicate=ssbrc:flag/sneaking] charge.1 1
...
execute if score #super_jump.falloff temp matches 200.. run function ssbrc:game/logic/game/entity/player/jump/super_jump/reset
