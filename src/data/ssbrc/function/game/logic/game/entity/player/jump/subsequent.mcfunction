function ssbrc:game/logic/game/entity/player/jump/sound with entity @s equipment.body.components."minecraft:custom_data".temp.fighter
...
execute if items entity @s[scores={jump=2..},tag=villager.balloon_trip] armor.body *[minecraft:custom_data~{temp: {fighter: {fighter: "villager"}}}] run function ssbrc:game/fighter/villager/balloon_trip/jump

execute if score @s jump matches 2.. run function ssbrc:game/logic/game/entity/player/jump/impulse
