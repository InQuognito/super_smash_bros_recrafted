...
execute at @s[predicate=ssbrc:player] run function ssbrc:game/logic/game/entity/player/tick

execute as @e[type=!minecraft:player,predicate=ssbrc:owner] at @s run function ssbrc:game/logic/game/entity/player/ability/tick
