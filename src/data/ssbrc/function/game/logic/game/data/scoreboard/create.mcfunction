...
scoreboard objectives add health.prev dummy
...
function ssbrc:game/logic/game/entity/player/loop {function: "ssbrc:game/logic/game/data/scoreboard/create/fighter"}

function ssbrc:game/logic/game/data/bonus/loop {function: "ssbrc:game/logic/game/data/scoreboard/create/bonus"}
