...
execute if data storage ssbrc:data option{debug: true} run return run function ssbrc:game/logic/game/data/gamerule/debug
function ssbrc:game/logic/game/data/gamerule/default
