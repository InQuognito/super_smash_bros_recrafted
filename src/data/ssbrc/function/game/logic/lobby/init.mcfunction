...
# Links
#execute positioned -531.99 4.5 -1943.5 run function ssbrc:game/logic/lobby/logo {id:"discord", color: "blue",link:"https://discord.gg/yAzw55N5Ax"}
#execute positioned -531.99 4.5 -1944.5 run function ssbrc:game/logic/lobby/logo {id:"pmc", color: "green",link:"https://www.planetminecraft.com/member/team_recrafted"}
