execute unless score @s menu matches 0 run function ssbrc:game/logic/pre_game/fighter_select/trigger/menu with entity @s equipment.body.components."minecraft:custom_data".temp.fighter
scoreboard players set @s menu 0
scoreboard players enable @s menu

execute unless score @s fighter_trigger matches 0 run function ssbrc:game/logic/pre_game/fighter_select/trigger/loadout with entity @s equipment.body.components."minecraft:custom_data".temp.fighter
