...
scoreboard players set #bowser.rage_ball const 25
...
# Items
execute if data storage ssbrc:data option{game_mode: "ctf"} run return run function ssbrc:game/logic/options/item_data/ctf
function ssbrc:game/logic/options/item_data/smash
