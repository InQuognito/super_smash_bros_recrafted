execute if data storage ssbrc:temp cache.stage_select{highest: "random_stage"} run return run function ssbrc:game/logic/stage/random/run {function: "ssbrc:game/logic/pre_game/stage_select/choose"}
