...
execute summon minecraft:interaction run function ssbrc:entity/_logic/init/interaction {height: 1, width: 1, left_click: "ssbrc:game/logic/stage/vote {name: random_stage, page: 1}", right_click: "ssbrc:game/logic/stage/vote {name: random_stage, page: 1}"}
