...
execute as @e[type=minecraft:text_display,tag=top,sort=random,limit=1] run function ssbrc:game/logic/pre_game/stage_select/pick_stage/load_stage with storage ssbrc:temp cache.stage_select
