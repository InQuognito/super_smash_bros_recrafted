...
function ssbrc:game/fighter/_logic/get_distance
execute if score #distance temp matches 30.. run scoreboard players add @s sniper 1

function ssbrc:game/fighter/_logic/bonuses/rapid_kill
...
execute if items entity @s armor.body *[minecraft:custom_data~{temp: {fighter: {fighter: "zelda"}}}] run return run function ssbrc:game/fighter/zelda/kill/player
