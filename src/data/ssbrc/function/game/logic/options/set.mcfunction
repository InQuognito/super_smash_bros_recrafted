...
# Options
function ssbrc:game/logic/options/interface/game_mode

function ssbrc:game/logic/options/interface/teams

function ssbrc:game/logic/options/interface/friendly_fire

function ssbrc:game/logic/options/interface/items

function ssbrc:game/logic/options/interface/hazards

function ssbrc:game/logic/options/interface/music

execute if items entity @s container.* minecraft:written_book[minecraft:custom_data~{item: "options"}] run function ssbrc:game/logic/item/init/replace {search_key: "item", search_value: "options", path: "ssbrc:options"}
