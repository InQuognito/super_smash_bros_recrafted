function ssbrc:game/stage/loop {operation: "function ssbrc:game/pre_game/stage_select/remove_vote"}
function ssbrc:game/pre_game/stage_select/remove_vote {name: "random_stage"}
...
function ssbrc:game/pre_game/stage_select/calculate {function: "ssbrc:game/pre_game/stage_select/diorama"}

$function ssbrc:game/pre_game/stage_select/stage_index/pages/$(page)
