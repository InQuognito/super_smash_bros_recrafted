...
execute positioned ~-.15 ~-.15 ~-.15 as @e[predicate=ssbrc:target,dx=0] positioned ~-.7 ~-.7 ~-.7 if entity @s[dx=0] run function ssbrc:game/damage/generic {amount: 12, kb_resist: 0, i_frames: 10}
