...
execute positioned -31 9 4 rotated -90 0 run function ssbrc:game/stage/pallet_town/pokemon/diglett
...
execute positioned 10 5 -18 summon minecraft:armor_stand run function ssbrc:game/stage/pallet_town/armor_stands/gary
execute positioned -40 .3 -52 summon minecraft:armor_stand run function ssbrc:game/stage/pallet_town/armor_stands/misty
execute positioned 7 3 -18 summon minecraft:armor_stand run function ssbrc:game/stage/pallet_town/armor_stands/nurse_joy
execute positioned 9 3 -17 summon minecraft:armor_stand run function ssbrc:game/stage/pallet_town/armor_stands/officer_jenny
execute positioned 8 6 -22 summon minecraft:armor_stand run function ssbrc:game/stage/pallet_town/armor_stands/professor_oak
