...
function ssbrc:game/stage/saturn_valley/well/off
execute unless data storage ssbrc:data option{hazards: "true"} run schedule clear ssbrc:game/stage/saturn_valley/well/on
