...
execute if data storage ssbrc:data option{game_mode: "ctf"} run return run function ssbrc:game/options/interface/game_mode/ctf
function ssbrc:game/options/interface/game_mode/smash
