...
# Options
function ssbrc:game/options/interface/game_mode

function ssbrc:game/options/interface/teams

function ssbrc:game/options/interface/friendly_fire

function ssbrc:game/options/interface/items

function ssbrc:game/options/interface/hazards

function ssbrc:game/options/interface/music

execute if items entity @s container.* minecraft:written_book[minecraft:custom_data~{item: "options"}] run function ssbrc:game/item/init/replace {search_key: "item", search_value: "options", path: "ssbrc:options"}
