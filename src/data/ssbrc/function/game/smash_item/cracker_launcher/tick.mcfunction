execute unless block ~ ~-.1 ~ #ssbrc:passthrough run return run function ssbrc:game/smash_item/cracker_launcher/explode
...
execute if score #entity_hit temp matches 1 run return run function ssbrc:game/smash_item/cracker_launcher/explode
