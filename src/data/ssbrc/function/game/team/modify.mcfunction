function ssbrc:game/team/modify/friendly_fire
function ssbrc:game/team/modify/teams

function ssbrc:game/team/set_option {key: "collisionRule", value: "always"}
function ssbrc:game/team/set_option {key: "deathMessageVisibility", value: "never"}
function ssbrc:game/team/set_option {key: "nametagVisibility", value: "always"}
function ssbrc:game/team/set_option {key: "prefix", value: ""}
function ssbrc:game/team/set_option {key: "suffix", value: ""}
