...
# Links
#execute positioned -531.99 4.5 -1943.5 run function ssbrc:game/lobby/logo {id:"discord", color: "blue",link:"https://discord.gg/yAzw55N5Ax"}
#execute positioned -531.99 4.5 -1944.5 run function ssbrc:game/lobby/logo {id:"pmc", color: "green",link:"https://www.planetminecraft.com/member/team_recrafted"}
#execute positioned -531.99 4.5 -1945.5 run function ssbrc:game/lobby/logo {id:"youtube", color: "red",link:"https://www.youtube.com/channel/UCCqXNuFgGs53GgP7oSQGtOA"}
...
#function ssbrc:game/lobby/credits/reset
