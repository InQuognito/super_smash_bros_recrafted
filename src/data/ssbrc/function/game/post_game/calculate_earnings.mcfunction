execute if entity @s[tag=ended_early] run function ssbrc:game/data/bonus/loop {function: "ssbrc:game/data/bonus/reset"}
...
function ssbrc:game/data/bonus/loop {function: "ssbrc:game/post_game/bonuses/calculate"}

execute if score @s quitter matches 1.. run function ssbrc:game/post_game/bonuses/quitter
