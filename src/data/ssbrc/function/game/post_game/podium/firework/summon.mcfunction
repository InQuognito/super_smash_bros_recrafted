function ssbrc:game/post_game/podium/firework/offset {axis: "x"}
function ssbrc:game/post_game/podium/firework/offset {axis: "z"}
...
execute summon minecraft:firework_rocket run function ssbrc:game/post_game/podium/firework/init with storage ssbrc:temp cache.firework
