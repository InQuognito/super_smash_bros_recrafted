$function ssbrc:game/item/find {search_key: "$(search_key)", search_value: "$(search_value)"}
...
$function ssbrc:game/item/init/class/$(class) with storage ssbrc:temp cache.item
