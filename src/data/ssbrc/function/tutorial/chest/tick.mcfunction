...
$execute on interaction if entity @s[advancements={ssbrc:tutorial/equipment/$(item)=false}] run function ssbrc:tutorial/chest/open {item: "$(item)", class: "$(class)", type: "$(type)"}
