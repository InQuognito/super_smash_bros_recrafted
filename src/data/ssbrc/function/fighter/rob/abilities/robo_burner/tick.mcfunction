...
execute if score @s charge.2 matches 6 run function ssbrc:fighter/rob/abilities/robo_burner/activate
execute if score @s charge.2 matches 6.. run function ssbrc:fighter/rob/abilities/robo_burner/particle
...
execute if score @s resource matches ..0 run function ssbrc:fighter/rob/abilities/robo_burner/deactivate
