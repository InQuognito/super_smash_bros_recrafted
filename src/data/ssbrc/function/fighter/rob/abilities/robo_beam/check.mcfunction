...
function ssbrc:fighter/rob/abilities/robo_beam/reset
...
execute if score robo_beam temp matches 100.. run function ssbrc:fighter/rob/abilities/robo_beam/activate
