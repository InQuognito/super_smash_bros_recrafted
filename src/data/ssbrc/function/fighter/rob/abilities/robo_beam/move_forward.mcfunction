...
execute if score robo_beam_size temp matches 2 run function ssbrc:fighter/rob/abilities/robo_beam/particles
...
execute if score n temp matches 1.. at @s run function ssbrc:fighter/rob/abilities/robo_beam/move_forward
