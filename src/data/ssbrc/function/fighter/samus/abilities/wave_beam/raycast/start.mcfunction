...
execute if score @s piercing <= samus.wave_beam.piercing const anchored eyes positioned ^ ^ ^ anchored feet run function ssbrc:fighter/samus/abilities/wave_beam/raycast/loop
