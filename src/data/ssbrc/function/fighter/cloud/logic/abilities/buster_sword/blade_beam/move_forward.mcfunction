...
execute positioned ~-0.2 ~ ~-0.2 as @e[tag=!self,predicate=ssbrc:target,dy=1] positioned ~-.6 ~ ~-.6 if entity @s[dy=1] run function ssbrc:fighter/cloud/logic/abilities/buster_sword/blade_beam/hit
