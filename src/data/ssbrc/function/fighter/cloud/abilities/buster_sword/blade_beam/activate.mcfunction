...
execute rotated ~ 0 positioned ^ ^ ^1 summon minecraft:marker run function ssbrc:fighter/cloud/abilities/buster_sword/blade_beam/init
...
execute if score @s resource >= cloud.limit.max const run function ssbrc:fighter/cloud/abilities/buster_sword/blade_beam/limit_break
