...
execute positioned ~-.375 ~-.375 ~-.375 as @e[tag=!self,predicate=ssbrc:target,dx=0] positioned ~-.25 ~-.25 ~-.25 if entity @s[dx=0] run function ssbrc:fighter/shovel_knight/logic/abilities/chaos_sphere/hit
...
execute if score @s point matches 1.. unless block ~ ~-.15 ~ #ssbrc:passthrough_barrier run function ssbrc:fighter/shovel_knight/logic/abilities/chaos_sphere/bounce

execute at @s rotated ~ 0 unless block ~-0.3 ~ ~ #ssbrc:passthrough_barrier store result entity @s Rotation[0] float -1 run data get entity @s Rotation[0]
execute at @s rotated ~ 0 unless block ~0.3 ~ ~ #ssbrc:passthrough_barrier store result entity @s Rotation[0] float -1 run data get entity @s Rotation[0]
execute at @s rotated ~ 0 unless block ~ ~ ~-0.3 #ssbrc:passthrough_barrier store result entity @s Rotation[0] float -1 run data get entity @s Rotation[0]
execute at @s rotated ~ 0 unless block ~ ~ ~0.3 #ssbrc:passthrough_barrier store result entity @s Rotation[0] float -1 run data get entity @s Rotation[0]
