# Shovel Drop
execute if items entity @s weapon.mainhand *[minecraft:custom_data~{item: "shovel_blade",shovel_drop:"true"}] run function ssbrc:fighter/shovel_knight/abilities/shovel_drop/tick
...
execute if score @s[tag=phase_locket] duration.2 matches 1.. run function ssbrc:fighter/shovel_knight/abilities/phase_locket/tick
