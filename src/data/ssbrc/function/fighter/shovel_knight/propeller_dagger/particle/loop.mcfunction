execute positioned ^ ^ ^.5 unless function ssbrc:logic/fighter/check/raycast/block run return run function ssbrc:fighter/shovel_knight/propeller_dagger/particle/success
