execute positioned ^ ^ ^.5 if function ssbrc:logic/game/entity/player/check/raycast/block run return run function ssbrc:fighter/shovel_knight/propeller_dagger/particle/success
