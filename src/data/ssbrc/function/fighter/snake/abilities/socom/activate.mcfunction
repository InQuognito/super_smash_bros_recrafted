...
function ssbrc:fighter/snake/abilities/socom/offset
...
execute anchored eyes positioned ^ ^ ^.5 run function ssbrc:fighter/snake/abilities/socom/start with storage ssbrc:temp cache.rotation

scoreboard players remove @s weapon_4.ammo 1
execute if entity @s[scores={weapon_4.mags=1..,weapon_4.ammo=0}] run function ssbrc:fighter/snake/abilities/socom/reload/start
