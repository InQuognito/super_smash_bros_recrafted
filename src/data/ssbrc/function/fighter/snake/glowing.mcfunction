execute if score #game_stage temp matches 4 run scoreboard players add @s timer 1
...
execute if score @s timer matches 0 run return run function ssbrc:logic/item/replace/get {search_key: "item", search_value: "status", path: "ssbrc:fighter/snake/status/undetected"}
