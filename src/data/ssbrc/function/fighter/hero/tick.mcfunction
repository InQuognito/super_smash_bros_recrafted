...
execute if score @s[tag=kaclang] duration.1 matches 1.. run function ssbrc:fighter/hero/kaclang/tick

execute if score @s[tag=oomph] duration.1 matches 1.. run function ssbrc:fighter/hero/oomph/tick
