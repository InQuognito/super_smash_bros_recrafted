...
execute positioned ~-1 ~-1 ~-1 as @e[tag=!self,predicate=ssbrc:target,dx=1] run function ssbrc:logic/damage/fire {amount: 20, burning: 60, type: "generic", kb_resist: 0, source: "@a[predicate=ssbrc:id_match,limit=1]"}
