...
execute as @e[tag=!self,predicate=ssbrc:target,distance=5.1..10] run return run function ssbrc:logic/damage/generic {amount: 8, type: "generic", kb_resist: 0, source: " by @a[tag=self,limit=1]"}
