...
function ssbrc:fighter/link/abilities/sword_spin/hit

execute unless predicate ssbrc:flag/on_ground run function ssbrc:fighter/link/abilities/sword_spin/levitate
