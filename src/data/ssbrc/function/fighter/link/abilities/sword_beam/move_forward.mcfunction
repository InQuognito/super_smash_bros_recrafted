...
function ssbrc:fighter/link/abilities/sword_beam/particle/check
...
execute if score n temp matches 1.. at @s run function ssbrc:fighter/link/abilities/sword_beam/move_forward
