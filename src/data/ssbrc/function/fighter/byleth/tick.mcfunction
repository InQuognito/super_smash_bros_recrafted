...
execute if entity @s[scores={charge.1=1..,cooldown.1=..0}] as @e[type=minecraft:marker,tag=divine_pulse,predicate=ssbrc:id_match,scores={temp=1},limit=1] at @s run function ssbrc:fighter/byleth/divine_pulse/rewind/marker with entity @s data
