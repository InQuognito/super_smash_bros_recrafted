...
execute if score @s charge.output matches 61..80 run function ssbrc:fighter/byleth/blue_lions/spin_attack/particles/rotate {type: "3"}
execute if score @s charge.output matches 81.. run function ssbrc:fighter/byleth/blue_lions/spin_attack/particles/rotate {type: "4"}
