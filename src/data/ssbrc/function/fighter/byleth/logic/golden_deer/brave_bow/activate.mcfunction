...
execute if entity @s[tag=!silenced] anchored eyes positioned ^ ^ ^1 summon minecraft:marker run function ssbrc:fighter/byleth/logic/golden_deer/brave_bow/init/marker
