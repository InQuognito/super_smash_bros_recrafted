...
execute positioned ^ ^ ^1.5 summon minecraft:item_display run function ssbrc:fighter/pit/abilities/guardian_orbitars/init/front
execute positioned ^ ^ ^-1.5 summon minecraft:item_display run function ssbrc:fighter/pit/abilities/guardian_orbitars/init/back
