...
execute if items entity @s armor.body *[minecraft:custom_data~{persona:"high_pixie"}] run function ssbrc:fighter/joker/logic/abilities/amrita_shower/tick
...
execute if score @s duration.1 matches 1 run function ssbrc:fighter/joker/logic/abilities/persona_awakening/deactivate with entity @s equipment.body.components."minecraft:custom_data"
