...
execute unless items entity @s weapon.mainhand *[minecraft:custom_data~{item: "rebel_knife"}] run function ssbrc:fighter/joker/logic/abilities/rebels_guard/deactivate
