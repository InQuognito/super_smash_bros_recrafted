execute unless score @s duration.1 matches 1.. run function math:percentage {val:"@s charge.1",div:"joker.awakening.max const"}
execute if score @s duration.1 matches 1.. run function math:percentage {val:"@s duration.1",div:"joker.awakening.max const"}
