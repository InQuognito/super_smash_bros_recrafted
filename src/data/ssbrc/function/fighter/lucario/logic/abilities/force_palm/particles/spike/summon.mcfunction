...
execute positioned ^ ^ ^1 summon minecraft:item_display run function ssbrc:fighter/lucario/logic/abilities/force_palm/particles/spike/init with storage ssbrc:temp cache.force_palm
