...
execute as @a[tag=cloaked,distance=..10] run function ssbrc:logic/game/entity/player/effects/glowing/uncloak
...
execute if score #percent temp matches ..0 run function ssbrc:fighter/yar/drone/kill
