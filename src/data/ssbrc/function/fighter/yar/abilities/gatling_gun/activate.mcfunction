...
execute anchored eyes positioned ^ ^ ^1 summon minecraft:marker run function ssbrc:fighter/yar/abilities/gatling_gun/init/marker

scoreboard players add @s charge.1 1
execute if score @s charge.1 matches 200.. run function ssbrc:fighter/yar/abilities/power_ups/reset
...
function ssbrc:fighter/yar/abilities/gatling_gun/cooldown with storage ssbrc:temp cache.cooldown
