...
# Falcon Kick
execute if entity @s[tag=!silenced,tag=!falcon_kick,scores={cooldown.2=..0},predicate=!ssbrc:flag/on_ground,predicate=ssbrc:flag/sneaking] run function ssbrc:fighter/captain_falcon/falcon_kick/activate
