...
function ssbrc:fighter/captain_falcon/abilities/raptor_boost/raycast/abort
execute as @a[tag=self,limit=1] run function ssbrc:fighter/captain_falcon/abilities/raptor_boost/success
