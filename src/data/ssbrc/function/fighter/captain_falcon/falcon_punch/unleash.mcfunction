...
execute positioned ^ ^ ^1 as @e[tag=!self,tag=!falcon_punched,predicate=ssbrc:target,dy=1] run function ssbrc:fighter/captain_falcon/falcon_punch/hit
execute positioned ^ ^ ^2 as @e[tag=!self,tag=!falcon_punched,predicate=ssbrc:target,dy=1] run function ssbrc:fighter/captain_falcon/falcon_punch/hit
