...
scoreboard players set @s[tag=!launched,tag=!ground_pound,scores={motion_y=..-10,charge.3=..0},predicate=ssbrc:flag/sneaking,predicate=!ssbrc:flag/on_ground] charge.3 1
