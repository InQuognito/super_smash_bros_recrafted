...
# Withdraw
execute if entity @s[tag=!silenced,scores={cooldown.2=..0},predicate=ssbrc:flag/sneaking] run function ssbrc:fighter/pokemon_trainer/squirtle/withdraw/charge
