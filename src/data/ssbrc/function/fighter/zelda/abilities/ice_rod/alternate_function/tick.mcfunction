...
execute if score @s temp matches 4.. run function ssbrc:fighter/zelda/abilities/ice_rod/alternate_function/break

scoreboard players add @s timer 1
execute if score @s timer matches 60.. run function ssbrc:fighter/zelda/abilities/ice_rod/alternate_function/break
