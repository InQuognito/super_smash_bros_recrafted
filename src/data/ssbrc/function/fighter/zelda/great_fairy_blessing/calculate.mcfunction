...
scoreboard players set #great_fairy_blessing.cost temp 10
...
function ssbrc:logic/item/modify {search_key: "item", search_value: "great_fairy_blessing", path: "ssbrc:fighter/zelda/great_fairy_blessing"}
