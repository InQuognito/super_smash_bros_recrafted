...
execute if score percentage temp matches 100.. run function ssbrc:fighter/zelda/bomb/explode
execute if entity @s[tag=blasting] unless block ~ ~-0.1 ~ #ssbrc:passthrough run function ssbrc:fighter/zelda/bomb/explode
