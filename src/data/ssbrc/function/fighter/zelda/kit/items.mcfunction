...
execute if score random.output temp matches 1 run data modify storage ssbrc:temp cache.weapon.enchant set value "default"
execute if score random.output temp matches 2 run data modify storage ssbrc:temp cache.weapon.enchant set value "emerald"
execute if score random.output temp matches 3 run data modify storage ssbrc:temp cache.weapon.enchant set value "glass"
execute if score random.output temp matches 4 run data modify storage ssbrc:temp cache.weapon.enchant set value "obsidian"
