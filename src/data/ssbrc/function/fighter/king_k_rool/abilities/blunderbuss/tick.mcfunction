function ssbrc:fighter/king_k_rool/abilities/blunderbuss/particle

execute unless block ~ ~-0.1 ~ #ssbrc:passthrough unless entity @s[tag=hit_ground] run function ssbrc:fighter/king_k_rool/abilities/blunderbuss/land
...
execute if entity @s[tag=!hit_ground,scores={temp=41}] run function ssbrc:fighter/king_k_rool/abilities/blunderbuss/drop
