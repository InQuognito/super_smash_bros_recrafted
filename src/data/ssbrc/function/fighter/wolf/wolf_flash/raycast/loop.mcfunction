...
execute positioned ~ ~.5 ~ positioned ^ ^ ^.5 if function ssbrc:logic/game/entity/player/check/raycast/block run return run function ssbrc:fighter/wolf/wolf_flash/raycast/success
