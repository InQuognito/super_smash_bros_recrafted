...
execute positioned ~ ~.5 ~ positioned ^ ^ ^.5 unless function ssbrc:logic/fighter/check/raycast/block run return run function ssbrc:fighter/wolf/wolf_flash/raycast/abort

teleport @s ~ ~ ~

scoreboard players remove #n temp 1
execute if score #n temp matches 1.. positioned ^ ^ ^.1 run return run function ssbrc:fighter/wolf/wolf_flash/raycast/loop
execute positioned ^ ^ ^.1 run function ssbrc:fighter/wolf/wolf_flash/end
