...
execute if score ray_abort temp matches 1 run function ssbrc:fighter/wolf/abilities/wolf_flash/raycast/abort

execute unless score ray_abort temp matches 1 run function ssbrc:fighter/wolf/abilities/wolf_flash/raycast/proceed
