...
execute if entity @s[tag=mega_man.beat_call] run function ssbrc:fighter/mega_man/beat_call/item
execute if items entity @s[tag=mega_man.drill_bomb] weapon.mainhand *[minecraft:custom_data~{item: "drill_bomb"}] run function ssbrc:fighter/mega_man/update {item: "drill_bomb"}
execute if items entity @s[tag=mega_man.flame_sword] weapon.mainhand *[minecraft:custom_data~{item: "flame_sword"}] run function ssbrc:fighter/mega_man/update {item: "flame_sword"}
