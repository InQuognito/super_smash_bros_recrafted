...
function ssbrc:logic/block/execute_at_ground {result:"execute summon minecraft:item_display run function ssbrc:fighter/mega_man/logic/abilities/junk_shield/summon with storage ssbrc:temp cache.rotation"}
function ssbrc:logic/block/execute_at_ground {result:"execute summon minecraft:item_display run function ssbrc:fighter/mega_man/logic/abilities/junk_shield/summon with storage ssbrc:temp cache.rotation"}
function ssbrc:logic/block/execute_at_ground {result:"execute summon minecraft:item_display run function ssbrc:fighter/mega_man/logic/abilities/junk_shield/summon with storage ssbrc:temp cache.rotation"}
function ssbrc:logic/block/execute_at_ground {result:"execute summon minecraft:item_display run function ssbrc:fighter/mega_man/logic/abilities/junk_shield/summon with storage ssbrc:temp cache.rotation"}
function ssbrc:logic/block/execute_at_ground {result:"execute summon minecraft:item_display run function ssbrc:fighter/mega_man/logic/abilities/junk_shield/summon with storage ssbrc:temp cache.rotation"}
