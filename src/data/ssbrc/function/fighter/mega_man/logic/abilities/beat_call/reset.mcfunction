...
execute unless items entity @s weapon.mainhand *[minecraft:custom_data~{item: "beat_call"}] run return run function ssbrc:fighter/mega_man/logic/abilities/beat_call/deactivate
