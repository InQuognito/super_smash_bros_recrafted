...
execute if entity @s[tag=mega_man.beat_call] run function ssbrc:fighter/mega_man/logic/abilities/beat_call/item
...
execute if entity @s[tag=mega_man.pile_driver] run function ssbrc:fighter/mega_man/logic/abilities/pile_driver/item
