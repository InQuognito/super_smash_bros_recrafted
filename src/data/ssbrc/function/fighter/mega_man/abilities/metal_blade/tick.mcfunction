...
execute if score display temp matches 0 run function ssbrc:fighter/mega_man/abilities/metal_blade/animation/1
execute if score display temp matches 2 run function ssbrc:fighter/mega_man/abilities/metal_blade/animation/2
execute if score display temp matches 4 run function ssbrc:fighter/mega_man/abilities/metal_blade/animation/3
