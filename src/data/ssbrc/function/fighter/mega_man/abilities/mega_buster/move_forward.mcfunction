...
function ssbrc:fighter/mega_man/abilities/mega_buster/particle
...
execute if score n temp matches 1.. at @s run function ssbrc:fighter/mega_man/abilities/mega_buster/move_forward
