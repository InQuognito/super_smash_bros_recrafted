...
execute if score loop temp matches 15 if predicate ssbrc:random_chance/10 run function ssbrc:fighter/jigglypuff/logic/abilities/rest/deactivate
...
execute if score @s charge.1 matches 400.. run function ssbrc:fighter/jigglypuff/logic/abilities/rest/deactivate
