...
# Hot Air
execute unless items entity @s[scores={cooldown.2=..0},predicate=ssbrc:flag/sneaking] armor.body *[minecraft:custom_data~{form: "rest"}] run function ssbrc:fighter/jigglypuff/logic/abilities/hot_air/tick
