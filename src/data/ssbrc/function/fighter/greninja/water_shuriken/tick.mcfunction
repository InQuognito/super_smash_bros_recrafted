...
execute if score display temp matches 0 run function ssbrc:fighter/greninja/water_shuriken/animation/1
execute if score display temp matches 2 run function ssbrc:fighter/greninja/water_shuriken/animation/2
execute if score display temp matches 4 run function ssbrc:fighter/greninja/water_shuriken/animation/3
