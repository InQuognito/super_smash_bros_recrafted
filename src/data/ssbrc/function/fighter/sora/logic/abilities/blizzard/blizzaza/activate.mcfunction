...
execute unless score @s charge.4 matches 3.. run function ssbrc:fighter/sora/logic/abilities/blizzard/blizzaza/summon
execute if score @s charge.4 matches 3.. unless score @s magic >= sora.spell.test temp run function ssbrc:fighter/sora/logic/abilities/blizzard/blizzaza/summon
