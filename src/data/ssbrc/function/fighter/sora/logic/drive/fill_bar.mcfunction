...
execute if score @s[predicate=!ssbrc:fighter/sora/drive_form] resource >= sora.drive.threshold.basic const run function ssbrc:fighter/sora/logic/drive_forms/enable
