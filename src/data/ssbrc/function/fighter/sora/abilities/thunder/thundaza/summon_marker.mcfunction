...
execute store result entity @s Pos[0] double .1 run scoreboard players operation pos_x temp += offset_x temp
...
execute store result entity @s Pos[2] double .1 run scoreboard players operation pos_z temp += offset_z temp
