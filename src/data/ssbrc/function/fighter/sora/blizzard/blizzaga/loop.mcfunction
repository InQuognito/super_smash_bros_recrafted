...
execute positioned ~-.1 ~-.1 ~-.1 as @e[tag=!self,predicate=ssbrc:target,dx=0] positioned ~-.8 ~-.8 ~-.8 if entity @s[dx=0] run function ssbrc:fighter/sora/blizzard/blizzaga/hit
