...
# Hand Slap
execute if entity @s[tag=!silenced,tag=!hand_slap,predicate=ssbrc:flag/sneaking] rotated ~ 0 positioned ^ ^ ^1 unless block ~ ~-0.1 ~ #ssbrc:passthrough run function ssbrc:fighter/donkey_kong/logic/abilities/hand_slap/activate
