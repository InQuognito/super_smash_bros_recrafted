...
execute if score @s point matches 1.. unless block ~ ~-.6 ~ #ssbrc:passthrough_barrier run function ssbrc:fighter/donkey_kong/logic/abilities/orange_grenade/bounce
