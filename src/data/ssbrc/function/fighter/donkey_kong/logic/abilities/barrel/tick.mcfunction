execute positioned ~-0.75 ~-0.75 ~-0.75 if entity @e[tag=!self,predicate=ssbrc:target,dx=0.5] positioned ~.75 ~.75 ~.75 run function ssbrc:fighter/donkey_kong/logic/abilities/barrel/explode
