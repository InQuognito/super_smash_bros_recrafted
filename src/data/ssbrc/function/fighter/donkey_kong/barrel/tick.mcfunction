execute positioned ~-0.75 ~-0.75 ~-0.75 if entity @e[tag=!self,predicate=ssbrc:target,dx=0.5] positioned ~.75 ~.75 ~.75 run function ssbrc:fighter/donkey_kong/barrel/explode
...
execute if score @s point matches 1.. unless block ~ ~-0.1 ~ #ssbrc:passthrough_barrier run function ssbrc:fighter/donkey_kong/barrel/bounce
