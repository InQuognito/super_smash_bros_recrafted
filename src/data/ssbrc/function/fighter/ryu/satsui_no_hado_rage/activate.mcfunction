...
attribute @s minecraft:movement_speed modifier add ssbrc:fighter/ryu/satsui_no_hado_rage .2 add_multiplied_base
...
function ssbrc:logic/item/data/set {item: "collarbone_breaker", flag_key: "evil", flag_value: "true"}
function ssbrc:logic/item/data/set {item: "collarbone_breaker", flag_key: "evil", flag_value: "true"}
