...
execute if block ^ ^ ^.09 #ssbrc:passthrough if score @s bowser.fire_breath < @s charge.1 positioned ^ ^ ^.09 run function ssbrc:fighter/bowser/abilities/fire_breath/raycast
