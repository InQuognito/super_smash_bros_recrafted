...
function ssbrc:fighter/bowser/abilities/fire_breath/particle
...
execute anchored eyes positioned ^ ^ ^.5 run function ssbrc:fighter/bowser/abilities/fire_breath/step with storage ssbrc:temp cache.fire_breath

execute store result storage ssbrc:temp cache.fire_breath.x double .01 run random value -100..100
execute store result storage ssbrc:temp cache.fire_breath.y double .01 run random value -100..100
execute store result storage ssbrc:temp cache.fire_breath.z double .1 run random value 80..175

execute anchored eyes positioned ^ ^ ^.5 run function ssbrc:fighter/bowser/abilities/fire_breath/step2 with storage ssbrc:temp cache.fire_breath

scoreboard players set @s bowser.fire_breath 0
execute anchored eyes positioned ^ ^-.3 ^.3 run function ssbrc:fighter/bowser/abilities/fire_breath/raycast
