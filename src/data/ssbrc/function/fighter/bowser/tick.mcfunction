# Fire Breath
execute if entity @s[tag=!silenced,predicate=ssbrc:flag/sneaking] run function ssbrc:fighter/bowser/fire_breath/tick
...
# Rage
execute if entity @s[tag=!silenced,scores={charge.2=200..}] run function ssbrc:fighter/bowser/rage/activate
