...
execute positioned ~-.5 ~-.15 ~-.5 as @e[tag=!self,predicate=ssbrc:target,dx=0] positioned ~ ~-.7 ~ if entity @s[dx=0] run function ssbrc:fighter/shadow/logic/abilities/chaos_spear/hit
