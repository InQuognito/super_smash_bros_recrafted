...
function ssbrc:fighter/shadow/abilities/chaos_blast/shockwave/particle
...
execute if score n temp matches 1.. at @s run function ssbrc:fighter/shadow/abilities/chaos_blast/shockwave/move_forward
