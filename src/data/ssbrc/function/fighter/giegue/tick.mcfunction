...
execute if entity @s[tag=!silenced,scores={cooldown.3=..0},predicate=ssbrc:flag/sneaking] positioned ~ ~0.1 ~ run function ssbrc:fighter/giegue/4th_dimensional_slip/activate
