...
function ssbrc:fighter/giegue/abilities/pk_freeze/particle
...
execute if entity @s[tag=!pk_freeze.split,scores={temp=30..}] run function ssbrc:fighter/giegue/abilities/pk_freeze/split
