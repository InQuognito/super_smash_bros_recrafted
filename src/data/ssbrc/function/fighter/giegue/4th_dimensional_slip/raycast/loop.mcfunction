...
execute if score ray_abort temp matches 1 run function ssbrc:fighter/giegue/4th_dimensional_slip/end

execute unless score ray_abort temp matches 1 run function ssbrc:fighter/giegue/4th_dimensional_slip/raycast/proceed
