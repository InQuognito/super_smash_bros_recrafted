...
execute store result entity @s Rotation[1] float 1 run scoreboard players get random.output temp

scoreboard players set ray_length temp 15
execute rotated as @s positioned ^ ^ ^-.75 run function ssbrc:fighter/team_rocket/logic/meowth/fury_swipes/loop
