...
execute as @e[tag=!self,predicate=ssbrc:target,dx=0] run function ssbrc:logic/damage/generic {amount: 1.5, type: "generic", kb_resist: 0, source: "@a[predicate=ssbrc:owner,limit=1]"}
