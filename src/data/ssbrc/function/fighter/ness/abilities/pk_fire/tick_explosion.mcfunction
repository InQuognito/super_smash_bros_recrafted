execute positioned ~ ~1 ~ run function ssbrc:fighter/ness/abilities/pk_fire/particles/diamonds/spawn
execute positioned ~ ~1 ~ run function ssbrc:fighter/ness/abilities/pk_fire/particles/diamonds/spawn
function ssbrc:fighter/ness/abilities/pk_fire/particles/smoke/offset
function ssbrc:fighter/ness/abilities/pk_fire/particles/smoke/offset
function ssbrc:fighter/ness/abilities/pk_fire/particles/smoke/offset
