...
execute as @e[predicate=ssbrc:target,tag=!self,distance=..1.5] run function ssbrc:logic/damage/fire {amount: 4, burning: 10, type: "pierce", kb_resist: .9, source: "@a[predicate=ssbrc:id_match,limit=1]"}
