...
execute if score @s raycast matches 1.. positioned ^ ^ ^.1 if block ~ ~ ~ #ssbrc:passthrough run function ssbrc:fighter/dark_samus/logic/abilities/phazon_overload/raycast
