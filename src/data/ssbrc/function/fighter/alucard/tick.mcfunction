...
# Mist
execute if entity @s[scores={silenced=..0,cooldown.1=..0},predicate=ssbrc:flag/sneaking] unless function ssbrc:logic/game/entity/player/if_grounded run function ssbrc:fighter/alucard/mist/activate
