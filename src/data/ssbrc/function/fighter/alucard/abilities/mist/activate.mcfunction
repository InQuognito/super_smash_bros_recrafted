...
execute if entity @s[tag=blood_metamorphosis] summon minecraft:marker run function ssbrc:fighter/alucard/abilities/mist/summon

function ssbrc:fighter/alucard/abilities/mist/shield
