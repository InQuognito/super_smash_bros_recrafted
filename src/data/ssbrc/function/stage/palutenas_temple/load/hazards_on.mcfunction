...
# Spike Pits
execute positioned 50007 202.5 24966 summon minecraft:item_display run function ssbrc:stage/palutenas_temple/logic/spike_pit/init
execute positioned 50007 202.5 24974 summon minecraft:item_display run function ssbrc:stage/palutenas_temple/logic/spike_pit/init
