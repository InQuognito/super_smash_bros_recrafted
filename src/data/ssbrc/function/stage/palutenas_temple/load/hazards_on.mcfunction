...
# Spike Pits
execute positioned 21 -10 -7 summon minecraft:item_display run function ssbrc:stage/palutenas_temple/spike_pit/init
execute positioned 21 -10 1 summon minecraft:item_display run function ssbrc:stage/palutenas_temple/spike_pit/init
