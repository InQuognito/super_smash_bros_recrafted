...
# Spike Pits
execute positioned 23 -9.5 -5 summon minecraft:item_display run function ssbrc:stage/palutenas_temple/spike_pit/init
execute positioned 23 -9.5 3 summon minecraft:item_display run function ssbrc:stage/palutenas_temple/spike_pit/init
