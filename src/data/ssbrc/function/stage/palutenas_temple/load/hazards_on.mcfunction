...
# Spike Pits
execute positioned 22 -10 -6 summon minecraft:item_display run function ssbrc:stage/palutenas_temple/spike_pit/init
execute positioned 22 -10 2 summon minecraft:item_display run function ssbrc:stage/palutenas_temple/spike_pit/init
