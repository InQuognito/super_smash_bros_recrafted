...
execute if data storage ssbrc:data option{debug: true} run function ssbrc:logic/game/entity/player/get/random {function: "ssbrc:stage/miiverse/posts/apply/get"}
