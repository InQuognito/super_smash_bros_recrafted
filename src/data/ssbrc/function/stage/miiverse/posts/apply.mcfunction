...
execute unless data storage ssbrc:data option{debug: true} as @p[tag=not_posted] run function ssbrc:stage/miiverse/posts/apply/get with entity @s equipment.body.components."minecraft:custom_data"
