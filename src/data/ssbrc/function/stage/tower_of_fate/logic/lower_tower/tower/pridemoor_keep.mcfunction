...
execute positioned ~-7 ~-9 ~ rotated -90 0 summon minecraft:armor_stand run function ssbrc:stage/tower_of_fate/logic/lower_tower/tower/pridemoor_keep/armor_stands/init
execute positioned ~7 ~-9 ~ rotated 90 0 summon minecraft:armor_stand run function ssbrc:stage/tower_of_fate/logic/lower_tower/tower/pridemoor_keep/armor_stands/init
