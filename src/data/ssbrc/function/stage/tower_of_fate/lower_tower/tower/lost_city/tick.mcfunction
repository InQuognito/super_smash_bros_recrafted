...
} align xyz positioned ~.5 ~-.5 ~.5 unless entity @e[type=minecraft:marker,tag=tower_of_fate.lost_city.block,distance=...01] summon minecraft:marker run function ssbrc:stage/tower_of_fate/lower_tower/tower/lost_city/block/init
