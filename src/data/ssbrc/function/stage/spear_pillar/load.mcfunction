...
execute if predicate ssbrc:fighter/pokemon/shiny_chance run function ssbrc:stage/spear_pillar/pokemon/dialga/shiny

# Giratina
function ssbrc:stage/spear_pillar/pokemon/giratina/default
execute if predicate ssbrc:fighter/pokemon/shiny_chance run function ssbrc:stage/spear_pillar/pokemon/giratina/shiny
