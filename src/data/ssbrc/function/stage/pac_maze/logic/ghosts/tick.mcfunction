...
execute if data storage ssbrc:temp game.stage{variant:"pac_maze"} positioned 23336 5 8613 unless data entity @s data{state:"dead"} unless entity @s[dx=45,dy=5,dz=55] run function ssbrc:stage/pac_maze/logic/ghosts/touch/kill_ghost with storage ssbrc:temp game.stage
execute if data storage ssbrc:temp game.stage{variant:"mrs_pac_maze"} positioned 23284 5 8613 unless data entity @s data{state:"dead"} unless entity @s[dx=50,dy=5,dz=55] run function ssbrc:stage/pac_maze/logic/ghosts/touch/kill_ghost with storage ssbrc:temp game.stage
