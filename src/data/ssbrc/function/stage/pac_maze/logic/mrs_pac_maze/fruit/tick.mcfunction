execute align xyz positioned ~.5 ~ ~.5 if entity @s[distance=..0.09] positioned ~ ~7 ~ if block ~ ~ ~ minecraft:light_blue_concrete run function ssbrc:stage/pac_maze/logic/ghosts/navigation/turn/random
