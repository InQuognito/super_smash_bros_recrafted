...
execute if score random.output temp matches 1 positioned 23287.5 6 8629.5 rotated -90 0 summon minecraft:item_display run function ssbrc:stage/pac_maze/logic/fruit/init with storage ssbrc:temp cache
execute if score random.output temp matches 2 positioned 23331.5 6 8629.5 rotated 90 0 summon minecraft:item_display run function ssbrc:stage/pac_maze/logic/fruit/init with storage ssbrc:temp cache
execute if score random.output temp matches 3 positioned 23287.5 6 8648.5 rotated -90 0 summon minecraft:item_display run function ssbrc:stage/pac_maze/logic/fruit/init with storage ssbrc:temp cache
execute if score random.output temp matches 4 positioned 23331.5 6 8648.5 rotated 90 0 summon minecraft:item_display run function ssbrc:stage/pac_maze/logic/fruit/init with storage ssbrc:temp cache
