...
execute positioned 23360.5 6.5 8638 summon minecraft:item_display run function ssbrc:stage/pac_maze/logic/ghosts/init {name:"pinky"}
execute positioned 23358.5 6.5 8638 summon minecraft:item_display run function ssbrc:stage/pac_maze/logic/ghosts/init {name:"inky"}
execute positioned 23362.5 6.5 8638 summon minecraft:item_display run function ssbrc:stage/pac_maze/logic/ghosts/init {name:"clyde"}
execute if data storage ssbrc:data option{hazards: true} positioned 23360.5 6.5 8633.5 summon minecraft:item_display run return run function ssbrc:stage/pac_maze/logic/ghosts/init {name:"blinky"}
execute positioned 23360.5 6.5 8636.5 summon minecraft:item_display run function ssbrc:stage/pac_maze/logic/ghosts/init {name:"blinky"}
