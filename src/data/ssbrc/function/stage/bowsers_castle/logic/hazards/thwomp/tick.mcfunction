...
execute if entity @s[tag=top] run function ssbrc:stage/bowsers_castle/logic/hazards/thwomp/top/tick
execute if entity @s[tag=left] run function ssbrc:stage/bowsers_castle/logic/hazards/thwomp/left/tick
