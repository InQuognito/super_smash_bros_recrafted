...
execute if block ~ ~-.1 ~ minecraft:stripped_jungle_log run return run function ssbrc:stage/bowsers_castle/logic/hazards/destruction/bridge/damaged
execute if block ~ ~-.1 ~ minecraft:polished_andesite run function ssbrc:stage/bowsers_castle/logic/hazards/destruction/bridge/broken
