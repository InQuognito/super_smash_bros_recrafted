particle minecraft:cloud ^ ^.5 ^-.5 .5 .25 .5 .025 10 normal @a
...
execute if score @s temp matches 252..330 positioned ^ ^4.25 ^3.5 run function ssbrc:stage/lake_of_rage/pokemon/gyarados/hyper_beam/tick
...
execute if score @s temp matches 621 run function ssbrc:stage/lake_of_rage/pokemon/gyarados/deactivate
