...
particle minecraft:item{item:{id:"minecraft:stick",components:{"minecraft:item_model":"animated_java:blueprint/fgii_graham/body"}}} ~ ~ ~ 0 0 0 .15 100 normal @a
...
schedule function ssbrc:stage/pyrosphere/fgii_graham/activate 600t replace
